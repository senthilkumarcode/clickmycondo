...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["todo-todo-module"], {
    ...
    function () {
      ...
      _createClass(TodoCreateComponent, [{
        ...
        value: function editCategory(id) {
          ...
          this.todoService.getTodoListCategoryById(id).subscribe(function (resp) {
            var data = resp;
            data['type'] = 'edit';
  ...
  function srcAppAmsTodoTodoHistoryTodoHistoryComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      ...
      _createClass(TodoHistoryComponent, [{
        ...
        key: "getTodoHistory",
        value: function getTodoHistory() {// this.todoService.getAllTodoLists().subscribe(
          //   (resp: any) => {
  ...
  function srcAppAmsTodoTodoListTodoListComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function TodoListComponent(todoService, cookieService, dialog) {
      ...
      _createClass(TodoListComponent, [{
        ...
        value: function getTodoList() {
          ...
          this.todoService.getAllTodoListsByApartmentId(getList).subscribe(function (resp) {
            _this13.todoList = resp.filter(function (data) {
              return data.isActive;
            });
          }, function (error) {});
        }
        ...
        value: function deleteList(id) {
          ...
          this.todoService.deleteTodoList(deleteParam).subscribe(function (resp) {
            _this15.getTodoList();
          }, function (error) {});
        }
      }, {
    ...
    }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_api_controllers_TodoList__WEBPACK_IMPORTED_MODULE_2__["TodoListService"], ngx_cookie_service__WEBPACK_IMPORTED_MODULE_3__["CookieService"], _angular_material_dialog__WEBPACK_IMPORTED_MODULE_5__["MatDialog"]])], TodoListComponent);
    /***/
  },
      ...
      _createClass(TodoReminderComponent, [{
        ...
        value: function getTodoHistory() {
          ...
          this.todoService.getAllTodoLists(getTodoParam).subscribe(function (resp) {
            _this17.todoReminderList = resp.filter(function (data) {
              return data.isActive;
            });
          }, function (error) {});
        }
