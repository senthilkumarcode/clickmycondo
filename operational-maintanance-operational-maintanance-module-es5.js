      ...
      _createClass(MaintainOperationalMaintananceComponent, [{
        ...
        value: function ngOnInit() {
          ...
          if (this.opMaintenancePlanId) {
            ...
            this.genMaintService.getGenMaintenancePlanById(params).subscribe(function (res) {
              ...
              _this4.dropDownListOfSubCategory();
            });
          }
        }
      }, {
        ...
        value: function getAllStaff() {
          ...
          this.staffService.getAllStaffsByApartmentId(queryParamBase).subscribe(function (res) {
            if (res.length > 0) {
              _this7.staffList.dropdownList = res.filter(function (ele) {
                ele.customLabel = "".concat(ele.firstName, " ").concat(ele.lastName, " ").concat(ele.staffCategory_Label);
                return ele.isActive;
              });

              if (_this7.isEdit) {
                _this7.staffList.selectedItems = _this7.staffList.dropdownList.filter(function (data) {
                  return data.staffId == parseInt(_this7.maintain.performedbyAssociationStaffId);
                });
              }
            }
          });
        ...
        value: function addMaintanance() {
          ...
          this.genMaintService.addGenMaintenancePlan(params).subscribe(function (res) {
            if (res.message) {
              ...
              _this8.router.navigate(['ams/operational-maintenance/operational-maintenance-list']);
            }
          });
        }
      }, {
        ...
        value: function updateMaintanance() {
          ...
          this.genMaintService.updateGenMaintenancePlan(params).subscribe(function (res) {
            if (res && res.message) {
              ...
              _this9.router.navigate(['ams/operational-maintenance/operational-maintenance-list']);
            }
          });
        }
      }, {
