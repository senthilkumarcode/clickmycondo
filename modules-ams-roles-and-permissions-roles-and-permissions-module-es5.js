  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["modules-ams-roles-and-permissions-roles-and-permissions-module"], {
        ...
        _createClass(RolesAndPermissionsListComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.sharedService.unitlistdeleteindexcast.subscribe(function (id) {
              if (id != null) {
                ...
                _this.screenService.deleteMenuRoleSecLevel(params).subscribe(function (res) {
                  _this.getRolePermissionList();
                }, function (error) {
                  console.log(error);
                });
              }
          ...
          value: function getRolePermissionList() {
            ...
            this.screenService.getAllDefaultMenuRoleSecLevelbyApartmentId(param).subscribe(function (resp) {
              ...
              _this2.roleList = new jqx.dataAdapter(gridSourceData);
              _this2.isShowRoleList = true;
              _this2.isEnableCreate = true;
            });
          }
        }]);
    ...
    function srcAppModulesAmsRolesAndPermissionsRolesAndPermissionsRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var routes = [{
        ...
        path: 'set-permission',
        component: _set_permissions_set_permissions_component__WEBPACK_IMPORTED_MODULE_4__["SetPermissionsComponent"]
      }, {
        path: '**',
        redirectTo: 'roles-permissions-list',
        pathMatch: 'full'
        ...
        _createClass(SetPermissionsComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.activatedRoute.queryParams.subscribe(function (params) {
              _this3.secLevelId = params['secLevelId'];
              _this3.roleId = params['roleId'];

              _this3.getScreenList();
            });
            this.actionList = [{
              name: 'add',
              functionId: 0,
          ...
          value: function getScreenList() {
            ...
            this.screenService.getMenuFunctionByRoleIdMultiFilter(queryParamBase).subscribe(function (resp) {
              _this4.menuList = resp;

              if (_this4.menuList && _this4.menuList.length) {
                _this4.selectedMenuName = _this4.menuList[0].menuName;
          ...
          value: function changeMenu(event) {
            ...
            if (this.selectedMenuName) {
              this.menuList.filter(function (key) {
                if (key.menuName == _this5.selectedMenuName) {
                  _this5.subMenuList = key.subMenuNames;
                  _this5.selectedSubMenuName = _this5.subMenuList.length ? _this5.subMenuList[0].subMenuName : '';

                  _this5.changeSubMenu('');
                }
              });
            }
          }
          ...
          value: function changeSubMenu(event) {
            ...
            if (event) {
              ...
              this.subMenuList.filter(function (key) {
                if (_this6.selectedSubMenuName == key.subMenuName) {
                  _this6.actions = key.actions;
