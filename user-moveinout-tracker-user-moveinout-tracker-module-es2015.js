...
/* harmony import */ var _components_user_movein_user_movein_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/user-movein/user-movein.component */ "./src/app/user/user-moveinout-tracker/components/user-movein/user-movein.component.ts");
/* harmony import */ var _components_user_moveout_user_moveout_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/user-moveout/user-moveout.component */ "./src/app/user/user-moveinout-tracker/components/user-moveout/user-moveout.component.ts");
...
const routes = [
    ...
    { path: 'movein', component: _components_user_movein_user_movein_component__WEBPACK_IMPORTED_MODULE_3__["UserMoveinComponent"] },
    { path: 'moveout', component: _components_user_moveout_user_moveout_component__WEBPACK_IMPORTED_MODULE_4__["UserMoveoutComponent"] },
    { path: '**', redirectTo: 'movein', pathMatch: 'full' }
];
let UserMoveinoutTrackerRoutingModule = class UserMoveinoutTrackerRoutingModule {
};
UserMoveinoutTrackerRoutingModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
UserMoveinoutTrackerComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-user-moveinout-tracker',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./user-moveinout-tracker.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/user/user-moveinout-tracker/user-moveinout-tracker.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./user-moveinout-tracker.component.scss */ "./src/app/user/user-moveinout-tracker/user-moveinout-tracker.component.scss")).default]
    }),
...
/* harmony import */ var _components_user_movein_user_movein_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/user-movein/user-movein.component */ "./src/app/user/user-moveinout-tracker/components/user-movein/user-movein.component.ts");
/* harmony import */ var _components_user_moveout_user_moveout_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./components/user-moveout/user-moveout.component */ "./src/app/user/user-moveinout-tracker/components/user-moveout/user-moveout.component.ts");
...
UserMoveinoutTrackerModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        declarations: [
            _user_moveinout_tracker_component__WEBPACK_IMPORTED_MODULE_5__["UserMoveinoutTrackerComponent"],
            _components_user_movein_user_movein_component__WEBPACK_IMPORTED_MODULE_6__["UserMoveinComponent"],
            _components_user_moveout_user_moveout_component__WEBPACK_IMPORTED_MODULE_7__["UserMoveoutComponent"]
        ],
        imports: [
...
//# sourceMappingURL=user-moveinout-tracker-user-moveinout-tracker-module-es2015.js.map