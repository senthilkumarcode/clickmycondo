(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["modules-ams-staff-manager-staff-manager-module"], {
    ...
    function node_modulesRawLoaderDistCjsJsSrcAppModulesAmsStaffManagerComponentsAddEntryAddEntryComponentHtml(module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_exports__["default"] = "<app-loader *ngIf=\"!isEntrySubmitted\"></app-loader>\n<div class=\"main\">\n\n\t<h4 class=\"mb-4\">\n\t\t<span *ngIf=\"!isEditEntry\">Add Attadance</span>\n\t\t<span *ngIf=\"isEditEntry\">Edit Attadance</span>\n\t</h4>\n\t<form #addEntryForm=\"ngForm\" *ngIf=\"isEntrySubmitted\" name=\"addEntryForm\" (ngSubmit)=\"submitEntryForm(addEntryForm)\"\n\t\t\tnovalidate>\n\t\t\t<div class=\"bg-card shadow\">\n\t\t\t\t<div class=\"row\">\n\t\t\t\t\t<div class=\"col-sm-4\">\n\t\t\t\t\t\t<div class=\"select-box\">\n\t\t\t\t\t\t\t<label>Name*</label>\n\t\t\t\t\t\t\t<select name=\"staffId\" id=\"staffId\" class=\"form-control\" [(ngModel)]=\"entry.staffId\"\n\t\t\t\t\t\t\t\t(ngModelChange)=\"getStaffJobTitle()\" required>\n\t\t\t\t\t\t\t\t<option value=\"\" disabled selected hidden>Select</option>\n\t\t\t\t\t\t\t\t<option *ngFor=\"let item of staffDataList\" [value]=\"item.staffId\">{{ item.firstName }}</option>\n\t\t\t\t\t\t\t</select>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t</div>\n\t\t\t\t\t<div class=\"col-sm-4\">\n\t\t\t\t\t\t<div class=\"input-box\">\n\t\t\t\t\t\t\t<label>Job title*</label>\n\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\" placeholder=\"Enter text\" name=\"ticketSubject\"\n\t\t\t\t\t\t\t\t[(ngModel)]=\"entry.jobTitle\" required>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t</div>\n\t\t\t\t\t<div class=\"col-sm-4\">\n\t\t\t\t\t\t<div class=\"input-box\">\n\t\t\t\t\t\t\t<label>In-time*</label>\n\t\t\t\t\t\t\t<input class=\"form-control\" name=\"staffInTime\" [owlDateTime]=\"staffInTime\"\n\t\t\t\t\t\t\t\t[owlDateTimeTrigger]=\"staffInTime\" placeholder=\"Date Time\" [(ngModel)]=\"entry.inTime\" required>\n\t\t\t\t\t\t\t<owl-date-time #staffInTime [pickerType]=\"'timer'\"></owl-date-time>\n\t\t\t\t\t\t\t<div class=\"date-btn\" [owlDateTimeTrigger]=\"staffInTime\">\n\t\t\t\t\t\t\t\t<i-feather class=\"icon del-c float-left mr-1\" name=\"x-circle\" width=\"18\"\n\t\t\t\t\t\t\t\t\t*ngIf=\"entry.inTime != '' && entry.inTime != undefined\" (click)=\"entry.inTime=''\">\n\t\t\t\t\t\t\t\t</i-feather>\n\t\t\t\t\t\t\t\t<mat-icon svgIcon=\"feather:calendar\"></mat-icon>\n\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t</div>\n\t\t\t\t\t<div class=\"col-sm-4\">\n\t\t\t\t\t\t<div class=\"input-box\">\n\t\t\t\t\t\t\t<label>Out-time</label>\n\t\t\t\t\t\t\t<input class=\"form-control\" name=\"staffOutTime\" [owlDateTime]=\"staffOutTime\"\n\t\t\t\t\t\t\t\t[owlDateTimeTrigger]=\"staffOutTime\" placeholder=\"Date Time\" [(ngModel)]=\"entry.outTime\">\n\t\t\t\t\t\t\t<owl-date-time #staffOutTime [pickerType]=\"'timer'\"></owl-date-time>\n\t\t\t\t\t\t\t<div class=\"date-btn\" [owlDateTimeTrigger]=\"staffOutTime\">\n\t\t\t\t\t\t\t\t<i-feather class=\"icon del-c float-left mr-1\" name=\"x-circle\" width=\"18\"\n\t\t\t\t\t\t\t\t\t*ngIf=\"entry.outTime != '' && entry.outTime != undefined\" (click)=\"entry.outTime=''\">\n\t\t\t\t\t\t\t\t</i-feather>\n\t\t\t\t\t\t\t\t<mat-icon svgIcon=\"feather:calendar\"></mat-icon>\n\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t</div>\n\t\t\t\t\t<div class=\"col-sm-4\">\n\t\t\t\t\t\t<div class=\"select-box\">\n\t\t\t\t\t\t\t<label>In Gate*</label>\n\t\t\t\t\t\t\t<select name=\"inGateId\" id=\"inGateId\" class=\"form-control\" [(ngModel)]=\"entry.inGateId\" required>\n\t\t\t\t\t\t\t\t<option value=\"\" disabled selected hidden>Select</option>\n\t\t\t\t\t\t\t\t<option *ngFor=\"let item of gatesDataList\" [value]=\"item.gateId\">{{ item.gateName }}</option>\n\t\t\t\t\t\t\t</select>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t</div>\n\t\t\t\t\t<div class=\"col-sm-4\">\n\t\t\t\t\t\t<div class=\"select-box\">\n\t\t\t\t\t\t\t<label>Out Gate*</label>\n\t\t\t\t\t\t\t<select name=\"outGateId\" id=\"outGateId\" class=\"form-control\" [(ngModel)]=\"entry.outGateId\">\n\t\t\t\t\t\t\t\t<option value=\"\" disabled selected hidden>Select</option>\n\t\t\t\t\t\t\t\t<option *ngFor=\"let item of gatesDataList\" [value]=\"item.gateId\">{{ item.gateName }}</option>\n\t\t\t\t\t\t\t</select>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t</div>\n\t\t\t\t\t<div class=\"col-sm-4\">\n\t\t\t\t\t\t<div class=\"input-box radio-box\">\n\t\t\t\t\t\t\t<label>shift Type*</label>\n\t\t\t\t\t\t\t<div class=\"form-group\">\n\t\t\t\t\t\t\t\t<input name=\"shiftType\" id=\"Morning\" [(ngModel)]=\"shiftType\" (ngModelChange)=\"getShifts()\"\n\t\t\t\t\t\t\t\t\tvalue=\"127\" type=\"radio\" required>\n\t\t\t\t\t\t\t\t<label class=\"radio-inline\" for=\"Morning\">Morning</label>\n\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t<div class=\"form-group\">\n\t\t\t\t\t\t\t\t<input name=\"shiftType\" id=\"Night\" [(ngModel)]=\"shiftType\" (ngModelChange)=\"getShifts()\"\n\t\t\t\t\t\t\t\t\tvalue=\"128\" type=\"radio\" required>\n\t\t\t\t\t\t\t\t<label class=\"radio-inline\" for=\"Night\">Night</label>\n\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t</div>\n\t\t\t\t\t<div class=\"col-sm-4\" *ngIf=\"isShiftSelected()\">\n\t\t\t\t\t\t<div class=\"select-box\">\n\t\t\t\t\t\t\t<label>Start Time*</label>\n\t\t\t\t\t\t\t<select name=\"startTime\" id=\"startTime\" class=\"form-control\" [(ngModel)]=\"entry.shiftId\" required>\n\t\t\t\t\t\t\t\t<option value=\"\" disabled selected hidden>Select</option>\n\t\t\t\t\t\t\t\t<option *ngFor=\"let item of shiftsFilteredDataList\" [value]=\"item.shiftId\">{{ item.startTime }}\n\t\t\t\t\t\t\t\t</option>\n\t\t\t\t\t\t\t</select>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t</div>\n\t\t\t\t\t<div class=\"col-sm-6\">\n\t\t\n\t\t\t\t\t\t<div class=\"input-box\">\n\t\t\t\t\t\t\t<label>Comments</label>\n\t\t\t\t\t\t\t<textarea placeholder=\"some text here\" name=\"comments\" [(ngModel)]=\"entryComments\"></textarea>\n\t\t\t\t\t\t</div>\n\t\t\n\t\t\t\t\t</div>\n\t\t\t\t\t<div class=\"col-sm-12\">\n\t\t\t\t\t\t<ul class=\"list-inline float-right mt-4\">\n\t\t\t\t\t\t\t<li class=\"list-inline-item\">\n\t\t\t\t\t\t\t\t<button mat-flat-button [color]=\"'primary'\" [disabled]=\"addEntryForm.invalid\">Submit</button>\n\t\t\t\t\t\t\t\t<button mat-flat-button  routerLink=\"/ams/staff/attendance\" \n\t\t\t\t\t\t\t\trouterLinkActive=\"active\"\n\t\t\t\t\t\t\t\t[routerLinkActiveOptions] = \"{exact:true}\">Cancel</button>\n\t\t\t\t\t\t\t</li>\n\t\t\t\t\t\t</ul>\n\t\t\t\t\t</div>\n\t\t\n\t\t\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t</form>\n\n</div>";
      /***/
    },
    ...
    /***/
    "./node_modules/raw-loader/dist/cjs.js!./src/app/modules/ams/staff-manager/components/staff-setup/associate-staff/associate-staff.component.html":
    /*!*******************************************************************************************************************************************************!*\
      !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/modules/ams/staff-manager/components/staff-setup/associate-staff/associate-staff.component.html ***!
      \*******************************************************************************************************************************************************/
    ...
    /***/
    function node_modulesRawLoaderDistCjsJsSrcAppModulesAmsStaffManagerComponentsStaffSetupAssociateStaffAssociateStaffComponentHtml(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function node_modulesRawLoaderDistCjsJsSrcAppModulesAmsStaffManagerComponentsStaffSetupPersonalStaffPersonalStaffComponentHtml(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_exports__["default"] = "<mat-drawer-container class=\"content-layout right-sidebar-fullheight-basic-inner-scroll\" [hasBackdrop]=\"true\">\n\t<mat-drawer #association mode=\"over\" position=\"end\">\n\t\t<div class=\"add-association-category\">\n\t\t\t<div class=\"title\">\n\t\t\t\t<h4>\n\t\t\t\t\t<span *ngIf=\"!isEdit\">Add Personal</span>\n\t\t\t\t\t<span *ngIf=\"isEdit\">Update Personal</span>\n\t\t\t\t</h4>\n\t\t\t\t<div class=\"ml-auto\">\n\t\t\t\t\t<button mat-icon-button (click)=\"addCategory()\">\n\t\t\t\t\t\t<mat-icon [svgIcon]=\"'close'\"></mat-icon>\n\t\t\t\t\t</button>\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t\t<form #addAssociationCategoryForm=\"ngForm\">\n\t\t\t\t<div class=\"row\">\n\t\t\t\t\t<div class=\"col-sm-12\">\n\t\t\t\t\t\t<div class=\"input-box\">\n\t\t\t\t\t\t\t<label>Sub Category</label>\n\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\" placeholder=\"Enter text\" name=\"staffCategory\"\n\t\t\t\t\t\t\t\t[(ngModel)]=\"staffCategory\" required>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\t\t\t\t<div class=\"row\">\n\t\t\t\t\t<div class=\"col-sm-12\">\n\t\t\t\t\t\t<div class=\"float-right\">\n\t\t\t\t\t\t\t<button class=\"mr-2\" mat-flat-button [color]=\"'primary'\"\n\t\t\t\t\t\t\t\t(click)=\"submitAssociate()\">{{isEdit ? 'Update' : 'Submit'}}</button>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\t\t\t</form>\n\t\t</div>\n\t</mat-drawer>\n\t<mat-drawer-content>\n\t\t<app-loader *ngIf=\"!isCategoryDataLoaded\"></app-loader>\n\t\t<div class=\"main\">\n\t\t\t<div *ngIf=\"isCategoryDataLoaded\">\n\t\t\t\t<!-- Document Header -->\n\t\t\t\t<div class=\"d-flex mb-4\">\n\t\t\t\t\t<div>\n\t\t\t\t\t\t<h4>Personal Staff Categories</h4>\n\t\t\t\t\t\t<p class=\"text-secondary\">{{categoryOffcialListData.length}} Items</p>\n\t\t\t\t\t</div>\n\t\t\t\t\t<div class=\"ml-auto d-none d-md-block mr-3\">\n\t\t\t\t\t\t<input type=\"text\" class=\"form-control\" placeholder=\"Search...\" [(ngModel)]=\"categorySearch\">\n\t\t\t\t\t</div>\n\t\t\t\t\t<div>\n\t\t\t\t\t\t<button mat-flat-button [color]=\"'primary'\" (click)=\"addCategory()\">\n\t\t\t\t\t\t\t<mat-icon class=\"mr-2\" [svgIcon]=\"'add'\"></mat-icon>\n\t\t\t\t\t\t\tAdd New Category\n\t\t\t\t\t\t</button>\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\t\t\t\t<!-- Document List -->\n\t\t\t\t<div class=\"bg-card-list\">\n\t\t\t\t\t<div class=\"bg-card pt-4 pr-5 pl-5 shadow\"\n\t\t\t\t\t\t*ngFor=\"let item of categoryOffcialListData | simpleSearch: categorySearch; let i = index\">\n\t\t\t\t\t\t<div class=\"desp mt-3\">\n\t\t\t\t\t\t\t<h6>{{item.lookupValueName}}</h6>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t\t<div class=\"mt-3 ml-n4 button-wrapper\">\n\t\t\t\t\t\t\t<button class=\"px-3\" mat-button [color]=\"'primary'\" (click)=\"editStaffCategory(item)\">\n\t\t\t\t\t\t\t\t<mat-icon [svgIcon]=\"'feather:edit'\"></mat-icon> Edit\n\t\t\t\t\t\t\t</button>\n\t\t\t\t\t\t\t<button class=\"px-3\" mat-button [color]=\"'warn'\"\n\t\t\t\t\t\t\t\t(click)=\"deleteAssociate(item.lookupValueId)\">\n\t\t\t\t\t\t\t\t<mat-icon [svgIcon]=\"'feather:trash-2'\"></mat-icon> Delete\n\t\t\t\t\t\t\t</button>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\t\t\t\t<!-- Document Create -->\n\t\t\t</div>\n\t\t</div>\n\t</mat-drawer-content>\n</mat-drawer-container>";
      /***/
    },
    ...
    function srcAppModulesAmsStaffManagerComponentsAddEntryAddEntryComponentTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var AddEntryComponent = /*#__PURE__*/function () {
        function AddEntryComponent(router, route, staffService, lookupService, sharedService, sessionService) {
    ...
    function srcAppModulesAmsStaffManagerComponentsAddStaffAddStaffComponentScss(module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_exports__["default"] = ".intl-tel-input {\n  width: 100%;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
      /***/
    },
    ...
    function srcAppModulesAmsStaffManagerComponentsAddStaffAddStaffComponentTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var AddStaffComponent = /*#__PURE__*/function () {
        function AddStaffComponent(router, route, userService, staffService, lookupService, sharedService, sessionService, emailSendService, screenService) {
            ...
            if (!this.isEditStaff) {
              ...
              this.userService.addUser(userParams).subscribe(function (res) {
                if (res && res.responseData && res.responseData.statusCode === 200) {
                  _this6.userId = res.responseData.value.message;
                  var staffDetails = {
                    ...
                    "contactNumber": _this6.phoneForm.value.phone.e164Number,
                    ...
                    "updatedBy": parseInt(_this6.sessionService.userId),
                    "updatedOn": "2019-11-30T12:41:45.620Z",
                    "secLevelId": _this6.staff.secLevelId
                  };
                  var staffParams = {
                    staff: staffDetails
                  };
                      ...
                      _this6.userService.addUserRole(roleParams).subscribe(function (res) {
                        if (res.message) {
                          ...
                          _this6.emailSendService.sendEmail(emailDetails).subscribe(function (res) {
                            _this6.sharedService.openSnackBar("Staff added successfully", 'success');
                ...
                if (res.message) {
                  ...
                  _this6.staffService.updateStaff(staffParams).subscribe(function (res) {
                    ...
                    if (res.message) {
                      ...
                      _this6.sharedService.openSnackBar("Staff updated successfully", 'success');
          ...
          value: function ngOnInit() {
            ...
            if (this.route.params['value'].id != undefined) {
              ...
              this.staffService.getStaffByStaffId(getStaffParam).subscribe(function (res) {
                ...
                _this7.phoneForm = new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormGroup"]({
                  phone: new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormControl"](_this7.staff.contactNumber, [_angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required])
                });
              }, function (error) {});
            } else {
            ...
            this.screenService.getAllDefaultMenuRoleSecLevelbyApartmentId(menuControlParam).subscribe(function (resp) {
              _this7.menuControlList = resp.filter(function (data) {
    ...
    function srcAppModulesAmsStaffManagerComponentsStaffAttendanceStaffAttendanceComponentTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var StaffAttendanceComponent = /*#__PURE__*/function () {
        function StaffAttendanceComponent(staffService, lookupService, sessionService, constantsService, router) {
      ...
      StaffAttendanceComponent.propDecorators = {
        ...
        onEditAttendenceStaff: [{
          type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["HostListener"],
          args: ['window:onEditAttendenceStaff', ['$event.detail']]
        }]
      };
      ...
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [src_app_api_controllers_Staff__WEBPACK_IMPORTED_MODULE_2__["StaffService"], src_app_api_controllers_Lookup__WEBPACK_IMPORTED_MODULE_3__["LookupService"], src_app_core_session_session_service__WEBPACK_IMPORTED_MODULE_4__["SessionService"], src_app_shared_services_constants_service__WEBPACK_IMPORTED_MODULE_9__["ConstantsService"], _angular_router__WEBPACK_IMPORTED_MODULE_5__["Router"]])], StaffAttendanceComponent);
    ...
    function srcAppModulesAmsStaffManagerComponentsStaffMaintainStaffStaffMaintainStaffComponentTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var StaffMaintainStaffComponent = /*#__PURE__*/function () {
        function StaffMaintainStaffComponent(injector, staffService, lookupService, sharedService, sessionService, router) {
        ...
        _createClass(StaffMaintainStaffComponent, [{
            ...
            this.sharedService.unitlistdeleteindexcast.subscribe(function (id) {
              if (id != null) {
                ...
                _this19.staffService.deleteStaff(params).subscribe(function (res) {
                  ...
                  //   }
                  // })
                  _this19.sharedService.openSnackBar("Staff deleted", 'success');
          ...
          value: function getAllStaff() {
            ...
            this.staffService.getAllStaffsByApartmentId(this.params).subscribe(function (res) {
              //filter active true items
              _this20.staffListData = res.filter(function (data) {
                return data.isActive;
              });
              _this20.gridSourceData = {
                localdata: _this20.staffListData,
                datatype: "array"
              };
              _this20.staffListData = new jqx.dataAdapter(_this20.gridSourceData);
              _this20.totalItems = _this20.staffListData.length;
              _this20.isStaffDataLoaded = true;
            });
          }
        }]);
      ...
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injector"], src_app_api_controllers_Staff__WEBPACK_IMPORTED_MODULE_3__["StaffService"], src_app_api_controllers_Lookup__WEBPACK_IMPORTED_MODULE_4__["LookupService"], src_app_shared_services_shared_service__WEBPACK_IMPORTED_MODULE_5__["SharedService"], src_app_core_session_session_service__WEBPACK_IMPORTED_MODULE_7__["SessionService"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"]])], StaffMaintainStaffComponent);
    ...
    /***/
    function srcAppModulesAmsStaffManagerComponentsStaffSetupAssociateStaffAssociateStaffComponentScss(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    function srcAppModulesAmsStaffManagerComponentsStaffSetupAssociateStaffAssociateStaffComponentTs(module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, "AssociateStaffComponent", function () {
        return AssociateStaffComponent;
      });
      /* harmony import */
      ...
      var AssociateStaffComponent = /*#__PURE__*/function () {
        ...
        _createClass(AssociateStaffComponent, [{
            ...
            this.sharedService.unitlistdeleteindexcast.subscribe(function (lookupValueId) {
              if (lookupValueId != null) {
                ...
                _this21.lookupService.deleteLookupvalue(params).subscribe(function (res) {
                  _this21.sharedService.openSnackBar('Associate Category Deleted Successfully', 'error');

                  _this21.sharedService.setUnitListDeleteIndex(null);

                  _this21.getAssociateStaff();
                }, function (error) {});
              }
            });
          }
          ...
          value: function getAssociateStaff() {
            ...
            this.lookupService.getLookupValueByLookupTypeId(params).subscribe(function (res) {
              _this22.categoryOffcialListData = res.filter(function (item) {
                return item.isActive;
              });
              _this22.isCategoryDataLoaded = true;
            }, function (error) {});
          }
        }, {
          ...
          key: "deleteAssociate",
          value: function deleteAssociate(lookupValueId) {
          ...
          value: function submitAssociate() {
            ...
            if (!this.isEdit) {
              ...
              this.lookupService.addLookupValue(params).subscribe(function (res) {
                _this23.sharedService.openSnackBar('Associate Category Added', 'Suceess');

                _this23.isShowForm = false;

                _this23.matDrawer.toggle();

                _this23.getAssociateStaff();
              });
            } else {
              var _details3 = {
                "apartmentId": this.sessionService.apartmentId,
              ...
              this.lookupService.updateLookupValue(_params4).subscribe(function (res) {
                _this23.sharedService.openSnackBar('Associate Category Updated', 'Suceess');
      ...
      AssociateStaffComponent.propDecorators = {
        matDrawer: [{
          type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"],
          args: ['association', {
            "static": true
      ...
      AssociateStaffComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-associate-staff',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
        /*! raw-loader!./associate-staff.component.html */
        "./node_modules/raw-loader/dist/cjs.js!./src/app/modules/ams/staff-manager/components/staff-setup/associate-staff/associate-staff.component.html"))["default"],
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
        /*! ./associate-staff.component.scss */
        "./src/app/modules/ams/staff-manager/components/staff-setup/associate-staff/associate-staff.component.scss"))["default"]]
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [src_app_api_controllers_Lookup__WEBPACK_IMPORTED_MODULE_2__["LookupService"], src_app_core_session_session_service__WEBPACK_IMPORTED_MODULE_3__["SessionService"], _angular_core__WEBPACK_IMPORTED_MODULE_1__["Injector"], src_app_shared_services_shared_service__WEBPACK_IMPORTED_MODULE_4__["SharedService"]])], AssociateStaffComponent);
      /***/
    },

    /***/
    "./src/app/modules/ams/staff-manager/components/staff-setup/personal-staff/personal-staff.component.scss":
    /*!***************************************************************************************************************!*\
      !*** ./src/app/modules/ams/staff-manager/components/staff-setup/personal-staff/personal-staff.component.scss ***!
      \***************************************************************************************************************/
    ...
    /***/
    function srcAppModulesAmsStaffManagerComponentsStaffSetupPersonalStaffPersonalStaffComponentScss(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    function srcAppModulesAmsStaffManagerComponentsStaffSetupPersonalStaffPersonalStaffComponentTs(module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, "PersonalStaffComponent", function () {
        return PersonalStaffComponent;
      });
      /* harmony import */
      ...
      var PersonalStaffComponent = /*#__PURE__*/function () {
        function PersonalStaffComponent(lookupService, sessionService, injector, sharedService) {
          _classCallCheck(this, PersonalStaffComponent);
        ...
        _createClass(PersonalStaffComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.sharedService.unitlistdeleteindexcast.subscribe(function (lookupValueId) {
              if (lookupValueId != null) {
                ...
                _this24.lookupService.deleteLookupvalue(params).subscribe(function (res) {
                  _this24.sharedService.openSnackBar('Personal Category Deleted Successfully', 'error');

                  _this24.sharedService.setUnitListDeleteIndex(null);

                  _this24.getAssociateStaff();
                }, function (error) {});
              }
            });
          }
          ...
          value: function getAssociateStaff() {
            ...
            this.lookupService.getLookupValueByLookupTypeId(params).subscribe(function (res) {
              _this25.categoryOffcialListData = res.filter(function (item) {
                return item.isActive;
              });
              _this25.isCategoryDataLoaded = true;
            }, function (error) {});
          }
        }, {
          key: "editStaffCategory",
          ...
          value: function submitAssociate() {
            ...
            if (!this.isEdit) {
              ...
              this.lookupService.addLookupValue(params).subscribe(function (res) {
                _this26.sharedService.openSnackBar('Personal Category Added', 'Suceess');

                _this26.isShowForm = false;

                _this26.matDrawer.toggle();

                _this26.getAssociateStaff();
              });
            } else {
              var _details4 = {
                "apartmentId": this.sessionService.apartmentId,
              ...
              this.lookupService.updateLookupValue(_params5).subscribe(function (res) {
                _this26.sharedService.openSnackBar('Personal Category Updated', 'Suceess');
      ...
      PersonalStaffComponent.ctorParameters = function () {
        return [{
          type: src_app_api_controllers_Lookup__WEBPACK_IMPORTED_MODULE_2__["LookupService"]
        }, {
          type: src_app_core_session_session_service__WEBPACK_IMPORTED_MODULE_3__["SessionService"]
      ...
      PersonalStaffComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
        /*! raw-loader!./personal-staff.component.html */
        "./node_modules/raw-loader/dist/cjs.js!./src/app/modules/ams/staff-manager/components/staff-setup/personal-staff/personal-staff.component.html"))["default"],
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
        /*! ./personal-staff.component.scss */
        "./src/app/modules/ams/staff-manager/components/staff-setup/personal-staff/personal-staff.component.scss"))["default"]]
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [src_app_api_controllers_Lookup__WEBPACK_IMPORTED_MODULE_2__["LookupService"], src_app_core_session_session_service__WEBPACK_IMPORTED_MODULE_3__["SessionService"], _angular_core__WEBPACK_IMPORTED_MODULE_1__["Injector"], src_app_shared_services_shared_service__WEBPACK_IMPORTED_MODULE_4__["SharedService"]])], PersonalStaffComponent);
      /***/
    },
        ...
        _createClass(StaffShiftsComponent, [{
          ...
          value: function submitShiftsForm(form) {
            ...
            if (!this.isEditShift) {
              ...
              this.staffService.addShift(params).subscribe(function (res) {
                if (res.message) {
                  _this27.isShiftsLoaded = true;

                  _this27.sharedService.setAlertMessage("Shift added Successfully!");

                  _this27.getAllShifts();
                }
              }, function (error) {});
            } else {
              var _details5 = {
              ...
              this.staffService.updateShift(_params6).subscribe(function (res) {
                if (res.message) {
                  _this27.isShiftsLoaded = true;

                  _this27.sharedService.setAlertMessage("Shift updated Successfully!");
          ...
          value: function getAllShifts() {
            ...
            this.staffService.getAllShiftsByApartmentId(params).subscribe(function (res) {
              _this30.shiftsListData = res.filter(function (item) {
                return item.isActive;
              });
              _this30.totalItems = _this30.shiftsListData.length;
              ...
              _this30.isShiftTableLoaded = true;
            }, function (error) {});
          }
        }, {
          key: "ngOnInit",
          value: function ngOnInit() {
            ...
            this.lookupService.getLookupValueByLookupTypeId(params).subscribe(function (res) {
              _this31.shiftTypeList = res.filter(function (item) {
                return item.isActive;
              });
            }, function (error) {}); // delete item
            ...
            this.sharedService.unitlistdeleteindexcast.subscribe(function (item) {
              if (item != null) {
                ...
                _this31.isShiftTableLoaded = false;

                _this31.staffService.deleteShift(params).subscribe(function (res) {
                  _this31.shiftsListData = _this31.shiftsListData.filter(function (type) {
                    return type.shiftId !== item.shiftId;
                  });

                  _this31.sharedService.setUnitListDeleteIndex(null);

                  _this31.isShiftTableLoaded = true;
                }, function (error) {
                  console.log(error);
                });
              }
    ...
    function srcAppModulesAmsStaffManagerStaffManagerRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var _components_staff_setup_staff_setup_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! ./components/staff-setup/staff-setup.component */
      "./src/app/modules/ams/staff-manager/components/staff-setup/staff-setup.component.ts");
      /* harmony import */


      var _components_staff_maintain_staff_staff_maintain_staff_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ./components/staff-maintain-staff/staff-maintain-staff.component */
      "./src/app/modules/ams/staff-manager/components/staff-maintain-staff/staff-maintain-staff.component.ts");
      /* harmony import */


      var _components_staff_inactive_staff_staff_inactive_staff_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./components/staff-inactive-staff/staff-inactive-staff.component */
      "./src/app/modules/ams/staff-manager/components/staff-inactive-staff/staff-inactive-staff.component.ts");
      /* harmony import */


      var _components_staff_attendance_staff_attendance_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! ./components/staff-attendance/staff-attendance.component */
      "./src/app/modules/ams/staff-manager/components/staff-attendance/staff-attendance.component.ts");
      /* harmony import */


      var _components_staff_payroll_staff_payroll_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      /*! ./components/staff-payroll/staff-payroll.component */
      "./src/app/modules/ams/staff-manager/components/staff-payroll/staff-payroll.component.ts");
      /* harmony import */


      var _components_staff_overtime_staff_overtime_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
      /*! ./components/staff-overtime/staff-overtime.component */
      "./src/app/modules/ams/staff-manager/components/staff-overtime/staff-overtime.component.ts");
      /* harmony import */


      var _components_staff_reports_staff_reports_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
      /*! ./components/staff-reports/staff-reports.component */
      "./src/app/modules/ams/staff-manager/components/staff-reports/staff-reports.component.ts");
      /* harmony import */


      var _components_add_staff_add_staff_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
      /*! ./components/add-staff/add-staff.component */
      "./src/app/modules/ams/staff-manager/components/add-staff/add-staff.component.ts");
      /* harmony import */


      var _components_add_entry_add_entry_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
      /*! ./components/add-entry/add-entry.component */
      "./src/app/modules/ams/staff-manager/components/add-entry/add-entry.component.ts");
      /* harmony import */


      var _components_staff_setup_associate_staff_associate_staff_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
      /*! ./components/staff-setup/associate-staff/associate-staff.component */
      "./src/app/modules/ams/staff-manager/components/staff-setup/associate-staff/associate-staff.component.ts");
      /* harmony import */


      var _components_staff_setup_personal_staff_personal_staff_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(
      /*! ./components/staff-setup/personal-staff/personal-staff.component */
      "./src/app/modules/ams/staff-manager/components/staff-setup/personal-staff/personal-staff.component.ts");
      ...
      var routes = [{
        ...
        path: 'settings',
        component: _components_staff_setup_staff_setup_component__WEBPACK_IMPORTED_MODULE_4__["StaffSetupComponent"],
        ...
        children: [{
          ...
          path: 'associate',
          component: _components_staff_setup_associate_staff_associate_staff_component__WEBPACK_IMPORTED_MODULE_13__["AssociateStaffComponent"],
          canActivate: [src_app_core_auth_guards_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]]
        }, {
          path: 'personal',
          component: _components_staff_setup_personal_staff_personal_staff_component__WEBPACK_IMPORTED_MODULE_14__["PersonalStaffComponent"],
          canActivate: [src_app_core_auth_guards_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]]
        }, {
          path: '**',
          redirectTo: 'associate',
        ...
        path: 'maintain-staff',
        component: _components_staff_maintain_staff_staff_maintain_staff_component__WEBPACK_IMPORTED_MODULE_5__["StaffMaintainStaffComponent"],
        canActivate: [src_app_core_auth_guards_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]]
      }, {
        path: 'add-staff',
        component: _components_add_staff_add_staff_component__WEBPACK_IMPORTED_MODULE_11__["AddStaffComponent"],
        canActivate: [src_app_core_auth_guards_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]]
      }, {
        path: 'edit-staff/:id',
        component: _components_add_staff_add_staff_component__WEBPACK_IMPORTED_MODULE_11__["AddStaffComponent"],
        ...
        path: 'inactive-staff',
        component: _components_staff_inactive_staff_staff_inactive_staff_component__WEBPACK_IMPORTED_MODULE_6__["StaffInactiveStaffComponent"],
        canActivate: [src_app_core_auth_guards_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]]
      }, {
        path: 'overtime',
        component: _components_staff_overtime_staff_overtime_component__WEBPACK_IMPORTED_MODULE_9__["StaffOvertimeComponent"],
        canActivate: [src_app_core_auth_guards_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]]
      }, {
        path: 'attendance',
        component: _components_staff_attendance_staff_attendance_component__WEBPACK_IMPORTED_MODULE_7__["StaffAttendanceComponent"],
        canActivate: [src_app_core_auth_guards_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]]
      }, {
        path: 'add-entry',
        component: _components_add_entry_add_entry_component__WEBPACK_IMPORTED_MODULE_12__["AddEntryComponent"],
        canActivate: [src_app_core_auth_guards_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]]
      }, {
        path: 'edit-entry/:id',
        component: _components_add_entry_add_entry_component__WEBPACK_IMPORTED_MODULE_12__["AddEntryComponent"],
        ...
        path: 'payroll',
        component: _components_staff_payroll_staff_payroll_component__WEBPACK_IMPORTED_MODULE_8__["StaffPayrollComponent"],
        canActivate: [src_app_core_auth_guards_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]]
      }, {
        path: 'reports',
        component: _components_staff_reports_staff_reports_component__WEBPACK_IMPORTED_MODULE_10__["StaffReportsComponent"],
        canActivate: [src_app_core_auth_guards_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]]
      }, {
        path: '**',
        redirectTo: 'settings',
    ...
    function srcAppModulesAmsStaffManagerStaffManagerModuleTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var _ui_card_card_module__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(
      /*! ../../ui/card/card.module */
      "./src/app/modules/ui/card/card.module.ts");
      /* harmony import */


      var ngx_intl_tel_input__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(
      /*! ngx-intl-tel-input */
      "./node_modules/ngx-intl-tel-input/__ivy_ngcc__/fesm2015/ngx-intl-tel-input.js");
      /* harmony import */


      var _components_staff_setup_associate_staff_associate_staff_component__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(
      /*! ./components/staff-setup/associate-staff/associate-staff.component */
      "./src/app/modules/ams/staff-manager/components/staff-setup/associate-staff/associate-staff.component.ts");
      /* harmony import */


      var _components_staff_setup_personal_staff_personal_staff_component__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(
      /*! ./components/staff-setup/personal-staff/personal-staff.component */
      "./src/app/modules/ams/staff-manager/components/staff-setup/personal-staff/personal-staff.component.ts");
