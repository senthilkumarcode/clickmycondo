...
/* harmony import */ var src_app_api_controllers_Ticket__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! src/app/api/controllers/Ticket */ "./src/app/api/controllers/Ticket.ts");
...
/* harmony import */ var src_app_api_controllers_Staff__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! src/app/api/controllers/Staff */ "./src/app/api/controllers/Staff.ts");
...
let HelpdeskCreateTicketComponent = class HelpdeskCreateTicketComponent {
    constructor(router, acticateRoute, ticketService, lookupService, sharedService, sessionService, sanitizer, fileUploadService, fileDownloadService, fileDetailsService, constantsService, apartmentService, staffService) {
        this.router = router;
    ...
    routerNavigate() {
        let url = (this.sessionService.roleTypeName == 'Admin' || this.sessionService.roleTypeName == 'Staff') ? '/ams/helpdesk/all-tickets' : '/user/servicedesk/view-ticket';
    ...
    createTicket() {
        ...
        this.ticketService.addTicket(params).subscribe((res) => {
            ...
            if (!isNaN(res.message)) {
                this.routerNavigate();
                this.sharedService.setAlertMessage("Ticket added successfully");
            }
            else if (res.message)
...
HelpdeskCreateTicketComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_10__["Router"],
        ...
        src_app_api_controllers_Ticket__WEBPACK_IMPORTED_MODULE_11__["TicketService"],
        ...
        src_app_api_controllers_Staff__WEBPACK_IMPORTED_MODULE_14__["StaffService"]])
...
const routes = [
    ...
    { path: 'create-ticket', component: _components_helpdesk_create_ticket_helpdesk_create_ticket_component__WEBPACK_IMPORTED_MODULE_9__["HelpdeskCreateTicketComponent"] },
    { path: 'edit-ticket/:id', component: _components_helpdesk_create_ticket_helpdesk_create_ticket_component__WEBPACK_IMPORTED_MODULE_9__["HelpdeskCreateTicketComponent"] },
    { path: 'unassigned', component: _components_helpdesk_ticket_filter_helpdesk_ticket_filter_component__WEBPACK_IMPORTED_MODULE_7__["HelpdeskTicketFilterComponent"] },
    { path: 'open-tickets', component: _components_helpdesk_ticket_filter_helpdesk_ticket_filter_component__WEBPACK_IMPORTED_MODULE_7__["HelpdeskTicketFilterComponent"] },
    { path: 'closed-tickets', component: _components_helpdesk_ticket_filter_helpdesk_ticket_filter_component__WEBPACK_IMPORTED_MODULE_7__["HelpdeskTicketFilterComponent"] },
    { path: 'assigned-to-me', component: _components_helpdesk_ticket_filter_helpdesk_ticket_filter_component__WEBPACK_IMPORTED_MODULE_7__["HelpdeskTicketFilterComponent"] },
    { path: 'all-tickets', component: _components_helpdesk_ticket_filter_helpdesk_ticket_filter_component__WEBPACK_IMPORTED_MODULE_7__["HelpdeskTicketFilterComponent"] },
    ...
    { path: 'reports/:name/:id', component: _components_helpdesk_reports_helpdesk_reports_data_helpdesk_reports_data_component__WEBPACK_IMPORTED_MODULE_8__["HelpdeskReportsDataComponent"] },
    { path: '**', redirectTo: 'settings', pathMatch: 'full' }
];
