...
/***/ "./node_modules/raw-loader/dist/cjs.js!./src/app/modules/ams/helpdesk/components/helpdesk-create-ticket/helpdesk-create-ticket.component.html":
/*!****************************************************************************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/modules/ams/helpdesk/components/helpdesk-create-ticket/helpdesk-create-ticket.component.html ***!
  \****************************************************************************************************************************************************/
...
/***/ "./src/app/modules/ams/helpdesk/components/helpdesk-create-ticket/helpdesk-create-ticket.component.scss":
/*!**************************************************************************************************************!*\
  !*** ./src/app/modules/ams/helpdesk/components/helpdesk-create-ticket/helpdesk-create-ticket.component.scss ***!
  \**************************************************************************************************************/
/*! exports provided: default */
...
/*!************************************************************************************************************!*\
  !*** ./src/app/modules/ams/helpdesk/components/helpdesk-create-ticket/helpdesk-create-ticket.component.ts ***!
  \************************************************************************************************************/
/*! exports provided: HelpdeskCreateTicketComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "HelpdeskCreateTicketComponent", function() { return HelpdeskCreateTicketComponent; });
...
let HelpdeskCreateTicketComponent = class HelpdeskCreateTicketComponent {
    constructor(router, acticateRoute, ticketService, lookupService, sharedService, sessionService, apartmentService, staffService, _changeDetectorRef) {
        this.router = router;
    ...
    getPrimaryNameForUnit() {
        let unitDetails, primaryDetails;
        this.ticket.apartmentBlockUnitUserId = '';
        this.block.primaryName = '';
        unitDetails = this.blockUnitList.filter((data) => data.apartmentBlockUnitId == this.block.apartmentBlockUnitId);
        primaryDetails = unitDetails[0].blockUnitUserIsPrimaryContact;
        if (primaryDetails.length > 0) {
            this.ticket.apartmentBlockUnitUserId = primaryDetails[0].primaryContactUserId;
            this.block.primaryName = primaryDetails[0].primaryContactName; //view Mode
        }
    }
    getFileIds(event) {
        ...
        if (!this.form.valid) {
            ...
            let params = {
                ticket: {
                    ...
                    isActive: true,
                    apartmentBlockUnitUserId: this.ticket.apartmentBlockUnitUserId,
            ...
            this.ticketService.addTicket(params).subscribe((res) => {
                if (res.message) {
                    if (this.sessionService.isAdmin()) {
                        this.router.navigate(['/ams/helpdesk/open-tickets']);
                    }
                    else {
                        this.router.navigate(['/user/servicedesk/all-tickets']);
                    }
        ...
        if (!this.form.valid) {
            ...
            let params = {
                ticket: {
                    ...
                    apartmentId: this.ticket.apartmentId,
                    ticketTypeId: this.ticket.ticketTypeId,
                    title: this.ticket.title,
                    description: this.ticket.description,
                    resolutionDescription: this.ticket.resolutionDescription,
                    raisedBy: this.ticket.raisedBy,
                    ticketStatusId: this.ticket.ticketStatusId,
                    ticketCategoryId: this.ticket.ticketCategoryId,
                    supervisorId: this.ticket.supervisorId,
                    ticketPriorityId: this.ticket.ticketPriorityId,
            ...
            this.ticketService.updateTicket(params).subscribe((res) => {
                if (res.message) {
    ...
    getCommentList() {
        ...
        this.ticketService.getAllTicketCommentsByTicketId(params).subscribe((res) => {
            if (res.length > 0) {
                this.ticketCommentList = res.reverse();
            }
        });
    }
    ngOnInit() {
        ...
        if (!this.isAdmin()) {
            ...
            this.ticket.apartmentBlockUnitUserId = this.sessionService.apartmentBlockUnitUserId;
        }
        //Ticket Type List
        ...
        if (this.viewMode == 'edit') {
            ...
            this.ticketService.getTicketById(ticketId).subscribe(res => {
                ...
                //owner or tenant edit mode
                if (this.ticket.apartmentBlockUnitUserId) {
                    this.createdBY = 'owner';
                    this.blockunitprimeName = `${this.ticket.tower_Unit} ${this.ticket.primaryContactName}`;
                }
                //staff Edit Mode
                if (this.ticket.staffId) {
...
HelpdeskCreateTicketComponent.ctorParameters = () => [
...
HelpdeskCreateTicketComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-helpdesk-create-ticket',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./helpdesk-create-ticket.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/modules/ams/helpdesk/components/helpdesk-create-ticket/helpdesk-create-ticket.component.html")).default,
        encapsulation: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewEncapsulation"].None,
        animations: src_condo_animations__WEBPACK_IMPORTED_MODULE_9__["CondoAnimations"],
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./helpdesk-create-ticket.component.scss */ "./src/app/modules/ams/helpdesk/components/helpdesk-create-ticket/helpdesk-create-ticket.component.scss")).default]
    }),
...
let HelpdeskReportsDataComponent = class HelpdeskReportsDataComponent {
    ...
    isListOfTickets() {
        return this.pageName = "List of Open and closed tickets";
    }
    isListofAgedtickets() {
    ...
    getBlockDetails() {
        ...
        if (this.isListOfTickets()) {
            ...
            var details = {
                ...
                EndDate: this.end_date === null ? moment__WEBPACK_IMPORTED_MODULE_8__(new Date()).format('YYYY-MM-DD') : this.getDate(this.end_date),
                TicketStatus: this.TicketStatus,
                TicketType: this.TicketType,
                TicketRaisedBy: this.TicketRaisedBy,
                AssignedToStaffId: this.AssignedToStaffId,
...
/* harmony import */ var _components_helpdesk_ticket_filter_helpdesk_ticket_filter_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./components/helpdesk-ticket-filter/helpdesk-ticket-filter.component */ "./src/app/modules/ams/helpdesk/components/helpdesk-ticket-filter/helpdesk-ticket-filter.component.ts");
/* harmony import */ var _components_helpdesk_reports_helpdesk_reports_data_helpdesk_reports_data_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./components/helpdesk-reports/helpdesk-reports-data/helpdesk-reports-data.component */ "./src/app/modules/ams/helpdesk/components/helpdesk-reports/helpdesk-reports-data/helpdesk-reports-data.component.ts");
/* harmony import */ var _components_helpdesk_create_ticket_helpdesk_create_ticket_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./components/helpdesk-create-ticket/helpdesk-create-ticket.component */ "./src/app/modules/ams/helpdesk/components/helpdesk-create-ticket/helpdesk-create-ticket.component.ts");
...
const routes = [
    ...
    { path: 'settings', component: _components_helpdesk_setup_helpdesk_setup_component__WEBPACK_IMPORTED_MODULE_3__["HelpdeskSetupComponent"], canActivate: [src_app_core_auth_guards_auth_guard__WEBPACK_IMPORTED_MODULE_10__["AuthGuard"]],
        children: [
            { path: '', redirectTo: 'private-category', canActivate: [src_app_core_auth_guards_auth_guard__WEBPACK_IMPORTED_MODULE_10__["AuthGuard"]], pathMatch: 'full' },
            { path: 'private-category', component: _components_helpdesk_setup_private_category_private_category_component__WEBPACK_IMPORTED_MODULE_5__["PrivateCategoryComponent"], canActivate: [src_app_core_auth_guards_auth_guard__WEBPACK_IMPORTED_MODULE_10__["AuthGuard"]] },
            { path: 'common-category', component: _components_helpdesk_setup_common_category_common_category_component__WEBPACK_IMPORTED_MODULE_6__["CommonCategoryComponent"], canActivate: [src_app_core_auth_guards_auth_guard__WEBPACK_IMPORTED_MODULE_10__["AuthGuard"]] },
            { path: '**', redirectTo: 'private-category', pathMatch: 'full' }
        ]
    },
    { path: 'create-ticket', component: _components_helpdesk_create_ticket_helpdesk_create_ticket_component__WEBPACK_IMPORTED_MODULE_9__["HelpdeskCreateTicketComponent"], canActivate: [src_app_core_auth_guards_auth_guard__WEBPACK_IMPORTED_MODULE_10__["AuthGuard"]] },
    { path: 'edit-ticket/:id', component: _components_helpdesk_create_ticket_helpdesk_create_ticket_component__WEBPACK_IMPORTED_MODULE_9__["HelpdeskCreateTicketComponent"], canActivate: [src_app_core_auth_guards_auth_guard__WEBPACK_IMPORTED_MODULE_10__["AuthGuard"]] },
    { path: 'unassigned', component: _components_helpdesk_ticket_filter_helpdesk_ticket_filter_component__WEBPACK_IMPORTED_MODULE_7__["HelpdeskTicketFilterComponent"], canActivate: [src_app_core_auth_guards_auth_guard__WEBPACK_IMPORTED_MODULE_10__["AuthGuard"]] },
    { path: 'open-tickets', component: _components_helpdesk_ticket_filter_helpdesk_ticket_filter_component__WEBPACK_IMPORTED_MODULE_7__["HelpdeskTicketFilterComponent"], canActivate: [src_app_core_auth_guards_auth_guard__WEBPACK_IMPORTED_MODULE_10__["AuthGuard"]] },
    { path: 'closed-tickets', component: _components_helpdesk_ticket_filter_helpdesk_ticket_filter_component__WEBPACK_IMPORTED_MODULE_7__["HelpdeskTicketFilterComponent"], canActivate: [src_app_core_auth_guards_auth_guard__WEBPACK_IMPORTED_MODULE_10__["AuthGuard"]] },
    { path: 'assigned-to-me', component: _components_helpdesk_ticket_filter_helpdesk_ticket_filter_component__WEBPACK_IMPORTED_MODULE_7__["HelpdeskTicketFilterComponent"], canActivate: [src_app_core_auth_guards_auth_guard__WEBPACK_IMPORTED_MODULE_10__["AuthGuard"]] },
    { path: 'all-tickets', component: _components_helpdesk_ticket_filter_helpdesk_ticket_filter_component__WEBPACK_IMPORTED_MODULE_7__["HelpdeskTicketFilterComponent"], canActivate: [src_app_core_auth_guards_auth_guard__WEBPACK_IMPORTED_MODULE_10__["AuthGuard"]] },
    { path: 'reports', component: _components_helpdesk_reports_helpdesk_reports_component__WEBPACK_IMPORTED_MODULE_4__["HelpdeskReportsComponent"], canActivate: [src_app_core_auth_guards_auth_guard__WEBPACK_IMPORTED_MODULE_10__["AuthGuard"]] },
    { path: 'reports/:name/:id', component: _components_helpdesk_reports_helpdesk_reports_data_helpdesk_reports_data_component__WEBPACK_IMPORTED_MODULE_8__["HelpdeskReportsDataComponent"], canActivate: [src_app_core_auth_guards_auth_guard__WEBPACK_IMPORTED_MODULE_10__["AuthGuard"]] },
    { path: '**', redirectTo: 'settings', pathMatch: 'full' }
];
...
/* harmony import */ var _components_helpdesk_create_ticket_helpdesk_create_ticket_component__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./components/helpdesk-create-ticket/helpdesk-create-ticket.component */ "./src/app/modules/ams/helpdesk/components/helpdesk-create-ticket/helpdesk-create-ticket.component.ts");
/* harmony import */ var src_app_modules_ui_upload_upload_module__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! src/app/modules/ui/upload/upload.module */ "./src/app/modules/ui/upload/upload.module.ts");
...
/* harmony import */ var src_app_modules_ui_list_list_module__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! src/app/modules/ui/list/list.module */ "./src/app/modules/ui/list/list.module.ts");
...
HelpdeskModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        declarations: [
            ...
            _components_helpdesk_create_ticket_helpdesk_create_ticket_component__WEBPACK_IMPORTED_MODULE_16__["HelpdeskCreateTicketComponent"],
        ],
        imports: [
            ...
            src_app_modules_ui_upload_upload_module__WEBPACK_IMPORTED_MODULE_17__["UploadModule"],
            src_app_modules_ui_message_message_module__WEBPACK_IMPORTED_MODULE_18__["CondoMessageModule"],
            src_app_modules_ui_list_list_module__WEBPACK_IMPORTED_MODULE_19__["ListModule"]
        ],
