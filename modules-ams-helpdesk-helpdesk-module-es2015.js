...
let HelpdeskCreateTicketComponent = class HelpdeskCreateTicketComponent {
    ...
    getFileIds(event) {
        ...
        event.forEach((res, index) => {
            if (index == 0)
                this.ticket.fileDetailsId1 = res;
            else if (index == 1)
                this.ticket.fileDetailsId2 = res;
        });
    }
    createTicket() {
        this.message = null;
        ...
        if (this.viewMode == 'edit') {
            ...
            this.ticketService.getTicketById(ticketId).subscribe(res => {
                ...
                if (this.ticket.apartmentBlockUnitUserId) {
                    ...
                    this.apartmentService.getApartmentBlockUnitUserByApartmentBlockUnitUserId(blockUnit).subscribe((res) => {
                        if (res.length > 0)
                            this.blockunitprimeName = `${res[0].blockunit_Label} ${res[0].primarycontact_Name}`;
                    });
                }
                //staff Edit Mode
