...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PropertyAllUnitsRoutingModule", function() { return PropertyAllUnitsRoutingModule; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/__ivy_ngcc__/fesm2015/router.js");
/* harmony import */ var _property_all_units_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./property-all-units.component */ "./src/app/modules/ams/my-property/property-all-units/property-all-units.component.ts");
/* harmony import */ var _property_units_list_property_units_list_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./property-units-list/property-units-list.component */ "./src/app/modules/ams/my-property/property-all-units/property-units-list/property-units-list.component.ts");
...
let PropertyAllUnitsRoutingModule = class PropertyAllUnitsRoutingModule {
};
PropertyAllUnitsRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PropertyAllUnitsComponent", function() { return PropertyAllUnitsComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");


let PropertyAllUnitsComponent = class PropertyAllUnitsComponent {
    constructor() { }
    ngOnInit() {
    }
};
PropertyAllUnitsComponent.ctorParameters = () => [];
PropertyAllUnitsComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-property-all-units',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./property-all-units.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/modules/ams/my-property/property-all-units/property-all-units.component.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./property-all-units.component.scss */ "./src/app/modules/ams/my-property/property-all-units/property-all-units.component.scss")).default]
    }),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [])
], PropertyAllUnitsComponent);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PropertyAllUnitsModule", function() { return PropertyAllUnitsModule; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/__ivy_ngcc__/fesm2015/common.js");
/* harmony import */ var _property_all_units_routing_module__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./property-all-units-routing.module */ "./src/app/modules/ams/my-property/property-all-units/property-all-units-routing.module.ts");
...
/* harmony import */ var _property_all_units_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./property-all-units.component */ "./src/app/modules/ams/my-property/property-all-units/property-all-units.component.ts");
/* harmony import */ var _property_units_list_property_units_list_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./property-units-list/property-units-list.component */ "./src/app/modules/ams/my-property/property-all-units/property-units-list/property-units-list.component.ts");
...
let PropertyAllUnitsModule = class PropertyAllUnitsModule {
};
PropertyAllUnitsModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        imports: [
            ...
            _property_all_units_routing_module__WEBPACK_IMPORTED_MODULE_3__["PropertyAllUnitsRoutingModule"]
        ]
    })
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PropertyUnitsListComponent", function() { return PropertyUnitsListComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/__ivy_ngcc__/fesm2015/router.js");
...
let PropertyUnitsListComponent = class PropertyUnitsListComponent {
    ...
    getAllBlockData() {
        ...
        this.apartmentService.getApartmentBlockUnitByApartmentId(params).subscribe((res) => {
            ...
            this.gridSourceData.localdata = unitDataList;
            this.datagrid.updatebounddata('cells');
            this.totalItems = unitDataList.length;
        });
    }
    getSingleBlock(block) {
        ...
        this.apartmentService.getApartmentBlockUnitByApartmentId(params).subscribe((res) => {
            var unitDataList = res.filter(item => {
            ...
            },
            {
                ...
                cellsrenderer: (row, coloumn, value) => {
                    ...
                    return '<div class="simple-actions">'
                        + '<a href="javascript:void(0)" class="mr-2 text-secondary" onClick="editUnitEvent(' + row + ')">'
                        + '<i class="fa fa-pencil" aria-hidden="true"></i>'
                        + '</a>'
                        + '<a href="javascript:void(0)" class="mr-2 text-secondary" onClick="deleteUnitEvent(' + row + ')">'
    ...
    ngOnInit() {
        ...
        this.apartmentService.getApartmentBlockByApartmentId(params).subscribe((res) => {
            ...
            this.apartmentService.getApartmentBlockUnitByApartmentId(params).subscribe((res) => {
                ...
                this.unitDataList = new jqx.dataAdapter(this.gridSourceData);
                this.renderColumns();
            });
        });
    }
};
PropertyUnitsListComponent.ctorParameters = () => [
...
PropertyUnitsListComponent.propDecorators = {
    ...
    onEditUnitEvent: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["HostListener"], args: ['window:onEditUnitEvent', ['$event.detail'],] }]
};
PropertyUnitsListComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-property-units-list',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./property-units-list.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/modules/ams/my-property/property-all-units/property-units-list/property-units-list.component.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./property-units-list.component.scss */ "./src/app/modules/ams/my-property/property-all-units/property-units-list/property-units-list.component.scss")).default]
    }),
...
//# sourceMappingURL=src-app-modules-ams-my-property-property-all-units-property-all-units-module-es2015.js.map