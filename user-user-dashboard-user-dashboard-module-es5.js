...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["user-user-dashboard-user-dashboard-module"], {
  /***/
  ...
  function srcAppUserNewUserRegistrationNewUserRegistrationComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function NewUserRegistrationComponent(dialogRef, data, apartmentService, lookupService, sharedService, userService, cookieService, todoService) {
      ...
      _createClass(NewUserRegistrationComponent, [{
        ...
        value: function addFamilyDetails() {
          ...
          this.addFamilyList.filter(function (key) {
            var details = {
              "firstName": key.firstName,
              "middleName": key.middleName,
              "lastName": key.lastName,
              "relationship": key.relationship,
              "relatedUserId": parseInt(_this2.cookieService.get('userId')),
              "emailId": key.emailId,
            ...
            _this2.userService.addUserFamilyMember(params).subscribe(function (res) {
              if (res.message) {
                _this2.sharedService.setAlertMessage("Family Member added successfully");
              } else {}
            });
          });
        }
        ...
        value: function updateUser() {
          ...
          var userDetails = {
            ...
            "emergencyContactNumberSecondary": this.data.emergencyContactNumberSecondary,
            "emergencyContactPersonSecondary": this.data.emergencyContactPersonSecondary,
            "accessCardNumber": this.data.accessCardNumber,
          ...
          this.userService.updateUser(params).subscribe(function (res) {
            if (res.message) {
              ...
              var apartmentBlockUnitUser = {
                ...
                "userId": userId,
                "isPrimaryContact": _this3.data.isPrimaryContact,
                "userTypeId": parseInt(_this3.userType),
                "isActive": _this3.data.isActive,
                "insertedBy": parseInt(_this3.cookieService.get('userId')),
                "insertedOn": _this3.data.insertedOn,
                "updatedBy": _this3.data.updatedBy,
                "updatedOn": _this3.data.updatedOn
              };
              var apartmentParams = {
                apartmentBlockUnitUser: apartmentBlockUnitUser
              };

              _this3.apartmentService.addApartmentBlockUnitUser(apartmentParams).subscribe(function (res) {
                if (res.message) {
                  var userRole = {
                    "userId": userId,
                    "roleId": parseInt(_this3.userType),
                    "isActive": _this3.data.isActive,
                    "insertedBy": parseInt(_this3.cookieService.get('userId')),
                    "insertedOn": _this3.data.insertedOn,
                    "updatedBy": _this3.data.updatedBy,
    ...
    }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__param"])(1, Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"])(_angular_material_dialog__WEBPACK_IMPORTED_MODULE_2__["MAT_DIALOG_DATA"])), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_material_dialog__WEBPACK_IMPORTED_MODULE_2__["MatDialogRef"], Object, _api_controllers_Apartment__WEBPACK_IMPORTED_MODULE_8__["ApartmentService"], src_app_api_controllers_Lookup__WEBPACK_IMPORTED_MODULE_3__["LookupService"], src_app_shared_services_shared_service__WEBPACK_IMPORTED_MODULE_7__["SharedService"], _api_controllers_User__WEBPACK_IMPORTED_MODULE_6__["UserService"], ngx_cookie_service__WEBPACK_IMPORTED_MODULE_4__["CookieService"], src_app_api_controllers_TodoList__WEBPACK_IMPORTED_MODULE_5__["TodoListService"]])], NewUserRegistrationComponent);
    /***/
  },
  ...
  function srcAppUserUserDashboardUserDashboardComponentScss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = ".user-dashboard-wrapper .user-col-pad {\n  padding-left: 10px !important;\n  padding-right: 10px !important;\n}\n.user-dashboard-wrapper .bg-dark-blue {\n  background-color: #236aaf;\n}\n.user-dashboard-wrapper .opacity {\n  opacity: 0.8;\n}\n.user-dashboard-wrapper .bg-cyan-03 {\n  background-color: #00d1fa !important;\n}\n.user-dashboard-wrapper .bg-h-cyan {\n  background-color: #03cca6 !important;\n}\n.user-dashboard-wrapper .bg-s-blue {\n  background-color: #529eff !important;\n}\n.user-dashboard-wrapper .dark-blue {\n  color: #236aaf;\n}\n.user-dashboard-wrapper .widget-name {\n  font-size: 1.1rem;\n}\n.user-dashboard-wrapper .wid-height {\n  height: 343px;\n}\n.user-dashboard-wrapper .wid-max-height {\n  max-height: 343px;\n}\n.user-dashboard-wrapper .cyan-color {\n  color: #00d1fa;\n}\n.user-dashboard-wrapper .user-wid-name {\n  font-size: 1.3rem;\n}\n.user-dashboard-wrapper .user-wid-value {\n  font-size: 1.6rem;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
  ...
  function srcAppUserUserDashboardUserDashboardComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _new_user_registration_new_user_registration_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      ...
      _createClass(UserDashboardComponent, [{
        ...
        value: function calenderPopup(type) {
          ...
          dialogRef.afterClosed().subscribe(function (result) {
            _this4.visitotsCheckedin(result);
          });
        }
      }, {
        ...
        value: function visitotsCheckedin(params) {
          ...
          params.blockUnitUserId = parseInt(this.cookieService.get('apartmentBlockUnitUserId')), this.dashboardService.getUDashVisitorcheckedinbyblockunituser(params).subscribe(function (res) {
            _this5.widgetRowThree[1].value = res.visitorsCheckIn;
          });
        }
      }, {
        key: "firstRow",
        value: function firstRow() {
          ...
          this.dashboardService.getUDashTotalparkingbyblockunitId(params).subscribe(function (res) {
            _this6.widgetRowOne[0].value = res.totalParkingSlots;
          });
          this.dashboardService.getUDashVehiclecountbyblockunituser(entity).subscribe(function (res) {
            _this6.widgetRowOne[1].value = res.vehiclecountbyblockunituser;
          });
          this.userService.getUserFamilyCountByBlockUnitUserId(unitUser).subscribe(function (res) {
            _this6.widgetRowOne[2].value = res[0]; //dummy Need to integrate
          });
          this.dashboardService.getUDashTotalpetstbyblockunituser(entity).subscribe(function (res) {
            _this6.widgetRowOne[3].value = res.totalpetstbyblockunituser;
          });
          this.dashboardService.getUDashPrivateStaffbyblockunituser(entity).subscribe(function (res) {
            _this6.widgetRowOne[4].value = res.totalPrivateStaffbyblockunituser;
          });
          this.userService.getUserInterestGroupCountByBlockUnitUserId(unitUser).subscribe(function (res) {
            _this6.widgetRowOne[5].value = res[0]; //dummy Need to integrate
          });
        }
      }, {
        key: "thirdRow",
        value: function thirdRow() {
          ...
          this.dashboardService.getUDashOpenticektsbyblockunituser(entity).subscribe(function (res) {
            _this7.widgetRowThree[0].value = res.openticket;
          });
          ...
          this.dashboardService.getUDashVisitorNoTcheckeddoubyblockunitId(visNot).subscribe(function (res) {
            _this7.widgetRowThree[2].value = res.visitorsNotcheckedtoday;
          });
          this.dashboardService.getUDashCurrentViolationsbyblockunituserId(violation).subscribe(function (res) {
            _this7.widgetRowThree[3].value = res.currentViolations;
          });
        }
      }, {
        key: "fifthRow",
        value: function fifthRow() {
          ...
          this.dashboardService.getUDashWaterunitsbyblockunitId(reading).subscribe(function (res) {
            _this8.widgetRowFive[1].value = res.waterunits;
          });
          this.dashboardService.getUDapprovedfacilittbookingbyblockunitId(entity).subscribe(function (res) {
            _this8.widgetRowFive[2].value = res.approvedfaclitiesTodayCount;
        ...
        value: function ngOnInit() {
          ...
          this.userService.getUserById(params).subscribe(function (res) {
            ...
            if (_this9.userDetails && !_this9.userDetails.isApproved) {
              ...
              var dialogRef = _this9.dialog.open(_new_user_registration_new_user_registration_component__WEBPACK_IMPORTED_MODULE_8__["NewUserRegistrationComponent"], {
                width: 'auto',
                height: 'auto',
                data: data
              });
    ...
    }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [src_app_api_controllers_User__WEBPACK_IMPORTED_MODULE_3__["UserService"], src_app_shared_services_shared_service__WEBPACK_IMPORTED_MODULE_4__["SharedService"], ngx_cookie_service__WEBPACK_IMPORTED_MODULE_5__["CookieService"], src_app_api_controllers_DashBoard__WEBPACK_IMPORTED_MODULE_6__["DashBoardService"], _angular_material_dialog__WEBPACK_IMPORTED_MODULE_2__["MatDialog"]])], UserDashboardComponent);
    /***/
  },
...
//# sourceMappingURL=user-user-dashboard-user-dashboard-module-es5.js.map