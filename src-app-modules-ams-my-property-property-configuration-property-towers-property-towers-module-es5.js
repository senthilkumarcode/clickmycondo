(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["src-app-modules-ams-my-property-property-configuration-property-towers-property-towers-module"], {
    ...
    function node_modulesRawLoaderDistCjsJsSrcAppModulesAmsMyPropertyPropertyConfigurationPropertyTowersPropertyTowerInfoPropertyTowerInfoComponentHtml(module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_exports__["default"] = "<div class=\"property-tower-wrapper\">\n\n\t<app-loader *ngIf=\"!isTowersLoaded\"></app-loader>\n\n\t<ng-container *ngIf=\"isTowersLoaded\">\n\n\t\t<div class=\"row\">\n\t\t\t<div class=\"col-sm-12\">\n\t\t\t\t<div class=\"d-flex justify-content-end mb-3\">\n\t\t\t\t\t<div class=\"link\" (click)=\"showEditForm()\">\n\t\t\t\t\t\t<mat-icon  [color]=\"'primary'\" *ngIf=\"isEdit\" [svgIcon]=\"'arrow_back'\"></mat-icon>\n\t\t\t\t\t\t<mat-icon class=\"icon-md\" [color]=\"'primary'\" *ngIf=\"!isEdit\" svgIcon=\"feather:edit\"></mat-icon>\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t</div>\n\n\t\t<ng-container *ngIf=\"!isEdit\">\n\n\t\t\t<form #propertyDetailsForm = \"ngForm\" name=\"propertyDetailsForm\" novalidate>\n\t\t\t\t\n\t\t\t\t<div class=\"data-wrapper\">\n\t\t\t\t\t\n\t\t\t\t\t<div class=\"row\">\n\t\t\t\t\t\t<div class=\"col-sm-4\">\n\t\t\t\t\t\t\t<div class=\"input-box\">\n\t\t\t\t\t\t\t\t<label>{{'PROPERTY.CONFIGURATION.CONSTRUCTIONAREASQM' | translate}}</label>\n\t\t\t\t\t\t\t\t<p>{{tower.blockConstructedArea | notAvail}}</p>\n\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t\t<div class=\"col-sm-4\">\n\t\t\t\t\t\t\t<div class=\"input-box\">\n\t\t\t\t\t\t\t\t<label>{{'PROPERTY.CONFIGURATION.COMMONAREASQM' | translate}}</label>\n\t\t\t\t\t\t\t\t<p>{{tower.blockCommonArea | notAvail}}</p>\n\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t\t<div class=\"col-sm-4\">\n\t\t\t\t\t\t\t<div class=\"input-box\">\n\t\t\t\t\t\t\t\t<label>{{'PROPERTY.CONFIGURATION.UNITSUNDERCONSTRUCTION' | translate}}</label>\n\t\t\t\t\t\t\t\t<p>{{tower.unitsUnderConstruction | notAvail}}</p>\n\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t\t<div class=\"col-sm-4\">\n\t\t\t\t\t\t\t<div class=\"input-box\">\n\t\t\t\t\t\t\t\t<label>{{'PROPERTY.CONFIGURATION.TOTALUNITS' | translate}}</label>\n\t\t\t\t\t\t\t\t<p>{{totalItems}}</p>\n\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t</div>\n\t\n\t\t\t\t</div>\n\t\n\t\t\t</form>\n\t\n\t\t</ng-container>\n\t\n\t\t<ng-container *ngIf=\"isEdit\">\n\t\t\t\n\t\t\t<form #propertyDetailsForm = \"ngForm\" name=\"propertyDetailsForm\" novalidate>\n\t\t\t\t\n\t\t\t\t<div class=\"row\">\n\t\t\t\t\t<div class=\"col-sm-4\">\n\t\t\t\t\t\t<div class=\"input-box\">\n\t\t\t\t\t\t\t<label>{{'PROPERTY.CONFIGURATION.CONSTRUCTIONAREASQM' | translate}}</label>\n\t\t\t\t\t\t\t<input type=\"text\" OnlyNumber=\"true\" class=\"form-control\" placeholder=\"Enter value\" name=\"blockConstructedArea\" [(ngModel)]=\"tower.blockConstructedArea\">\n\t\t\t\t\t\t</div>\n\t\t\t\t\t</div>\n\t\t\t\t\t<div class=\"col-sm-4\">\n\t\t\t\t\t\t<div class=\"input-box\">\n\t\t\t\t\t\t\t<label>{{'PROPERTY.CONFIGURATION.COMMONAREASQM' | translate}}</label>\n\t\t\t\t\t\t\t<input type=\"text\" OnlyNumber=\"true\" class=\"form-control\" placeholder=\"Enter value\" name=\"blockCommonArea\" [(ngModel)]=\"tower.blockCommonArea\">\n\t\t\t\t\t\t</div>\n\t\t\t\t\t</div>\n\t\t\t\t\t<div class=\"col-sm-4\">\n\t\t\t\t\t\t<div class=\"input-box\">\n\t\t\t\t\t\t\t<label>{{'PROPERTY.CONFIGURATION.UNITSUNDERCONSTRUCTION' | translate}}</label>\n\t\t\t\t\t\t\t<input type=\"text\" OnlyNumber=\"true\" class=\"form-control\" placeholder=\"Enter value\" name=\"constructionInProgress\" [(ngModel)]=\"tower.unitsUnderConstruction\">\n\t\t\t\t\t\t</div>\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\n\t\t\t\t<div class=\"mt-4 float-right\">\n\t\t\t\t\t<submit-button [isSubmit]=\"isDataSubmitted\" (click)=\"submitPropertyDetailsForm()\">{{'BUTTONS.SUBMITBUTTON' | translate}}</submit-button>\n\t\t\t\t</div>\n\t\n\t\t\t</form>\n\t\n\t\t</ng-container>\n\n\t</ng-container>\n\n</div>";
      /***/
    },
    ...
    function srcAppModulesAmsMyPropertyPropertyConfigurationPropertyTowersPropertyTowerInfoPropertyTowerInfoComponentTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var PropertyTowerInfoComponent = /*#__PURE__*/function () {
        ...
        _createClass(PropertyTowerInfoComponent, [{
          ...
          value: function submitPropertyDetailsForm() {
            var _this = this;
            ...
            this.apartmentService.updateApartmentBlock(params).subscribe(function (res) {
              ...
              if (res.code == 200) {
                ...
                _this.sharedService.openSnackBar('Property Towers Updated.', 'success');
              } else {
                _this.isEdit = false;
              }
            });
