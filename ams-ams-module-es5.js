...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["ams-ams-module"], {
  ...
  function node_modulesAngularMaterial__ivy_ngcc__Fesm2015SidenavJs(module, __webpack_exports__, __webpack_require__) {
    ...
    function MatSidenavContainer_div_0_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵlistener"]("click", function MatSidenavContainer_div_0_Template_div_click_0_listener() {
          ...
          return ctx_r6._onBackdropClicked();
        });
    ...
    function (_angular_cdk_scrollin) {
      ...
      var _super2 = _createSuper(MatDrawerContent);
      ...
      function MatDrawerContent(_changeDetectorRef, _container, elementRef, scrollDispatcher, ngZone) {
        ...
        _this82 = _super2.call(this, elementRef, scrollDispatcher, ngZone);
        _this82._changeDetectorRef = _changeDetectorRef;
        _this82._container = _container;
        return _this82;
      }
      /**
       * @return {?}
    ...
    function () {
      ...
      function MatDrawer(_elementRef, _focusTrapFactory, _focusMonitor, _platform, _ngZone, _doc, _container) {
        ...
        */
        function (opened) {
          if (opened) {
            if (_this84._doc) {
              _this84._elementFocusedBeforeDrawerWasOpened =
              /** @type {?} */
              _this84._doc.activeElement;
            }

            _this84._takeFocus();
          } else {
            _this84._restoreFocus();
          }
        });
        /**
        ...
        */
        function () {
          /** @type {?} */
          Object(rxjs__WEBPACK_IMPORTED_MODULE_9__["fromEvent"])(_this84._elementRef.nativeElement, 'keydown').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_10__["filter"])(
          /**
          * @param {?} event
          * @return {?}
          */
          function (event) {
            return event.keyCode === _angular_cdk_keycodes__WEBPACK_IMPORTED_MODULE_8__["ESCAPE"] && !_this84.disableClose && !Object(_angular_cdk_keycodes__WEBPACK_IMPORTED_MODULE_8__["hasModifierKey"])(event);
          }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_10__["takeUntil"])(_this84._destroyed)).subscribe(
          /**
          * @param {?} event
          * @return {?}
          */
          function (event) {
            return _this84._ngZone.run(
            /**
            * @return {?}
            */
            function () {
        ...
        */
        function (event) {
          ...
          if (toState.indexOf('open') === 0 && fromState === 'void' || toState === 'void' && fromState.indexOf('open') === 0) {
            _this84.openedChange.emit(_this84._opened);
          }
        });
      }
      /**
      ...
      _createClass(MatDrawer, [{
        ...
        value: function _takeFocus() {
          ...
          */
          function (hasMovedFocus) {
            ...
            if (!hasMovedFocus && typeof _this85._elementRef.nativeElement.focus === 'function') {
              _this85._elementRef.nativeElement.focus();
            }
          });
        }
        /**
        ...
        value: function toggle() {
          ...
          */
          function (resolve) {
            _this86.openedChange.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_10__["take"])(1)).subscribe(
            /**
            * @param {?} open
            * @return {?}
            */
    ...
    function () {
      ...
      function MatDrawerContainer(_dir, _element, _ngZone, _changeDetectorRef, viewportRuler) {
        ...
        if (_dir) {
          ...
          */
          function () {
            _this87._validateDrawers();

            _this87.updateContentMargins();
          });
        ...
        */
        function () {
          return _this87.updateContentMargins();
        });
      ...
      _createClass(MatDrawerContainer, [{
        ...
        value: function ngAfterContentInit() {
          ...
          */
          function (drawer) {
            ...
            _this88._drawers.reset(drawer.filter(
            /**
            * @param {?} item
            * @return {?}
            */
            function (item) {
              return !item._container || item._container === _this88;
            }));

            _this88._drawers.notifyOnChanges();
          });
          ...
          */
          function () {
            _this88._validateDrawers();

            _this88._drawers.forEach(
            /**
            * @param {?} drawer
            * @return {?}
            */
            function (drawer) {
              _this88._watchDrawerToggle(drawer);

              _this88._watchDrawerPosition(drawer);

              _this88._watchDrawerMode(drawer);
            });

            if (!_this88._drawers.length || _this88._isDrawerOpen(_this88._start) || _this88._isDrawerOpen(_this88._end)) {
              _this88.updateContentMargins();
            }
          ...
          */
          function () {
            return _this88.updateContentMargins();
          });
        }
        /**
         * @return {?}
        ...
        value: function updateContentMargins() {
          ...
          if (left !== this._contentMargins.left || right !== this._contentMargins.right) {
            ...
            */
            function () {
              return _this89._contentMarginChanges.next(_this89._contentMargins);
            });
          }
        }
        /**
        ...
        value: function ngDoCheck() {
          ...
          if (this._autosize && this._isPushed()) {
            ...
            */
            function () {
              return _this90._doCheckSubject.next();
            });
          }
        }
        /**
        ...
        value: function _watchDrawerToggle(drawer) {
          ...
          */
          function (event) {
            ...
            if (event.toState !== 'open-instant' && _this91._animationMode !== 'NoopAnimations') {
              _this91._element.nativeElement.classList.add('mat-drawer-transition');
            }
          ...
          if (drawer.mode !== 'side') {
            ...
            */
            function () {
              return _this91._setContainerClass(drawer.opened);
            });
          }
        }
        /**
        ...
        value: function _watchDrawerPosition(drawer) {
          ...
          */
          function () {
            _this92._ngZone.onMicrotaskEmpty.asObservable().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_10__["take"])(1)).subscribe(
            /**
            * @return {?}
            */
            function () {
          ...
          */
          function (drawer) {
            if (drawer.position == 'end') {
              if (_this94._end != null) {
                throwMatDuplicatedDrawerError('end');
              }

              _this94._end = drawer;
            } else {
              if (_this94._start != null) {
                throwMatDuplicatedDrawerError('start');
              }

              _this94._start = drawer;
            }
          });
        ...
        value: function _closeModalDrawer() {
          ...
          */
          function (drawer) {
            return drawer && !drawer.disableClose && _this95._canHaveBackdrop(drawer);
          }).forEach(
          /**
          * @param {?} drawer
          * @return {?}
    ...
    function (_MatDrawerContent) {
      ...
      var _super3 = _createSuper(MatSidenavContent);
      ...
      function MatSidenavContent(changeDetectorRef, container, elementRef, scrollDispatcher, ngZone) {
        ...
        return _super3.call(this, changeDetectorRef, container, elementRef, scrollDispatcher, ngZone);
      }
    ...
    function (_MatDrawer) {
      ...
      var _super4 = _createSuper(MatSidenav);
      ...
      function MatSidenav() {
        ...
        _this96 = _super4.apply(this, arguments);
        _this96._fixedInViewport = false;
        _this96._fixedTopGap = 0;
        _this96._fixedBottomGap = 0;
        return _this96;
      }
      /**
    ...
    function (_MatDrawerContainer) {
      ...
      var _super5 = _createSuper(MatSidenavContainer);
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppAmsComponentsNotificationNotificationComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppAmsAmsRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var routes = [{
      ...
      children: [{
        ...
        loadChildren: function loadChildren() {
          return __webpack_require__.e(
          /*! import() | violation-violation-module */
          "violation-violation-module").then(__webpack_require__.bind(null,
          /*! ./violation/violation.module */
          "./src/app/ams/violation/violation.module.ts")).then(function (m) {
            return m.ViolationModule;
          });
        }
      }, {
        ...
        loadChildren: function loadChildren() {
          return __webpack_require__.e(
          /*! import() | roles-and-permissions-roles-and-permissions-module */
          "roles-and-permissions-roles-and-permissions-module").then(__webpack_require__.bind(null,
          /*! ./roles-and-permissions/roles-and-permissions.module */
          "./src/app/ams/roles-and-permissions/roles-and-permissions.module.ts")).then(function (m) {
            return m.RolesAndPermissionsModule;
          });
        }
      }, {
        path: 'todo',
  ...
  function srcAppAmsAmsModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _components_apartment_dialog_apartment_dialog_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(
    /*! ./components/apartment-dialog/apartment-dialog.component */
    "./src/app/ams/components/apartment-dialog/apartment-dialog.component.ts");
    /* harmony import */


    var _components_ams_bottom_menu_ams_bottom_menu_component__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(
    ...
    var _components_settings_payment_setup_payment_setup_component__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(
    ...
    var _components_settings_admin_admin_component__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(
    /*! ./components/settings/admin/admin.component */
    "./src/app/ams/components/settings/admin/admin.component.ts");
    /* harmony import */


    var _components_notification_notification_component__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(
  ...
  function srcAppAmsComponentsAmsBottomMenuAmsBottomMenuComponentScss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = ".bottom-menu-wrapper {\n  position: fixed;\n  bottom: 0;\n  height: 60px;\n  border-top: 1px solid #eaeaea;\n  background-color: #ffffff;\n  z-index: 1000;\n  width: 100% !important;\n  box-shadow: 0 0px 10px 1px rgba(0, 0, 0, 0.1);\n  -moz-box-shadow: 0 0px 10px 1px rgba(0, 0, 0, 0.1);\n  -webkit-box-shadow: 0 0px 10px 1px rgba(0, 0, 0, 0.1);\n}\n.bottom-menu-wrapper a {\n  display: block;\n  text-align: center;\n  margin: 8px 0 0 0;\n  height: 70px;\n}\n.bottom-menu-wrapper a .icon {\n  padding: 0 0 6px 0;\n}\n.bottom-menu-wrapper a .icon .svg {\n  width: 18px;\n  height: 16px;\n  fill: #585858;\n}\n.bottom-menu-wrapper a .icon path {\n  fill: #585858;\n}\n.bottom-menu-wrapper a h4 {\n  color: #585858;\n  font-size: 1.4rem;\n}\n.bottom-menu-wrapper a:hover, .bottom-menu-wrapper a.active {\n  text-decoration: none;\n}\n.bottom-menu-wrapper a:hover .icon .svg, .bottom-menu-wrapper a.active .icon .svg {\n  fill: #5cd694;\n}\n.bottom-menu-wrapper a:hover h4, .bottom-menu-wrapper a.active h4 {\n  color: #5cd694;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
    ...
    function () {
      ...
      _createClass(AmsBottomMenuComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.sharedService.sidebarminicast.subscribe(function (isSideBarMini) {
            return _this98.isSideBarMini = isSideBarMini;
          });
        }
      }]);
  ...
  /***/
  function srcAppAmsComponentsNotificationNotificationComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppAmsComponentsNotificationNotificationComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    NotificationComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/ams/components/notification/notification.component.html"))["default"],
      styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! ./notification.component.scss */
      "./src/app/ams/components/notification/notification.component.scss"))["default"]]
  ...
  function srcAppAmsComponentsSidebarSidebarComponentScss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "@charset \"UTF-8\";\n.ps-h, .sidebar .ps {\n  min-height: calc(100vh - 160px);\n  max-height: calc(100vh - 160px);\n}\n@media (max-width: 576px) {\n  .ps-h, .sidebar .ps {\n    min-height: calc(100vh - 70px);\n    max-height: calc(100vh - 70px);\n  }\n}\n.sidebar {\n  position: fixed;\n  width: 240px;\n  float: left;\n  margin-left: 0;\n  background-color: #ffffff;\n  box-shadow: 7px 0 60px rgba(0, 0, 0, 0.1);\n  -moz-box-shadow: 7px 0 60px rgba(0, 0, 0, 0.1);\n  -webkit-box-shadow: 7px 0 60px rgba(0, 0, 0, 0.1);\n  transition: all 0.2s ease;\n  z-index: 1;\n}\n.sidebar .hero-info .apartment {\n  padding: 20px 20px 0 20px;\n  border-bottom: 1px solid #eaeaea;\n  opacity: 1;\n  -moz-opacity: 1;\n  -webkit-opacity: 1;\n  height: 90px;\n  visibility: visible;\n  overflow: hidden;\n  transition: all 0.15s ease;\n  cursor: pointer;\n}\n.sidebar .hero-info .apartment .icon {\n  margin: 0 auto;\n  width: 50px;\n  height: 50px;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  background-color: #ffeb3b;\n  border-radius: 50px !important;\n}\n.sidebar .ps {\n  position: relative;\n  padding-bottom: 80px !important;\n}\n.sidebar .navs .nav-list {\n  cursor: pointer;\n  min-height: 48px;\n}\n.sidebar .navs .nav-list > a {\n  color: #373946;\n  display: block;\n  padding: 2px 20px 0 20px;\n  text-decoration: none;\n  line-height: 48px;\n  width: 100% !important;\n}\n.sidebar .navs .nav-list > a .icon {\n  display: inline-block;\n  width: 25px;\n  position: relative;\n  top: -2px;\n}\n.sidebar .navs .nav-list > a span {\n  font-family: \"Montserrat\", sans-serif;\n  font-weight: 400;\n  letter-spacing: 0.3px;\n  -webkit-font-smoothing: inherit;\n  -moz-osx-font-smoothing: inherit;\n  font-size: 1.3rem;\n  margin: 0 0 0 4px;\n}\n.sidebar .navs .nav-list:hover, .sidebar .navs .nav-list.nav-active {\n  background-color: #e0e3ec;\n}\n.sidebar .navs .nav-list:hover a, .sidebar .navs .nav-list:hover:after, .sidebar .navs .nav-list.nav-active a, .sidebar .navs .nav-list.nav-active:after {\n  color: #191c1e;\n}\n.sidebar .navs .nav-list .svg {\n  width: 18px;\n  height: 18px;\n  fill: #373946;\n}\n.sidebar .navs .nav-list.nav-parent {\n  position: relative;\n}\n.sidebar .navs .nav-list.nav-parent:after {\n  position: absolute;\n  content: \"\";\n  font-family: FontAwesome;\n  top: 18px;\n  right: 15px;\n  color: #585858;\n  font-size: 1.4rem;\n  font-weight: 400;\n}\n.sidebar .navs .nav-list.nav-parent:hover a, .sidebar .navs .nav-list.nav-parent:hover:after {\n  color: #191c1e;\n}\n.sidebar .navs .nav-list.nav-parent.nav-active:after {\n  content: \"\";\n}\n.sidebar .navs .nav-list.nav-parent .nav-children {\n  background-color: #ffffff;\n  max-height: 0;\n  overflow: hidden;\n  transition: max-height 0.3s ease;\n  padding: 0 0 0 12px !important;\n}\n.sidebar .navs .nav-list.nav-parent .nav-children li {\n  width: 100% !important;\n}\n.sidebar .navs .nav-list.nav-parent .nav-children li a {\n  display: block;\n  padding: 10px 20px 10px 34px;\n  position: relative;\n  color: #68696b;\n  font-family: \"Montserrat\", sans-serif;\n  font-weight: 400;\n  letter-spacing: 0.3px;\n  -webkit-font-smoothing: inherit;\n  -moz-osx-font-smoothing: inherit;\n  font-size: 1.3rem;\n  letter-spacing: 0.7px;\n}\n.sidebar .navs .nav-list.nav-parent .nav-children li a:before {\n  position: absolute;\n  content: \"\";\n  font-family: FontAwesome;\n  top: 10px;\n  left: 20px;\n  color: #68696b;\n  font-size: 1.4rem;\n  font-weight: 400;\n}\n.sidebar .navs .nav-list.nav-parent .nav-children li a.active, .sidebar .navs .nav-list.nav-parent .nav-children li a:hover {\n  color: #3f51b5;\n  text-decoration: none;\n}\n.sidebar .navs .nav-list.nav-parent .nav-children li a.active:before, .sidebar .navs .nav-list.nav-parent .nav-children li a:hover:before {\n  color: #3f51b5;\n}\n.sidebar .navs .nav-list.nav-parent .nav-children li a.active {\n  font-family: \"Montserrat\", sans-serif;\n  font-weight: 500;\n  letter-spacing: 0.2px;\n}\n.sidebar .navs .nav-list.nav-parent .nav-children.nav-active {\n  max-height: 1000px;\n  overflow: auto;\n  border-bottom: 1px solid #dedede;\n  transition: max-height 0.5s ease;\n}\n.sidebar .navs.scroller .mCSB_inside > .mCSB_container {\n  padding: 0 0 20px 0;\n}\n@media (min-width: 991px) {\n  .sidebar.mini {\n    margin-left: 0;\n    width: 70px;\n    transition: all 0.2s ease;\n  }\n  .sidebar.mini .user {\n    display: none !important;\n  }\n  .sidebar.mini .ps {\n    overflow: visible !important;\n    min-height: calc(100vh - 70px);\n    max-height: calc(100vh - 70px);\n  }\n  .sidebar.mini .ps.oh {\n    overflow: hidden !important;\n  }\n  .sidebar.mini .navs .nav-list {\n    min-height: 30px !important;\n  }\n  .sidebar.mini .navs .nav-list.nav-parent .nav-children {\n    padding: 0 0 0 5px !important;\n    border: none;\n  }\n  .sidebar.mini .navs .nav-list > a {\n    padding: 14px 20px !important;\n    line-height: inherit;\n  }\n  .sidebar.mini .navs .nav-list > a .icon {\n    position: static;\n  }\n  .sidebar.mini .navs .nav-list > a span {\n    opacity: 0;\n    -moz-opacity: 0;\n    -webkit-opacity: 0;\n    visibility: hidden;\n    overflow: hidden;\n    transition: all 0.2s ease;\n    position: fixed !important;\n  }\n  .sidebar.mini .navs .nav-list:after {\n    top: 16px !important;\n    right: 18px !important;\n  }\n  .sidebar.mini .hero-info .apartment {\n    padding: 0 !important;\n    opacity: 0;\n    -moz-opacity: 0;\n    -webkit-opacity: 0;\n    max-height: 0;\n    visibility: hidden;\n    overflow: hidden;\n    transition: all 0.15s ease;\n  }\n  .sidebar.mini .hero-info .user {\n    padding: 0 !important;\n  }\n  .sidebar.mini .hero-info .user .profile-picture {\n    width: 32px !important;\n    height: 32px !important;\n    padding: 6px 0 !important;\n    transition: all 0.2s ease;\n  }\n  .sidebar.mini .hero-info .user .profile-picture img {\n    width: 100% !important;\n    border-radius: 50% !important;\n  }\n  .sidebar.mini .nav-children {\n    position: absolute;\n    left: 70px;\n    top: 0;\n    min-width: 205px;\n    background-color: #ffffff !important;\n    box-shadow: 1px 2px 4px rgba(0, 0, 0, 0.2);\n    -moz-box-shadow: 1px 2px 4px rgba(0, 0, 0, 0.2);\n    -webkit-box-shadow: 1px 2px 4px rgba(0, 0, 0, 0.2);\n  }\n  .sidebar.mini .nav-children a {\n    padding: 10px 10px 10px 28px !important;\n  }\n  .sidebar.mini .nav-children a:before {\n    left: 12px !important;\n  }\n}\n@media (max-width: 991px) {\n  .sidebar {\n    margin-left: -240px;\n    transition: all 0.2s ease;\n  }\n  .sidebar.mini {\n    width: 100% !important;\n    margin-left: 0;\n    z-index: 1000;\n  }\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
  ...
  function srcAppAmsComponentsSidebarSidebarComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _shared_services_constants_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ../../../shared/services/constants.service */
    "./src/app/shared/services/constants.service.ts");
    /* harmony import */
    ...
    /*#__PURE__*/
    function () {
      function SidebarComponent(renderer, injector, router, screenService, cookieService, constantsService, sharedService) {
        var _this99 = this;
        ...
        router.events.subscribe(function (event) {
          if (event instanceof _angular_router__WEBPACK_IMPORTED_MODULE_2__["NavigationEnd"]) {
            if (window.innerWidth <= 991) {
              _this99.isSideBarMini = false;

              _this99.sharedService.setSideBarMini(_this99.isSideBarMini);
            }

            _this99.activePath = _this99.router.url;
          }
        });
      }
      ...
      _createClass(SidebarComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.sharedService.apartmentselectedcast.subscribe(function (isSelected) {
            _this100.isApartmentSelected = isSelected;

            if (_this100.isApartmentSelected) {
              _this100.menusDataList = _this100.constantsService.getAllMenus();
              var sidebarParams = {
                apartmentId: parseInt(_this100.cookieService.get('apartmentId'))
              };

              _this100.screenService.getAllScreens(sidebarParams).subscribe(function (res) {
                _this100.availableScreensDataList = res;
                _this100.isMenuLoaded = true;
                underscore__WEBPACK_IMPORTED_MODULE_8__["each"](_this100.availableScreensDataList, function (item) {
                  var menus = _this100.menusDataList.filter(function (menu) {
                    return menu.name === item.screenName;
                  }); // undefined check if local json doesnt have corrosponding menu data


                  if (menus[0] !== undefined) _this100.sidebarMenuDataList.push(menus[0]);
                });
                setTimeout(function () {
                  var navItems = $('.nav-list');
                  $.each(navItems, function (index, elem) {
                    if ($(elem).find('.nav-link').hasClass('active')) {
                      _this100.activeNav = $(elem).find('.nav-link').attr('name');
                    }
                  });
                }, 1000);
              }, function (error) {
          ...
          this.sharedService.sidebarminicast.subscribe(function (isSideBarMini) {
            return _this100.isSideBarMini = isSideBarMini;
          });
          this.sharedService.userlogin.subscribe(function (userLoggedIn) {
            return _this100.userLoggedIn = userLoggedIn;
          });
        }
      }]);
