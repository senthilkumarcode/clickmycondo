...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["income-tracker-income-tracker-module"], {
  ...
  function srcAppAmsIncomeTrackerComponentsIncomeAddSecurityDepositIncomeAddSecurityDepositComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      ...
      _createClass(IncomeAddSecurityDepositComponent, [{
        ...
        key: "onSelectChange",
        value: function onSelectChange(event) {
          if (event != null) this.deposit.collectionId = event.collectionId;
        }
      }, {
  ...
  function srcAppAmsIncomeTrackerComponentsIncomeJournalIncomeJournalComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function IncomeJournalComponent(apartmentService, accountsService, lookupService, cookieService) {
