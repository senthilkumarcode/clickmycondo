...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["income-tracker-income-tracker-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppAmsIncomeTrackerComponentsIncomeReceiptsReverseIncomeReceiptsReverseComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppAmsIncomeTrackerComponentsIncomeTrackerSetupIncomeTrackerSetupAutoInvoicingIncomeTrackerSetupAutoInvoicingComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppAmsIncomeTrackerComponentsIncomeTrackerSetupIncomeTrackerSetupGeneralIncomeTrackerSetupGeneralComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_exports__["default"] = "<div class=\"card\">\n    <div class=\"card-header\">\n        <div class=\"float-left\">\n            <h5>General</h5>\n        </div>\n    </div>\n    <div class=\"card-body profile-section\">\n        <app-alert-message [message]=\"errorMessage\" [isAlert]=\"isError\"></app-alert-message>\n        <!-- <app-loader *ngIf=\"!isSettingsDataLoaded\"></app-loader> -->\n        <ng-container >\n            <div class=\"row\">\n                <div class=\"col-sm-6\">\n                    <div class=\"select-box\">\n                        <label>Currency Type*</label>\n                        <!-- <input type=\"text\" name=\"lookupValueName\" [(ngModel)]=\"currencylookupValueName\"\n                            class=\"form-control\" readonly> -->\n                        <select name=\"lookupValueName\" id=\"lookupValueName\" class=\"form-control\"\n                            [(ngModel)]=\"currencylookupValueName\" readonly>\n                            <option value=\"\" disabled selected hidden>select</option>\n                            <option *ngFor=\"let item of currencyTypeDataList\" [label]=\"item.lookupValueName\"\n                                [value]=\"item.lookupValueName\">\n                               {{item.lookupValueName}}</option>\n                        </select>\n                    </div>\n                </div>\n            </div>\n        </ng-container>\n\n    </div>\n\n    <!-- AR controlGL account -->\n\n    <!-- <div class=\"card-body profile-section\">\n\n        <app-alert-message [message]=\"errorMessage\" [isAlert]=\"isError\"></app-alert-message>\n\n        <app-loader *ngIf=\"!isSettingsDataLoaded\"></app-loader>\n\n        <ng-container *ngIf=\"isSettingsDataLoaded && !isEditReconciliation\">\n            <div class=\"row\">\n                <div class=\"col-sm-4\">\n                    <div class=\"select-box\">\n                        <label>AR Control GL Account*</label>\n                        <select name=\"glaccountId\" id=\"glaccountId\" class=\"form-control\"\n                            [(ngModel)]=\"custAccData.glaccountId\" required readonly>\n                            <option value=\"\" disabled selected hidden>select</option>\n                            <option *ngFor=\"let item of glAccountListData\" [label]=\"item.glaccountName\"\n                                [value]=\"item.glaccountId\">\n                                {{ item.glaccountNumber}} - {{ item.glaccountName }}</option>\n                        </select>\n                    </div>\n                </div>\n                <div class=\"col-sm-2 add-btn\" *ngIf=\"!isEditReconciliation\">\n                    <a class=\"btn lime-green\" (click)=\"editReconciliation()\">\n                        <i-feather class=\"icon plus\" name=\"plus\"></i-feather>Add\n                    </a>\n                </div>\n            </div>\n        </ng-container>\n\n        <ng-container *ngIf=\"isSettingsDataLoaded && isEditReconciliation\">\n\n            <form #glAccount=\"ngForm\" name=\"glAccount\" (ngSubmit)=\"addCustAccount(custAccData)\" novalidate>\n\n                <div class=\"row\">\n\n                    <div class=\"col-sm-4\">\n                        <div class=\"select-box\">\n                            <label>AR Control GL Account*</label>\n                            <select name=\"glaccountId\" id=\"glaccountId\" class=\"form-control\"\n                                [(ngModel)]=\"custAccData.glaccountId\" required>\n                                <option value=\"\" disabled selected hidden>select</option>\n                                <option *ngFor=\"let item of glAccountListData\" [label]=\"item.glaccountName\"\n                                    [value]=\"item.glaccountId\">\n                                    {{ item.glaccountNumber}} - {{ item.glaccountName }}</option>\n                            </select>\n                        </div>\n                    </div>\n\n                    <div class=\"col-sm-2\">\n                        <div>\n                            <button class=\"btn blue mr-2 save-button\" [disabled]=\"glAccount.invalid\">Save</button>\n                        </div>\n                        <div class=\"icon-wrapper back-button\" *ngIf=\"isEditReconciliation\">\n                            <i-feather class=\"icon back\" name=\"chevron-left\" (click)=\"editReconciliation()\"></i-feather>\n                        </div>\n                    </div>\n                </div>\n\n            </form>\n        </ng-container>\n    </div> -->\n\n    <!-- AR Control GL Account* -->\n    <div class=\"card-body profile-section\">\n        <ng-container>\n            <div class=\"row\">\n                <div class=\"col-sm-6 mb-30 select-box\">\n                    <label>AR Control GL Account*</label>\n                    <div class=\"card clear\" id=\"accordion1\">\n                        <div class=\"card-body p-0\">\n                            <ul class=\"list-group tabs clear\">\n                                <li class=\"list-group-item\" #accordion1 data-toggle=\"collapse\" data-target=\"#glAcc\"\n                                    aria-expanded=\"false\" aria-controls=\"collapseOne\">\n                                    <span class=\"font-med\">AR Control GL Account*</span>&nbsp;<span\n                                        *ngIf=\"glAccountListData.length!=0\">({{glAccountListData.length}})</span>\n                                </li>\n                                <div id=\"glAcc\" class=\"collapse\" aria-labelledby=\"headingOne\" data-parent=\"#accordion1\">\n                                    <div class=\"details\">\n                                        <table class=\"mini-table-1\" [ngClass]=\"isMobileView()\">\n                                            <thead>\n                                                <tr>\n                                                    <th class=\"name\">GL Account</th>\n                                                    <th class=\"action\">Action</th>\n                                                </tr>\n                                            </thead>\n                                            <tbody *ngIf=\"glAccountListData.length!=0\">\n                                                <tr *ngFor=\"let item of glAccountListData;index as i;\">\n                                                    <td class=\"name\"> {{ item.glaccountNumber}} -\n                                                        {{ item.glaccountName }}</td>\n                                                    <td class=\"action\">\n                                                        <a class=\"pr-2 add lime-green\" (click)=\"addCustAccount(item)\">\n                                                            <i-feather class=\"icon plus\" name=\"plus\"></i-feather>\n                                                        </a>\n                                                        <!-- <a class=\"pr-2\" (click)=\"addCustAccount(item)\">\n                                                            <i-feather class=\"icon plus\" name=\"plus\"></i-feather>\n                                                        </a> -->\n                                                    </td>\n                                                </tr>\n                                            </tbody>\n                                        </table>\n                                    </div>\n                                </div>\n                            </ul>\n                        </div>\n                    </div>\n                </div>\n            </div>\n        </ng-container>\n    </div>\n\n    <!-- custIncome -->\n    <div class=\"card-body profile-section\">\n        <ng-container>\n            <div class=\"row\">\n                <div class=\"col-sm-6 mb-30 select-box\">\n                    <label>Customer Income Payment Term*</label>\n                    <!-- <p class=\"font-med mb-2\"><b>Customer Income Payment Term*</b></p> -->\n                    <table class=\"mini-table\" [ngClass]=\"isMobileView()\">\n                        <thead>\n                            <tr>\n                                <th>\n                                    <input type=\"text\" class=\"tablewidth form-control\" placeholder=\"Enter\"\n                                        name=\"lookupValueName\" [(ngModel)]=\"customerIncomeValue.lookupValueName\">\n                                </th>\n                                <th width=\"5%\">\n                                    <a class=\"btn lime-green\" (click)=\"addLookupValue('customerIncomeValue')\">\n                                        <i-feather class=\"icon plus\" name=\"plus\"></i-feather>Add\n                                    </a>\n                                </th>\n                            </tr>\n                        </thead>\n                    </table>\n                    <div class=\"card clear\" id=\"accordion1\">\n                        <div class=\"card-body p-0\">\n                            <ul class=\"list-group tabs clear\">\n                                <li class=\"list-group-item\" #accordion1 data-toggle=\"collapse\"\n                                    data-target=\"#CustomerIncome\" aria-expanded=\"false\" aria-controls=\"collapseOne\">\n                                    <span class=\"font-med\">Customer Income Payment Term List</span>&nbsp;<span\n                                        *ngIf=\"custIncomelist.length!=0\">({{custIncomelist.length}})</span>\n                                </li>\n                                <div id=\"CustomerIncome\" class=\"collapse\" aria-labelledby=\"headingOne\"\n                                    data-parent=\"#accordion1\">\n                                    <div class=\"details\">\n                                        <table class=\"mini-table-1\" [ngClass]=\"isMobileView()\">\n                                            <thead>\n                                                <tr>\n                                                    <th class=\"name\">Lookup Value Name</th>\n                                                    <th class=\"action\">Action</th>\n                                                </tr>\n                                            </thead>\n                                            <tbody *ngIf=\"custIncomelist.length!=0\">\n                                                <tr *ngFor=\"let item of custIncomelist;index as i;\">\n                                                    <td class=\"name\">{{item.lookupValueName}}</td>\n                                                    <td class=\"action\">\n                                                        <a class=\"pr-2\"\n                                                            (click)=\"editLookupValue(i, 'customerIncomeValue',item)\">\n                                                            <i-feather class=\"icon edit\" name=\"edit\"></i-feather>\n                                                        </a>\n                                                        <a (click)=\"deleteLookupvalue(i, 'customerIncomeValue',item)\">\n                                                            <i-feather class=\"icon delete\" name=\"trash\"></i-feather>\n                                                        </a>\n                                                    </td>\n                                                </tr>\n                                            </tbody>\n                                        </table>\n                                    </div>\n                                </div>\n                            </ul>\n                        </div>\n                    </div>\n                </div>\n            </div>\n        </ng-container>\n    </div>\n    <!-- vatValue -->\n    <div class=\"card-body profile-section\">\n        <ng-container>\n            <div class=\"row\">\n                <div class=\"col-sm-6 mb-30 select-box\">\n                    <!-- <p class=\"font-med mb-2\"><b>% VAT*</b></p> -->\n                    <label>% VAT*</label>\n                    <table class=\"mini-table\" [ngClass]=\"isMobileView()\">\n                        <thead>\n                            <tr>\n                                <th>\n                                    <input type=\"text\" class=\"tablewidth form-control\" placeholder=\"Enter\"\n                                        name=\"lookupValueName\" [(ngModel)]=\"vatValue.lookupValueName\">\n                                </th>\n                                <th width=\"5%\">\n                                    <a class=\"btn lime-green\" (click)=\"addLookupValue('vatValue')\">\n                                        <i-feather class=\"icon plus\" name=\"plus\"></i-feather>Add\n                                    </a>\n                                </th>\n                            </tr>\n                        </thead>\n                    </table>\n                    <div class=\"card clear\" id=\"accordion1\">\n                        <div class=\"card-body p-0\">\n                            <ul class=\"list-group tabs clear\">\n                                <li class=\"list-group-item\" #accordion1 data-toggle=\"collapse\" data-target=\"#VatValue\"\n                                    aria-expanded=\"false\" aria-controls=\"collapseOne\">\n                                    <span class=\"font-med\">% VAT</span> &nbsp;<span\n                                        *ngIf=\"vatPecentageDataList.length!=0\">({{vatPecentageDataList.length}})</span>\n                                </li>\n                                <div id=\"VatValue\" class=\"collapse\" aria-labelledby=\"headingOne\"\n                                    data-parent=\"#accordion1\">\n                                    <div class=\"details\">\n                                        <table class=\"mini-table-1\" [ngClass]=\"isMobileView()\">\n                                            <thead>\n                                                <tr>\n                                                    <th class=\"name\">% Vat Id</th>\n                                                    <th class=\"action\">Action</th>\n                                                </tr>\n                                            </thead>\n                                            <tbody *ngIf=\"vatPecentageDataList.length!=0\">\n                                                <tr *ngFor=\"let item of vatPecentageDataList;index as i;\">\n                                                    <td class=\"name\">{{item.lookupValueName}}</td>\n                                                    <td class=\"action\">\n                                                        <a class=\"pr-2\" (click)=\"editLookupValue(i, 'vatValue',item)\">\n                                                            <i-feather class=\"icon edit\" name=\"edit\"></i-feather>\n                                                        </a>\n                                                        <a (click)=\"deleteLookupvalue(i, 'vatValue',item)\">\n                                                            <i-feather class=\"icon delete\" name=\"trash\"></i-feather>\n                                                        </a>\n                                                    </td>\n                                                </tr>\n                                            </tbody>\n                                        </table>\n                                    </div>\n                                </div>\n                            </ul>\n                        </div>\n                    </div>\n                </div>\n            </div>\n        </ng-container>\n    </div>\n    <!-- taxValue -->\n    <div class=\"card-body profile-section\">\n        <ng-container>\n            <div class=\"row\">\n                <div class=\"col-sm-6 mb-30 select-box\">\n                    <!-- <p class=\"font-med mb-2\"><b>% TAX*</b></p> -->\n                    <label>% TAX*</label>\n                    <table class=\"mini-table\" [ngClass]=\"isMobileView()\">\n                        <thead>\n                            <tr>\n                                <th>\n                                    <input type=\"text\" class=\"tablewidth form-control\" placeholder=\"Enter\"\n                                        name=\"lookupValueName\" [(ngModel)]=\"taxValue.lookupValueName\">\n                                </th>\n                                <th width=\"5%\">\n                                    <a class=\"btn lime-green\" (click)=\"addLookupValue('taxValue')\">\n                                        <i-feather class=\"icon plus\" name=\"plus\"></i-feather>Add\n                                    </a>\n                                </th>\n                            </tr>\n                        </thead>\n                    </table>\n                    <div class=\"card clear\" id=\"accordion1\">\n                        <div class=\"card-body p-0\">\n                            <ul class=\"list-group tabs clear\">\n                                <li class=\"list-group-item\" #accordion1 data-toggle=\"collapse\" data-target=\"#taxValue\"\n                                    aria-expanded=\"false\" aria-controls=\"collapseOne\">\n                                    <span class=\"font-med\">% Tax</span> &nbsp;<span\n                                        *ngIf=\"taxPecentageDataList.length!=0\">({{taxPecentageDataList.length}})</span>\n                                </li>\n                                <div id=\"taxValue\" class=\"collapse\" aria-labelledby=\"headingOne\"\n                                    data-parent=\"#accordion1\">\n                                    <div class=\"details\">\n                                        <table class=\"mini-table-1\" [ngClass]=\"isMobileView()\">\n                                            <thead>\n                                                <tr>\n                                                    <th class=\"name\">% Tax Id</th>\n                                                    <th class=\"action\">Action</th>\n                                                </tr>\n                                            </thead>\n                                            <tbody *ngIf=\"taxPecentageDataList.length!=0\">\n                                                <tr *ngFor=\"let item of taxPecentageDataList;index as i;\">\n                                                    <td class=\"name\">{{item.lookupValueName}}</td>\n                                                    <td class=\"action\">\n                                                        <a class=\"pr-2\" (click)=\"editLookupValue(i, 'taxValue',item)\">\n                                                            <i-feather class=\"icon edit\" name=\"edit\"></i-feather>\n                                                        </a>\n                                                        <a (click)=\"deleteLookupvalue(i, 'taxValue',item)\">\n                                                            <i-feather class=\"icon delete\" name=\"trash\"></i-feather>\n                                                        </a>\n                                                    </td>\n                                                </tr>\n                                            </tbody>\n                                        </table>\n                                    </div>\n                                </div>\n                            </ul>\n                        </div>\n                    </div>\n                </div>\n            </div>\n        </ng-container>\n    </div>\n</div>";
    /***/
  },
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppAmsIncomeTrackerComponentsIncomeTrackerSetupIncomeTrackerSetupPenaltySetupIncomeTrackerSetupPenaltySetupComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppAmsIncomeTrackerComponentsIncomeInvoiceReverseIncomeInvoiceReverseComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])(), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", Object)], IncomeInvoiceReverseComponent.prototype, "childEvent", void 0);
  ...
  function srcAppAmsIncomeTrackerComponentsIncomePostMultiInvoiceFieldsIncomePostMultiInvoiceFieldsComponentScss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "form {\n  display: contents;\n}\nform .input-box, form .select-box {\n  margin: 0;\n}\nform .input-box input[readonly] {\n  background-color: #f9f9f9;\n}\nform .input-box input[readonly]:-webkit-autofill {\n  -webkit-box-shadow: 0 0 0px 1000px #e6e6e6 inset;\n  -webkit-text-fill-color: #e6e6e6;\n}\nform .input-box ::ng-deep input {\n  height: 34px !important;\n  border-radius: 0 !important;\n}\nform .input-box ::ng-deep .select-list-dropdown {\n  min-width: 100px;\n}\nform .input-box textarea {\n  height: auto !important;\n  border: none;\n  padding: 0;\n}\nform .input-box textarea:focus {\n  border: none !important;\n}\nform .account-name-box ::ng-deep input {\n  padding: 0;\n  width: 180px;\n  overflow: hidden;\n  text-overflow: ellipsis;\n}\nform .discount-box ::ng-deep .clear-filter {\n  z-index: 1000;\n  position: relative;\n  top: -24px;\n  right: -20px;\n}\n.heads {\n  padding: 0 24px 0 14px;\n  display: table-cell;\n  border: none;\n  border-right: 1px solid #dee2e6;\n  border-top: 1px solid #dee2e6;\n}\n.heads:last-child {\n  border-right: none;\n  padding: 12px 0;\n}\n.heads.deselect .select-group[_ngcontent-iqr-c297] .simple-select[_ngcontent-iqr-c297] + .select-arrow.down[_ngcontent-iqr-c297]:before {\n  color: #8e8e8e !important;\n}\n.heads p {\n  font-size: 1.4rem;\n  color: #373946;\n}\n.float-close {\n  width: 23px;\n  height: 23px;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  border-radius: 23px !important;\n  background-color: #5cd694;\n  cursor: pointer;\n  display: inline-block;\n  margin: 9px 4px;\n  line-height: 20px;\n}\n.float-close.disabled {\n  background-color: #f0f3f3 !important;\n  pointer-events: none;\n}\n.float-close.disabled .icon {\n  color: #e6e6e6;\n}\n.float-close.delete {\n  background-color: #ea7962;\n}\n.float-close.valid {\n  background-color: #389583;\n}\n.float-close .icon {\n  cursor: pointer;\n  width: 13px;\n  color: #ffffff;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
  ...
  function srcAppAmsIncomeTrackerComponentsIncomePostMultiInvoiceFieldsIncomePostMultiInvoiceFieldsComponentTs(module, __webpack_exports__, __webpack_require__) {
      ...
      _createClass(IncomePostMultiInvoiceFieldsComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.accountsService.getAllGlAccounts().subscribe(function (res) {
            _this15.glAccountListData = res.filter(function (item) {
          ...
          this.lookupService.getLookupValueByLookupTypeId(disListParams).subscribe(function (res) {
            _this15.discountTypeDataList = res;
          });
        }
      }]);
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", Object)], IncomePostMultiInvoiceFieldsComponent.prototype, "isEditInvoice", void 0);
  ...
  function srcAppAmsIncomeTrackerComponentsIncomePostMultiInvoiceIncomePostMultiInvoiceComponentScss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = ".income-post-invoice-wrapper .add-invoice-block {\n  padding: 10px 0;\n  border-bottom: 1px solid #dee2e6;\n}\n.income-post-invoice-wrapper .invoice-table {\n  width: 100% !important;\n  overflow-x: scroll;\n  overflow-y: visible;\n  float: left;\n}\n.income-post-invoice-wrapper .invoice-header {\n  display: table-row;\n}\n.income-post-invoice-wrapper .invoice-header .heads {\n  font-family: \"Lato\", sans-serif;\n  font-weight: 400;\n  letter-spacing: 0.3px;\n  -webkit-font-smoothing: inherit;\n  -moz-osx-font-smoothing: inherit;\n  font-size: 1.2rem;\n  color: #373946;\n  text-transform: uppercase;\n  border: none;\n  border-right: 1px solid #dee2e6;\n  padding: 10px 14px;\n  display: table-cell;\n}\n.income-post-invoice-wrapper .invoice-fields {\n  display: table-row;\n}\n.income-post-invoice-wrapper .add-invoice-box {\n  padding: 12px 0 6px 10px;\n  border-top: 1px solid #eaeaea;\n  overflow: auto;\n}\n.income-post-invoice-wrapper .add-invoice-box .icon {\n  color: #373946;\n  width: 18px;\n  position: relative;\n  top: -2px;\n}\n.income-post-invoice-wrapper .add-invoice-box span {\n  font-family: \"Montserrat\", sans-serif;\n  font-weight: 500;\n  letter-spacing: 0.2px;\n  color: #585858;\n  margin: 0 0 0 6px;\n  font-size: 1.4rem;\n}\n.income-post-invoice-wrapper .add-invoice-box .add-invoice-link {\n  cursor: pointer;\n}\n.income-post-invoice-wrapper .add-invoice-box .add-invoice-link:hover span, .income-post-invoice-wrapper .add-invoice-box .add-invoice-link:hover .icon {\n  color: #54b941;\n}\n.income-post-invoice-wrapper .total-box {\n  padding: 15px 14px;\n}\n.income-post-invoice-wrapper .total-box p {\n  font-family: \"Montserrat\", sans-serif;\n  font-weight: 400;\n  letter-spacing: 0.3px;\n  -webkit-font-smoothing: inherit;\n  -moz-osx-font-smoothing: inherit;\n  margin: 8px 0 !important;\n  font-size: 1.3rem;\n}\n.income-post-invoice-wrapper .total-box.final p {\n  font-family: \"Montserrat\", sans-serif;\n  font-weight: 500;\n  letter-spacing: 0.2px;\n  margin: 0 !important;\n  font-size: 1.4rem;\n}\n.income-post-invoice-wrapper .total-box .discount-input input {\n  width: 100px;\n  border-radius: 0 !important;\n  height: 34px;\n}\n.income-post-invoice-wrapper .total-box .discount-input input[readonly] {\n  background-color: #f9f9f9;\n}\n.income-post-invoice-wrapper .total-box .discount-box ::ng-deep input {\n  width: 100px;\n  border-radius: 0 !important;\n  height: 34px;\n}\n.income-post-invoice-wrapper .total-box .discount-box ::ng-deep .select-arrow {\n  color: #8e8e8e;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
    ...
    function () {
      ...
      _createClass(IncomePostMultiInvoiceComponent, [{
        ...
        value: function addInvoice() {
          ...
          this.isFormInValid = underscore__WEBPACK_IMPORTED_MODULE_7__["some"](this.invoiceGLAccountsArray, function (item) {
            return !item.form;
          });
        }
      }, {
        ...
        value: function getFieldParams(event) {
          ...
          var totalVatamount = this.invoiceGLAccountsArray.map(function (item) {
            return item.vatamount;
          }).reduce(function (a, b) {
            return a + b;
          });
          this.invoice.totalVatamount = parseFloat(totalVatamount).toFixed(2);
          var totalDiscount = this.invoiceGLAccountsArray.map(function (item) {
        ...
        value: function getCustTaxInvoiceParams(event) {
          ...
          this.vatTypeDataList.forEach(function (item) {
            var data = _this16.custInvoiceTaxArray.filter(function (invoice) {
        ...
        key: "onDiscountFinalChange",
        value: function onDiscountFinalChange(event) {
          if (event != null) {
        ...
        value: function submitIncomeMultiInvoiceForm(form) {
          ...
          if (!this.isEditInvoice) {
            ...
            this.accountsService.addCustInvoice(params).subscribe(function (res) {
              if (res.message) {
                _this17.isInvoiceSubmitted = true;

                _this17.sharedService.setAlertMessage("All Invoices added successfully");

                _this17.router.navigate(['ams/income/subledger']);
              } else {
                _this17.isInvoiceSubmitted = true;
              }
            }, function (error) {
            ...
            this.accountsService.updateCustInvoice(_params2).subscribe(function (res) {
              if (res.message) {
                ...
                _this17.sharedService.setAlertMessage("All Invoices updated successfully");
        ...
        value: function ngOnInit() {
          ...
          this.lookupService.getLookupValueByLookupTypeId(dateParams).subscribe(function (res) {
            _this18.invoice.dueDate = moment__WEBPACK_IMPORTED_MODULE_8__().add(parseInt(res[0].lookupValueName), 'days');
          });
          var vatListParams = {
            LookupTypeId: 77
          }; //VAT types
          ...
          this.lookupService.getLookupValueByLookupTypeId(vatListParams).subscribe(function (res) {
            ...
            underscore__WEBPACK_IMPORTED_MODULE_7__["each"](_this18.vatTypeDataList, function (item) {
              item.custVatTypeAmount = 0;
            });
          });
          var disListParams = {
          ...
          this.lookupService.getLookupValueByLookupTypeId(disListParams).subscribe(function (res) {
            _this18.discountFinalTypeDataList = res;
          ...
          if (this.route.params['value'].invoiceid != undefined) {
            ...
            this.accountsService.getCustInvoiceById(params).subscribe(function (res) {
              _this18.invoice = res[0];
              _this18.invoiceGLAccountsArray = _this18.invoice.invoiceGLAccounts;

              _this18.invoiceGLAccountsArray.forEach(function (item) {
                item.form = true;
              });

              _this18.custInvoiceTaxArray = _this18.invoice.custinvoiceTax; //getting vat amount list

              underscore__WEBPACK_IMPORTED_MODULE_7__["each"](_this18.vatTypeDataList, function (item) {
                var totalVatAmount = 0;
                underscore__WEBPACK_IMPORTED_MODULE_7__["each"](_this18.custInvoiceTaxArray, function (data) {
          ...
          this.accountsService.getIncomeTrackerSubLedgersByApartmentId(accountListParams).subscribe(function (res) {
            _this18.accountDataList = res.filter(function (item) {
              return item.apartmentBlockUnitId == _this18.route.params['value'].id;
            });
            _this18.isAccountDataLoaded = true;
          });
        }
      }]);
  ...
  /***/
  function srcAppAmsIncomeTrackerComponentsIncomeReceiptsReverseIncomeReceiptsReverseComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppAmsIncomeTrackerComponentsIncomeReceiptsReverseIncomeReceiptsReverseComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "IncomeReceiptsReverseComponent", function () {
      return IncomeReceiptsReverseComponent;
    });
    /* harmony import */
    ...
    var IncomeReceiptsReverseComponent =
    /*#__PURE__*/
    function () {
      function IncomeReceiptsReverseComponent(accountsService, sharedService, cookieService) {
        _classCallCheck(this, IncomeReceiptsReverseComponent);
      ...
      _createClass(IncomeReceiptsReverseComponent, [{
        ...
        value: function submitReverseIncomeReceiptsForm(form) {
          ...
          this.accountsService.addCustCollectionReversal(params).subscribe(function (res) {
            if (res.message) {
              _this19.isReceiptSubmitted = true;

              _this19.sharedService.setAlertMessage("Invoice reversed successfully");
            } else {
              _this19.isReceiptSubmitted = true;
    ...
    IncomeReceiptsReverseComponent.ctorParameters = function () {
      return [{
        type: src_app_api_controllers_Accounts__WEBPACK_IMPORTED_MODULE_2__["AccountsService"]
      }, {
        type: _shared_services_shared_service__WEBPACK_IMPORTED_MODULE_3__["SharedService"]
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", Object)], IncomeReceiptsReverseComponent.prototype, "receipts", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])(), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", Object)], IncomeReceiptsReverseComponent.prototype, "childEvent", void 0);
    IncomeReceiptsReverseComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-income-receipts-reverse',
      template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! raw-loader!./income-receipts-reverse.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/ams/income-tracker/components/income-receipts-reverse/income-receipts-reverse.component.html"))["default"],
      styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      ...
      _createClass(IncomeSubLedgerComponent, [{
        ...
        value: function getAllBlockData() {
          ...
          this.accountsService.getIncomeTrackerSubLedgersByApartmentId(params).subscribe(function (res) {
            ...
            console.log(res);
            _this20.gridSourceData.localdata = subLedgerDataList;

            _this20.datagrid.updatebounddata('cells');

            _this20.calculateTotalAmount(subLedgerDataList);
          });
        }
      }, {
        key: "getSingleBlock",
  ...
  function srcAppAmsIncomeTrackerComponentsIncomeTrackerAgeingIncomeTrackerAgeingComponentScss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = ".income-tracker-ageing-wrapper .filter-box {\n  margin: 30px 0 0 0;\n  padding: 0;\n  border: 0;\n}\n.income-tracker-ageing-wrapper .filter-box li {\n  border-right: 1px solid #eaeaea;\n  margin: 0;\n  padding: 10px 20px;\n  cursor: pointer;\n}\n.income-tracker-ageing-wrapper .filter-box li p {\n  font-family: \"Montserrat\", sans-serif;\n  font-weight: 400;\n  letter-spacing: 0.3px;\n  -webkit-font-smoothing: inherit;\n  -moz-osx-font-smoothing: inherit;\n  font-size: 1.4rem;\n  color: #585858;\n}\n.income-tracker-ageing-wrapper .filter-box li.title {\n  cursor: auto;\n}\n.income-tracker-ageing-wrapper .filter-box li.title p {\n  color: #8391a1 !important;\n}\n.income-tracker-ageing-wrapper .filter-box li.title p .icon {\n  width: 18px;\n  height: 18px;\n}\n.income-tracker-ageing-wrapper .filter-box li:not(.title):hover, .income-tracker-ageing-wrapper .filter-box li.active {\n  background-color: #5cd694;\n}\n.income-tracker-ageing-wrapper .filter-box li:not(.title):hover p, .income-tracker-ageing-wrapper .filter-box li.active p {\n  color: #ffffff;\n}\n.income-tracker-ageing-wrapper .account-chart-card {\n  margin: 30px 0;\n}\n.income-tracker-ageing-wrapper .account-chart-card .chart-box {\n  margin: 10px 0;\n  height: auto;\n  width: 300px;\n  float: left;\n}\n@media (min-width: 576px) and (max-width: 767px) {\n  .income-tracker-ageing-wrapper .account-chart-card .chart-box {\n    width: 235px;\n  }\n}\n@media (max-width: 576px) {\n  .income-tracker-ageing-wrapper .account-chart-card .chart-box {\n    float: none;\n    width: auto;\n  }\n}\n.income-tracker-ageing-wrapper .account-chart-card .chart-box canvas {\n  width: auto !important;\n  height: 100% !important;\n}\n.income-tracker-ageing-wrapper .account-chart-card .chart-box.hide-chart {\n  overflow: hidden;\n  visibility: hidden;\n}\n.income-tracker-ageing-wrapper .account-chart-card .legends-list {\n  margin: 10px 0 0 0 !important;\n  text-align: center;\n}\n@media (max-width: 576px) {\n  .income-tracker-ageing-wrapper .account-chart-card .legends-list {\n    text-align: left;\n    display: inline-block;\n    transform: translateX(-45%) !important;\n    position: relative;\n    left: 50%;\n  }\n}\n.income-tracker-ageing-wrapper .account-chart-card .legends-list li {\n  list-style: none;\n  margin: 0 !important;\n  padding: 8px 0;\n  overflow: auto;\n  width: 250px;\n}\n.income-tracker-ageing-wrapper .account-chart-card .legends-list li div {\n  font-family: \"Montserrat\", sans-serif;\n  font-weight: 500;\n  letter-spacing: 0.2px;\n  font-size: 1.4rem;\n  color: #8391a1;\n}\n.income-tracker-ageing-wrapper .account-chart-card .legends-list li div.title {\n  color: #373946;\n  float: left;\n  min-width: 180px !important;\n}\n@media (min-width: 576px) {\n  .income-tracker-ageing-wrapper .account-chart-card .legends-list li div.title {\n    min-width: auto !important;\n  }\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
  ...
  /***/
  function srcAppAmsIncomeTrackerComponentsIncomeTrackerSetupIncomeTrackerSetupAutoInvoicingIncomeTrackerSetupAutoInvoicingComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_exports__["default"] = ".card.table-card .card-body {\n  overflow: hidden;\n}\n\n.wd-100 {\n  width: 100%;\n}\n\n.wd-50 {\n  width: 50%;\n}\n\nheader {\n  background-color: #333;\n  color: #fff;\n  overflow: auto;\n  position: -webkit-sticky;\n  position: sticky;\n  top: 0;\n  padding: 15px;\n  display: flex;\n  justify-content: space-between;\n  margin-bottom: 50px;\n}\n\nmat-icon {\n  cursor: pointer;\n}\n\n.action-container {\n  display: flex;\n  justify-content: space-between;\n  padding: 20px;\n}\n\n.table {\n  padding: 20px;\n}\n\n.table tbody tr td,\n.table thead th,\n.table thead {\n  border-left: 1px solid #dee2e6;\n  border-right: 1px solid #dee2e6;\n  border-bottom: 1px solid #dee2e6;\n}\n\n.colname th,\ntd {\n  padding: 14px 10px 14px 10px;\n}\n\nspan.ui-column-resizer {\n  width: 100%;\n  height: 100%;\n  cursor: col-resize;\n  padding: 30px;\n}\n\n.effective-date {\n  border-color: rgba(0, 0, 0, 0.42);\n  border-top: none;\n  border-left: none;\n  border-right: none;\n}\n\ninput:focus {\n  outline: none;\n  box-shadow: unset;\n}\n\nmat-icon {\n  cursor: pointer;\n}\n\n.action-container {\n  display: flex;\n  justify-content: space-between;\n  padding: 20px;\n}\n\n.table {\n  padding: 20px;\n}\n\n.table tbody tr td,\n.table thead th,\n.table thead {\n  border-left: 1px solid #dee2e6;\n  border-right: 1px solid #dee2e6;\n  border-bottom: 1px solid #dee2e6;\n}\n\n.output {\n  padding: 20px;\n}\n\n.delete {\n  color: red;\n}\n\n.done {\n  color: green;\n}\n\n.edit {\n  color: yellow;\n}\n\nspan.ui-column-resizer {\n  width: 100%;\n  height: 100%;\n  cursor: col-resize;\n  padding: 30px;\n}\n\n.stock-date {\n  border-color: rgba(0, 0, 0, 0.42);\n  border-top: none;\n  border-left: none;\n  border-right: none;\n}\n\ninput:focus {\n  outline: none;\n  box-shadow: unset;\n}\n\n.save-icon {\n  padding-left: 7px;\n  padding-top: 27px;\n}\n\n.fa-floppy-o {\n  color: #54b941;\n}\n\n.cus-input {\n  border-radius: 8px;\n  border: 1px solid #dadada;\n  padding-left: 10px;\n  height: 30px;\n}\n\n.save-icon {\n  padding-left: 7px;\n  padding-top: 27px;\n}\n\n.fa-times {\n  color: #ff3638;\n}\n\n.search-left {\n  left: 2px !important;\n}\n\n.pad-top {\n  padding-top: 22px;\n}\n\n@media only screen and (min-width: 300px) and (max-width: 767px) {\n  .card.table-card .card-body {\n    overflow: scroll;\n  }\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
  ...
  /***/
  function srcAppAmsIncomeTrackerComponentsIncomeTrackerSetupIncomeTrackerSetupAutoInvoicingIncomeTrackerSetupAutoInvoicingComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "IncomeTrackerSetupAutoInvoicingComponent", function () {
      return IncomeTrackerSetupAutoInvoicingComponent;
    });
    /* harmony import */
    ...
    var IncomeTrackerSetupAutoInvoicingComponent =
    /*#__PURE__*/
    function () {
      function IncomeTrackerSetupAutoInvoicingComponent(accountsService, lookupService, sharedService, cookieService, fb, apartmentService, injector) {
        _classCallCheck(this, IncomeTrackerSetupAutoInvoicingComponent);
      ...
      _createClass(IncomeTrackerSetupAutoInvoicingComponent, [{
        key: "isMobileView",
        value: function isMobileView() {
          return window.innerWidth <= 767 ? 'table-responsive' : '';
        }
        ...
        value: function addAutoinvoiceConfig(data) {
          ...
          this.accountsService.addAutoinvoiceConfig(params).subscribe(function (res) {
            if (res) {
              _this33.sharedService.setAlertMessage("Auto invoice config added successfully");

              _this33.row = {};

              _this33.getAutoinvoiceConfigByApartmentId();
            }
          });
        }
      }, {
        ...
        value: function updateAutoinvoiceConfig(data) {
          ...
          this.accountsService.updateAutoinvoiceConfig(params).subscribe(function (res) {
            if (res) {
              _this34.sharedService.setAlertMessage("Auto invoice config Updated successfully");

              _this34.isEditRow = false;
              _this34.updateAutoInvoiceIndex = -1;
              _this34.row = {};
        ...
        value: function getAutoinvoiceConfigByApartmentId() {
          ...
          this.accountsService.getAutoinvoiceConfigByApartmentId(queryParamBase).subscribe(function (res) {
            if (res) {
              _this35.autoInvoicingData = res && res.length > 0 ? res : [];
              console.log("auto invoice ", _this35.autoInvoicingData);
              _this35.totalItems = _this35.autoInvoicingData.length;
        ...
        value: function getGlAccountsIdbyGlAccountTypeId() {
          ...
          this.accountsService.getGlAccountsIdbyGlAccountTypeId(queryParamBase).subscribe(function (res) {
            if (res) {
              _this36.glAccountList = res ? res : [];
              console.log(_this36.glAccountList);
            }
          });
        }
      }, {
        ...
        value: function ngOnInit() {
          ...
          this.lookupService.getLookupValueByLookupTypeId(vatListParams).subscribe(function (res) {
            _this38.vatPecentageDataList = res.filter(function (item) {
              return item.isActive;
            });
          }); //TAx
          ...
          this.lookupService.getLookupValueByLookupTypeId(taxListParams).subscribe(function (res) {
            _this38.taxPecentageDataList = res.filter(function (item) {
              return item.isActive;
            });
          });
          this.getGlAccountsIdbyGlAccountTypeId();
          setTimeout(function () {
            _this38.getAutoinvoiceConfigByApartmentId();
          }, 1000); //DeleteRow
          ...
          this.sharedService.unitlistdeleteindexcast.subscribe(function (id) {
            ...
            if (id != null) {
              if (_this38.deleteType) {
                var deleteparam = {};
                deleteparam = {
                  apartmentId: _this38.cookieService.get('apartmentId'),
                  Id: id,
                  deleteBy: parseInt(_this38.cookieService.get('userId'))
                };

                _this38.accountsService.deleteAutoinvoiceConfig(deleteparam).subscribe(function (res) {
                  if (res.message) {
                    _this38.getAutoinvoiceConfigByApartmentId();

                    setTimeout(function () {
                      _this38.sharedService.setAlertMessage("Auto invoicing deleted successfully");

                      _this38.sharedService.setUnitListDeleteIndex(null);
                    }, 500);
                  } else {
                    _this38.sharedService.setAlertMessage(res.errorMessage);
                  }

                  _this38.deleteType = true;
                }, function (error) {
                  console.log(error);
                });
              }
    ...
    IncomeTrackerSetupAutoInvoicingComponent.ctorParameters = function () {
      return [{
        type: src_app_api_controllers_Accounts__WEBPACK_IMPORTED_MODULE_3__["AccountsService"]
      }, {
        type: src_app_api_controllers_Lookup__WEBPACK_IMPORTED_MODULE_4__["LookupService"]
    ...
    IncomeTrackerSetupAutoInvoicingComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-income-tracker-setup-auto-invoicing',
      template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! raw-loader!./income-tracker-setup-auto-invoicing.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/ams/income-tracker/components/income-tracker-setup/income-tracker-setup-auto-invoicing/income-tracker-setup-auto-invoicing.component.html"))["default"],
      styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! ./income-tracker-setup-auto-invoicing.component.scss */
      "./src/app/ams/income-tracker/components/income-tracker-setup/income-tracker-setup-auto-invoicing/income-tracker-setup-auto-invoicing.component.scss"))["default"]]
    }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [src_app_api_controllers_Accounts__WEBPACK_IMPORTED_MODULE_3__["AccountsService"], src_app_api_controllers_Lookup__WEBPACK_IMPORTED_MODULE_4__["LookupService"], src_app_shared_services_shared_service__WEBPACK_IMPORTED_MODULE_5__["SharedService"], ngx_cookie_service__WEBPACK_IMPORTED_MODULE_6__["CookieService"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"], src_app_api_controllers_Apartment__WEBPACK_IMPORTED_MODULE_8__["ApartmentService"], _angular_core__WEBPACK_IMPORTED_MODULE_1__["Injector"]])], IncomeTrackerSetupAutoInvoicingComponent);
    /***/
  },
  ...
  /***/
  function srcAppAmsIncomeTrackerComponentsIncomeTrackerSetupIncomeTrackerSetupGeneralIncomeTrackerSetupGeneralComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_exports__["default"] = ".save {\n  margin: 25px 0px 0px 25px;\n}\n\n.editbutton {\n  margin: 28px 10px 0px 0px;\n}\n\n.select-box label {\n  font-size: 13px;\n  font-family: \"Lato\", sans-serif;\n  font-weight: 400;\n  letter-spacing: 0.3px;\n  -webkit-font-smoothing: inherit;\n  -moz-osx-font-smoothing: inherit;\n  font-size: 1.2rem;\n  color: #585858;\n  margin: 0 0 7px 0;\n  text-transform: uppercase;\n  letter-spacing: 0.4px;\n}\n\n.mini-table-1 {\n  width: 100%;\n}\n\n.mini-table-1 th {\n  font-size: 1.3rem;\n  width: 404px;\n}\n\n.mini-table-1 td {\n  font-size: 1.3rem;\n}\n\n.mini-table-1 .name {\n  max-width: 30%;\n  min-width: 30%;\n}\n\n.mini-table-1 .action {\n  width: 10%;\n  max-width: 10%;\n  min-width: 10%;\n}\n\n.mini-table-1 .desc {\n  width: 50%;\n  max-width: 50%;\n  min-width: 50%;\n}\n\n@media (max-width: 767px) {\n  .mini-table-1 .desc {\n    display: none !important;\n  }\n}\n\n.mini-table-1 .inc-desc {\n  width: 60%;\n  max-width: 60%;\n  min-width: 60%;\n}\n\n@media (max-width: 767px) {\n  .mini-table-1 .inc-desc {\n    display: none !important;\n  }\n}\n\n.mini-table-1 .inc-wdesc {\n  width: 70%;\n  max-width: 70%;\n  min-width: 70%;\n}\n\n@media (max-width: 767px) {\n  .mini-table-1 .inc-wdesc {\n    display: none !important;\n  }\n}\n\n.card .card-body .tabs li {\n  font-size: 12px;\n}\n\n.add-btn {\n  float: left;\n  margin: 25px 0px 0px 70px;\n}\n\n.tablewidth {\n  width: 80%;\n}\n\n.card {\n  width: 100%;\n  margin: 12px 0px;\n}\n\n.back-button {\n  margin: 28px 0px 0px 132px;\n}\n\n.save-button {\n  margin: 25px 0px 0px 0px;\n  float: left;\n}\n\n.currency {\n  padding-right: 0px;\n}\n\n.glacc {\n  width: 377px;\n  float: left;\n}\n\n.add {\n  color: black;\n  margin-left: 10px;\n}\n\ni-feather {\n  width: 18px;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
  ...
  /***/
  function srcAppAmsIncomeTrackerComponentsIncomeTrackerSetupIncomeTrackerSetupGeneralIncomeTrackerSetupGeneralComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "IncomeTrackerSetupGeneralComponent", function () {
      return IncomeTrackerSetupGeneralComponent;
    });
    /* harmony import */
    ...
    var IncomeTrackerSetupGeneralComponent =
    /*#__PURE__*/
    function () {
      function IncomeTrackerSetupGeneralComponent(accountsService, lookupService, sharedService, cookieService) {
        _classCallCheck(this, IncomeTrackerSetupGeneralComponent);
        ...
        this.glAccountIndicator = "Income";
        this.currencyTypeDataList = [];
        this.isEdit = false;
        this.isEditReconciliation = false;
        this.isCustIncomeAdd = false;
        this.value = {};
        this.custAccData = {};
      ...
      _createClass(IncomeTrackerSetupGeneralComponent, [{
        ...
        value: function vatValuebutton() {
          ...
          this.percentageValue.lookupTypeId = 77;
          console.log("vatvalue ", this.percentageValue);
        }
      }, {
        key: "taxValuebutton",
        value: function taxValuebutton() {
          ...
          this.percentageValue.lookupTypeId = 183;
          console.log("vatvalue ", this.percentageValue);
        }
      }, {
        key: "addnewLookupvalue",
        value: function addnewLookupvalue() {
          console.log("percentage value : ", this.percentageValue);
          this.addLookupValue(this.percentageValue);
        }
      }, {
        key: "addCustAccount",
        value: function addCustAccount(data) {
          ...
          reqObj = {
            "custAccountId": 0,
            "apartmentId": parseInt(this.cookieService.get('apartmentId')),
            "glaccountId": parseInt(data.glaccountId),
            "comment": "AR Control GL Account",
            "isActive": true,
            "insertedBy": parseInt(this.cookieService.get('userId')),
            "insertedOn": new Date().toISOString,
            "updatedBy": parseInt(this.cookieService.get('userId')),
          ...
          this.accountsService.addCustAccount(params).subscribe(function (res) {
            if (res.message) {
              _this39.sharedService.setAlertMessage("Custom account added successfully"); // this.row ={};
        ...
        value: function getCustomerLookupValueByLookupTypeId() {
          ...
          this.lookupService.getLookupValueByLookupTypeId(custPayParams).subscribe(function (res) {
            _this40.custIncomelist = res.filter(function (item) {
              return item.isActive;
            });
            _this40.custIncomelist = _this40.custIncomelist && _this40.custIncomelist.length > 0 ? _this40.custIncomelist : []; // this.customerIncomeValue.lookupValueId = this.custIncomelist[0].lookupValueId;
          });
        }
      }, {
        ...
        value: function getVatgetLookupValueByLookupTypeId() {
          ...
          this.lookupService.getLookupValueByLookupTypeId(vatListParams).subscribe(function (res) {
            _this41.vatPecentageDataList = res.filter(function (item) {
              return item.isActive;
            });
          });
        }
        ...
        value: function getTaxgetLookupValueByLookupTypeId() {
          ...
          this.lookupService.getLookupValueByLookupTypeId(taxListParams).subscribe(function (res) {
            _this42.taxPecentageDataList = res.filter(function (item) {
              return item.isActive;
            });
          });
        } //workpermitMethod
        ...
        value: function addLookupValue(listName) {
          ...
          if (listName == 'customerIncomeValue') {
            ...
            this.assignValue.lookupValueName = this.customerIncomeValue.lookupValueName;
            this.assignValue.lookupValueId = this.customerIncomeValue.lookupValueId;
          } else if (listName == 'vatValue') {
            this.assignValue.lookupTypeId = 77;
            this.assignValue.lookupValueName = this.vatValue.lookupValueName;
            this.assignValue.lookupValueId = this.vatValue.lookupValueId;
          } else if (listName == 'taxValue') {
            this.assignValue.lookupTypeId = 183;
            this.assignValue.lookupValueName = this.taxValue.lookupValueName;
            this.assignValue.lookupValueId = this.taxValue.lookupValueId;
          }

          if (this.edit) {
            var reqObj = {};
            reqObj = {
              "lookupValueId": this.assignValue.lookupValueId,
              "apartmentId": parseInt(this.cookieService.get('apartmentId')),
              "lookupTypeId": this.assignValue.lookupTypeId,
              "lookupValueName": this.assignValue.lookupValueName,
              "description": "string",
              "isActive": true,
              "insertedBy": parseInt(this.cookieService.get('userId')),
              "insertedOn": new Date().toISOString,
            ...
            this.lookupService.updateLookupValue(params).subscribe(function (res) {
              ...
              if (res.message) {
                _this43.sharedService.setAlertMessage("LookupValue updated successfully");

                _this43.assignValue = {};

                if (listName == 'customerIncomeValue') {
                  _this43.getCustomerLookupValueByLookupTypeId();

                  _this43.customerIncomeValue = {};
                } else if (listName == 'vatValue') {
                  _this43.getVatgetLookupValueByLookupTypeId();

                  _this43.vatValue = {};
                } else if (listName == 'taxValue') {
                  _this43.getTaxgetLookupValueByLookupTypeId();

                  _this43.taxValue = {};
                }
              } else {
                if (res.errorMessage == "updateLookupValue Not Added as it already exist.") {
                  _this43.sharedService.setAlertMessage("LookupValue not added as it already exist");
                } else {
                  _this43.sharedService.setAlertMessage(res.errorMessage);
                }
              }
            });
          } else {
        ...
        key: "editLookupValue",
        value: function editLookupValue(index, listName, data) {
          this.edit = true;

          if (listName == 'customerIncomeValue') {
            this.customerIncomeValue.lookupValueName = data.lookupValueName;
            this.customerIncomeValue.lookupValueId = data.lookupValueId;
            console.log("customerIncomeValue == > ", this.customerIncomeValue);
          } else if (listName == 'vatValue') {
            this.vatValue.lookupValueName = data.lookupValueName;
            this.vatValue.lookupValueId = data.lookupValueId;
            console.log("vatValue ", this.vatValue);
          } else if (listName == 'taxValue') {
            this.taxValue.lookupValueName = data.lookupValueName;
            this.taxValue.lookupValueId = data.lookupValueId;
        ...
        value: function deleteLookupvalue(index, listName, data) {
          ...
          this.lookupService.deleteLookupvalue(params).subscribe(function (res) {
            if (res.message) {
              _this44.sharedService.setAlertMessage('Lookup value deleted successfully');
        ...
        value: function ngOnInit() {
          ...
          this.getTaxgetLookupValueByLookupTypeId(); //currency type
          ...
          this.lookupService.getLookupValueByLookupTypeId(params).subscribe(function (res) {
            _this45.currencyTypeDataList = res.filter(function (item) {
              return item.isActive;
            });
            _this45.currencylookupValueName = _this45.currencyTypeDataList[0].lookupValueName;
            console.log("current type", _this45.currencyTypeDataList);
          }); //GLAccountTypeId
          ...
          this.accountsService.getGlAccountsIdbyGlAccountTypeId(glAccountTypeIdparams).subscribe(function (res) {
            ...
            console.log("GL ACC ", _this45.glAccountListData);
            _this45.custAccData.glaccountId = _this45.glAccountListData[0].glaccountId;
          });
        }
      }, {
    ...
    IncomeTrackerSetupGeneralComponent.ctorParameters = function () {
      return [{
        type: src_app_api_controllers_Accounts__WEBPACK_IMPORTED_MODULE_2__["AccountsService"]
      }, {
    ...
    IncomeTrackerSetupGeneralComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-income-tracker-setup-general',
      template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! raw-loader!./income-tracker-setup-general.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/ams/income-tracker/components/income-tracker-setup/income-tracker-setup-general/income-tracker-setup-general.component.html"))["default"],
      styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! ./income-tracker-setup-general.component.scss */
      "./src/app/ams/income-tracker/components/income-tracker-setup/income-tracker-setup-general/income-tracker-setup-general.component.scss"))["default"]]
    }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [src_app_api_controllers_Accounts__WEBPACK_IMPORTED_MODULE_2__["AccountsService"], src_app_api_controllers_Lookup__WEBPACK_IMPORTED_MODULE_3__["LookupService"], src_app_shared_services_shared_service__WEBPACK_IMPORTED_MODULE_4__["SharedService"], ngx_cookie_service__WEBPACK_IMPORTED_MODULE_5__["CookieService"]])], IncomeTrackerSetupGeneralComponent);
    /***/
  },
  ...
  /***/
  function srcAppAmsIncomeTrackerComponentsIncomeTrackerSetupIncomeTrackerSetupPenaltySetupIncomeTrackerSetupPenaltySetupComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_exports__["default"] = ".card.table-card .card-body {\n  overflow: hidden;\n}\n\n.wd-100 {\n  width: 100%;\n}\n\n.wd-50 {\n  width: 50%;\n}\n\nheader {\n  background-color: #333;\n  color: #fff;\n  overflow: auto;\n  position: -webkit-sticky;\n  position: sticky;\n  top: 0;\n  padding: 15px;\n  display: flex;\n  justify-content: space-between;\n  margin-bottom: 50px;\n}\n\nmat-icon {\n  cursor: pointer;\n}\n\n.action-container {\n  display: flex;\n  justify-content: space-between;\n  padding: 20px;\n}\n\n.table {\n  padding: 20px;\n}\n\n.table tbody tr td,\n.table thead th,\n.table thead {\n  border-left: 1px solid #dee2e6;\n  border-right: 1px solid #dee2e6;\n  border-bottom: 1px solid #dee2e6;\n}\n\n.colname th,\ntd {\n  padding: 14px 10px 14px 10px;\n}\n\n.output {\n  padding: 20px;\n}\n\n.delete {\n  color: red;\n}\n\n.done {\n  color: green;\n}\n\n.edit {\n  color: yellow;\n}\n\nspan.ui-column-resizer {\n  width: 100%;\n  height: 100%;\n  cursor: col-resize;\n  padding: 30px;\n}\n\n.effective-date {\n  border-color: rgba(0, 0, 0, 0.42);\n  border-top: none;\n  border-left: none;\n  border-right: none;\n}\n\ninput:focus {\n  outline: none;\n  box-shadow: unset;\n}\n\n.card.table-card .card-body {\n  overflow: hidden;\n}\n\n.subCategory {\n  padding-top: 10px;\n  font-family: \"Montserrat\", sans-serif;\n  font-weight: 400;\n  letter-spacing: 0.3px;\n  -webkit-font-smoothing: inherit;\n  -moz-osx-font-smoothing: inherit;\n  padding-bottom: 10px;\n}\n\n.subCategory li {\n  list-style-type: circle;\n}\n\n.wd-100 {\n  width: 100%;\n}\n\n.wd-50 {\n  width: 50%;\n}\n\nheader {\n  background-color: #333;\n  color: #fff;\n  overflow: auto;\n  position: -webkit-sticky;\n  position: sticky;\n  top: 0;\n  padding: 15px;\n  display: flex;\n  justify-content: space-between;\n  margin-bottom: 50px;\n}\n\nmat-icon {\n  cursor: pointer;\n}\n\n.action-container {\n  display: flex;\n  justify-content: space-between;\n  padding: 20px;\n}\n\n.output {\n  padding: 20px;\n}\n\n.delete {\n  color: red;\n}\n\n.done {\n  color: green;\n}\n\n.edit {\n  color: yellow;\n}\n\nspan.ui-column-resizer {\n  width: 100%;\n  height: 100%;\n  cursor: col-resize;\n  padding: 30px;\n}\n\n.stock-date {\n  border-color: rgba(0, 0, 0, 0.42);\n  border-top: none;\n  border-left: none;\n  border-right: none;\n}\n\ninput:focus {\n  outline: none;\n  box-shadow: unset;\n}\n\n.save-icon {\n  padding-left: 7px;\n  padding-top: 27px;\n}\n\n.fa-times {\n  color: #ff3638;\n}\n\n.search-left {\n  left: 2px !important;\n}\n\n.pad-top {\n  padding-top: 22px;\n}\n\n@media only screen and (min-width: 300px) and (max-width: 767px) {\n  .card.table-card .card-body {\n    overflow: scroll;\n  }\n}\n\n.staticTable {\n  width: 280px;\n}\n\nform input:required.ng-dirty.ng-invalid {\n  border: none;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
  ...
  /***/
  function srcAppAmsIncomeTrackerComponentsIncomeTrackerSetupIncomeTrackerSetupPenaltySetupIncomeTrackerSetupPenaltySetupComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "IncomeTrackerSetupPenaltySetupComponent", function () {
      return IncomeTrackerSetupPenaltySetupComponent;
    });
    /* harmony import */
    ...
    var IncomeTrackerSetupPenaltySetupComponent =
    /*#__PURE__*/
    function () {
      function IncomeTrackerSetupPenaltySetupComponent(accountsService, lookupService, sharedService, cookieService, injector, apartmentService, fb) {
        _classCallCheck(this, IncomeTrackerSetupPenaltySetupComponent);
        ...
        this.ItemStartIndex = 0;
        this.row = {};
        this.deleteType = false; //penaltydatalistTable
      ...
      _createClass(IncomeTrackerSetupPenaltySetupComponent, [{
        key: "isMobileView",
        value: function isMobileView() {
          return window.innerWidth <= 767 ? 'table-responsive' : '';
        }
        ...
        value: function addPenaltyConfig(data) {
          ...
          this.accountsService.addPenaltyConfig(params).subscribe(function (res) {
            if (res.message) {
              _this46.sharedService.setAlertMessage("Penalty Setup Config added successfully");

              _this46.isAssetLoaded = false;
              _this46.row = {};

              _this46.getAllPenaltyConfigByApartmentId();
            } else {
        ...
        value: function updatePenaltyConfig(data) {
          ...
          this.accountsService.updatePenaltyConfig(params).subscribe(function (res) {
            if (res) {
              _this47.sharedService.setAlertMessage("Penalty setup config Updated successfully"); // this.isAssetLoaded = false;


              _this47.isEditRow = false;
              _this47.updatePenaltyRowIndex = -1;
        ...
        value: function getAllPenaltyConfigByApartmentId() {
          ...
          this.accountsService.getAllPenaltyConfigByApartmentId(queryParamBase).subscribe(function (res) {
            if (res) {
              ...
              _this48.penaltyData = res && res.length > 0 ? res : [];
              _this48.isAssetLoaded = false; // this.tempWarehouseData = this.warehouseData;

              _this48.totalItems = _this48.penaltyData.length;
        ...
        value: function getPenaltyConfigByPenaltyId() {
          ...
          this.accountsService.getPenaltyConfigByPenaltyId(queryParamBase).subscribe(function (res) {
            if (res) {
              ...
              _this49.penaltyType = res ? res : [];
              console.log("penalty type ==> ", _this49.penaltyType);
            }
          });
        }
      }, {
        ...
        value: function getGlAccountsIdbyGlAccountTypeId() {
          ...
          this.accountsService.getGlAccountsIdbyGlAccountTypeId(queryParamBase).subscribe(function (res) {
            if (res) {
              ...
              _this50.glAccountList = res ? res : [];
              console.log(_this50.glAccountList);
            }
          });
        }
      }, {
        ...
        value: function ngOnInit() {
          ...
          this.sharedService.unitlistdeleteindexcast.subscribe(function (id) {
            if (id != null) {
              if (_this52.deleteType) {
                var param = {};
                param = {
                  apartmentId: _this52.cookieService.get('apartmentId'),
                  PenaltyId: id,
                  deleteBy: parseInt(_this52.cookieService.get('userId'))
                };

                _this52.accountsService.deletePenaltyConfig(param).subscribe(function (res) {
                  if (res.message) {
                    _this52.getAllPenaltyConfigByApartmentId();

                    setTimeout(function () {
                      _this52.sharedService.setAlertMessage("Penalty deleted successfully");

                      _this52.sharedService.setUnitListDeleteIndex(null);
                    }, 500);
                  } else {
                    _this52.sharedService.setAlertMessage(res.errorMessage);
                  }

                  _this52.deleteType = false;
                }, function (error) {
                  console.log(error);
                });
              }
    ...
    IncomeTrackerSetupPenaltySetupComponent.ctorParameters = function () {
      return [{
        type: src_app_api_controllers_Accounts__WEBPACK_IMPORTED_MODULE_3__["AccountsService"]
      }, {
        type: src_app_api_controllers_Lookup__WEBPACK_IMPORTED_MODULE_4__["LookupService"]
    ...
    IncomeTrackerSetupPenaltySetupComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-income-tracker-setup-penalty-setup',
      template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! raw-loader!./income-tracker-setup-penalty-setup.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/ams/income-tracker/components/income-tracker-setup/income-tracker-setup-penalty-setup/income-tracker-setup-penalty-setup.component.html"))["default"],
      styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! ./income-tracker-setup-penalty-setup.component.scss */
      "./src/app/ams/income-tracker/components/income-tracker-setup/income-tracker-setup-penalty-setup/income-tracker-setup-penalty-setup.component.scss"))["default"]]
    }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [src_app_api_controllers_Accounts__WEBPACK_IMPORTED_MODULE_3__["AccountsService"], src_app_api_controllers_Lookup__WEBPACK_IMPORTED_MODULE_4__["LookupService"], src_app_shared_services_shared_service__WEBPACK_IMPORTED_MODULE_5__["SharedService"], ngx_cookie_service__WEBPACK_IMPORTED_MODULE_6__["CookieService"], _angular_core__WEBPACK_IMPORTED_MODULE_1__["Injector"], src_app_api_controllers_Apartment__WEBPACK_IMPORTED_MODULE_8__["ApartmentService"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"]])], IncomeTrackerSetupPenaltySetupComponent);
    /***/
  },
  ...
  function srcAppAmsIncomeTrackerComponentsIncomeTrackerSetupIncomeTrackerSetupComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function IncomeTrackerSetupComponent() {
  ...
  function srcAppAmsIncomeTrackerComponentsIncomeViewCreditIncomeViewCreditComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function IncomeViewCreditComponent(dialog, userService, apartmentService, accountsService, sharedService, cookieService, constantsService, router) {
      ...
      _createClass(IncomeViewCreditComponent, [{
        ...
        value: function updateCreditItem(credit) {
          ...
          setTimeout(function () {
            _this53.isCreditNoteLoaded = false;
            var details = {
              "creditNoteId": parseInt(credit.creditNoteId),
              "apartmentId": parseInt(_this53.cookieService.get('apartmentId')),
              ...
              "isActive": true,
              "insertedBy": parseInt(_this53.cookieService.get('userId')),
              "insertedOn": new Date().toISOString(),
            ...
            _this53.accountsService.updateCreditNote(params).subscribe(function (res) {
              if (res.message) {
                _this53.isCreditNoteLoaded = true;

                _this53.sharedService.setAlertMessage("Credit Note updated successfully");
              } else {
                _this53.isCreditNoteLoaded = true;
              }
            }, function (error) {
        ...
        value: function onGlSearchFilter() {
          ...
          if (this.creditNoteData != "") {
            var filtergroup = new jqx.filter();
            var filter_or_operator = 1;
            var filtervalue = this.creditNoteData;
            var filtercondition = 'contains';
            var filterData = filtergroup.createfilter('stringfilter', filtervalue, filtercondition);
            filtergroup.operator = 'or';
            filtergroup.addfilter(filter_or_operator, filterData);
            ...
            this.columnData.forEach(function (item) {
              if (item.datafield != 'Actions') {
                _this54.datagrid.addfilter(item.datafield, filtergroup, true);
              }
            });
            this.datagrid.applyfilters();
          } else {
        ...
        key: "onEditCreditNotes",
        value: function onEditCreditNotes(detail) {
          var dataRecord = this.datagrid.getrowdata(detail.rowId);
          var creditNoteId = dataRecord.creditNoteId;
          this.router.navigateByUrl('/ams/income/edit-credit/' + creditNoteId);
        }
      }, {
        key: "onUpdateInvoice",
        value: function onUpdateInvoice(detail) {
          var invoice = this.datagrid.getrowdata(detail.rowId); // this.updateInvoiceItem(invoice, detail.column);
        }
      }, {
        key: "onUpdateInvoiceSms",
        value: function onUpdateInvoiceSms(detail) {
          var invoice = this.datagrid.getrowdata(detail.rowId); // this.updateInvoiceItem(invoice, detail.column);
        }
      }, {
        key: "ngOnInit",
        value: function ngOnInit() {
          ...
          this.columnData = [{
            ...
            cellsrenderer: function cellsrenderer(row, column, value) {
              return '<div class="jqx-custom-inner-cell">' + moment__WEBPACK_IMPORTED_MODULE_10__(value).format(_this55.constantsService.dateFormat) + '</div>';
            },
            minwidth: 80,
            renderer: columnrenderer
          }, {
          ...
          this.userService.getAllUsers().subscribe(function (res) {
            _this55.userDataList = res;
          });
          var params = {
            apartmentId: parseInt(this.cookieService.get('apartmentId'))
          };
          this.accountsService.getCreditNotesByApartmentId(params).subscribe(function (res) {
            _this55.creditNoteDataList = res;
            _this55.gridSourceData = {
              localdata: _this55.creditNoteDataList,
              datatype: "array"
            };
            _this55.creditNoteDataList = new jqx.dataAdapter(_this55.gridSourceData);
            console.log('creditNoteDataList', _this55.creditNoteDataList);
            _this55.totalItems = _this55.creditNoteDataList.length;
            ...
            _this55.accountsService.getCustInvoicesByApartmentId(params).subscribe(function (res) {
              _this55.custInvoiceDataList = res.filter(function (item) {
                return item.isActive;
              });
            }, function (error) {
              console.log(error);
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('datagrid', {
      "static": false
    }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", src_app_shared_jqwidgets_scripts_jqwidgets_ts_angular_jqxgrid__WEBPACK_IMPORTED_MODULE_11__["jqxGridComponent"])], IncomeViewCreditComponent.prototype, "datagrid", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["HostListener"])('window:onEditCreditNotes', ['$event.detail']), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", Function), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [Object]), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:returntype", void 0)], IncomeViewCreditComponent.prototype, "onEditCreditNotes", null);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["HostListener"])('window:onUpdateInvoice', ['$event.detail']), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", Function), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [Object]), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:returntype", void 0)], IncomeViewCreditComponent.prototype, "onUpdateInvoice", null);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["HostListener"])('window:onUpdateInvoiceSms', ['$event.detail']), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", Function), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [Object]), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:returntype", void 0)], IncomeViewCreditComponent.prototype, "onUpdateInvoiceSms", null);
      ...
      _createClass(IncomeViewDefaultersComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.accountsService.getIncomeTrackerDefaulterByApartmentId(params).subscribe(function (res) {
            _this57.gridDefaultDataList = res;
            underscore__WEBPACK_IMPORTED_MODULE_5__["each"](_this57.gridDefaultDataList, function (item) {
              item.checked = false;
            });
            _this57.gridSourceData = {
              localdata: _this57.gridDefaultDataList,
              datatype: "array"
            };
            _this57.defaultDataList = new jqx.dataAdapter(_this57.gridSourceData);

            _this57.renderColumns();

            _this57.totalItems = _this57.defaultDataList.length;
            _this57.isDefaultersDataLoaded = true;
          }, function (error) {
            console.log(error);
          });
        }
      ...
      _createClass(IncomeViewInvoiceHistoryComponent, [{
        ...
        value: function getFieldParams(event) {
          ...
          this.accountsService.getAccountHistoryByApartmentUnitId(params).subscribe(function (res) {
            _this58.invoiceDataList = res; //filter items

            if (event.isReversed != null) {
              _this58.invoiceDataList = _this58.invoiceDataList.filter(function (item) {
            ...
            _this58.invoiceDataList.sort(function (a, b) {
              return new Date(b.postedDate).getTime() - new Date(a.postedDate).getTime();
            });

            _this58.totalItems = _this58.invoiceDataList.length;
            ...
            _this58.isInvoiceDataTableLoaded = true;
          }, function (error) {});
        }
      }, {
        key: "reverseItem",
        value: function reverseItem(item) {
          ...
          this.accountsService.addCustTransReversal(params).subscribe(function (res) {
            if (res.message) {
              _this59.reverse.comment = "";

              _this59.sharedService.setAlertMessage("Invoice Reversed");

              var params = {
                ApartmentBlockUnitID: _this59.route.params['value'].id
              };

              _this59.accountsService.getAccountHistoryByApartmentUnitId(params).subscribe(function (res) {
                _this59.invoiceDataList = res;
                ...
                _this59.isReverseSubmitted = true;
              });
            } else {}
          }, function (error) {});
        }
        ...
        value: function ngOnInit() {
          ...
          this.accountsService.getAllGlAccounts().subscribe(function (res) {
            var glAccountListData = res.filter(function (item) {
              return item.apartmentId == parseInt(_this60.cookieService.get('apartmentId'));
            });
            _this60.glAccountListData = glAccountListData;
          });
          var params = {
            ApartmentBlockUnitID: this.route.params['value'].id
          };
          this.accountsService.getAccountHistoryByApartmentUnitId(params).subscribe(function (res) {
            _this60.invoiceDataList = res; //sorting by date ( new to old )
            ...
            var accountListParams = {
              apartmentId: parseInt(_this60.cookieService.get('apartmentId'))
            };

            _this60.accountsService.getIncomeTrackerSubLedgersByApartmentId(accountListParams).subscribe(function (res) {
              _this60.accountDataList = res.filter(function (item) {
                return item.apartmentBlockUnitId == _this60.route.params['value'].id;
              });
              _this60.isAccountDataLoaded = true;
            });
            ...
            _this60.userService.getAllUsersByApartmentId(userListParams).subscribe(function (res) {
              _this60.userDataList = res;
              _this60.isInvoiceDataLoaded = true;
            }, function (error) {});
          });
        }
      }]);
  ...
  function srcAppAmsIncomeTrackerComponentsIncomeViewInvoiceIncomeViewInvoiceComponentScss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "::ng-deep .ams-all-invoices .material .mat-dialog-container {\n  width: 1200px;\n  height: 500px;\n  overflow: auto;\n}\n::ng-deep .ams-all-invoices .material .mat-dialog-container .info-modal-box h5 {\n  font-family: \"Montserrat\", sans-serif;\n  font-weight: 500;\n  letter-spacing: 0.2px;\n  color: #52c570;\n}\n::ng-deep .ams-all-invoices .material .mat-dialog-container .info-modal-box .other-info .address, ::ng-deep .ams-all-invoices .material .mat-dialog-container .info-modal-box .other-info .email {\n  font-family: \"Lato\", sans-serif;\n  font-weight: 400;\n  letter-spacing: 0.3px;\n  -webkit-font-smoothing: inherit;\n  -moz-osx-font-smoothing: inherit;\n  font-size: 1.4rem;\n  display: inline-block;\n}\n::ng-deep .ams-all-invoices .material .mat-dialog-container .info-modal-box .other-info.grey .address, ::ng-deep .ams-all-invoices .material .mat-dialog-container .info-modal-box .other-info.grey .email {\n  color: #8391a1;\n}\n::ng-deep .ams-all-invoices .material .mat-dialog-container .info-modal-box .details {\n  padding: 10px 19px;\n}\n::ng-deep .ams-all-invoices .material .mat-dialog-container .info-modal-box .details p {\n  font-size: 1.4rem;\n  color: #8391a1;\n}\n::ng-deep .ams-all-invoices .material .mat-dialog-container .info-modal-box .details p span {\n  color: #373946;\n}\n::ng-deep .ams-all-invoices .material .mat-dialog-container .info-modal-box .table thead th {\n  padding: 12px 20px;\n  background-color: #eaeaea;\n}\n::ng-deep .ams-all-invoices .material .mat-dialog-container .info-modal-box .table tr.total td {\n  font-family: \"Lato\", sans-serif;\n  font-weight: 700;\n  letter-spacing: 0.3px;\n  -webkit-font-smoothing: antialiased;\n  -moz-osx-font-smoothing: grayscale;\n  text-rendering: optimizeLegibility;\n}\n::ng-deep .ams-all-invoices .material .mat-dialog-container .info-modal-box p.bottom {\n  font-size: 1.3rem;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
  ...
  function srcAppAmsIncomeTrackerComponentsIncomeViewInvoiceIncomeViewInvoiceComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _shared_services_constants_service__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
    ...
    var html2canvas__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(
    /*! html2canvas */
    "./node_modules/html2canvas/dist/html2canvas.js");
    /* harmony import */


    var html2canvas__WEBPACK_IMPORTED_MODULE_16___default =
    /*#__PURE__*/
    __webpack_require__.n(html2canvas__WEBPACK_IMPORTED_MODULE_16__);
    /* harmony import */


    var jspdf__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(
    /*! jspdf */
    "./node_modules/jspdf/dist/jspdf.min.js");
    /* harmony import */


    var jspdf__WEBPACK_IMPORTED_MODULE_17___default =
    /*#__PURE__*/
    __webpack_require__.n(jspdf__WEBPACK_IMPORTED_MODULE_17__);

    var IncomeViewInvoiceComponent =
    /*#__PURE__*/
    function () {
      function IncomeViewInvoiceComponent(dialog, router, route, userService, accountsService, apartmentService, lookupService, sharedService, constantsService, cookieService) {
      ...
      _createClass(IncomeViewInvoiceComponent, [{
        ...
        value: function printInvoice() {
          ...
          html2canvas__WEBPACK_IMPORTED_MODULE_16___default()(data).then(function (canvas) {
            var imgWidth = 208;
            var pageHeight = 295;
            var imgHeight = canvas.height * imgWidth / canvas.width;
            var heightLeft = imgHeight;
            var contentDataURL = canvas.toDataURL('image/png');
            var pdf = new jspdf__WEBPACK_IMPORTED_MODULE_17__('p', 'mm', 'a4'); // A4 size page of PDF  
        ...
        value: function onGlSearchFilter() {
          ...
          if (this.invoiceData != "") {
            ...
            this.columnData.forEach(function (item) {
              if (item.datafield != 'Actions') {
                _this61.datagrid.addfilter(item.datafield, filtergroup, true);
              }
            });
            this.datagrid.applyfilters();
          } else {
        ...
        value: function onDownloadInvoice(detail) {
          ...
          this.accountsService.getCustInvoiceById(params).subscribe(function (res) {
            _this62.custTaxDetails = res[0].custinvoiceTax;
            _this62.isInvoicePrintLoaded = true;
          });
        }
      }, {
        key: "onEditInvoice",
        ...
        key: "getVatType",
        value: function getVatType(custInvoiceItem) {
          var id = custInvoiceItem.invoiceTaxId;
          var data = this.vatTypeDataList.filter(function (item) {
        ...
        value: function updateInvoiceItem(invoice, type) {
          ...
          this.accountsService.updateCustInvoice(params).subscribe(function (res) {
            if (res.message) {
              _this64.sharedService.setAlertMessage("Invoice updated successfully");
            } else {
              _this64.isInvoiceDataLoaded = true;
            }
          }, function (error) {
            _this64.isInvoiceDataLoaded = true;
          });
        ...
        value: function ngOnInit() {
          ...
          this.accountsService.getAllGlAccounts().subscribe(function (res) {
            _this65.glAccountListData = res.filter(function (item) {
              return item.isActive && parseInt(_this65.cookieService.get('apartmentId')) && item.indicator == _this65.glAccountIndicator;
            });
          }); //BIND THE TABLE
        ...
        value: function tableBindingdata() {
          ...
          this.accountsService.getCustInvoicesByApartmentId(params).subscribe(function (res) {
            ...
            _this66.invoice = invoiceDataList[0];
            _this66.reversePopOverSelector = '#' + _this66.invoice.custInvoiceId;
            _this66.gridSourceData = {
              localdata: invoiceDataList,
              datatype: "array"
            };
            _this66.invoiceDataList = new jqx.dataAdapter(_this66.gridSourceData);
            ...
            _this66.totalItems = _this66.invoiceDataList.length;
            ...
            _this66.columnData = [{
              ...
              minwidth: 120,
              cellsrenderer: function cellsrenderer(row, column, value) {
                return '<div class="jqx-custom-inner-cell">' + moment__WEBPACK_IMPORTED_MODULE_15__(value).format(_this66.constantsService.dateFormat) + '</div>';
              },
              renderer: columnrenderer
            }, {
              text: 'Posted By',
              ...
              cellsrenderer: function cellsrenderer(row, coloumn, value) {
                ...
                var elemId = invoiceDataList[row].custInvoiceId; // return '<div class="simple-actions"><a href="javascript:void(0)" class="mr-2" onClick="editInvoiceEvent('+ row +')"><i class="fa fa-pencil icon edit" aria-hidden="true"></i></a><a href="javascript:void(0)" class="mr-2" id="'+ elemId +'" onClick="editReverseEvent('+ row +')"><i class="fa fa-repeat icon delete" aria-hidden="true"></i></a></div>'

                return '<div class="simple-actions">' + '<a href="javascript:void(0)" class="mr-2" onClick="editInvoiceEvent(' + row + ')">' + '<i class="fa fa-pencil icon edit" aria-hidden="true"></i>' + '</a>' + '<div class="' + valueData.obj1 + '">' + '<div href="javascript:void(0)" class="mr-2" id="' + elemId + '" onClick="editReverseEvent(' + row + ')">' + '<i class="fa fa-repeat icon delete" aria-hidden="true"></i>' + '</div>' + '</div>' + '<div>' + '<span class="' + valueData.obj2 + '">R</span>' + '</div>' + '</div>';
              },
              renderer: columnrenderer
            }];
            var params = {
              apartmentId: parseInt(_this66.cookieService.get('apartmentId'))
            };

            _this66.userService.getAllUsersByApartmentId(params).subscribe(function (res) {
              _this66.userDataList = res;
              _this66.isInvoiceDataLoaded = true;
            }, function (error) {});
          });
        }
      }, {
    ...
    }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_material_dialog__WEBPACK_IMPORTED_MODULE_3__["MatDialog"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"], src_app_api_controllers_User__WEBPACK_IMPORTED_MODULE_7__["UserService"], src_app_api_controllers_Accounts__WEBPACK_IMPORTED_MODULE_8__["AccountsService"], src_app_api_controllers_Apartment__WEBPACK_IMPORTED_MODULE_9__["ApartmentService"], src_app_api_controllers_Lookup__WEBPACK_IMPORTED_MODULE_10__["LookupService"], _shared_services_shared_service__WEBPACK_IMPORTED_MODULE_11__["SharedService"], _shared_services_constants_service__WEBPACK_IMPORTED_MODULE_12__["ConstantsService"], ngx_cookie_service__WEBPACK_IMPORTED_MODULE_13__["CookieService"]])], IncomeViewInvoiceComponent);
  ...
  function srcAppAmsIncomeTrackerComponentsIncomeViewReceiptsIncomeViewReceiptsComponentScss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "::ng-deep .material .mat-dialog-container {\n  width: 1200px;\n  height: 650px;\n  overflow: auto;\n}\n::ng-deep .material .mat-dialog-container .info-modal-box h5 {\n  font-family: \"Montserrat\", sans-serif;\n  font-weight: 500;\n  letter-spacing: 0.2px;\n  color: #52c570;\n}\n::ng-deep .material .mat-dialog-container .info-modal-box .other-info .address,\n::ng-deep .material .mat-dialog-container .info-modal-box .other-info .email {\n  font-family: \"Lato\", sans-serif;\n  font-weight: 400;\n  letter-spacing: 0.3px;\n  -webkit-font-smoothing: inherit;\n  -moz-osx-font-smoothing: inherit;\n  font-size: 1.4rem;\n  display: inline-block;\n}\n::ng-deep .material .mat-dialog-container .info-modal-box .other-info.grey .address,\n::ng-deep .material .mat-dialog-container .info-modal-box .other-info.grey .email {\n  color: #8391a1;\n}\n::ng-deep .material .mat-dialog-container .info-modal-box .details {\n  padding: 10px 19px;\n}\n::ng-deep .material .mat-dialog-container .info-modal-box .details p {\n  font-size: 1.4rem;\n  color: #8391a1;\n  float: right;\n}\n::ng-deep .material .mat-dialog-container .info-modal-box .details p span {\n  color: #373946;\n}\n::ng-deep .material .mat-dialog-container .info-modal-box .table thead th {\n  padding: 12px 20px;\n  background-color: #eaeaea;\n}\n::ng-deep .material .mat-dialog-container .info-modal-box .table tr.total td {\n  font-family: \"Lato\", sans-serif;\n  font-weight: 700;\n  letter-spacing: 0.3px;\n  -webkit-font-smoothing: antialiased;\n  -moz-osx-font-smoothing: grayscale;\n  text-rendering: optimizeLegibility;\n}\n::ng-deep .material .mat-dialog-container .info-modal-box p.bottom {\n  font-size: 1.3rem;\n}\n.unit p {\n  font-size: 14px;\n}\n.generated p span {\n  font-family: \"Montserrat\", sans-serif;\n  font-weight: 500;\n  letter-spacing: 0.2px;\n  color: #52c570;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
  ...
  function srcAppAmsIncomeTrackerComponentsIncomeViewReceiptsIncomeViewReceiptsComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var src_app_shared_jqwidgets_scripts_jqwidgets_ts_angular_jqxwindow__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! src/app/shared/jqwidgets-scripts/jqwidgets-ts/angular_jqxwindow */
    "./src/app/shared/jqwidgets-scripts/jqwidgets-ts/angular_jqxwindow.ts");
    /* harmony import */


    var src_app_shared_jqwidgets_scripts_jqwidgets_ts_angular_jqxpopover__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    /*! src/app/shared/jqwidgets-scripts/jqwidgets-ts/angular_jqxpopover */
    "./src/app/shared/jqwidgets-scripts/jqwidgets-ts/angular_jqxpopover.ts");
    /* harmony import */
    ...
    /*#__PURE__*/
    function () {
      function IncomeViewReceiptsComponent(dialog, accountsService, cookieService, constantsService) {
      ...
      _createClass(IncomeViewReceiptsComponent, [{
        ...
        value: function onGlSearchFilter() {
          ...
          if (this.receiptsData != "") {
            var filtergroup = new jqx.filter();
            var filter_or_operator = 1;
            var filtervalue = this.receiptsData;
            var filtercondition = 'contains';
            var filterData = filtergroup.createfilter('stringfilter', filtervalue, filtercondition);
            filtergroup.operator = 'or';
            filtergroup.addfilter(filter_or_operator, filterData);
            ...
            this.columnData.forEach(function (item) {
              if (item.datafield != 'Actions') {
                _this67.datagrid.addfilter(item.datafield, filtergroup, true);
              }
            });
            this.datagrid.applyfilters();
          } else {
        ...
        value: function downloadReceiptEvent() {
          ...
          this.accountsService.getCollectionByCollectionId(params).subscribe(function (res) {
            ...
            _this69.isReceiptPrintLoaded = true;
            _this69.receiptInfoDetails = res;
        ...
        value: function tablebinding() {
          ...
          this.accountsService.getIncomeTrackerReceiptsByApartmentId(params).subscribe(function (res) {
            _this70.receiptsDataList = res;
            _this70.receipts = _this70.receiptsDataList[0];
            _this70.reversePopOverSelectorReceipt = '#' + _this70.receipts.receiptNumber;
            _this70.gridSourceData = {
              localdata: _this70.receiptsDataList,
              datatype: "array"
            };
            _this70.receiptsDataList = new jqx.dataAdapter(_this70.gridSourceData);
            _this70.totalItems = _this70.receiptsDataList.length;
            console.log('aaa', _this70.receiptsDataList);

            if (_this70.totalItems > _this70.itemLimit) {
              _this70.ItemEndIndex = _this70.itemLimit;
            } else {
              _this70.ItemEndIndex = _this70.totalItems;
            }

            _this70.isReceiptsLoaded = true;
          }, function (error) {
            console.log(error);
          });
        }
        ...
        value: function ngOnInit() {
          ...
          this.columnData = [{
            ...
            minwidth: 120,
            cellsrenderer: function cellsrenderer(row, column, value) {
              return '<div class="jqx-custom-inner-cell">' + moment__WEBPACK_IMPORTED_MODULE_6__(value).format(_this71.constantsService.dateFormat) + '</div>';
            },
            renderer: columnrenderer
          }, {
            text: 'Tower Unit',
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])("viewReceiptsDetailsRef", {
      "static": false
    }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_1__["TemplateRef"])], IncomeViewReceiptsComponent.prototype, "viewReceiptsDetailsRef", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('datagrid', {
      "static": false
    }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", src_app_shared_jqwidgets_scripts_jqwidgets_ts_angular_jqxgrid__WEBPACK_IMPORTED_MODULE_7__["jqxGridComponent"])], IncomeViewReceiptsComponent.prototype, "datagrid", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('reversePopWindow', {
      "static": false
    }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", src_app_shared_jqwidgets_scripts_jqwidgets_ts_angular_jqxwindow__WEBPACK_IMPORTED_MODULE_8__["jqxWindowComponent"])], IncomeViewReceiptsComponent.prototype, "reversePopWindow", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('reversePopOver', {
      "static": false
    }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", src_app_shared_jqwidgets_scripts_jqwidgets_ts_angular_jqxpopover__WEBPACK_IMPORTED_MODULE_9__["jqxPopoverComponent"])], IncomeViewReceiptsComponent.prototype, "reversePopOver", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])("viewInvoiceDetailsRef", {
      "static": false
    }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_1__["TemplateRef"])], IncomeViewReceiptsComponent.prototype, "viewInvoiceDetailsRef", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["HostListener"])('window:onEditReverse', ['$event.detail']), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", Function), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [Object]), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:returntype", void 0)], IncomeViewReceiptsComponent.prototype, "onEditReverse", null);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["HostListener"])('window:onUpdateInvoice', ['$event.detail']), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", Function), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [Object]), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:returntype", void 0)], IncomeViewReceiptsComponent.prototype, "onUpdateInvoice", null);
    ...
    }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_material_dialog__WEBPACK_IMPORTED_MODULE_2__["MatDialog"], src_app_api_controllers_Accounts__WEBPACK_IMPORTED_MODULE_3__["AccountsService"], ngx_cookie_service__WEBPACK_IMPORTED_MODULE_4__["CookieService"], src_app_shared_services_constants_service__WEBPACK_IMPORTED_MODULE_10__["ConstantsService"]])], IncomeViewReceiptsComponent);
  ...
  function srcAppAmsIncomeTrackerIncomeTrackerRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _components_income_tracker_setup_income_tracker_setup_general_income_tracker_setup_general_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(
    /*! ./components/income-tracker-setup/income-tracker-setup-general/income-tracker-setup-general.component */
    "./src/app/ams/income-tracker/components/income-tracker-setup/income-tracker-setup-general/income-tracker-setup-general.component.ts");
    /* harmony import */


    var _components_income_tracker_setup_income_tracker_setup_auto_invoicing_income_tracker_setup_auto_invoicing_component__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(
    /*! ./components/income-tracker-setup/income-tracker-setup-auto-invoicing/income-tracker-setup-auto-invoicing.component */
    "./src/app/ams/income-tracker/components/income-tracker-setup/income-tracker-setup-auto-invoicing/income-tracker-setup-auto-invoicing.component.ts");
    /* harmony import */
    ...
    var routes = [{
      ...
      children: [{
        path: 'general',
        component: _components_income_tracker_setup_income_tracker_setup_general_income_tracker_setup_general_component__WEBPACK_IMPORTED_MODULE_17__["IncomeTrackerSetupGeneralComponent"],
        pathMatch: 'full'
      }, {
        path: 'auto-invoicing',
        component: _components_income_tracker_setup_income_tracker_setup_auto_invoicing_income_tracker_setup_auto_invoicing_component__WEBPACK_IMPORTED_MODULE_18__["IncomeTrackerSetupAutoInvoicingComponent"]
      }, {
        path: 'penalty-setup',
        component: _components_income_tracker_setup_income_tracker_setup_penalty_setup_income_tracker_setup_penalty_setup_component__WEBPACK_IMPORTED_MODULE_19__["IncomeTrackerSetupPenaltySetupComponent"]
      }, {
        path: '**',
        redirectTo: 'general',
        pathMatch: 'full'
  ...
  function srcAppAmsIncomeTrackerIncomeTrackerModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _components_income_post_multi_invoice_income_post_multi_invoice_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
    /*! ./components/income-post-multi-invoice/income-post-multi-invoice.component */
    "./src/app/ams/income-tracker/components/income-post-multi-invoice/income-post-multi-invoice.component.ts");
    /* harmony import */


    var _components_income_post_multi_invoice_fields_income_post_multi_invoice_fields_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
    /*! ./components/income-post-multi-invoice-fields/income-post-multi-invoice-fields.component */
    "./src/app/ams/income-tracker/components/income-post-multi-invoice-fields/income-post-multi-invoice-fields.component.ts");
    /* harmony import */


    var _components_income_post_collection_income_post_collection_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(
    /*! ./components/income-post-collection/income-post-collection.component */
    "./src/app/ams/income-tracker/components/income-post-collection/income-post-collection.component.ts");
    /* harmony import */


    var _components_income_pay_invoice_income_pay_invoice_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(
    /*! ./components/income-pay-invoice/income-pay-invoice.component */
    "./src/app/ams/income-tracker/components/income-pay-invoice/income-pay-invoice.component.ts");
    /* harmony import */


    var _components_income_tracker_ageing_income_tracker_ageing_component__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(
    /*! ./components/income-tracker-ageing/income-tracker-ageing.component */
    "./src/app/ams/income-tracker/components/income-tracker-ageing/income-tracker-ageing.component.ts");
    /* harmony import */


    var _components_income_add_credit_income_add_credit_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(
    /*! ./components/income-add-credit/income-add-credit.component */
    "./src/app/ams/income-tracker/components/income-add-credit/income-add-credit.component.ts");
    /* harmony import */


    var _components_income_invoice_reverse_income_invoice_reverse_component__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(
    /*! ./components/income-invoice-reverse/income-invoice-reverse.component */
    "./src/app/ams/income-tracker/components/income-invoice-reverse/income-invoice-reverse.component.ts");
    /* harmony import */


    var _components_income_tracker_reports_income_tracker_reports_component__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(
    /*! ./components/income-tracker-reports/income-tracker-reports.component */
    "./src/app/ams/income-tracker/components/income-tracker-reports/income-tracker-reports.component.ts");
    /* harmony import */


    var _components_income_tracker_setup_income_tracker_setup_component__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(
    /*! ./components/income-tracker-setup/income-tracker-setup.component */
    "./src/app/ams/income-tracker/components/income-tracker-setup/income-tracker-setup.component.ts");
    /* harmony import */


    var _components_income_tracker_reports_income_tracker_reports_customer_income_tracker_reports_customer_component__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(
    /*! ./components/income-tracker-reports/income-tracker-reports-customer/income-tracker-reports-customer.component */
    "./src/app/ams/income-tracker/components/income-tracker-reports/income-tracker-reports-customer/income-tracker-reports-customer.component.ts");
    /* harmony import */


    var _components_income_tracker_reports_income_tracker_reports_vendor_income_tracker_reports_vendor_component__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(
    /*! ./components/income-tracker-reports/income-tracker-reports-vendor/income-tracker-reports-vendor.component */
    "./src/app/ams/income-tracker/components/income-tracker-reports/income-tracker-reports-vendor/income-tracker-reports-vendor.component.ts");
    /* harmony import */


    var _components_income_tracker_filter_income_tracker_filter_component__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(
    /*! ./components/income-tracker-filter/income-tracker-filter.component */
    "./src/app/ams/income-tracker/components/income-tracker-filter/income-tracker-filter.component.ts");
    /* harmony import */


    var _components_income_receipts_reverse_income_receipts_reverse_component__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(
    /*! ./components/income-receipts-reverse/income-receipts-reverse.component */
    "./src/app/ams/income-tracker/components/income-receipts-reverse/income-receipts-reverse.component.ts");
    /* harmony import */


    var _components_income_tracker_setup_income_tracker_setup_general_income_tracker_setup_general_component__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(
    /*! ./components/income-tracker-setup/income-tracker-setup-general/income-tracker-setup-general.component */
    "./src/app/ams/income-tracker/components/income-tracker-setup/income-tracker-setup-general/income-tracker-setup-general.component.ts");
    /* harmony import */


    var _components_income_tracker_setup_income_tracker_setup_auto_invoicing_income_tracker_setup_auto_invoicing_component__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(
    /*! ./components/income-tracker-setup/income-tracker-setup-auto-invoicing/income-tracker-setup-auto-invoicing.component */
    "./src/app/ams/income-tracker/components/income-tracker-setup/income-tracker-setup-auto-invoicing/income-tracker-setup-auto-invoicing.component.ts");
    /* harmony import */


    var _components_income_tracker_setup_income_tracker_setup_penalty_setup_income_tracker_setup_penalty_setup_component__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(
    /*! ./components/income-tracker-setup/income-tracker-setup-penalty-setup/income-tracker-setup-penalty-setup.component */
    "./src/app/ams/income-tracker/components/income-tracker-setup/income-tracker-setup-penalty-setup/income-tracker-setup-penalty-setup.component.ts");
