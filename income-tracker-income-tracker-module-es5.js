...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["income-tracker-income-tracker-module"], {
  ...
  function srcAppAmsIncomeTrackerComponentsIncomePostMultiInvoiceFieldsIncomePostMultiInvoiceFieldsComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      ...
      _createClass(IncomePostMultiInvoiceFieldsComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.invoiceGLAccountsDataSub.subscribe(function (data) {
            console.log(data);
          });
        }
      }, {
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('postIncomeMultiInvoiceFieldsForm', {
      "static": true
    }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", _angular_forms__WEBPACK_IMPORTED_MODULE_4__["NgForm"])], IncomePostMultiInvoiceFieldsComponent.prototype, "invoiceForm", void 0);
    ...
    }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_core__WEBPACK_IMPORTED_MODULE_1__["ChangeDetectorRef"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"], _api_services_accounts_service__WEBPACK_IMPORTED_MODULE_5__["AccountsService"], _shared_services_shared_service__WEBPACK_IMPORTED_MODULE_6__["SharedService"], _api_services_lookup_service__WEBPACK_IMPORTED_MODULE_7__["LookupService"], ngx_cookie_service__WEBPACK_IMPORTED_MODULE_8__["CookieService"]])], IncomePostMultiInvoiceFieldsComponent);
    /***/
  },
    ...
    function () {
      ...
      _createClass(IncomePostMultiInvoiceComponent, [{
        ...
        value: function getFieldParams(event) {
          ...
          this.invoiceGLAccountsArray = event; //console.log(this.invoiceGLAccountsArray);
          ...
          underscore__WEBPACK_IMPORTED_MODULE_7__["each"](this.invoiceGLAccountsArray, function (item) {
            ...
            _this19.vatTypeDataList[0].custVatTypeAmount = _this19.vatTypeDataList[0].custVatTypeAmount + parseInt(item.tax1Amount);
            _this19.vatTypeDataList[1].custVatTypeAmount = _this19.vatTypeDataList[1].custVatTypeAmount + parseInt(item.tax2Amount);
          });
        }
      }, {
    ...
    function () {
      ...
      _createClass(IncomeSubLedgerComponent, [{
        ...
        value: function getAllBlockData() {
          ...
          this.singleBlock = "Select Block";
          this.accountsService.GetIncomeTrackerSubLedgersByApartmentId(parseInt(this.cookieService.get('apartmentId'))).subscribe(function (res) {
            _this23.subLedgerDataList = res;
            _this23.totalItems = _this23.subLedgerDataList.length;
            _this23.netDueAmount = 0;
            _this23.totalDueAmount = 0;
            underscore__WEBPACK_IMPORTED_MODULE_7__["each"](_this23.subLedgerDataList, function (item, index) {
        ...
        value: function getSingleBlock(block) {
          ...
          this.accountsService.GetIncomeTrackerSubLedgersByApartmentId(parseInt(this.cookieService.get('apartmentId'))).subscribe(function (res) {
            _this24.subLedgerDataList = res.filter(function (item) {
              return item.apartmentBlockNumber == _this24.singleBlock;
            });
            _this24.totalItems = _this24.subLedgerDataList.length;
            ...
            _this24.netDueAmount = 0;
            _this24.totalDueAmount = 0;
            underscore__WEBPACK_IMPORTED_MODULE_7__["each"](_this24.subLedgerDataList, function (item, index) {
      ...
      _createClass(IncomeTrackerAgeingComponent, [{
        ...
        value: function drawChart() {
          ...
          setTimeout(function () {
            ...
            _this26.chart = new chart_js__WEBPACK_IMPORTED_MODULE_5__["Chart"](_this26.chartRef.nativeElement, {
              type: 'doughnut',
              data: data,
              options: {
                responsive: true,
        ...
        value: function getAgeingData() {
          ...
          this.accountsService.GetARAgingCollectionDueSummary(ageingParams).subscribe(function (res) {
            ...
            underscore__WEBPACK_IMPORTED_MODULE_6__["each"](_this27.ageingDataDataList, function (item) {
            ...
            underscore__WEBPACK_IMPORTED_MODULE_6__["each"](_this27.ageingDataDataList, function (item, index) {
      ...
      _createClass(IncomeTrackerReportsVendorComponent, [{
        ...
        value: function submitIncomeReportsVendorForm(form) {
          ...
          this.accountsService.getVendorGltransactionsMultiFilter(details).subscribe(function (res) {
            ...
            console.log(_this31.reportsDataList);
  ...
  function srcAppAmsIncomeTrackerComponentsIncomeTrackerReportsIncomeTrackerReportsComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function IncomeTrackerReportsComponent(sharedService, cookieService) {
      ...
      _createClass(IncomeTrackerReportsComponent, [{
        ...
        value: function ngOnInit() {
          this.reportsDataList = [{
            name: 'Customer Journal Report',
            type: 'customer'
          }, {
            name: 'Vendor Journal Entires',
            type: 'vendor'
          }];
        }
      }]);
    ...
    }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_shared_services_shared_service__WEBPACK_IMPORTED_MODULE_2__["SharedService"], ngx_cookie_service__WEBPACK_IMPORTED_MODULE_3__["CookieService"]])], IncomeTrackerReportsComponent);
    /***/
  },
    ...
    function () {
      ...
      _createClass(IncomeTrackerSetupComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.penalty.gracePeriodInvoiceId = ""; //currency type
      ...
      _createClass(IncomeViewCreditComponent, [{
        ...
        value: function updateCreditItem(credit) {
          ...
          setTimeout(function () {
            ...
            _this34.accountsService.updateCreditNote(details).subscribe(function (res) {
              if (res.message) {
        ...
        value: function ngOnInit() {
          ...
          this.accountsService.getCreditNotesByApartmentIdStatus(parseInt(this.cookieService.get('apartmentId'))).subscribe(function (res) {
            ...
            _this35.accountsService.getCustInvoicesByApartmentId(parseInt(_this35.cookieService.get('apartmentId'))).subscribe(function (res) {
      ...
      _createClass(IncomeViewInvoiceHistoryComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.accountsService.GetAccountHistoryByApartmentUnitId(params).subscribe(function (res) {
            ...
            _this39.accountsService.GetIncomeTrackerSubLedgersByApartmentId(parseInt(_this39.cookieService.get('apartmentId'))).subscribe(function (res) {
            ...
            _this39.userService.getAllUsersByApartmentId(parseInt(_this39.cookieService.get('apartmentId'))).subscribe(function (res) {
  ...
  function srcAppAmsIncomeTrackerComponentsIncomeViewInvoiceIncomeViewInvoiceComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      ...
      _createClass(IncomeViewInvoiceComponent, [{
        ...
        key: "getUserName",
        value: function getUserName(invoice, id) {
          var data = underscore__WEBPACK_IMPORTED_MODULE_7__["filter"](this.userDataList, function (item) {
            if (item.userId === id) return item;
          });
        ...
        key: "getAccountName",
        value: function getAccountName(invoice, account) {
          var accountDetails = {
            glaccountId: 0
          };
        ...
        value: function updateInvoiceItem(invoice) {
          ...
          setTimeout(function () {
            _this40.isInvoiceDataLoaded = false;
            var details = {
              ...
              "isSmssent": false,
              "custInvoiceStatusId": 1,
              "postedBy": parseInt(_this40.cookieService.get('userId')),
              "postedOn": new Date().toISOString(),
              "billToPay": "string",
              ...
              "penaltyComment": "string",
              "isActive": true,
              "insertedBy": parseInt(_this40.cookieService.get('userId')),
              "insertedOn": new Date().toISOString(),
              "updatedBy": parseInt(_this40.cookieService.get('userId')),
              "updatedOn": new Date().toISOString(),
              "transReference1": "string",
              "transReference2": "string",
              "invoiceGLAccounts": [{
            ...
            _this40.accountsService.updateCustInvoice(details).subscribe(function (res) {
              if (res.message) {
                _this40.isInvoiceDataLoaded = true;

                _this40.sharedService.setAlertMessage("Invoice updated successfully");
              } else {
                _this40.isInvoiceDataLoaded = true;
              }
            }, function (error) {
        ...
        value: function ngOnInit() {
          ...
          this.accountsService.getAllGLAccounts().subscribe(function (res) {
            _this41.glAccountListData = res.filter(function (item) {
              return item.isActive && parseInt(_this41.cookieService.get('apartmentId')) && item.indicator == _this41.glAccountIndicator;
            });
          });
          var params = {
            apartmentId: parseInt(this.cookieService.get('apartmentId')),
          ...
          this.accountsService.getCustInvoicesByApartmentId(parseInt(this.cookieService.get('apartmentId'))).subscribe(function (res) {
            ...
            underscore__WEBPACK_IMPORTED_MODULE_7__["each"](_this41.invoiceDataList, function (item) {
              item.towerUnit = item.apartmentBlockNumber + ' ' + item.apartmentBlockUnitNumber;
            });
      ...
      _createClass(IncomeViewReceiptsComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.accountsService.GetIncomeTrackerReceiptsByApartmentId(parseInt(this.cookieService.get('apartmentId'))).subscribe(function (res) {
            _this42.receiptsDataList = res;
            console.log(res);
            _this42.totalItems = _this42.receiptsDataList.length;
  ...
  function srcAppAmsIncomeTrackerIncomeTrackerRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _components_income_tracker_reports_income_tracker_reports_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(
    /*! ./components/income-tracker-reports/income-tracker-reports.component */
    "./src/app/ams/income-tracker/components/income-tracker-reports/income-tracker-reports.component.ts");
    /* harmony import */


    var _components_income_tracker_setup_income_tracker_setup_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(
    /*! ./components/income-tracker-setup/income-tracker-setup.component */
    "./src/app/ams/income-tracker/components/income-tracker-setup/income-tracker-setup.component.ts");
    /* harmony import */


    var _components_income_tracker_reports_income_tracker_reports_customer_income_tracker_reports_customer_component__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(
    /*! ./components/income-tracker-reports/income-tracker-reports-customer/income-tracker-reports-customer.component */
    "./src/app/ams/income-tracker/components/income-tracker-reports/income-tracker-reports-customer/income-tracker-reports-customer.component.ts");
    /* harmony import */


    var _components_income_tracker_reports_income_tracker_reports_vendor_income_tracker_reports_vendor_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(
    ...
    var routes = [{
      ...
      path: 'settings',
      component: _components_income_tracker_setup_income_tracker_setup_component__WEBPACK_IMPORTED_MODULE_15__["IncomeTrackerSetupComponent"]
    }, {
      path: 'subledger',
    ...
    }, //{ path: 'post-invoice/:id/:type', component: IncomePostInvoiceComponent},
    {
      ...
      path: 'reports',
      component: _components_income_tracker_reports_income_tracker_reports_component__WEBPACK_IMPORTED_MODULE_14__["IncomeTrackerReportsComponent"]
    }, {
      path: 'reports/customer',
      component: _components_income_tracker_reports_income_tracker_reports_customer_income_tracker_reports_customer_component__WEBPACK_IMPORTED_MODULE_16__["IncomeTrackerReportsCustomerComponent"]
    }, {
      path: 'reports/vendor',
      component: _components_income_tracker_reports_income_tracker_reports_vendor_income_tracker_reports_vendor_component__WEBPACK_IMPORTED_MODULE_17__["IncomeTrackerReportsVendorComponent"]
    }, {
      path: '**',
      redirectTo: 'subledger',
      pathMatch: 'full'
