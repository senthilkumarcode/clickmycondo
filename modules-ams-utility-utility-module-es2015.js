...
let UtilityHistoryComponent = class UtilityHistoryComponent {
    ...
    getAllWaterUtiliy() {
        ...
        this.utilityTrackerService.getUtilityTrackerWaterChargesByApartmentId(params).subscribe((res) => {
            ...
            //   this.ItemEndIndex = this.totalItems;
            // }
            let filteredUtilityWaterList = res.filter(item => {
                return item.isActive;
            });
...
/* harmony import */ var src_app_api_controllers_UtilityTracker__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! src/app/api/controllers/UtilityTracker */ "./src/app/api/controllers/UtilityTracker.ts");
...
let UtilityReportDataComponent = class UtilityReportDataComponent {
    constructor(router, route, userService, apartmentService, lookupService, sharedService, sessionService, utilityService) {
        this.router = router;
        this.route = route;
...
UtilityReportDataComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"],
        ...
        src_app_shared_services_shared_service__WEBPACK_IMPORTED_MODULE_6__["SharedService"],
        src_app_core_session_session_service__WEBPACK_IMPORTED_MODULE_7__["SessionService"],
        src_app_api_controllers_UtilityTracker__WEBPACK_IMPORTED_MODULE_11__["UtilityTrackerService"]])
