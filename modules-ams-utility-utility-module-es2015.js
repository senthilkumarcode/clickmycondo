    ...
    loadUtilityCategory() {
        ...
        this.utilityTrackerService.getUtilityTrackerCategorysByApartmentId(params).subscribe((res) => {
            ...
            this.utilityCategoryData.filter(key => {
                if (key.utilityTrackerCategoryId == 11) {
                    key['url'] = "electricity-reading";
                }
                else if (key.utilityTrackerCategoryId == 12) {
                    key['url'] = "water-reading";
                }
                else if (key.utilityTrackerCategoryId == 14) {
                    key['url'] = "insurance";
                }
            });
...
let UnitReadingInfoComponent = class UnitReadingInfoComponent {
    ...
    ngOnInit() {
        ...
        this.calculateSubject.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_11__["debounceTime"])(500)).subscribe(searchTextValue => {
...
let WaterReadingComponent = class WaterReadingComponent {
    constructor(apartmentService, utilityTrackerService, sharedService, sessionService) {
        this.apartmentService = apartmentService;
        this.utilityTrackerService = utilityTrackerService;
        this.sharedService = sharedService;
        this.sessionService = sessionService;
        ...
        if (this.isListofElectricity()) {
            ...
            this.columnData = [
                ...
                },
                {
                    ...
                    width: 200,
                    cellsrenderer: (row, column, value) => {
                        var content = this.userReportDataList.records[row].waterCharge.length > 0 ? this.userReportDataList.records[row].waterCharge[0]["connectionNo"] === null ? '' : this.userReportDataList.records[row].waterCharge[0]["connectionNo"] : '';
                        return '<div class="jqx-custom-inner-cell">' + content + '</div>';
                    },
                    renderer: columnrenderer
                },
                {
                    ...
                    width: 200,
                    cellsrenderer: (row, column, value) => {
                        var content = this.userReportDataList.records[row].waterCharge.length > 0 ? this.userReportDataList.records[row].waterCharge[0]["prevReading"] : '';
                        return '<div class="jqx-custom-inner-cell">' + content + '</div>';
                    },
                    renderer: columnrenderer
                },
                {
                    ...
                    width: 200,
                    cellsrenderer: (row, column, value) => {
                        var content = this.userReportDataList.records[row].waterCharge.length > 0 ? this.userReportDataList.records[row].waterCharge[0]["currReading"] : '';
                        return '<div class="jqx-custom-inner-cell">' + content + '</div>';
                    },
                    renderer: columnrenderer
                },
