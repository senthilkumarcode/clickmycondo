        ...
        _createClass(IncomePayInvoiceComponent, [{
          ...
          value: function renderColumns() {
            ...
            this.columnData = [{
              ...
              width: 120,
              cellsrenderer: function cellsrenderer(row, column, value) {
                return '<div class="jqx-custom-inner-cell">' + moment__WEBPACK_IMPORTED_MODULE_6__["utc"](value).tz(_this4.timeZone.region).format(_this4.timeZone.date) + '</div>';
              },
              renderer: columnrenderer
            }, {
              text: 'Due Date',
    ...
    function srcAppModulesAmsIncomeTrackerIncomePayInvoiceIncomePostCollectionIncomePostCollectionComponentTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var IncomePostCollectionComponent = /*#__PURE__*/function () {
        ...
        _createClass(IncomePostCollectionComponent, [{
          ...
          value: function getSelectedGlAccount(event) {
          ...
          value: function ngOnInit() {
            ...
            this.accountsService.getCustAccountsByOffsetAccountIds(accountParams).subscribe(function (res) {
