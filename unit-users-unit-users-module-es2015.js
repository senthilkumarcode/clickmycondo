...
let DeActivatedComponent = class DeActivatedComponent {
    constructor(injector, dialog, userService, sharedService, cookieService) {
        this.injector = injector;
        this.dialog = dialog;
        this.userService = userService;
        this.sharedService = sharedService;
    ...
    getSelectedDeActivatedUser(unit) {
        var length = 0;
        underscore__WEBPACK_IMPORTED_MODULE_7__["each"](this.deActivatedListData, (item) => {
            if (item.checked) {
                length++;
            }
        });
    ...
    activateUser() {
        this.isUserDataLoaded = false;
        underscore__WEBPACK_IMPORTED_MODULE_7__["each"](this.deActivatedListData, (item, index) => {
            if (item.checked) {
...
let SignuprequestComponent = class SignuprequestComponent {
    ...
    ngOnInit() {
        this.userService.getAllSignupUserRequestByApartmentId(parseInt(this.cookieService.get('apartmentId'))).subscribe((res) => {
            ...
            console.log(res);
            var unitLstData = res;
            this.unitListData = unitLstData.filter(itm => itm.isActive);
    ...
    getBookedDate(itr, date) {
        underscore__WEBPACK_IMPORTED_MODULE_8__["each"](this.unitListData, (obj, index) => {
...
let UnapprovedComponent = class UnapprovedComponent {
    constructor(injector, dialog, router, route, userService, sharedService, cookieService, srvModal) {
        this.injector = injector;
        this.dialog = dialog;
        this.router = router;
        this.route = route;
    ...
    ngOnInit() {
        ...
        this.userService.getAllUnApprovedUsersByApartmentId(parseInt(this.cookieService.get('apartmentId'))).subscribe((res) => {
            //filter active true items
            this.unitListData = res.filter(data => {
                return data.active;
            });
            this.totalUserItems = this.unitListData.length;
            if (this.totalUserItems > this.itemUserLimit) {
        ...
        this.sharedService.unitlistdeleteindexcast.subscribe(id => {
            if (id != null) {
                ...
                this.userService.deleteUserById(params).subscribe((res) => {
                    underscore__WEBPACK_IMPORTED_MODULE_8__["each"](this.unitListData, (type) => {
                        if (type.id == id) {
                            type.active = false;
                        }
                    });
