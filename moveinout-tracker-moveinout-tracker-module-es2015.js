...
let CreateMoveinComponent = class CreateMoveinComponent {
    ...
    getDateString(value) {
        ...
        let UTCDate = Date.UTC(date.getFullYear(), date.getMonth(), date.getDate()) - date.getTimezoneOffset();
        let date_ = new Date(UTCDate);
                ...
                cellsrenderer: (row, column, value) => {
                    if (value != "") {
                        return '<div class="simple-actions">'
                            ...
                            + '<div class="icon-wrapper">'
                            + ' <img src="assets/images/eye-icon.svg" class="svg" width="17" height="17" alt="Comments">'
                            + ' </div></a>'
        ...
        this.moveInOutService.updateMoveIn(params).subscribe((res) => {
            if (res.message) {
                ...
                this.moveInOutService.getMoveInByStatusIds(params).subscribe((res) => {
                    ...
                    this.moveInDataList = this.moveInDataList.reverse();
                    this.gridSourceData = {
                        localdata: this.moveInDataList,
                        datatype: "array"
                    };
