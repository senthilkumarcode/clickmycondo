        ...
        _createClass(InventorySetupWarehouseComponent, [{
          ...
          value: function updateWareHouse(data) {
            ...
            this.purchaseOrderService.updateWarehouse(params).subscribe(function (res) {
              if (res) {
                _this4.sharedService.openSnackBar("Warehouse updated successfully", 'success');
          ...
          value: function ngOnInit() {
            ...
            this.sharedService.unitlistdeleteindexcast.subscribe(function (id) {
              if (id != null) {
                ...
                _this6.purchaseOrderService.deleteWarehouse(param).subscribe(function (res) {
                  _this6.getAllGetAllWarehouse();

                  setTimeout(function () {
                    _this6.sharedService.openSnackBar("Warehouse deleted successfully", 'success');
