      ...
      _createClass(WorkpermitApprovalComponent, [{
        ...
        value: function getWorkPermit() {
          ...
          this.workPermit.getWorkPermitsByApartmentId(apartMentID).subscribe(function (res) {
            _this22.workPermitListData = res;
            _this22.isDataLoaded = true;
            _this22.totalItems = _this22.workPermitListData.length;
        ...
        value: function submitCreateWorkPermitForm(form) {
          ...
          this.workPermitService.addWorkPermit(workPermitDetails).subscribe(function (res) {
            if (res.message) {
              ...
              if (_this29.listWorkers.length != 0) {
                for (var i = 0; i < _this29.listWorkers.length; i++) {
                  var workpermitworkers = {
                    "workPermitWorkersId": 0,
                    "apartmentId": _this29.workpermit.WPApartment,
                    "workPermitId": workPermitId,
                    "workerName": _this29.listWorkers[i].name,
                    "workDescription": _this29.listWorkers[i].description,
                    "isActive": true,
                    "insertedBy": parseInt(_this29.cookieService.get('userId')),
                    "insertedOn": new Date().toISOString(),
                    "updatedBy": null,
                    "updatedOn": null
                  };

                  _this29.workPermitService.addWorkPermitWorkers(workpermitworkers).subscribe(function (res) {});
                }
              }

              if (_this29.listMaterials.length != 0) {
                for (var i = 0; i < _this29.listMaterials.length; i++) {
                  var workpermitmaterials = {
                    "workPermitMaterialsId": 0,
                    "apartmentId": _this29.workpermit.WPApartment,
                    "workPermitId": workPermitId,
                    "material": _this29.listMaterials[i].name,
                    "quantity": _this29.listMaterials[i].qty,
                    "description": _this29.listMaterials[i].description,
                    "isActive": true,
                    "insertedBy": parseInt(_this29.cookieService.get('userId')),
                    "insertedOn": new Date().toISOString(),
                    "updatedBy": null,
                  ...
                  _this29.workPermitService.addWorkPermitMaterials(workpermitmaterials).subscribe(function (res) {});
                }
              }

              if (_this29.listTools.length != 0) {
                for (var i = 0; i < _this29.listTools.length; i++) {
                  var workpermittools = {
                    "workPermitToolsId": 0,
                    "apartmentId": _this29.workpermit.WPApartment,
                    "workPermitId": workPermitId,
                    "tool": _this29.listTools[i].name,
                    "quantity": _this29.listTools[i].qty,
                    "description": _this29.listTools[i].description,
                    "isActive": true,
                    "insertedBy": parseInt(_this29.cookieService.get('userId')),
                    "insertedOn": new Date().toISOString(),
                    "updatedBy": null,
                  ...
                  _this29.workPermitService.addWorkPermitTools(workpermittools).subscribe(function (res) {});
                }
              }

              if (res.message) {
                _this29.sharedService.setAlertMessage("Work Permit added successfully");

                _this29.router.navigate(['/ams/work-permit/settings/approval']);
              }
            } else {
              _this29.isWorkpermitSubmitted = false;
              _this29.isError = true;
              _this29.errorMessage = res.errorMessage;
            }
          }, function (error) {});
        }
      }]);
    ...
    function () {
      ...
      _createClass(WorkpermitSetupComponent, [{
        ...
        value: function getWorktype() {
          ...
          this.lookupService.getLookupValueByLookupTypeId(90).subscribe(function (res) {
            _this30.allWorkType = res;
            _this30.isDataLoaded = true;
            _this30.totalItems = _this30.allWorkType.length;
        ...
        value: function getNaturework() {
          ...
          this.lookupService.getLookupValueByLookupTypeId(89).subscribe(function (res) {
            _this31.allNatureWork = res;
            _this31.isDataLoaded = true;
            _this31.NWtotalItems = _this31.allNatureWork.length;

            if (_this31.NWtotalItems > _this31.NWitemLimit) {
              _this31.NWItemEndIndex = _this31.NWitemLimit;
            } else {
        ...
        value: function submitCreateWorkPermitTypeForm(form) {
          ...
          this.lookupService.addLookupValue(workpermittypes).subscribe(function (res) {
            if (res.message) {
              _this32.sharedService.setAlertMessage("WorkPermit Type added successfully");
        ...
        value: function submitCreateNatureofWorkForm(form) {
          ...
          this.lookupService.addLookupValue(workpermittypes).subscribe(function (res) {
            if (res.message) {
              _this33.sharedService.setAlertMessage("WorkPermit Nature of work added successfully");

              _this33.getNaturework();
            }
          });
        }
      }]);
