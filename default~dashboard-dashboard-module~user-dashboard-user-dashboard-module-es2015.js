...
let DashComListComponent = class DashComListComponent {
    ...
    ngOnInit() {
        ...
        if (this.label == 'Emergency Alerts' && this.role != 'Owner' && this.role != 'Tenant') {
            ...
            this.workpermitService.getWorkPermitsByApartmentIdUnitId(params).subscribe((res) => {
                this.workPermit = res;
            });
        }
...
//# sourceMappingURL=default~dashboard-dashboard-module~user-dashboard-user-dashboard-module-es2015.js.map