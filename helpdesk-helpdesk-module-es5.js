...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["helpdesk-helpdesk-module"], {
  ...
  function srcAppAmsHelpdeskComponentsHelpdeskReportsHelpdeskReportsComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function HelpdeskReportsComponent() {
    ...
    HelpdeskReportsComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [])], HelpdeskReportsComponent);
    /***/
  },
  ...
  function srcAppAmsHelpdeskComponentsHelpdeskSetupHelpdeskEditStaffHelpdeskEditStaffComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    HelpdeskEditStaffComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
  ...
  function srcAppAmsHelpdeskComponentsHelpdeskSetupHelpdeskSetupComponentTs(module, __webpack_exports__, __webpack_require__) {
      ...
      _createClass(HelpdeskSetupComponent, [{
        ...
        value: function submitStaffForm(form) {
          ...
          if (this.staffType == "26") {
            ...
            var categoryAvailable = underscore__WEBPACK_IMPORTED_MODULE_8__["some"](this.categoryCommonListData, function (item) {
              return item.lookupValueName === _this2.staffCategory;
            });
            ...
            if (categoryAvailable) {
              ...
              this.lookupService.addLookupValue(details).subscribe(function (res) {
                _this2.isStaffLoaded = true;
                _this2.isCategoryDataLoaded = false;

                _this2.lookupService.getLookupValueByLookupTypeId(_this2.staffTypeId).subscribe(function (res) {
                  var categoryCommonListData = res.filter(function (item) {
                    return item.isActive;
                  });
                  _this2.categoryCommonListData = categoryCommonListData;
                  _this2.isCategoryDataLoaded = true;
                }, function (error) {});
              }, function (error) {});
            }
          } else {
            ...
            if (categoryAvailable) {
              ...
              this.lookupService.addLookupValue(details).subscribe(function (res) {
                ...
                _this2.lookupService.getLookupValueByLookupTypeId(_this2.staffTypeId).subscribe(function (res) {
                  ...
                  _this2.categoryPrivateListData = categoryPrivateListData;
                  _this2.isCategoryDataLoaded = true;
                }, function (error) {});
              }, function (error) {});
            }
        ...
        value: function ngOnInit() {
          ...
          this.lookupService.getLookupValueByLookupTypeId(16).subscribe(function (res) {
            ...
            _this3.categoryPrivateListData = categoryPrivateListData; //get all common category

            _this3.lookupService.getLookupValueByLookupTypeId(17).subscribe(function (res) {
              var categoryCommonListData = res.filter(function (item) {
                return item.isActive;
              });
          ...
          this.sharedService.unitlistdeleteindexcast.subscribe(function (index) {
            if (index != null) {
              if (_this3.staffDeleteTypeId == "27") {
                var params = {
                  lookupValueId: _this3.categoryPrivateListData[index].id,
                  updateUserId: parseInt(_this3.cookieService.get('userId'))
                };
              } else {
                var params = {
                  lookupValueId: _this3.categoryCommonListData[index].id,
                  updateUserId: parseInt(_this3.cookieService.get('userId'))
                };
              }
              ...
              _this3.userService.deleteUserById(params).subscribe(function (res) {
                if (_this3.staffDeleteTypeId == "26") {
                  _this3.categoryPrivateListData.splice(index, 1);
                } else {
                  _this3.categoryCommonListData.splice(index, 1);
                }
    ...
    HelpdeskSetupComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
  ...
  function srcAppAmsHelpdeskComponentsHelpdeskUnassignedHelpdeskUnassignedComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    HelpdeskUnassignedComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [])], HelpdeskUnassignedComponent);
    /***/
  },
  ...
  function srcAppAmsHelpdeskComponentsHelpdeskUpdateTicketHelpdeskUpdateTicketComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    HelpdeskUpdateTicketComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"]])], HelpdeskUpdateTicketComponent);
    /***/
  },
  ...
  function srcAppAmsHelpdeskHelpdeskRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _components_helpdesk_all_tickets_helpdesk_all_tickets_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./components/helpdesk-all-tickets/helpdesk-all-tickets.component */
    ...
    var _components_helpdesk_update_ticket_add_ticket_add_ticket_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ./components/helpdesk-update-ticket/add-ticket/add-ticket.component */
    ...
    var routes = [{
      ...
      path: 'edit-ticket/:id',
      component: _components_helpdesk_update_ticket_add_ticket_add_ticket_component__WEBPACK_IMPORTED_MODULE_8__["AddTicketComponent"]
    }, {
      path: 'all-tickets',
      component: _components_helpdesk_all_tickets_helpdesk_all_tickets_component__WEBPACK_IMPORTED_MODULE_5__["HelpdeskAllTicketsComponent"]
    }, {
      path: 'unassigned',
    ...
    HelpdeskRoutingModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
  ...
  function srcAppAmsHelpdeskHelpdeskComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    HelpdeskComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [])], HelpdeskComponent);
    /***/
  },
  ...
  function srcAppAmsHelpdeskHelpdeskModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _components_helpdesk_all_tickets_helpdesk_all_tickets_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ./components/helpdesk-all-tickets/helpdesk-all-tickets.component */
    "./src/app/ams/helpdesk/components/helpdesk-all-tickets/helpdesk-all-tickets.component.ts");
    /* harmony import */
    ...
    var _components_helpdesk_update_ticket_add_ticket_add_ticket_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
    /*! ./components/helpdesk-update-ticket/add-ticket/add-ticket.component */
    "./src/app/ams/helpdesk/components/helpdesk-update-ticket/add-ticket/add-ticket.component.ts");
    /* harmony import */


    var _components_helpdesk_setup_helpdesk_edit_staff_helpdesk_edit_staff_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
    /*! ./components/helpdesk-setup/helpdesk-edit-staff/helpdesk-edit-staff.component */
    "./src/app/ams/helpdesk/components/helpdesk-setup/helpdesk-edit-staff/helpdesk-edit-staff.component.ts");
    ...
    HelpdeskModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      declarations: [_helpdesk_component__WEBPACK_IMPORTED_MODULE_5__["HelpdeskComponent"], _components_helpdesk_setup_helpdesk_setup_component__WEBPACK_IMPORTED_MODULE_6__["HelpdeskSetupComponent"], _components_helpdesk_update_ticket_helpdesk_update_ticket_component__WEBPACK_IMPORTED_MODULE_7__["HelpdeskUpdateTicketComponent"], _components_helpdesk_all_tickets_helpdesk_all_tickets_component__WEBPACK_IMPORTED_MODULE_8__["HelpdeskAllTicketsComponent"], _components_helpdesk_unassigned_helpdesk_unassigned_component__WEBPACK_IMPORTED_MODULE_9__["HelpdeskUnassignedComponent"], _components_helpdesk_reports_helpdesk_reports_component__WEBPACK_IMPORTED_MODULE_10__["HelpdeskReportsComponent"], _components_helpdesk_update_ticket_add_ticket_add_ticket_component__WEBPACK_IMPORTED_MODULE_11__["AddTicketComponent"], _components_helpdesk_setup_helpdesk_edit_staff_helpdesk_edit_staff_component__WEBPACK_IMPORTED_MODULE_12__["HelpdeskEditStaffComponent"]],
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _shared_shared_module__WEBPACK_IMPORTED_MODULE_4__["SharedModule"].forRoot(), _helpdesk_routing_module__WEBPACK_IMPORTED_MODULE_3__["HelpdeskRoutingModule"]],
