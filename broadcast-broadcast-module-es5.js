...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["broadcast-broadcast-module"], {
  ...
  function srcAppAmsBroadcastBroadcastModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    BroadcastModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      ...
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _shared_shared_module__WEBPACK_IMPORTED_MODULE_3__["SharedModule"], _broadcast_routing_module__WEBPACK_IMPORTED_MODULE_4__["BroadcastRoutingModule"]]
    })], BroadcastModule);
    /***/
  },
  ...
  function srcAppAmsBroadcastComponentsBroadcastHistoryBroadcastHistoryComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      ...
      _createClass(BroadcastHistoryComponent, [{
        ...
        key: "getAllBroadcast",
        value: function getAllBroadcast() {
          var _this = this;

          var apartmentID = parseInt(this.cookieService.get('apartmentId'));
          this.broadcastService.getBroadcastsByApartmentId(apartmentID).subscribe(function (res) {
            _this.allBroadcast = res;
            _this.isDataLoaded = true;
            _this.totalItems = _this.allBroadcast.length;
        ...
        value: function getAllCategory() {
          ...
          var apartmentID = parseInt(this.cookieService.get('apartmentId'));
          this.broadcastService.getBroadCastCategorysByApartmentId(apartmentID).subscribe(function (res) {
            _this3.allCategory = res;
          });
        } //Get All Type
        ...
        value: function getCategoryName(name) {
          var data = underscore__WEBPACK_IMPORTED_MODULE_7__["filter"](this.allCategory, function (item) {
            if (item.broadCastCategoryId === name) return item;
          });
  ...
  function srcAppAmsBroadcastComponentsBroadcastSendmessageBroadcastSendmessageComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function BroadcastSendmessageComponent(broadcastService, sharedService, cookieService) {
      ...
      _createClass(BroadcastSendmessageComponent, [{
        ...
        value: function getAllCategory() {
          ...
          var apartmentID = parseInt(this.cookieService.get('apartmentId'));
          this.broadcastService.getBroadCastCategorysByApartmentId(apartmentID).subscribe(function (res) {
            var allcategory = res; //filter active true items

            _this6.allcategory = allcategory.filter(function (data) {
        ...
        value: function submitCreateBroadcastMessageForm(form) {
          ...
          this.broadcastService.addBroadcast(broadcastMessage).subscribe(function (res) {
            if (res.message) {
              _this7.sharedService.setAlertMessage("Broadcast Message sent successfully");
      ...
      _createClass(BroadcastSetupComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.sharedService.unitlistdeleteindexcast.subscribe(function (index) {
            if (index != null) {
              var params = {
                broadcastId: _this8.allBroadcastCategory[index].broadCastCategoryId,
                deleteBy: parseInt(_this8.cookieService.get('userId'))
              };
              _this8.isDataLoaded = false;

              _this8.broadcastService.deleteBroadCastCategory(params).subscribe(function (res) {
                _this8.allBroadcastCategory.splice(index, 1);

                _this8.totalItems = _this8.allBroadcastCategory.length;
        ...
        value: function getAllCategory() {
          ...
          this.broadcastService.getBroadCastCategorysByApartmentId(apartmentID).subscribe(function (res) {
            ...
            _this9.allBroadcastCategory = allBroadcastCategory.filter(function (data) {
              return data.isActive;
            });
            _this9.isDataLoaded = true;
            _this9.totalItems = _this9.allBroadcastCategory.length;
        ...
        key: "submitCreateBroadcastCategoryForm",
        value: function submitCreateBroadcastCategoryForm(form) {
          var _this10 = this;
          ...
          if (this.isEdit == false) {
            ...
            this.broadcastService.addBroadCastCategory(broadcastCategory).subscribe(function (res) {
              if (res.message) {
                _this10.sharedService.setAlertMessage("Broadcast category added successfully");

                _this10.getAllCategory();

                _this10.category = {};
              }
            });
          } else {
            var _broadcastCategory = {
            ...
            this.broadcastService.updateBroadCastCategory(_broadcastCategory).subscribe(function (res) {
              if (res.message) {
                _this10.sharedService.setAlertMessage("Broadcast category updated successfully");

                _this10.getAllCategory();

                _this10.category = {};
                _this10.isEdit = false;
              }
            });
          }
        }
