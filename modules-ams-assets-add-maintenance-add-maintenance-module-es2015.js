...
let AddMaintenanceComponent = class AddMaintenanceComponent {
    constructor(route, assetService, lookupService, sessionService, sharedService, dialog, router, activatedRoute, staffService, _changeDetectorRef, translateService) {
        this.route = route;
...
AddMaintenanceComponent.propDecorators = {
    addMaintenanceForm: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"], args: ['addMaintenanceForm', { static: false },] }]
};
