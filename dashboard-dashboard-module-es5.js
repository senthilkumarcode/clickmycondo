...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["dashboard-dashboard-module"], {
  ...
  function node_modulesRawLoaderDistCjsJsSrcAppAmsDashboardComponentsSharedDashComListDashComListComponentHtml(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "<div class=\"card dashboard-card meeting-schedule\">\n    <div class=\"card-body dash-height\">\n        <div class=\"align-left-right mb-2\">\n            <div>\n                <i class=\"icon-md fa fa-calendar mr-3 dark-blue\" aria-hidden=\"true\"></i>\n                <h6 class=\"font-weight-bold d-inline dark-blue\">{{label}}</h6>\n            </div>\n            <div>\n                <p class=\"font-weight-bold d-inline mr-3 more\">More</p>\n                <i class=\"icon-md fa fa-caret-down link dark-blue\" aria-hidden=\"true\" (click)=\"calenderPopUp('meeting')\"></i>\n            </div>\n        </div>\n        <ng-container *ngIf=\"label == 'Emergency Alert'\">\n            <div class=\"border-line mt-3\" *ngFor=\"let data of emergencyAlert\">\n                <div class=\"row mb-2\">\n                    <div class=\"col-sm-4\">\n                        <p class=\"more\">{{data.notes}}</p> \n                        <p class=\"font-weight-bold dark-blue\">{{data.apartmentBlockUnitId}}</p>\n                    </div>\n                    <div class=\"col-sm-4\">\n                        <p class=\"more\">{{data.subject}}</p>\n                    </div>\n                    <div class=\"col-sm-4\">\n                        <!-- <p class=\"more\">{{data.fromTime }} - {{data.toTime}}</p> -->\n                        <p class=\"text-muted\">{{data.receivedDate | date: 'EEE, MMM d, y'}}</p>\n                    </div>\n                </div>\n            </div>\n        </ng-container>\n        <ng-container *ngIf=\"label == 'Violation Messages'\">\n            <div class=\"border-line mt-3\" *ngFor=\"let data of violation\">\n                <div class=\"row mb-2\">\n                    <div class=\"col-sm-4\">\n                        <p class=\"more\">{{data.comments}}</p> \n                        <p class=\"font-weight-bold dark-blue\"><span>{{data.securityPerson}} - {{data.apartmentBlockUnitId}}</span></p>\n                    </div>\n                    <div class=\"col-sm-4\">\n                        <p class=\"more\">{{data.subject}}</p>\n                    </div>\n                    <div class=\"col-sm-4\">\n                        <!-- <p class=\"more\">{{data.fromTime }} - {{data.toTime}}</p> -->\n                        <p class=\"text-muted\">{{data.noticedOn | date: 'EEE, MMM d, y'}}</p>\n                    </div>\n                </div>\n            </div>\n        </ng-container>\n        <ng-container *ngIf=\"label == 'Work Permit'\">\n            <div class=\"border-line mt-3\" *ngFor=\"let data of workPermit\">\n                <div class=\"row mb-2\">\n                    <div class=\"col-sm-4\">\n                        <p class=\"more\">{{data.wptitle}}</p> \n                        <p class=\"font-weight-bold dark-blue\"><span>{{data.residentName}} - {{data.apartmentBlockUnitNumber}}</span></p>\n                    </div>\n                    <div class=\"col-sm-4\">\n                        <p class=\"more\">{{data.status}}</p>\n                    </div>\n                    <div class=\"col-sm-4\">\n                        <p class=\"more\">{{data.startTime }} - {{data.endTime}}</p>\n                        <p class=\"text-muted\">{{data.startDate | date: 'EEE, MMM d, y'}}</p>\n                        <p class=\"text-muted\">{{data.endDate | date: 'EEE, MMM d, y'}}</p>\n                    </div>\n                </div>\n            </div>\n        </ng-container>\n        <ng-container *ngIf=\"label == 'Facility Bookings'\">\n            <div class=\"border-line mt-3\" *ngFor=\"let data of facility\">\n                <div class=\"row mb-2\">\n                    <div class=\"col-sm-4\">\n                        <p class=\"more\">{{data.comments}}</p> \n                        <p class=\"font-weight-bold dark-blue\"><span>{{data.residentName}} - {{data.apartmentBlockUnitId}}</span></p>\n                    </div>\n                    <div class=\"col-sm-4\">\n                        <p class=\"more\">{{data.comment}}</p>\n                    </div>\n                    <div class=\"col-sm-4\">\n                        <!-- <p class=\"more\">{{data.fromTime }} - {{data.toTime}}</p> -->\n                        <p class=\"text-muted\">{{data.bookedOn | date: 'EEE, MMM d, y'}}</p>\n                    </div>\n                </div>\n            </div>\n        </ng-container>\n    </div>\n</div>";
    /***/
  },
  ...
  function srcAppAmsDashboardComponentsDashboardAdminDashboardAdminDashboardComponentScss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = ".admin-dashboard-wrapper .dark-blue {\n  color: #236aaf;\n}\n.admin-dashboard-wrapper .more {\n  font-size: 1.4rem;\n}\n.admin-dashboard-wrapper .border-line {\n  border-bottom: 2px solid #dedede;\n}\n.admin-dashboard-wrapper .dash-height {\n  height: 309px;\n  overflow-y: auto;\n}\n.admin-dashboard-wrapper .meeting-schedule .border-line:last-child, .admin-dashboard-wrapper .announcement .border-line:last-child {\n  border-bottom: unset;\n}\n.admin-dashboard-wrapper .announce-round {\n  width: 40px;\n  height: 35px;\n  border-radius: 50%;\n  background-color: #236aaf;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
  ...
  function srcAppAmsDashboardComponentsDashboardCustomDashboardCustomDashboardComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*! angular2gridster */
    "./node_modules/angular2gridster/__ivy_ngcc__/fesm2015/angular2gridster.js"); // const COLORS = [
    //   '#ea4335',
    //   '#4285f4',
    //   '#fbbc04',
    //   '#34a853',
    ...
    function () {
      ...
      _createClass(CustomDashboardComponent, [{
        ...
        key: "itemChange",
        value: function itemChange($event, gridster) {
  ...
  function srcAppAmsDashboardComponentsSharedDashBroadCastDashBroadCastComponentScss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = ".dash-height {\n  height: 309px;\n  overflow-y: auto;\n}\n\n.meeting-schedule .border-line:last-child, .announcement .border-line:last-child {\n  border-bottom: unset;\n}\n\n.more {\n  font-size: 1.4rem;\n}\n\n.dark-blue {\n  color: #236aaf;\n}\n\n.announce-round {\n  width: 40px;\n  height: 35px;\n  border-radius: 50%;\n  background-color: #236aaf;\n}\n\n.border-line {\n  border-bottom: 2px solid #dedede;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
    ...
    function () {
      ...
      _createClass(DashBroadCastComponent, [{
        ...
        value: function calenderPopUp(dateType) {
          ...
          dialogRef.afterClosed().subscribe(function (result) {
            if (result) {
              _this72.announcementList(result);
            }
          });
        }
      }, {
  ...
  function srcAppAmsDashboardComponentsSharedDashComListDashComListComponentScss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = ".dash-height {\n  height: 309px;\n  overflow-y: auto;\n}\n\n.meeting-schedule .border-line:last-child, .announcement .border-line:last-child {\n  border-bottom: unset;\n}\n\n.more {\n  font-size: 1.4rem;\n}\n\n.dark-blue {\n  color: #236aaf;\n}\n\n.dash-height {\n  height: 309px;\n  overflow-y: auto;\n}\n\n.border-line {\n  border-bottom: 2px solid #dedede;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
    ...
    function () {
      ...
      _createClass(DashComListComponent, [{
        ...
        value: function ngOnInit() {
          ...
          } else if (this.label == 'Violation Messages') {
  ...
  function srcAppAmsDashboardComponentsSharedDashMeetingDashMeetingComponentScss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = ".dash-height {\n  height: 309px;\n  overflow-y: auto;\n}\n\n.meeting-schedule .border-line:last-child, .announcement .border-line:last-child {\n  border-bottom: unset;\n}\n\n.more {\n  font-size: 1.4rem;\n}\n\n.dark-blue {\n  color: #236aaf;\n}\n\n.dash-height {\n  height: 309px;\n  overflow-y: auto;\n}\n\n.border-line {\n  border-bottom: 2px solid #dedede;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
  ...
  function srcAppAmsDashboardDashboardModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _components_dashboard_admin_dashboard_admin_dashboard_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
    /*! ./components/dashboard/admin-dashboard/admin-dashboard.component */
    "./src/app/ams/dashboard/components/dashboard/admin-dashboard/admin-dashboard.component.ts");
    /* harmony import */


    var _components_dashboard_security_dashboard_security_dashboard_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
    /*! ./components/dashboard/security-dashboard/security-dashboard.component */
    "./src/app/ams/dashboard/components/dashboard/security-dashboard/security-dashboard.component.ts");
    /* harmony import */


    var _components_dashboard_staff_dashboard_staff_dashboard_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
    /*! ./components/dashboard/staff-dashboard/staff-dashboard.component */
    "./src/app/ams/dashboard/components/dashboard/staff-dashboard/staff-dashboard.component.ts");
    /* harmony import */


    var _components_shared_users_chart_users_chart_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
    /*! ./components/shared/users-chart/users-chart.component */
    "./src/app/ams/dashboard/components/shared/users-chart/users-chart.component.ts");
    /* harmony import */


    var _components_shared_unit_chart_unit_chart_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(
    /*! ./components/shared/unit-chart/unit-chart.component */
    "./src/app/ams/dashboard/components/shared/unit-chart/unit-chart.component.ts");
    /* harmony import */


    var _components_shared_helpdesk_chart_helpdesk_chart_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(
    /*! ./components/shared/helpdesk-chart/helpdesk-chart.component */
    "./src/app/ams/dashboard/components/shared/helpdesk-chart/helpdesk-chart.component.ts");
    /* harmony import */


    var _components_shared_visitors_comp_visitors_comp_component__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(
    /*! ./components/shared/visitors-comp/visitors-comp.component */
    "./src/app/ams/dashboard/components/shared/visitors-comp/visitors-comp.component.ts");
    /* harmony import */


    var _components_shared_ledger_comp_ledger_comp_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(
    /*! ./components/shared/ledger-comp/ledger-comp.component */
    "./src/app/ams/dashboard/components/shared/ledger-comp/ledger-comp.component.ts");
    /* harmony import */


    var _components_shared_bank_comp_bank_comp_component__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(
    /*! ./components/shared/bank-comp/bank-comp.component */
    "./src/app/ams/dashboard/components/shared/bank-comp/bank-comp.component.ts");
    /* harmony import */


    var _components_shared_income_tracker_comp_income_tracker_comp_component__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(
    /*! ./components/shared/income-tracker-comp/income-tracker-comp.component */
    "./src/app/ams/dashboard/components/shared/income-tracker-comp/income-tracker-comp.component.ts");
    /* harmony import */


    var _components_shared_expense_tracker_comp_expense_tracker_comp_component__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(
    /*! ./components/shared/expense-tracker-comp/expense-tracker-comp.component */
    "./src/app/ams/dashboard/components/shared/expense-tracker-comp/expense-tracker-comp.component.ts");
    /* harmony import */


    var _components_shared_payment_comp_payment_comp_component__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(
    /*! ./components/shared/payment-comp/payment-comp.component */
    "./src/app/ams/dashboard/components/shared/payment-comp/payment-comp.component.ts");
    /* harmony import */


    var src_app_api_controllers_DashBoard__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(
    /*! src/app/api/controllers/DashBoard */
    "./src/app/api/controllers/DashBoard.ts");
    /* harmony import */


    var _components_shared_date_model_date_model_component__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(
    /*! ./components/shared/date-model/date-model.component */
    "./src/app/ams/dashboard/components/shared/date-model/date-model.component.ts");
    /* harmony import */


    var _components_shared_dash_pie_chart_dash_pie_chart_component__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(
    /*! ./components/shared/dash-pie-chart/dash-pie-chart.component */
    "./src/app/ams/dashboard/components/shared/dash-pie-chart/dash-pie-chart.component.ts");
    /* harmony import */


    var _components_shared_dash_income_chart_dash_income_chart_component__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(
    /*! ./components/shared/dash-income-chart/dash-income-chart.component */
    "./src/app/ams/dashboard/components/shared/dash-income-chart/dash-income-chart.component.ts");
    /* harmony import */


    var _components_dashboard_custom_dashboard_custom_dashboard_component__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(
    ...
    var _components_shared_admin_dash_first_row_admin_dash_first_row_component__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(
    /*! ./components/shared/admin-dash-first-row/admin-dash-first-row.component */
    "./src/app/ams/dashboard/components/shared/admin-dash-first-row/admin-dash-first-row.component.ts");
    /* harmony import */


    var _components_shared_admin_dash_second_row_admin_dash_second_row_component__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(
    /*! ./components/shared/admin-dash-second-row/admin-dash-second-row.component */
    "./src/app/ams/dashboard/components/shared/admin-dash-second-row/admin-dash-second-row.component.ts");
    /* harmony import */


    var _components_shared_dash_meeting_dash_meeting_component__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(
    /*! ./components/shared/dash-meeting/dash-meeting.component */
    "./src/app/ams/dashboard/components/shared/dash-meeting/dash-meeting.component.ts");
    /* harmony import */


    var _components_shared_dash_broad_cast_dash_broad_cast_component__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(
    /*! ./components/shared/dash-broad-cast/dash-broad-cast.component */
    "./src/app/ams/dashboard/components/shared/dash-broad-cast/dash-broad-cast.component.ts");
    /* harmony import */


    var angular2gridster__WEBPACK_IMPORTED_MODULE_32__ = __webpack_require__(
    /*! angular2gridster */
    "./node_modules/angular2gridster/__ivy_ngcc__/fesm2015/angular2gridster.js");
    /* harmony import */


    var _components_shared_dash_com_list_dash_com_list_component__WEBPACK_IMPORTED_MODULE_33__ = __webpack_require__(
    ...
    DashboardModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      declarations: [_dashboard_component__WEBPACK_IMPORTED_MODULE_9__["DashboardComponent"], _components_dashboard_admin_dashboard_admin_dashboard_component__WEBPACK_IMPORTED_MODULE_10__["AdminDashboardComponent"], _components_dashboard_security_dashboard_security_dashboard_component__WEBPACK_IMPORTED_MODULE_11__["SecurityDashboardComponent"], _components_dashboard_staff_dashboard_staff_dashboard_component__WEBPACK_IMPORTED_MODULE_12__["StaffDashboardComponent"], _components_shared_users_chart_users_chart_component__WEBPACK_IMPORTED_MODULE_13__["UsersChartComponent"], _components_shared_unit_chart_unit_chart_component__WEBPACK_IMPORTED_MODULE_14__["UnitChartComponent"], _components_shared_helpdesk_chart_helpdesk_chart_component__WEBPACK_IMPORTED_MODULE_15__["HelpdeskChartComponent"], _components_shared_visitors_comp_visitors_comp_component__WEBPACK_IMPORTED_MODULE_16__["VisitorsCompComponent"], _components_shared_ledger_comp_ledger_comp_component__WEBPACK_IMPORTED_MODULE_17__["LedgerCompComponent"], _components_shared_bank_comp_bank_comp_component__WEBPACK_IMPORTED_MODULE_18__["BankCompComponent"], _components_shared_income_tracker_comp_income_tracker_comp_component__WEBPACK_IMPORTED_MODULE_19__["IncomeTrackerCompComponent"], _components_shared_expense_tracker_comp_expense_tracker_comp_component__WEBPACK_IMPORTED_MODULE_20__["ExpenseTrackerCompComponent"], _components_shared_payment_comp_payment_comp_component__WEBPACK_IMPORTED_MODULE_21__["PaymentCompComponent"], _components_shared_date_model_date_model_component__WEBPACK_IMPORTED_MODULE_23__["DateModelComponent"], _components_shared_dash_pie_chart_dash_pie_chart_component__WEBPACK_IMPORTED_MODULE_24__["DashPieChartComponent"], _components_shared_dash_income_chart_dash_income_chart_component__WEBPACK_IMPORTED_MODULE_25__["DashIncomeChartComponent"], _components_dashboard_custom_dashboard_custom_dashboard_component__WEBPACK_IMPORTED_MODULE_26__["CustomDashboardComponent"], _components_shared_admin_dash_first_row_admin_dash_first_row_component__WEBPACK_IMPORTED_MODULE_28__["AdminDashFirstRowComponent"], _components_shared_admin_dash_second_row_admin_dash_second_row_component__WEBPACK_IMPORTED_MODULE_29__["AdminDashSecondRowComponent"], _components_shared_dash_meeting_dash_meeting_component__WEBPACK_IMPORTED_MODULE_30__["DashMeetingComponent"], _components_shared_dash_broad_cast_dash_broad_cast_component__WEBPACK_IMPORTED_MODULE_31__["DashBroadCastComponent"], _components_shared_dash_com_list_dash_com_list_component__WEBPACK_IMPORTED_MODULE_33__["DashComListComponent"]],
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["RouterModule"].forChild(_dashboard_routing_module__WEBPACK_IMPORTED_MODULE_3__["routes"]), angular2gridster__WEBPACK_IMPORTED_MODULE_32__["GridsterModule"].forRoot(), _shared_shared_module__WEBPACK_IMPORTED_MODULE_5__["SharedModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_6__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_6__["ReactiveFormsModule"], _dashboard_routing_module__WEBPACK_IMPORTED_MODULE_3__["DashboardRoutingModule"], _angular_material_grid_list__WEBPACK_IMPORTED_MODULE_7__["MatGridListModule"], _angular_cdk_drag_drop__WEBPACK_IMPORTED_MODULE_27__["DragDropModule"]],
      providers: [_auth_guard__WEBPACK_IMPORTED_MODULE_8__["AuthGuard"], src_app_api_controllers_DashBoard__WEBPACK_IMPORTED_MODULE_22__["DashBoardService"]],
