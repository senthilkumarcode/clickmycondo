...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "UserWorkpermitComponent", function() { return UserWorkpermitComponent; });
...
/* harmony import */ var _workpermit_status_workpermit_status_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../workpermit-status/workpermit-status.component */ "./src/app/modules/common/work-permit/components/workpermit-status/workpermit-status.component.ts");
...
let UserWorkpermitComponent = class UserWorkpermitComponent {
    ...
    navigateEditViewPage(type, id) {
        this.router.navigate([`/user/work-permit/${type}/${id}`]);
    }
    onEditTicket(detail) {
    ...
    getWorkPermitByUser() {
        ...
        this.workPermit.getWorkPermitsByApartmentIdUnitId(params).subscribe((res) => {
           ...
           <div class="status-badge bg-status-${status}-700">
             <span class="font-bold text-status-${status}-900 text-uppercase">${this.workPermitListData.loadedData[row].status}</span>
                ...
                cellsrenderer: (row) => {
                    ...
                    if (this.workPermitListData.loadedData[row].statusId == 358 || this.workPermitListData.loadedData[row].statusId == 355)
...
UserWorkpermitComponent.ctorParameters = () => [
...
UserWorkpermitComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-user-workpermit',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./user-workpermit.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/modules/common/work-permit/components/user-workpermit/user-workpermit.component.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./user-workpermit.component.scss */ "./src/app/modules/common/work-permit/components/user-workpermit/user-workpermit.component.scss")).default]
    }),
...
let WorkpermitCreateComponent = class WorkpermitCreateComponent {
    ...
    deletelistItems(index, listName, data) {
        if (listName === 'worker') {
            if (data.workPermitWorkersId == 0)
                this.deleteConfirmDialog(listName, index);
            else
                this.modalService.showConfirmModal({ type: listName, id: data.workPermitWorkersId, index: index });
        }
        else if (listName === 'material') {
            if (data.workPermitMaterialsId == 0)
                this.deleteConfirmDialog(listName, index);
            else
                this.modalService.showConfirmModal({ type: listName, id: data.workPermitMaterialsId, index: index });
        }
        else {
            if (data.workPermitToolsId == 0)
                this.deleteConfirmDialog(listName, index);
            else
                this.modalService.showConfirmModal({ type: listName, id: data.workPermitToolsId, index: index });
        }
    }
        ...
        if (!this.form.valid) {
            ...
            this.workPermitService.updateWorkPermit(params).subscribe((res) => {
                if (res.message) {
                    ...
                    this.createWorkers(null);
                    this.createMaterials(null);
    ...
    createWorkers(workPermitId) {
        for (var i = 0; i < this.workersList.length; i++) {
            ...
            if (createWorker)
                ...
                this.workPermitService.updateWorkPermitWorkers(params).toPromise();
        }
    }
    createMaterials(workPermitId) {
        for (var i = 0; i < this.materialsList.length; i++) {
            ...
            if (createMaterial)
                ...
                this.workPermitService.updateWorkPermitMaterials(params).toPromise();
        }
    }
    createTools(workPermitId) {
        for (var i = 0; i < this.toolsList.length; i++) {
            ...
            if (createTool)
                ...
                this.workPermitService.updateWorkPermitTools(params).toPromise();
        }
    }
    deleteWorkers(id, index) {
        let params = {
            workPermitWorkersId: id,
            deleteBy: this.sessionService.userId,
        };
        this.workPermitService.deleteWorkPermitWorkers(params).subscribe((res) => {
            this.sharedService.setUnitListDeleteIndex(null);
            this.workersList.splice(index, 1);
        });
    }
    deleteMaterials(id, index) {
        let params = {
            workPermitMaterialsId: id,
            deleteBy: this.sessionService.userId,
        };
        this.workPermitService.deleteWorkPermitMaterials(params).subscribe((res) => {
            this.sharedService.setUnitListDeleteIndex(null);
            this.materialsList.splice(index, 1);
        });
    }
    deleteTools(id, index) {
        let params = {
            workPermitToolsId: id,
            deleteBy: this.sessionService.userId,
        };
        this.workPermitService.deleteWorkPermitTools(params).subscribe((res) => {
            this.sharedService.setUnitListDeleteIndex(null);
            this.toolsList.splice(index, 1);
        });
    }
    ...
    ngOnInit() {
        ...
        this.lookupService.getLookupValueByLookupTypeId(natureWork).subscribe((res) => {
            this.natureWorkList = res;
        });
        let workPermitType = {
            LookupTypeId: 90,
            ApartmentId: this.sessionService.apartmentId,
        };
        this.lookupService.getLookupValueByLookupTypeId(workPermitType).subscribe((res) => {
            this.workPermitTypeList = res;
        });
        let vendor = {
            apartmentId: this.sessionService.apartmentId
        };
        ...
        this.lookupService.getLookupValueByLookupTypeId(statusParams).subscribe((res) => {
            if (this.activateRouter.params['value'].type) {
                ...
                this.statusList = res.filter((data) => data.lookupValueId != 353);
            }
        });
        //Edit Mode
        this.activateRouter.params.subscribe((params) => {
            if (params.id && params.type) {
                ...
                this.workPermitService.getWorkPermitById(entity).subscribe((res) => {
                    this.workPermit = res[0];
                    this.workPermit.startTime = moment__WEBPACK_IMPORTED_MODULE_9__(res[0].startTime, 'HH:mm').format();
                    this.workPermit.endTime = moment__WEBPACK_IMPORTED_MODULE_9__(res[0].endTime, 'HH:mm').format();
                    this.termsConditions = this.workPermit.termsConditions;
                    //tower Info
                    if (this.isAdmin()) {
                        this.block.blockId = res[0].apartmentBlockID;
                        this.getTowers().subscribe((res) => {
                            this.towerList = res;
                            this.getUnits('edit');
                            this.getPrimaryName();
                        });
                ...
                //termsCondition
                this.apartmentService.getAllTermsConditionsByApartmentIdTermsNo({ ApartmentId: this.sessionService.apartmentId, TermsNo: "1" }).subscribe((res) => {
                    if (res.length > 0)
        ...
        this.apiSubscribe = this.sharedService.unitlistdeleteindexcast.subscribe(item => {
            if (item && item.id && item.type == 'worker')
                this.deleteWorkers(item.id, item.index);
            else if (item && item.id && item.type == 'material')
                this.deleteMaterials(item.id, item.index);
            else if (item && item.id && item.type == 'tool')
                this.deleteTools(item.id, item.index);
        });
    }
    ngOnDestroy() {
...
WorkpermitCreateComponent.propDecorators = {
    ...
    accordion1: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"], args: ['myaccordion1',] }],
    accordion2: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"], args: ['myaccordion2',] }],
    accordion3: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"], args: ['myaccordion3',] }]
};
WorkpermitCreateComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-workpermit-create',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./workpermit-create.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/modules/common/work-permit/components/workpermit-create/workpermit-create.component.html")).default,
        encapsulation: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewEncapsulation"].None,
        animations: src_condo_animations__WEBPACK_IMPORTED_MODULE_15__["CondoAnimations"],
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./workpermit-create.component.scss */ "./src/app/modules/common/work-permit/components/workpermit-create/workpermit-create.component.scss")).default]
    }),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_material_dialog__WEBPACK_IMPORTED_MODULE_17__["MatDialog"],
...
let WorkpermitListComponent = class WorkpermitListComponent {
    ...
    navigateEditViewPage(type, id) {
        this.router.navigate([`/ams/work-permit/${type}/${id}`]);
    }
    onEditTicket(detail) {
        let dataRecord = this.datagrid.getrowdata(detail.rowId);
        let permitId = dataRecord.workPermitId;
    ...
    ngOnInit() {
        ...
        this.columnData = [{
                ...
                align: 'center',
                cellsrenderer: (row, column, value) => {
                    let status, statusId = this.workPermitListData.loadedData[row].statusId;
                    ;
                    if (statusId == 354) { //Pending Approval
                        status = 'purple';
                    }
                    else if (statusId == 356) { //inprogress
                        status = 'orange';
                    }
                    else if (statusId == 358 || statusId == 355) { //completed || Approved
                        status = 'green';
                    }
                    else if (statusId == 353 || statusId == 357 || statusId == 359) { //Cancelled || Rejected || onHold
                        status = 'red';
                    }
                    return `<div class="jqx-custom-inner-cell">
           <div class="status-badge bg-status-${status}-700">
             <span class="font-bold text-status-${status}-900 text-uppercase">${value}</span>
           </div>
        </div>`;
                },
                minwidth: 160,
...
WorkpermitListComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./workpermit-list.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/modules/common/work-permit/components/workpermit-list/workpermit-list.component.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./workpermit-list.component.scss */ "./src/app/modules/common/work-permit/components/workpermit-list/workpermit-list.component.scss")).default]
    }),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"],
        _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"],
        src_app_core_session_session_service__WEBPACK_IMPORTED_MODULE_4__["SessionService"],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "NatureOfWorkSetupComponent", function() { return NatureOfWorkSetupComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var src_app_api_controllers_Lookup__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/app/api/controllers/Lookup */ "./src/app/api/controllers/Lookup.ts");
/* harmony import */ var src_app_shared_services_shared_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/shared/services/shared.service */ "./src/app/shared/services/shared.service.ts");
...
let NatureOfWorkSetupComponent = class NatureOfWorkSetupComponent {
    ...
    getNatureOfWorklist() {
        ...
        this.lookupService.getLookupValueByLookupTypeId(params).subscribe((resp) => {
            if (resp.length > 0) {
            ...
            },
            {
                ...
                cellsrenderer: (row) => {
                    return '<div class="simple-actions">'
                        + '<a href="javascript:void(0)" class="mr-2" onClick="editNatureWork(' + row + ')"><i class="fa fa-pencil icon edit" aria-hidden="true"></i></a>'
                        + '<a href="javascript:void(0)" class="mr-2" onClick="deleteNatureWork(' + row + ')"><i class="fa fa-trash icon delete" aria-hidden="true"></i></a>'
                        + '</div>';
                },
                width: 120,
                renderer: columnrenderer
...
NatureOfWorkSetupComponent.ctorParameters = () => [
    { type: src_app_api_controllers_Lookup__WEBPACK_IMPORTED_MODULE_2__["LookupService"] },
    { type: src_app_shared_services_shared_service__WEBPACK_IMPORTED_MODULE_3__["SharedService"] },
    { type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Injector"] },
    { type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ChangeDetectorRef"] },
...
NatureOfWorkSetupComponent.propDecorators = {
    dataGrid: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"], args: ['dataGrid', { static: false },] }],
    form: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"], args: ['workForm',] }],
    OnDeleteNatureWork: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["HostListener"], args: ['window:OnDeleteNatureWork', ['$event.detail'],] }],
    onEditNatureWork: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["HostListener"], args: ['window:onEditNatureWork', ['$event.detail'],] }]
};
NatureOfWorkSetupComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-nature-of-work-setup',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./nature-of-work-setup.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/modules/common/work-permit/components/workpermit-setup/nature-of-work-setup/nature-of-work-setup.component.html")).default,
        encapsulation: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewEncapsulation"].None,
        animations: src_condo_animations__WEBPACK_IMPORTED_MODULE_9__["CondoAnimations"],
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./nature-of-work-setup.component.scss */ "./src/app/modules/common/work-permit/components/workpermit-setup/nature-of-work-setup/nature-of-work-setup.component.scss")).default]
    }),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [src_app_api_controllers_Lookup__WEBPACK_IMPORTED_MODULE_2__["LookupService"],
        src_app_shared_services_shared_service__WEBPACK_IMPORTED_MODULE_3__["SharedService"],
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["Injector"],
...
let WorkpermitSetupComponent = class WorkpermitSetupComponent {
    ...
    ngOnInit() {
        this.navArray = [
            { link: 'workpermit-type', name: 'WorkPermit Type' },
            { link: 'nature-of-work', name: 'Nature of Work' }
        ];
    }
};
...
WorkpermitSetupComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./workpermit-setup.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/modules/common/work-permit/components/workpermit-setup/workpermit-setup.component.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./workpermit-setup.component.scss */ "./src/app/modules/common/work-permit/components/workpermit-setup/workpermit-setup.component.scss")).default]
    }),
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "WorkpermitTypeSetupComponent", function() { return WorkpermitTypeSetupComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var src_app_api_controllers_Lookup__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/app/api/controllers/Lookup */ "./src/app/api/controllers/Lookup.ts");
/* harmony import */ var src_app_shared_services_shared_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/shared/services/shared.service */ "./src/app/shared/services/shared.service.ts");
    ...
    ngOnInit() {
        ...
        this.column = [
            ...
            },
            {
                ...
                cellsrenderer: (row) => {
                    return '<div class="simple-actions">'
                        + '<a href="javascript:void(0)" class="mr-2" onClick="editWorkPermit(' + row + ')"><i class="fa fa-pencil icon edit" aria-hidden="true"></i></a>'
                        + '<a href="javascript:void(0)" class="mr-2" onClick="deleteWorkPermit(' + row + ')"><i class="fa fa-trash icon delete" aria-hidden="true"></i></a>'
                        + '</div>';
                },
                width: 120,
                renderer: columnrenderer
...
WorkpermitTypeSetupComponent.ctorParameters = () => [
    { type: src_app_api_controllers_Lookup__WEBPACK_IMPORTED_MODULE_2__["LookupService"] },
    { type: src_app_shared_services_shared_service__WEBPACK_IMPORTED_MODULE_3__["SharedService"] },
    { type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Injector"] },
    { type: src_app_core_session_session_service__WEBPACK_IMPORTED_MODULE_7__["SessionService"] },
...
WorkpermitTypeSetupComponent.propDecorators = {
    dataGrid: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"], args: ['dataGrid', { static: false },] }],
    form: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"], args: ['workPermitForm',] }],
    onDeleteWorkPermit: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["HostListener"], args: ['window:onDeleteWorkPermit', ['$event.detail'],] }],
    onEditWorkPermit: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["HostListener"], args: ['window:onEditWorkPermit', ['$event.detail'],] }]
};
WorkpermitTypeSetupComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-workpermit-type-setup',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./workpermit-type-setup.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/modules/common/work-permit/components/workpermit-setup/workpermit-type-setup/workpermit-type-setup.component.html")).default,
        encapsulation: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewEncapsulation"].None,
        animations: src_condo_animations__WEBPACK_IMPORTED_MODULE_9__["CondoAnimations"],
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./workpermit-type-setup.component.scss */ "./src/app/modules/common/work-permit/components/workpermit-setup/workpermit-type-setup/workpermit-type-setup.component.scss")).default]
    }),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [src_app_api_controllers_Lookup__WEBPACK_IMPORTED_MODULE_2__["LookupService"],
        src_app_shared_services_shared_service__WEBPACK_IMPORTED_MODULE_3__["SharedService"],
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["Injector"],
...
let WorkpermitStatusComponent = class WorkpermitStatusComponent {
    constructor(dialogRef, data, lookupService, workPermitService, sessionService, sharedService) {
    ...
    onConfirm() {
        ...
        this.workPermitService.updateWorkPermitStatusById(params).subscribe((data) => {
            this.isDataSubmitted = false;
            if (data.message) {
                this.sharedService.openSnackBar('Workpermit Status Updated', 'success');
    ...
    ngOnInit() {
        ...
        this.lookupService.getLookupValueByLookupTypeId(statusParams).subscribe((res) => {
            if (res.length > 0) {
                this.statusTypeData = res.filter((status) => {
                    // Admin Side
...
WorkpermitStatusComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./workpermit-status.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/modules/common/work-permit/components/workpermit-status/workpermit-status.component.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./workpermit-status.component.scss */ "./src/app/modules/common/work-permit/components/workpermit-status/workpermit-status.component.scss")).default]
    }),
...
/* harmony import */ var _components_workpermit_setup_workpermit_setup_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/workpermit-setup/workpermit-setup.component */ "./src/app/modules/common/work-permit/components/workpermit-setup/workpermit-setup.component.ts");
/* harmony import */ var _components_workpermit_create_workpermit_create_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/workpermit-create/workpermit-create.component */ "./src/app/modules/common/work-permit/components/workpermit-create/workpermit-create.component.ts");
/* harmony import */ var _components_workpermit_setup_workpermit_type_setup_workpermit_type_setup_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/workpermit-setup/workpermit-type-setup/workpermit-type-setup.component */ "./src/app/modules/common/work-permit/components/workpermit-setup/workpermit-type-setup/workpermit-type-setup.component.ts");
...
const routes = [
    ...
    { path: ':type/:id', component: _components_workpermit_create_workpermit_create_component__WEBPACK_IMPORTED_MODULE_5__["WorkpermitCreateComponent"], canActivate: [src_app_core_auth_guards_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]] },
...
WorkPermitComponent.ctorParameters = () => [];
WorkPermitComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-work-permit',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./work-permit.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/modules/common/work-permit/work-permit.component.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./work-permit.component.scss */ "./src/app/modules/common/work-permit/work-permit.component.scss")).default]
    }),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [])
], WorkPermitComponent);
...
/* harmony import */ var _work_permit_routing_module__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./work-permit-routing.module */ "./src/app/modules/common/work-permit/work-permit-routing.module.ts");
...
/* harmony import */ var _work_permit_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./work-permit.component */ "./src/app/modules/common/work-permit/work-permit.component.ts");
/* harmony import */ var _components_workpermit_setup_workpermit_setup_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./components/workpermit-setup/workpermit-setup.component */ "./src/app/modules/common/work-permit/components/workpermit-setup/workpermit-setup.component.ts");
/* harmony import */ var _components_workpermit_create_workpermit_create_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./components/workpermit-create/workpermit-create.component */ "./src/app/modules/common/work-permit/components/workpermit-create/workpermit-create.component.ts");
/* harmony import */ var _components_workpermit_status_workpermit_status_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./components/workpermit-status/workpermit-status.component */ "./src/app/modules/common/work-permit/components/workpermit-status/workpermit-status.component.ts");
...
WorkPermitModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        declarations: [
            _work_permit_component__WEBPACK_IMPORTED_MODULE_7__["WorkPermitComponent"],
            _components_workpermit_setup_workpermit_setup_component__WEBPACK_IMPORTED_MODULE_8__["WorkpermitSetupComponent"],
...
//# sourceMappingURL=modules-common-work-permit-work-permit-module-es2015.js.map