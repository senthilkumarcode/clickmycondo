...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["parking-management-parking-management-module"], {
  ...
  function srcAppAmsParkingManagementComponentsParkingCreateParkingSlotParkingCreateParkingSlotComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [])], ParkingCreateParkingSlotComponent);
    /***/
  },
  ...
  function srcAppAmsParkingManagementComponentsParkingManageAllocatedSlotsParkingManageAllocatedSlotsComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [])], ParkingManageAllocatedSlotsComponent);
    /***/
  },
  ...
  function srcAppAmsParkingManagementComponentsParkingManageBookingParkingManageBookingComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [])], ParkingManageBookingComponent);
    /***/
  },
      ...
      _createClass(ParkingManageParkingSlotsComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.vehicleService.getParkingSlotByApartmentId(parseInt(this.cookieService.get('apartmentId'))).subscribe(function (res) {
            _this6.parkingSlotDataList = res.filter(function (item) {
              return item.isActive;
            });
            _this6.totalItems = _this6.parkingSlotDataList.length;
          ...
          this.apartmentService.getApartmentBlockUnitByApartmentId(parseInt(this.cookieService.get('apartmentId'))).subscribe(function (res) {
            _this6.apartmentBlockUnitDataList = res.filter(function (item) {
              return item.isActive;
            });
          }); //slot main type

          this.lookupService.getLookupValueByLookupTypeId(71).subscribe(function (res) {
            _this6.slotMainTypeDataList = res.filter(function (item) {
              return item.isActive;
            });
          }); //slot type

          this.lookupService.getLookupValueByLookupTypeId(18).subscribe(function (res) {
            _this6.slotTypeDataList = res.filter(function (item) {
              return item.isActive;
            });
            console.log(_this6.slotTypeDataList);
          }); //vehicle type
          ...
          this.sharedService.unitlistdeleteindexcast.subscribe(function (item) {
            if (item != null) {
              ...
              _this6.vehicleService.deleteParkingSlot(params).subscribe(function (res) {
                _this6.parkingSlotDataList = _this6.parkingSlotDataList.filter(function (type) {
      ...
      _createClass(ParkingManagementAllottedComponent, [{
        ...
        value: function showVehicleInfo(index) {
          ...
          this.vehicleService.getVehicleByVehicleId(vehicleId).subscribe(function (res) {
            ...
            var data = underscore__WEBPACK_IMPORTED_MODULE_10__["filter"](_this7.vehicleTypeData, function (item) {
            ...
            _this7.dialog.open(_this7.viewVehicleRef, {
              panelClass: 'material',
              disableClose: true,
              data: vehicleData
            });
        ...
        value: function showSelectedBlockSlots() {
          ...
          underscore__WEBPACK_IMPORTED_MODULE_10__["each"](this.allSlotsData, function (item, index) {
            ...
            if (_this8.apartmentBlockNumber == blockName) {
              _this8.allottedSlotListData.push(item);
            }

            _this8.totalUserItems = _this8.allottedSlotListData.length;

            if (_this8.totalUserItems > _this8.itemUserLimit) {
              _this8.ItemUserEndIndex = _this8.itemUserLimit;
            } else {
              _this8.ItemUserEndIndex = _this8.totalUserItems;
            }

            _this8.vehicleService.getAllVehiclesByApartmentBlockUnitId(item.apartmentBlockUnitId).subscribe(function (data) {
              if (data == undefined || data.length == 0) {
                _this8.allSlotsData[index].isVehicleAvailable = false;
              } else {
                _this8.allSlotsData[index].isVehicleAvailable = true;
                _this8.allSlotsData[index].vehicleId = data[0].vehicleId;
              }
            });
        ...
        value: function ngOnInit() {
          ...
          this.vehicleService.getParkingSlotByApartmentId(parseInt(this.cookieService.get('apartmentId'))).subscribe(function (res) {
            _this9.allSlotsData = res.filter(function (item) {
              return item.isActive;
            });
            underscore__WEBPACK_IMPORTED_MODULE_10__["each"](_this9.allSlotsData, function (item, index) {
              _this9.apartmentService.getApartmentBlockUnitById(item.apartmentBlockUnitId).subscribe(function (res) {
                _this9.allSlotsData[index].blockNo = res[0].apartmentBlockNumber;
                _this9.allSlotsData[index].unitNo = res[0].apartmentBlockUnitNumber;

                _this9.apartmentService.getAllApartmentBlockUnitUsersByApartmentBlockUnitId(item.apartmentBlockUnitId).subscribe(function (res) {
                  if (res == undefined || res.length == 0) {
                    return '';
                  } else {
                    var userId = res[0].userId;

                    _this9.userService.getUserById(userId).subscribe(function (res) {
                      _this9.allSlotsData[index].userName = res[0].firstName + ' ' + res[0].lastName;
                      ;
                    });
                  }
                });
  ...
  function srcAppAmsParkingManagementComponentsParkingManagementSettingsParkingAddSetupVehicleTypeParkingAddSetupVehicleTypeComponentTs(module, __webpack_exports__, __webpack_require__) {
        ...
        value: function submitAddVehicleForm(form) {
          ...
          if (this.type != 'edit') {
            ...
            this.lookupService.addLookupValue(details).subscribe(function (res) {
              if (res.message) {
                _this10.lookupService.getLookupValueByLookupTypeId(2).subscribe(function (res) {});
              } else {}
            });
          } else {
            var _details3 = {
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", Object)], ParkingAddSetupVehicleTypeComponent.prototype, "type", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", Object)], ParkingAddSetupVehicleTypeComponent.prototype, "vehicleId", void 0);
    ...
    function () {
      ...
      _createClass(ParkingManagementSettingsComponent, [{
        ...
        value: function ngOnInit() {
          ...
          //get vehcile type
          this.lookupService.getLookupValueByLookupTypeId(2).subscribe(function (res) {
            _this11.isVehicleDataLoaded = true;
            _this11.vehicleCategoryData = res.filter(function (item) {
              return item.isActive;
            });
          }); //get main slot type

          this.lookupService.getLookupValueByLookupTypeId(71).subscribe(function (res) {
            _this11.isSlotMainDataLoaded = true;
            _this11.slotMainCategoryData = res.filter(function (item) {
              return item.isActive;
            });
          }); //get slot type

          this.lookupService.getLookupValueByLookupTypeId(18).subscribe(function (res) {
            _this11.isSlotDataLoaded = true;
            _this11.slotCategoryData = res.filter(function (item) {
              return item.isActive;
            });
          });
        }
      ...
      _createClass(ParkingManagementSlotTypesComponent, [{
        ...
        value: function deleteSlotType(item, index) {
          ...
          this.lookupService.deleteLookupvalue(params).subscribe(function (res) {
            _this12.slotDataList.splice(index, 1);
        ...
        value: function ngOnInit() {
          ...
          this.lookupService.getLookupValueByLookupTypeId(2).subscribe(function (res) {
            _this13.slotDataList = res.filter(function (item) {
              return item.isActive;
            });
            _this13.totalItems = _this13.slotDataList.length;
          ...
          this.lookupService.getLookupValueByLookupTypeId(71).subscribe(function (res) {
            _this13.slotMainTypeDataList = res.filter(function (item) {
              return item.isActive;
            });
          });
        }
      ...
      _createClass(ParkingManagementVehicleTypesComponent, [{
        ...
        value: function submitAddvehicleTypeForm(form) {
          ...
          if (this.isVehicleTypeNew) {
            ...
            this.lookupService.addLookupValue(details).subscribe(function (res) {
              if (res.message) {
                _this14.lookupService.getLookupValueByLookupTypeId(2).subscribe(function (res) {
                  _this14.isVehicleTypeSubmitted = true;

                  _this14.sharedService.setAlertMessage("Vehicle Type added successfully");

                  _this14.vehicleDataList = res.filter(function (item) {
                    return item.isActive;
                  });
                });
              } else {
            ...
            this.lookupService.updateLookupValue(_details4).subscribe(function (res) {
              if (res.message) {
                _this14.lookupService.getLookupValueByLookupTypeId(2).subscribe(function (res) {
                  ...
                  _this14.sharedService.setAlertMessage("Vehicle Type updated successfully");
        ...
        value: function ngOnInit() {
          ...
          this.lookupService.getLookupValueByLookupTypeId(2).subscribe(function (res) {
            _this15.vehicleDataList = res.filter(function (item) {
              return item.isActive;
            });
            _this15.totalItems = _this15.vehicleDataList.length;
          ...
          this.sharedService.unitlistdeleteindexcast.subscribe(function (item) {
            if (item != null) {
              ...
              _this15.lookupService.deleteLookupvalue(params).subscribe(function (res) {
                _this15.vehicleDataList = _this15.vehicleDataList.filter(function (type) {
