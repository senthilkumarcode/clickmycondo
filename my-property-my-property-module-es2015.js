...
let PropertyConfigurationComponent = class PropertyConfigurationComponent {
    constructor(lookupService, router, cookieService) {
    ...
    sortSubCategory(menu) {
        ...
        this.categoryList.filter(key => {
            if (key.id == menu.id) {
                this.subMenuList = key.subCategory;
            }
        });
    }
    getRandomColor() {
    ...
    navigateProperty(menu) {
        if (menu.name == 'Assets') {
            ...
            this.selectedCategoryName = '';
            this.selectedSubCategoryName = '';
            let rootUrl = 'ams/my-property/property-configuration' + menu.url;
...
PropertyConfigurationComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [src_app_api_controllers_Lookup__WEBPACK_IMPORTED_MODULE_2__["LookupService"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"], ngx_cookie_service__WEBPACK_IMPORTED_MODULE_5__["CookieService"]])
