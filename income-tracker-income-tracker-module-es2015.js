...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<div class=\"income-tracker-setup-wrapper\">\n\t\n\t<div class=\"card\">\n\n\t\t<div class=\"card-header\">\n\t\t\t<div class=\"float-left\">\n    \t\t\t<h5>Settings</h5>\n    \t\t</div>\n    \t</div>\n\t\t\n\t\t<div class=\"card-body\">\n\n\t\t\t<app-alert-message [message]=\"errorMessage\" [isAlert]=\"isError\"></app-alert-message>\n\n\t\t\t<app-loader *ngIf=\"!isSettingsDataLoaded\"></app-loader>\n\n\t\t\t<ng-container *ngIf=\"isSettingsDataLoaded\">\n\n\t\t\t\t<form #incomeSettingsForm = \"ngForm\" name=\"incomeSettingsForm\" (ngSubmit)=\"submitIncomeSettingsForm(incomeSettingsForm)\"  novalidate>\n\t\t\t\t\t\n\t\t\t\t\t<div class=\"row\">\n\t\t\t\t\t\t\n\t\t\t\t\t\t<div class=\"col-sm-4\">\n\t\t\t\t\t\t\t<div class=\"select-box\">\n\t\t\t                    <label>Currency Type*</label>\n\t\t\t                    <select \n\t\t\t\t\t\t\t        name=\"currencyType\" \n\t\t\t\t\t\t\t        id=\"currencyType\" \n\t\t\t\t\t\t\t        class=\"form-control\"\n\t\t\t\t\t\t\t        [(ngModel)]=\"setting.currencyId\" required>\n\t\t\t\t\t\t\t        <option value=\"\" disabled selected hidden>Select</option>\n\t\t\t\t\t\t\t        <option *ngFor=\"let item of currencyTypeDataList\" [value]=\"item.lookupValueId\">{{ item.lookupValueName }}</option>\n\t\t\t\t\t\t\t    </select>\n\t                \t\t</div>\n\t\t\t\t\t\t</div>\n\n\t\t\t\t\t\t<div class=\"col-sm-4\">\n\t\t\t\t\t\t\t<div class=\"select-box\">\n\t\t\t                    <label>Customer Reconciliation Account*</label>\n\t\t\t                    <select \n\t\t\t\t\t\t\t        name=\"glAccount\" \n\t\t\t\t\t\t\t        id=\"glAccount\" \n\t\t\t\t\t\t\t        class=\"form-control\"\n\t\t\t\t\t\t\t        [(ngModel)]=\"setting.glAccountId\" required>\n\t\t\t\t\t\t\t        <option value=\"\" disabled selected hidden>Select</option>\n\t\t\t\t\t\t\t        <option *ngFor=\"let item of glAccountListData\" [value]=\"item.glaccountId\">{{ item.glaccountName }}</option>\n\t\t\t\t\t\t\t    </select>\n\t                \t\t</div>\n\t\t\t\t\t\t</div>\n\n\t\t\t\t\t\t<div class=\"col-sm-4\">\n\t\t\t\t\t\t\t<div class=\"select-box\">\n\t\t\t                    <label>Customer Income Payment Term*</label>\n\t\t\t                    <select \n\t\t\t\t\t\t\t        name=\"paymentTerm\" \n\t\t\t\t\t\t\t        id=\"paymentTerm\" \n\t\t\t\t\t\t\t        class=\"form-control\"\n\t\t\t\t\t\t\t        [(ngModel)]=\"setting.paymentTerm\" required>\n\t\t\t\t\t\t\t        <option value=\"\" disabled selected hidden>Select</option>\n\t\t\t\t\t\t\t        <option *ngFor=\"let item of paymentInvoiceDataList\" [value]=\"item.lookupValueId\">{{ item.lookupValueName }}</option>\n\t\t\t\t\t\t\t    </select>\n\t                \t\t</div>\n\t\t\t\t\t\t</div>\n\n\t\t\t\t\t\t<div class=\"col-sm-4\">\n\t\t\t\t\t\t\t<div class=\"select-box\">\n\t\t\t                    <label>Customer Invoice VAT %*</label>\n\t\t\t                    <select \n\t\t\t\t\t\t\t        name=\"paymentTerm\" \n\t\t\t\t\t\t\t        id=\"paymentTerm\" \n\t\t\t\t\t\t\t        class=\"form-control\"\n\t\t\t\t\t\t\t        [(ngModel)]=\"setting.vatPercentage\" required>\n\t\t\t\t\t\t\t        <option value=\"\" disabled selected hidden>Select</option>\n\t\t\t\t\t\t\t        <option *ngFor=\"let item of vatPecentageDataList\" [value]=\"item.lookupValueId\">{{ item.lookupValueName }}</option>\n\t\t\t\t\t\t\t    </select>\n\t                \t\t</div>\n\t\t\t\t\t\t</div>\n\n\t\t\t\t\t</div>\n\n\t\t\t\t\t<div class=\"row\">\n\t\t\t\t\t\t<div class=\"col-sm-12\">\n\t\t\t\t\t\t\t<ul class=\"list-inline float-right mt-4\">\n\t\t\t\t\t\t\t\t<li class=\"list-inline-item\">\n\t\t\t\t\t\t\t\t\t<button class=\"btn blue mr-2\" [disabled]=\"incomeSettingsForm.invalid\">Save</button>\n\t\t\t\t\t\t\t\t</li>\n\t\t\t\t\t\t\t</ul>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t</div>\n\n\n\t\t\t\t</form>\n\n\t\t\t</ng-container>\n\n\n\t\t</div>\n\n\t</div>\n\n\t<div class=\"card mt-30\">\n\n\t\t<div class=\"card-header\">\n\t\t\t<div class=\"float-left\">\n    \t\t\t<h5>Customer Penalty</h5>\n    \t\t</div>\n    \t</div>\n\n    \t<div class=\"card-body\">\n\n\t\t\t<app-alert-message [message]=\"errorMessage\" [isAlert]=\"isError\"></app-alert-message>\n\n\t\t\t<app-loader *ngIf=\"!isPenaltyDataLoaded\"></app-loader>\n\n\t\t\t<ng-container *ngIf=\"isPenaltyDataLoaded\">\n\n\t\t\t\t<form #incomePenaltySettingsForm = \"ngForm\" name=\"incomePenaltySettingsForm\" (ngSubmit)=\"submitIncomePenaltySettingsForm(incomePenaltySettingsForm)\"  novalidate>\n\t\t\t\t\t\n\t\t\t\t\t<div class=\"row\">\n\t\t\t\t\t\t\n\t\t\t\t\t\t<div class=\"col-sm-4\">\n\t\t\t\t\t\t\t<div class=\"select-box\">\n\t\t\t                    <label>Type*</label>\n\t\t\t                    <select \n\t\t\t\t\t\t\t        name=\"penaltyType\" \n\t\t\t\t\t\t\t        id=\"penaltyType\" \n\t\t\t\t\t\t\t        class=\"form-control\"\n\t\t\t\t\t\t\t        [(ngModel)]=\"penalty.penaltyTypeId\" required>\n\t\t\t\t\t\t\t        <option value=\"\" disabled selected hidden>Select</option>\n\t\t\t\t\t\t\t        <option *ngFor=\"let item of penaltyDataList\" [value]=\"item.lookupValueId\">{{ item.lookupValueName }}</option>\n\t\t\t\t\t\t\t    </select>\n\t                \t\t</div>\n\t\t\t\t\t\t</div>\n\n\t\t\t\t\t\t<div class=\"col-sm-4\">\n\t\t\t\t\t\t\t<div class=\"select-box\">\n\t\t\t                    <label>Flat rate for Late payment*</label>\n\t\t\t                    <select \n\t\t\t\t\t\t\t        name=\"latePayment\" \n\t\t\t\t\t\t\t        id=\"latePayment\" \n\t\t\t\t\t\t\t        class=\"form-control\"\n\t\t\t\t\t\t\t        [(ngModel)]=\"penalty.latePaymentId\" required>\n\t\t\t\t\t\t\t        <option value=\"\" disabled selected hidden>Select</option>\n\t\t\t\t\t\t\t        <option *ngFor=\"let item of lastPaymentDataList\" [value]=\"item.lookupValueId\">{{ item.lookupValueName }}</option>\n\t\t\t\t\t\t\t    </select>\n\t                \t\t</div>\n\t\t\t\t\t\t</div>\n\n\t\t\t\t\t\t<div class=\"col-sm-4\">\n\t\t\t\t\t\t\t<div class=\"select-box\">\n\t\t\t                    <label>% Penalty*</label>\n\t\t\t                    <select \n\t\t\t\t\t\t\t        name=\"penaltyPercentage\" \n\t\t\t\t\t\t\t        id=\"penaltyPercentage\" \n\t\t\t\t\t\t\t        class=\"form-control\"\n\t\t\t\t\t\t\t        [(ngModel)]=\"penalty.penaltyPercentage\" required>\n\t\t\t\t\t\t\t        <option value=\"\" disabled selected hidden>Select</option>\n\t\t\t\t\t\t\t        <option *ngFor=\"let item of penaltyPercentageDataList\" [value]=\"item.lookupValueId\">{{ item.lookupValueName }}</option>\n\t\t\t\t\t\t\t    </select>\n\t                \t\t</div>\n\t\t\t\t\t\t</div>\n\n\t\t\t\t\t\t<div class=\"col-sm-4\">\n\t\t\t\t\t\t\t<div class=\"select-box\">\n\t\t\t                    <label>Grace Period for Invoice*</label>\n\t\t\t                    <select \n\t\t\t\t\t\t\t        name=\"gracePeriodInvoice\" \n\t\t\t\t\t\t\t        id=\"gracePeriodInvoice\" \n\t\t\t\t\t\t\t        class=\"form-control\"\n\t\t\t\t\t\t\t        [(ngModel)]=\"penalty.gracePeriodInvoiceId\" required>\n\t\t\t\t\t\t\t        <option value=\"\" disabled selected hidden>Select</option>\n\t\t\t\t\t\t\t        <option *ngFor=\"let item of gracePeriodInvoiceDataList\" [value]=\"item.lookupValueId\">{{ item.lookupValueName }}</option>\n\t\t\t\t\t\t\t    </select>\n\t                \t\t</div>\n\t\t\t\t\t\t</div>\n\n\n\t\t\t\t\t</div>\n\n\t\t\t\t\t<div class=\"row\">\n\t\t\t\t\t\t<div class=\"col-sm-12\">\n\t\t\t\t\t\t\t<ul class=\"list-inline float-right mt-4\">\n\t\t\t\t\t\t\t\t<li class=\"list-inline-item\">\n\t\t\t\t\t\t\t\t\t<button class=\"btn blue mr-2\" [disabled]=\"incomePenaltySettingsForm.invalid\">Save</button>\n\t\t\t\t\t\t\t\t</li>\n\t\t\t\t\t\t\t</ul>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t</div>\n\n\t\t\t\t</form>\n\n\t\t\t</ng-container>\n\n\t\t</div>\n\n    </div>\n\n</div>\n");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("form {\n  display: contents;\n}\nform .input-box, form .select-box {\n  margin: 0;\n}\nform .input-box input[readonly] {\n  background-color: #f9f9f9;\n}\nform .input-box input[readonly]:-webkit-autofill {\n  -webkit-box-shadow: 0 0 0px 1000px #e6e6e6 inset;\n  -webkit-text-fill-color: #e6e6e6;\n}\nform .input-box textarea {\n  height: auto !important;\n  border: none;\n  padding: 0;\n}\nform .input-box textarea:focus {\n  border: none !important;\n}\n.heads {\n  padding: 12px 14px;\n  display: table-cell;\n  border: none;\n  border-right: 1px solid #dee2e6;\n  border-top: 1px solid #dee2e6;\n}\n.heads:last-child {\n  border-right: none;\n  padding: 12px 0;\n}\n.float-close {\n  width: 23px;\n  height: 23px;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  border-radius: 23px !important;\n  background-color: #5cd694;\n  cursor: pointer;\n  display: inline-block;\n  margin: 9px 4px;\n  line-height: 20px;\n}\n.float-close.disabled {\n  background-color: #c5c6c7;\n  pointer-events: none;\n}\n.float-close.disabled .icon {\n  color: #e6e6e6;\n}\n.float-close.delete {\n  background-color: #ea7962;\n}\n.float-close.valid {\n  background-color: #389583;\n}\n.float-close .icon {\n  cursor: pointer;\n  width: 13px;\n  color: #ffffff;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
let IncomePostMultiInvoiceFieldsComponent = class IncomePostMultiInvoiceFieldsComponent {
    constructor(cd, router, route, accountsService, sharedService, lookupService, cookieService) {
        ...
        this.invoiceGLAccountsDataSub = new rxjs__WEBPACK_IMPORTED_MODULE_3__["BehaviorSubject"](null);
    }
    deleteBlock() {
    ...
    onVatChange(event, index) {
        if (event != null) {
            ...
            var percent = parseInt(event.lookupValueName) / 100;
            if (event.lookupValueName == "12.5") {
    ...
    ngOnInit() {
        ...
        this.lookupService.getLookupValueByLookupTypeId(88).subscribe((res) => {
            this.curTypeDataList = res;
        });
        this.invoiceGLAccountsDataSub = this.invoiceGLAccountsData;
        this.invoiceGLAccountsDataSub.subscribe((data) => {
            console.log(data);
        });
    }
    ngOnChanges(changes) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".income-post-invoice-wrapper .add-invoice-block {\n  padding: 10px 0;\n  border-bottom: 1px solid #dee2e6;\n}\n.income-post-invoice-wrapper .invoice-table {\n  display: table;\n  width: 100% !important;\n}\n.income-post-invoice-wrapper .invoice-header {\n  display: table-row;\n}\n.income-post-invoice-wrapper .invoice-header .heads {\n  font-family: \"Lato\", sans-serif;\n  font-weight: 700;\n  letter-spacing: 0.3px;\n  -webkit-font-smoothing: antialiased;\n  -moz-osx-font-smoothing: grayscale;\n  text-rendering: optimizeLegibility;\n  font-size: 1.2rem;\n  color: #373946;\n  text-transform: uppercase;\n  border: none;\n  border-right: 1px solid #dee2e6;\n  padding: 12px 14px;\n  display: table-cell;\n}\n.income-post-invoice-wrapper .invoice-fields {\n  display: table-row;\n}\n.income-post-invoice-wrapper .add-invoice-box {\n  padding: 12px 0 6px 10px;\n  border-top: 1px solid #eaeaea;\n  overflow: auto;\n}\n.income-post-invoice-wrapper .add-invoice-box .icon {\n  color: #373946;\n  width: 18px;\n  position: relative;\n  top: -2px;\n}\n.income-post-invoice-wrapper .add-invoice-box span {\n  font-family: \"Montserrat\", sans-serif;\n  font-weight: 500;\n  letter-spacing: 0.2px;\n  color: #585858;\n  margin: 0 0 0 6px;\n  font-size: 1.4rem;\n}\n.income-post-invoice-wrapper .add-invoice-box .add-invoice-link {\n  cursor: pointer;\n}\n.income-post-invoice-wrapper .add-invoice-box .add-invoice-link:hover span, .income-post-invoice-wrapper .add-invoice-box .add-invoice-link:hover .icon {\n  color: #54b941;\n}\n.income-post-invoice-wrapper .total-box {\n  padding: 15px 14px;\n  background-color: #f9f9f9;\n  text-align: right;\n}\n.income-post-invoice-wrapper .total-box p {\n  font-family: \"Montserrat\", sans-serif;\n  font-weight: 400;\n  letter-spacing: 0.3px;\n  -webkit-font-smoothing: inherit;\n  -moz-osx-font-smoothing: inherit;\n  margin: 0 0 6px 0 !important;\n  font-size: 1.4rem;\n}\n.income-post-invoice-wrapper .total-box.final p {\n  font-family: \"Montserrat\", sans-serif;\n  font-weight: 500;\n  letter-spacing: 0.2px;\n  margin: 10px 0 6px 0;\n  font-size: 1.6rem;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
let IncomePostMultiInvoiceComponent = class IncomePostMultiInvoiceComponent {
    ...
    getFieldParams(event) {
        ...
        this.vatTypeDataList[0].custVatTypeAmount = 0;
        this.vatTypeDataList[1].custVatTypeAmount = 0;
        underscore__WEBPACK_IMPORTED_MODULE_7__["each"](this.invoiceGLAccountsArray, item => {
            if (item.form) {
                this.isFormInValid = false;
            }
            ...
            this.vatTypeDataList[0].custVatTypeAmount = this.vatTypeDataList[0].custVatTypeAmount + parseInt(item.tax1Amount);
            this.vatTypeDataList[1].custVatTypeAmount = this.vatTypeDataList[1].custVatTypeAmount + parseInt(item.tax2Amount);
        });
    }
    ...
    ngOnInit() {
        ...
        //for single invoice
        if (this.route.params['value'].type == 'single') {
...
let IncomeSubLedgerComponent = class IncomeSubLedgerComponent {
    constructor(injector, dialog, apartmentService, accountsService, sharedService, cookieService) {
        ...
        this.ItemStartIndex = 0;
        this.itemLimit = 10;
        this.unitFieldType = "primayContact";
        this.unitOrder = true;
        this.isMobile = false;
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".income-tracker-ageing-wrapper .filter-box {\n  margin: 30px 0 0 0;\n  padding: 0;\n  border: 0;\n}\n.income-tracker-ageing-wrapper .filter-box li {\n  border-right: 1px solid #eaeaea;\n  margin: 0;\n  padding: 10px 20px;\n  cursor: pointer;\n}\n.income-tracker-ageing-wrapper .filter-box li p {\n  font-family: \"Montserrat\", sans-serif;\n  font-weight: 400;\n  letter-spacing: 0.3px;\n  -webkit-font-smoothing: inherit;\n  -moz-osx-font-smoothing: inherit;\n  font-size: 1.4rem;\n  color: #585858;\n}\n.income-tracker-ageing-wrapper .filter-box li.title {\n  cursor: auto;\n}\n.income-tracker-ageing-wrapper .filter-box li.title p {\n  color: #8391a1 !important;\n}\n.income-tracker-ageing-wrapper .filter-box li.title p .icon {\n  width: 18px;\n  height: 18px;\n}\n.income-tracker-ageing-wrapper .filter-box li:not(.title):hover, .income-tracker-ageing-wrapper .filter-box li.active {\n  background-color: #5cd694;\n}\n.income-tracker-ageing-wrapper .filter-box li:not(.title):hover p, .income-tracker-ageing-wrapper .filter-box li.active p {\n  color: #ffffff;\n}\n.income-tracker-ageing-wrapper .account-chart-card {\n  margin: 30px 0;\n}\n.income-tracker-ageing-wrapper .account-chart-card .chart-box {\n  margin: 10px 0;\n  height: auto;\n  width: 300px;\n  float: left;\n}\n@media (min-width: 576px) and (max-width: 767px) {\n  .income-tracker-ageing-wrapper .account-chart-card .chart-box {\n    width: 235px;\n  }\n}\n@media (max-width: 576px) {\n  .income-tracker-ageing-wrapper .account-chart-card .chart-box {\n    float: none;\n    width: auto;\n  }\n}\n.income-tracker-ageing-wrapper .account-chart-card .chart-box canvas {\n  width: auto !important;\n  height: 100% !important;\n}\n.income-tracker-ageing-wrapper .account-chart-card .chart-box.hide-chart {\n  overflow: hidden;\n  visibility: hidden;\n}\n.income-tracker-ageing-wrapper .account-chart-card .legends-list {\n  margin: 10px 0 0 0 !important;\n  text-align: center;\n}\n@media (max-width: 576px) {\n  .income-tracker-ageing-wrapper .account-chart-card .legends-list {\n    text-align: left;\n    display: inline-block;\n    transform: translateX(-45%) !important;\n    position: relative;\n    left: 50%;\n  }\n}\n.income-tracker-ageing-wrapper .account-chart-card .legends-list li {\n  list-style: none;\n  margin: 0 !important;\n  padding: 8px 0;\n  overflow: auto;\n  width: 250px;\n}\n.income-tracker-ageing-wrapper .account-chart-card .legends-list li div {\n  font-family: \"Montserrat\", sans-serif;\n  font-weight: 500;\n  letter-spacing: 0.2px;\n  font-size: 1.4rem;\n  color: #8391a1;\n}\n.income-tracker-ageing-wrapper .account-chart-card .legends-list li div.title {\n  color: #373946;\n  float: left;\n  min-width: 180px !important;\n}\n@media (min-width: 576px) {\n  .income-tracker-ageing-wrapper .account-chart-card .legends-list li div.title {\n    min-width: auto !important;\n  }\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
let IncomeTrackerReportsComponent = class IncomeTrackerReportsComponent {
    ...
    ngOnInit() {
        this.reportsDataList = [
            { name: 'Customer Journal Report', type: 'customer' },
            { name: 'Vendor Journal Entires', type: 'vendor' }
        ];
    }
};
...
let IncomeTrackerSetupComponent = class IncomeTrackerSetupComponent {
    ...
    ngOnInit() {
        ...
        this.setting.glAccountId = "";
        this.setting.paymentTerm = "";
        this.setting.vatPercentage = "";
        this.penalty = {};
        this.penalty.penaltyTypeId = "";
        this.penalty.latePaymentId = "";
        this.penalty.penaltyPercentage = "";
        this.penalty.gracePeriodInvoiceId = "";
        //currency type
        this.lookupService.getLookupValueByLookupTypeId(88).subscribe((res) => {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".income-view-invoice-history-wrapper .slideup {\n  visibility: hidden;\n  height: 25px;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
let IncomeViewInvoiceComponent = class IncomeViewInvoiceComponent {
    ...
    getUserName(invoice, id) {
        ...
        if (data === undefined || data.length == 0) {
            ...
            this.invoiceDataList.map(obj => {
                if (obj.custInvoiceId == invoice.custInvoiceId) {
                    obj.postedByName = data[0].firstName + ' ' + data[0].lastName;
                }
            });
            return data[0].firstName + ' ' + data[0].lastName;
        }
    }
    getAccountName(invoice, account) {
        var accountDetails = {
            glaccountId: 0
        };
        if (account == undefined || account.length == 0) {
        ...
        if (data === undefined || data.length == 0) {
            ...
            this.invoiceDataList.map(obj => {
                if (obj.custInvoiceId == invoice.custInvoiceId) {
                    obj.glaccountName = data[0].glaccountName;
                }
            });
            return data[0].glaccountName;
        }
    ...
    getInvoiceDate(invoice, date) {
        this.invoiceDataList.map(obj => {
            if (obj.custInvoiceId == invoice.custInvoiceId) {
                obj.postedOn = moment__WEBPACK_IMPORTED_MODULE_8__(date).format("DD/MM/YYYY");
            }
        });
        return moment__WEBPACK_IMPORTED_MODULE_8__(date).format("DD/MM/YYYY");
    }
...
/* harmony import */ var _components_income_tracker_reports_income_tracker_reports_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./components/income-tracker-reports/income-tracker-reports.component */ "./src/app/ams/income-tracker/components/income-tracker-reports/income-tracker-reports.component.ts");
/* harmony import */ var _components_income_tracker_setup_income_tracker_setup_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./components/income-tracker-setup/income-tracker-setup.component */ "./src/app/ams/income-tracker/components/income-tracker-setup/income-tracker-setup.component.ts");
/* harmony import */ var _components_income_tracker_reports_income_tracker_reports_customer_income_tracker_reports_customer_component__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./components/income-tracker-reports/income-tracker-reports-customer/income-tracker-reports-customer.component */ "./src/app/ams/income-tracker/components/income-tracker-reports/income-tracker-reports-customer/income-tracker-reports-customer.component.ts");
/* harmony import */ var _components_income_tracker_reports_income_tracker_reports_vendor_income_tracker_reports_vendor_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./components/income-tracker-reports/income-tracker-reports-vendor/income-tracker-reports-vendor.component */ "./src/app/ams/income-tracker/components/income-tracker-reports/income-tracker-reports-vendor/income-tracker-reports-vendor.component.ts");
...
const routes = [
    ...
    { path: 'settings', component: _components_income_tracker_setup_income_tracker_setup_component__WEBPACK_IMPORTED_MODULE_15__["IncomeTrackerSetupComponent"] },
    ...
    { path: 'reports', component: _components_income_tracker_reports_income_tracker_reports_component__WEBPACK_IMPORTED_MODULE_14__["IncomeTrackerReportsComponent"] },
    { path: 'reports/customer', component: _components_income_tracker_reports_income_tracker_reports_customer_income_tracker_reports_customer_component__WEBPACK_IMPORTED_MODULE_16__["IncomeTrackerReportsCustomerComponent"] },
    { path: 'reports/vendor', component: _components_income_tracker_reports_income_tracker_reports_vendor_income_tracker_reports_vendor_component__WEBPACK_IMPORTED_MODULE_17__["IncomeTrackerReportsVendorComponent"] },
    { path: '**', redirectTo: 'subledger', pathMatch: 'full' }
];
