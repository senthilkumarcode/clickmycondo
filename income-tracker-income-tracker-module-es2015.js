...
let IncomePostInvoiceComponent = class IncomePostInvoiceComponent {
    constructor(router, route, accountsService, userService, apartmentService, sharedService, lookupService, cookieService) {
        this.router = router;
        this.route = route;
        this.accountsService = accountsService;
        this.userService = userService;
    ...
    ngOnInit() {
        ...
        if (this.route.params['value'].id != undefined && this.route.params['value'].type == undefined) {
            ...
            this.userService.getAllUsersByApartmentId(userListParams).subscribe((res) => {
                ...
                this.apartmentService.getAllApartmentBlockUnitUsersByApartmentBlockUnitId(this.apartmentBlockUnitId).subscribe((res) => {
                    var data = underscore__WEBPACK_IMPORTED_MODULE_9__["filter"](this.userDataList, item => {
        ...
        this.lookupService.getLookupValueByLookupTypeId(vatListParams).subscribe((res) => {
            ...
            this.invoice.vatPercent = parseFloat(this.vatTypeDataList[0].lookupValueName);
        });
        let disListParams = {
            LookupTypeId: 75
        };
        ...
        this.lookupService.getLookupValueByLookupTypeId(disListParams).subscribe((res) => {
            ...
            this.invoice.discount = parseFloat(this.discountTypeDataList[0].lookupValueName);
        });
    }
};
...
IncomePostInvoiceComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-income-post-invoice',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./income-post-invoice.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/ams/income-tracker/components/income-post-invoice/income-post-invoice.component.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./income-post-invoice.component.scss */ "./src/app/ams/income-tracker/components/income-post-invoice/income-post-invoice.component.scss")).default]
    }),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"],
        _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("form {\n  display: contents;\n}\nform .input-box, form .select-box {\n  margin: 0;\n}\nform .input-box input[readonly] {\n  background-color: #f9f9f9;\n}\nform .input-box input[readonly]:-webkit-autofill {\n  -webkit-box-shadow: 0 0 0px 1000px #e6e6e6 inset;\n  -webkit-text-fill-color: #e6e6e6;\n}\nform .input-box ::ng-deep input {\n  height: 34px !important;\n}\nform .input-box ::ng-deep .select-list-dropdown {\n  min-width: 100px;\n}\nform .input-box textarea {\n  height: auto !important;\n  border: none;\n  padding: 0;\n}\nform .input-box textarea:focus {\n  border: none !important;\n}\nform .account-name-box ::ng-deep input {\n  padding: 0;\n  width: 180px;\n  overflow: hidden;\n  text-overflow: ellipsis;\n}\nform .discount-box ::ng-deep .clear-filter {\n  z-index: 1000;\n  position: relative;\n  top: -24px;\n  right: -15px;\n}\n.heads {\n  padding: 0 14px;\n  display: table-cell;\n  border: none;\n  border-right: 1px solid #dee2e6;\n  border-top: 1px solid #dee2e6;\n}\n.heads:last-child {\n  border-right: none;\n  padding: 12px 0;\n}\n.heads.deselect {\n  background-color: #f0f3f3;\n}\n.heads.deselect .select-group[_ngcontent-iqr-c297] .simple-select[_ngcontent-iqr-c297] + .select-arrow.down[_ngcontent-iqr-c297]:before {\n  color: #8e8e8e !important;\n}\n.heads p {\n  font-size: 1.4rem;\n  color: #373946;\n}\n.float-close {\n  width: 23px;\n  height: 23px;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  border-radius: 23px !important;\n  background-color: #5cd694;\n  cursor: pointer;\n  display: inline-block;\n  margin: 9px 4px;\n  line-height: 20px;\n}\n.float-close.disabled {\n  background-color: #f0f3f3 !important;\n  pointer-events: none;\n}\n.float-close.disabled .icon {\n  color: #e6e6e6;\n}\n.float-close.delete {\n  background-color: #ea7962;\n}\n.float-close.valid {\n  background-color: #389583;\n}\n.float-close .icon {\n  cursor: pointer;\n  width: 13px;\n  color: #ffffff;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".income-post-invoice-wrapper .add-invoice-block {\n  padding: 10px 0;\n  border-bottom: 1px solid #dee2e6;\n}\n.income-post-invoice-wrapper .invoice-table {\n  /*display: table;*/\n  width: 100% !important;\n  overflow: scroll;\n  float: left;\n}\n.income-post-invoice-wrapper .invoice-header {\n  display: table-row;\n}\n.income-post-invoice-wrapper .invoice-header .heads {\n  font-family: \"Lato\", sans-serif;\n  font-weight: 400;\n  letter-spacing: 0.3px;\n  -webkit-font-smoothing: inherit;\n  -moz-osx-font-smoothing: inherit;\n  font-size: 1.2rem;\n  color: #373946;\n  text-transform: uppercase;\n  border: none;\n  border-right: 1px solid #dee2e6;\n  padding: 10px 14px;\n  display: table-cell;\n}\n.income-post-invoice-wrapper .invoice-fields {\n  display: table-row;\n  overflow: visible;\n}\n.income-post-invoice-wrapper .add-invoice-box {\n  padding: 12px 0 6px 10px;\n  border-top: 1px solid #eaeaea;\n  overflow: auto;\n}\n.income-post-invoice-wrapper .add-invoice-box .icon {\n  color: #373946;\n  width: 18px;\n  position: relative;\n  top: -2px;\n}\n.income-post-invoice-wrapper .add-invoice-box span {\n  font-family: \"Montserrat\", sans-serif;\n  font-weight: 500;\n  letter-spacing: 0.2px;\n  color: #585858;\n  margin: 0 0 0 6px;\n  font-size: 1.4rem;\n}\n.income-post-invoice-wrapper .add-invoice-box .add-invoice-link {\n  cursor: pointer;\n}\n.income-post-invoice-wrapper .add-invoice-box .add-invoice-link:hover span, .income-post-invoice-wrapper .add-invoice-box .add-invoice-link:hover .icon {\n  color: #54b941;\n}\n.income-post-invoice-wrapper .total-box {\n  padding: 15px 14px;\n}\n.income-post-invoice-wrapper .total-box p {\n  font-family: \"Montserrat\", sans-serif;\n  font-weight: 400;\n  letter-spacing: 0.3px;\n  -webkit-font-smoothing: inherit;\n  -moz-osx-font-smoothing: inherit;\n  margin: 8px 0 !important;\n  font-size: 1.3rem;\n}\n.income-post-invoice-wrapper .total-box.final p {\n  font-family: \"Montserrat\", sans-serif;\n  font-weight: 500;\n  letter-spacing: 0.2px;\n  margin: 0 !important;\n  font-size: 1.4rem;\n}\n.income-post-invoice-wrapper .total-box .discount-input input {\n  width: 100px;\n}\n.income-post-invoice-wrapper .total-box .discount-box ::ng-deep input {\n  width: 100px;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".income-tracker-ageing-wrapper .filter-box {\n  margin: 30px 0 0 0;\n  padding: 0;\n  border: 0;\n}\n.income-tracker-ageing-wrapper .filter-box li {\n  border-right: 1px solid #eaeaea;\n  margin: 0;\n  padding: 10px 20px;\n  cursor: pointer;\n}\n.income-tracker-ageing-wrapper .filter-box li p {\n  font-family: \"Montserrat\", sans-serif;\n  font-weight: 400;\n  letter-spacing: 0.3px;\n  -webkit-font-smoothing: inherit;\n  -moz-osx-font-smoothing: inherit;\n  font-size: 1.4rem;\n  color: #585858;\n}\n.income-tracker-ageing-wrapper .filter-box li.title {\n  cursor: auto;\n}\n.income-tracker-ageing-wrapper .filter-box li.title p {\n  color: #8391a1 !important;\n}\n.income-tracker-ageing-wrapper .filter-box li.title p .icon {\n  width: 18px;\n  height: 18px;\n}\n.income-tracker-ageing-wrapper .filter-box li:not(.title):hover, .income-tracker-ageing-wrapper .filter-box li.active {\n  background-color: #5cd694;\n}\n.income-tracker-ageing-wrapper .filter-box li:not(.title):hover p, .income-tracker-ageing-wrapper .filter-box li.active p {\n  color: #ffffff;\n}\n.income-tracker-ageing-wrapper .account-chart-card {\n  margin: 30px 0;\n}\n.income-tracker-ageing-wrapper .account-chart-card .chart-box {\n  margin: 10px 0;\n  height: auto;\n  width: 300px;\n  float: left;\n}\n@media (min-width: 576px) and (max-width: 767px) {\n  .income-tracker-ageing-wrapper .account-chart-card .chart-box {\n    width: 235px;\n  }\n}\n@media (max-width: 576px) {\n  .income-tracker-ageing-wrapper .account-chart-card .chart-box {\n    float: none;\n    width: auto;\n  }\n}\n.income-tracker-ageing-wrapper .account-chart-card .chart-box canvas {\n  width: auto !important;\n  height: 100% !important;\n}\n.income-tracker-ageing-wrapper .account-chart-card .chart-box.hide-chart {\n  overflow: hidden;\n  visibility: hidden;\n}\n.income-tracker-ageing-wrapper .account-chart-card .legends-list {\n  margin: 10px 0 0 0 !important;\n  text-align: center;\n}\n@media (max-width: 576px) {\n  .income-tracker-ageing-wrapper .account-chart-card .legends-list {\n    text-align: left;\n    display: inline-block;\n    transform: translateX(-45%) !important;\n    position: relative;\n    left: 50%;\n  }\n}\n.income-tracker-ageing-wrapper .account-chart-card .legends-list li {\n  list-style: none;\n  margin: 0 !important;\n  padding: 8px 0;\n  overflow: auto;\n  width: 250px;\n}\n.income-tracker-ageing-wrapper .account-chart-card .legends-list li div {\n  font-family: \"Montserrat\", sans-serif;\n  font-weight: 500;\n  letter-spacing: 0.2px;\n  font-size: 1.4rem;\n  color: #8391a1;\n}\n.income-tracker-ageing-wrapper .account-chart-card .legends-list li div.title {\n  color: #373946;\n  float: left;\n  min-width: 180px !important;\n}\n@media (min-width: 576px) {\n  .income-tracker-ageing-wrapper .account-chart-card .legends-list li div.title {\n    min-width: auto !important;\n  }\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
let IncomeTrackerSetupComponent = class IncomeTrackerSetupComponent {
    ...
    ngOnInit() {
        ...
        let invoiceListParams = {
            LookupTypeId: 88
        };
        //payment term
        this.lookupService.getLookupValueByLookupTypeId(invoiceListParams).subscribe((res) => {
            this.paymentInvoiceDataList = res.filter(item => {
                return item.isActive;
            });
        });
        let vatListParams = {
        ...
        let penalityListParams = {
            LookupTypeId: 80
        };
        //penalty
        this.lookupService.getLookupValueByLookupTypeId(penalityListParams).subscribe((res) => {
            this.penaltyDataList = res.filter(item => {
                return item.isActive;
            });
        });
        let lateListParams = {
        ...
        //late payment
        this.lookupService.getLookupValueByLookupTypeId(lateListParams).subscribe((res) => {
            this.lastPaymentDataList = res.filter(item => {
                return item.isActive;
            });
        });
        let penalityParams = {
        ...
        //% Penalty percentage
        this.lookupService.getLookupValueByLookupTypeId(penalityParams).subscribe((res) => {
            this.penaltyPercentageDataList = res.filter(item => {
                return item.isActive;
            });
        });
        let graceListParams = {
        ...
        this.lookupService.getLookupValueByLookupTypeId(graceListParams).subscribe((res) => {
            this.gracePeriodInvoiceDataList = res.filter(item => {
                return item.isActive;
            });
        });
    }
...
IncomeTrackerSetupComponent.ctorParameters = () => [
    { type: src_app_api_controllers_Accounts__WEBPACK_IMPORTED_MODULE_2__["AccountsService"] },
...
let IncomeViewCreditComponent = class IncomeViewCreditComponent {
    constructor(dialog, userService, apartmentService, accountsService, sharedService, cookieService) {
        this.dialog = dialog;
        this.userService = userService;
        this.apartmentService = apartmentService;
        this.accountsService = accountsService;
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("::ng-deep .material .mat-dialog-container {\n  width: 800px;\n  height: 500px;\n  overflow: auto;\n}\n::ng-deep .material .mat-dialog-container .info-modal-box h5 {\n  font-family: \"Montserrat\", sans-serif;\n  font-weight: 500;\n  letter-spacing: 0.2px;\n  color: #52c570;\n}\n::ng-deep .material .mat-dialog-container .info-modal-box .other-info .address, ::ng-deep .material .mat-dialog-container .info-modal-box .other-info .email {\n  font-family: \"Lato\", sans-serif;\n  font-weight: 400;\n  letter-spacing: 0.3px;\n  -webkit-font-smoothing: inherit;\n  -moz-osx-font-smoothing: inherit;\n  font-size: 1.4rem;\n  display: inline-block;\n}\n::ng-deep .material .mat-dialog-container .info-modal-box .other-info.grey .address, ::ng-deep .material .mat-dialog-container .info-modal-box .other-info.grey .email {\n  color: #8391a1;\n}\n::ng-deep .material .mat-dialog-container .info-modal-box .details {\n  padding: 10px 19px;\n}\n::ng-deep .material .mat-dialog-container .info-modal-box .details p {\n  font-size: 1.4rem;\n  color: #8391a1;\n}\n::ng-deep .material .mat-dialog-container .info-modal-box .details p span {\n  color: #373946;\n}\n::ng-deep .material .mat-dialog-container .info-modal-box .table thead th {\n  padding: 12px 20px;\n  background-color: #eaeaea;\n}\n::ng-deep .material .mat-dialog-container .info-modal-box .table tr.total td {\n  font-family: \"Lato\", sans-serif;\n  font-weight: 700;\n  letter-spacing: 0.3px;\n  -webkit-font-smoothing: antialiased;\n  -moz-osx-font-smoothing: grayscale;\n  text-rendering: optimizeLegibility;\n}\n::ng-deep .material .mat-dialog-container .info-modal-box p.bottom {\n  font-size: 1.3rem;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
let IncomeViewInvoiceComponent = class IncomeViewInvoiceComponent {
    constructor(dialog, router, route, userService, accountsService, apartmentService, sharedService, constantsService, cookieService) {
        this.dialog = dialog;
        this.router = router;
        this.route = route;
        this.userService = userService;
...
/* harmony import */ var _components_income_tracker_reports_income_tracker_reports_component__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./components/income-tracker-reports/income-tracker-reports.component */ "./src/app/ams/income-tracker/components/income-tracker-reports/income-tracker-reports.component.ts");
/* harmony import */ var _components_income_tracker_setup_income_tracker_setup_component__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./components/income-tracker-setup/income-tracker-setup.component */ "./src/app/ams/income-tracker/components/income-tracker-setup/income-tracker-setup.component.ts");
/* harmony import */ var _components_income_tracker_reports_income_tracker_reports_customer_income_tracker_reports_customer_component__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./components/income-tracker-reports/income-tracker-reports-customer/income-tracker-reports-customer.component */ "./src/app/ams/income-tracker/components/income-tracker-reports/income-tracker-reports-customer/income-tracker-reports-customer.component.ts");
/* harmony import */ var _components_income_tracker_reports_income_tracker_reports_vendor_income_tracker_reports_vendor_component__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./components/income-tracker-reports/income-tracker-reports-vendor/income-tracker-reports-vendor.component */ "./src/app/ams/income-tracker/components/income-tracker-reports/income-tracker-reports-vendor/income-tracker-reports-vendor.component.ts");
/* harmony import */ var _components_income_tracker_filter_income_tracker_filter_component__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ./components/income-tracker-filter/income-tracker-filter.component */ "./src/app/ams/income-tracker/components/income-tracker-filter/income-tracker-filter.component.ts");
...
IncomeTrackerModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        declarations: [
            ...
            _components_income_tracker_reports_income_tracker_reports_component__WEBPACK_IMPORTED_MODULE_20__["IncomeTrackerReportsComponent"],
            _components_income_tracker_setup_income_tracker_setup_component__WEBPACK_IMPORTED_MODULE_21__["IncomeTrackerSetupComponent"],
            _components_income_tracker_reports_income_tracker_reports_customer_income_tracker_reports_customer_component__WEBPACK_IMPORTED_MODULE_22__["IncomeTrackerReportsCustomerComponent"],
            _components_income_tracker_reports_income_tracker_reports_vendor_income_tracker_reports_vendor_component__WEBPACK_IMPORTED_MODULE_23__["IncomeTrackerReportsVendorComponent"],
            _components_income_tracker_filter_income_tracker_filter_component__WEBPACK_IMPORTED_MODULE_24__["IncomeTrackerFilterComponent"]
        ],
        imports: [
