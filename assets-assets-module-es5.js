...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["assets-assets-module"], {
  ...
  function srcAppAmsAssetsComponentsAddMaintenanceAddMaintenanceComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function AddMaintenanceComponent(route, assetService, lookupService, cookieService) {
      ...
      _createClass(AddMaintenanceComponent, [{
        ...
        key: "setMainSubType",
        value: function setMainSubType(val) {
          console.log(val);
        ...
        value: function addMaintenance() {
          ...
          reqObj.maintenanceTypeId = this.maintenance.maintenanceTypeId;
          reqObj.maintenanceByCompany = this.maintenance.maintenanceTypeId;
          ...
          reqObj.maintWithTax = 0, reqObj.maintenanceTotalBilledAmt = this.maintenance.maintenanceTotalBilledAmt;
          reqObj.isMaintainedbyStaff = true, reqObj.maintainedbyStaff = this.maintenance.maintainedbyStaff;
          reqObj.maintenanceSubtypeId = 0;
          this.isAssetLoaded = true; // for( const key in reqObj){
          //   if(reqObj[key] == '')  {
          //      delete reqObj[key];
          //   }
          // }
          ...
          reqObj = {
            ...
            "isActive": true,
            "insertedBy": 1,
            "insertedOn": "2020-05-19T06:54:33.948Z",
            "updatedBy": 1,
            "updatedOn": "2020-05-19T06:54:33.948Z",
            "actualMaintDate": "2020-05-19T06:54:33.948Z",
            "lastMaintenanceDate": "2020-05-19T06:54:33.948Z",
            "nextPlannedMaintenance": "2020-05-19T06:54:33.948Z",
            "maintenanceTypeId": 877,
            "maintenanceByCompany": "tech net",
            "maintenanceByPerson": "raja",
            "maintenanceCompanyContactNo": "9876545533",
            "maintLaborCost": 10,
            "maintPartsCost": 10,
            "maintVat": 10,
            "maintWithTax": 10,
            "maintenanceTotalBilledAmt": 50,
            "isMaintainedbyStaff": true,
            "maintainedbyStaff": 'raja',
            "maintenanceSubtypeId": 878
          };
          var params = {};
        ...
        value: function submitAddAssetForm(form) {
          ...
          if (!this.isEditAsset) {
            ...
            this.assetService.addAsset(addAssetParams).subscribe(function (res) {
              if (res.message) {
                _this8.isAssetSubmitted = false;

                _this8.sharedService.setAlertMessage("Asset added successfully");

                _this8.addInsurance(res.message); //this.router.navigate(['ams/assets/view']);
            ...
            this.assetService.updateAsset(editAssetParams).subscribe(function (res) {
              if (res.message) {
                ...
                _this8.sharedService.setAlertMessage("Asset updated successfully"); // this.router.navigate(['ams/assets/view']);


                _this8.updateInsurance(res.message);
              } else {
                _this8.isAssetSubmitted = false;
                _this8.isError = true;
                _this8.alertMessage = res.errorMessage;
      ...
      _createClass(AssetsMaintenanceHistoryComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.assetService.getAllAssetMaintenancePlanByAssetId(this.assetId).subscribe(function (res) {
            _this12.isAssetMaintenanceLoaded = true;
            _this12.maintenanceDataList = res;
            ...
            _this12.totalItems = _this12.maintenanceDataList.length;
          });
          var params = {
            LookupTypeId: 64
          };
        ...
        value: function ngOnInit() {
          ...
          this.sharedService.unitlistdeleteindexcast.subscribe(function (id) {
            if (id != null) {
              ...
              param = {
                categoryId: id,
                deletedBy: parseInt(_this13.cookieService.get('userId'))
              };

              _this13.lookupService.deleteCategory(param).subscribe(function (res) {
                ...
                _this13.getAllMaintenance();

                setTimeout(function () {
                  if (_this13.delType == "maintenance") {
                    _this13.sharedService.setAlertMessage("Maintenance type deleted successfully");
                  } else {
                    _this13.sharedService.setAlertMessage("Asset Category deleted successfully");
                  }
        ...
        value: function getAllMaintenance() {
          ...
          this.lookupService.getSubcategory(queryParamBase).subscribe(function (res) {
            if (res) {
              ...
              _this15.mainType = res ? res : [];
              _this15.tempMainType = _this15.mainType; // if (this.data && this.data.type === 'addSubType') {
        ...
        value: function getAllCategory() {
          ...
          this.lookupService.getSubcategory(queryParamBase).subscribe(function (res) {
            if (res) {
              ...
              _this16.categoryList = res ? res : [];
              _this16.tempCategoryList = _this16.categoryList;
            }
          });
        }
      }]);
        ...
        router.events.forEach(function (event) {
          if (event instanceof _angular_router__WEBPACK_IMPORTED_MODULE_2__["NavigationEnd"]) {
            ...
            _this17.lookupService.getLookupValueByLookupTypeId(params).subscribe(function (res) {
              _this17.assetCategoryData = res.filter(function (item) {
                return item.isActive;
              });

              _this17.getAssetCategoryData(_this17.assetCategoryId);
            });
          }
        });
      }
      ...
      _createClass(AssetsViewComponent, [{
        ...
        value: function getAssetCategoryData(id) {
          ...
          underscore__WEBPACK_IMPORTED_MODULE_11__["each"](this.assetCategoryData, function (item, index) {
            if (id != "All") {
              if (item.lookupValueId == parseInt(id)) {
                _this18.assetCategoryName = item.lookupValueName;
              }
            } else {
              _this18.assetCategoryName = "";
            }
          });
          var params = {
            apartmentId: parseInt(this.cookieService.get('apartmentId'))
          ...
          this.assetService.getAllAssetByApartmentId(params).subscribe(function (res) {
            if (id != "All") {
              _this18.assetListData = res.filter(function (item) {
            ...
            _this18.totalItems = _this18.assetListData.length;
        ...
        value: function ngOnInit() {
          ...
          if (this.route.params['value'].id == undefined) {
            ...
            this.assetService.getAllAssetByApartmentId(params).subscribe(function (res) {
              ...
              _this19.assetListData = res.filter(function (item) {
                return item.isActive;
              });
              _this19.totalItems = _this19.assetListData.length;
          ...
          this.lookupService.getLookupValueByLookupTypeId(assetContparams).subscribe(function (res) {
            _this19.assetConditionData = res.filter(function (item) {
              return item.isActive;
            });
          });
          var vendorParams = {
          ...
          this.assetService.getAllAssetMaintenancePlanByApartmentId(assetParams).subscribe(function (res) {
            _this19.assetMaintenaceDataList = res.filter(function (item) {
              return item.isActive;
            });
          });
          var statusparams = {
          ...
          this.sharedService.unitlistdeleteindexcast.subscribe(function (id) {
            if (id != null) {
              ...
              _this19.assetService.deleteAsset(params).subscribe(function (res) {
                underscore__WEBPACK_IMPORTED_MODULE_11__["each"](_this19.assetListData, function (type) {
                  if (type.assetId == id) {
                    type.isActive = false;
                  }
                });
                setTimeout(function () {
                  _this19.assetListData = _this19.assetListData.filter(function (type) {
                    return type.assetId !== id;
                  });
                  _this19.totalItems = _this19.assetListData.length;

                  _this19.sharedService.setAlertMessage("Asset deleted");
  ...
  function srcAppAmsAssetsComponentsLastMaintenanceLastMaintenanceComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function LastMaintenanceComponent(assetService, cookieService, lookupService) {
        ...
        value: function getMaintenaceHistory() {
          ...
          this.assetService.getAllAssetMaintenancePlanByApartmentId(params).subscribe(function (res) {
            ...
            if (res) {
              ...
              _this20.assetsHistoryData = new jqx.dataAdapter(_this20.gridSourceData);
            }
          });
        }
      }, {
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('datagrid', {
      "static": false
    }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", src_app_shared_jqwidgets_scripts_jqwidgets_ts_angular_jqxgrid__WEBPACK_IMPORTED_MODULE_4__["jqxGridComponent"])], LastMaintenanceComponent.prototype, "datagrid", void 0);
    ...
    }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [src_app_api_controllers_Asset__WEBPACK_IMPORTED_MODULE_2__["AssetService"], ngx_cookie_service__WEBPACK_IMPORTED_MODULE_3__["CookieService"], src_app_api_controllers_Lookup__WEBPACK_IMPORTED_MODULE_5__["LookupService"]])], LastMaintenanceComponent); //      assetCategoryId:string = "";
  ...
  function srcAppAmsAssetsComponentsMaintenanceHistoryMaintenanceHistoryComponentScss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = ".filter-icon {\n  font-size: 2.5rem;\n}\n\n.filter {\n  position: relative !important;\n  left: -4px !important;\n  padding-bottom: 8px;\n  font-size: 21px !important;\n  top: 0px !important;\n}\n\n.search-icon {\n  padding-top: 18px;\n  font-size: 2rem;\n}\n\n.wd-30 {\n  width: 30%;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
        ...
        value: function getMaintenaceHistory() {
          ...
          this.assetService.getAllAssetMaintenancePlanByApartmentId(params).subscribe(function (res) {
            ...
            if (res) {
              ...
              _this24.assetsHistoryData = new jqx.dataAdapter(_this24.gridSourceData);
            }
          });
        }
      }, {
