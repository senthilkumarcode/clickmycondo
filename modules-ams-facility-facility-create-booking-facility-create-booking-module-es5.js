  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["modules-ams-facility-facility-create-booking-facility-create-booking-module"], {
      ...
      var FacilityCreateBookingComponent = /*#__PURE__*/function () {
        ...
        _createClass(FacilityCreateBookingComponent, [{
          ...
          value: function selectSlot() {
            ...
            this.facilitySlotData.forEach(function (data) {
              if (_this7.booking.slotId == data.apartmentFacilitySlotId) {
                ...
                _this7.booking.tax = parseInt((_this7.booking.amount * (_this7.taxPecentage / 100)).toFixed(2));
                _this7.booking.totalBillAmount = parseInt((_this7.booking.amount + _this7.booking.tax).toFixed(2));
          ...
          value: function setMinTime() {
            ...
            if (fromTime && toTime) {
              ...
              if (totalDiffHrs >= this.facilityBookingDetail.minHoursBooking) {
                ...
                this.booking.tax = parseInt((this.booking.amount * (this.taxPecentage / 100)).toFixed(2));
                this.booking.totalBillAmount = parseInt((this.booking.amount + this.booking.tax).toFixed(2)); // this.facilityBookingForm.controls.bookedToTime.setErrors(null);
              } else {
          ...
          value: function calcDiscount() {
            var discount, memberShipDis, amount, totalDiscount;
            ...
            if (amount >= totalDiscount) {
              this.booking.totalBillAmount = parseInt((amount + this.booking.tax - totalDiscount).toFixed(2)); //this.facilityBookingForm.controls.discountAmt.setErrors({min:false})
            } else {
    ...
    function srcAppModulesAmsFacilityFacilityCreateBookingUserFacilityBookingListUserFacilityBookingListComponentTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var UserFacilityBookingListComponent = /*#__PURE__*/function () {
        function UserFacilityBookingListComponent(facilityService, sessionService, router, injector, sharedService, dialog) {
          ...
          value: function ngOnInit() {
            ...
            this.columnData = [{
              ...
              cellsrenderer: function cellsrenderer(row) {
                return '<div class="simple-actions">' + '<a href="javascript:void(0)" class="mr-3" onClick="editFacilityBooking(' + row + ')" title="Edit Facility"><i class="fa fa-pencil icon edit" aria-hidden="true"></i></a>' + '<a href="javascript:void(0)" onClick="deleteFacilityBooking(' + row + ')" title="Delete Facility"><i class="fa fa-trash icon delete" aria-hidden="true"></i></a>' + '</div>';
              },
              minwidth: 80,
              renderer: columnrenderer
            }]; //delete item
