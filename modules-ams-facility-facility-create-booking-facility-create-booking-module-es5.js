(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["modules-ams-facility-facility-create-booking-facility-create-booking-module"], {
    ...
    function srcAppModulesAmsFacilityFacilityCreateBookingFacilityCalenderFacilityCalenderComponentTs(module, __webpack_exports__, __webpack_require__) {
      ...
      "./node_modules/@angular/material/__ivy_ngcc__/fesm2015/dialog.js"); // import { CalendarOptions } from '@fullcalendar/angular';
    ...
    function srcAppModulesAmsFacilityFacilityCreateBookingFacilityCreateBookingRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var _user_facility_booking_list_user_facility_booking_list_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      ...
      {
        path: 'all-bookings',
        component: _user_facility_booking_list_user_facility_booking_list_component__WEBPACK_IMPORTED_MODULE_4__["UserFacilityBookingListComponent"],
        canActivate: [src_app_core_auth_guards_auth_guard__WEBPACK_IMPORTED_MODULE_5__["AuthGuard"]]
      }, {
        path: '**',
        redirectTo: 'create-booking',
      ...
      var FacilityCreateBookingComponent = /*#__PURE__*/function () {
        function FacilityCreateBookingComponent(router, route, userService, changeDetect, facilityService, lookupService, sharedService, apartmentService, sessionService, dialog, visitorService) {
          ...
          this.route.url.subscribe(function (data) {
            ...
            if (path == 'create-booking') _this.urlType = 'create';else if (path == 'edit-booking') _this.urlType = 'edit';else if (path == 'view-booking') _this.urlType = 'view';
          });
        }
        ...
        _createClass(FacilityCreateBookingComponent, [{
          ...
          value: function selectFacility(event) {
            ...
            var selectedFacility = this.facilityCatList.filter(function (item) {
              if (item.apartmentFacilityId === parseInt(_this2.booking.apartmentFacilityId)) return item;
            });
          ...
          value: function selectSlot() {
            ...
            this.facilitySlotData.forEach(function (data) {
              if (_this3.booking.slotId == data.apartmentFacilitySlotId) {
                _this3.booking.amount = parseInt(data.cost);
                _this3.booking.tax = parseInt((_this3.booking.amount * (_this3.taxPecentage / 100)).toFixed(2));
                _this3.booking.totalBillAmount = parseInt((_this3.booking.amount + _this3.booking.tax).toFixed(2));
                _this3.booking.discount = 0;
                _this3.booking.membershipDiscountAmount = 0;
              }
            });
          }
        }, {
          ...
          value: function createVisitor() {
            ...
            dialogRef.afterClosed().subscribe(function (result) {
              if (result && result.message && result.id) {
                ...
                _this4.booking.neededUserId = Number(id[0]);

                _this4.getVisitorsList();
              }
            });
          }
        }, {
          ...
          value: function getVisitorsList() {
            ...
            this.visitorService.getExpectedVisitorsByApartmentUnitId(params).subscribe(function (res) {
              if (res.length > 0) {
                _this5.visitorsList = res;

                _this5.visitorsList.forEach(function (ele) {
          ...
          value: function createFacilityBooking() {
            ...
            if (!this.facilityBookingForm.valid) {
              ...
              this.facilityService.addApartmentFacilityBooking(params).subscribe(function (res) {
                _this6.isBookingSubmitted = false;

                _this6.pageNavigate(res, 'create');
              }, function (error) {
                _this6.isBookingSubmitted = false;
          ...
          value: function updateFacilityBooking() {
            ...
            if (!this.facilityBookingForm.valid) {
              ...
              this.facilityService.updateApartmentFacilityBooking(params).subscribe(function (res) {
                _this7.isBookingSubmitted = false;

                _this7.pageNavigate(res, 'update');
              }, function (error) {
                _this7.isBookingSubmitted = false;
          ...
          value: function editFacilityBooking(id) {
            ...
            this.facilityService.getApartmentFacilityBookingsByFacilityBookingId(params).subscribe(function (res) {
              ...
              _this9.booking = response;
              _this9.booking.bookedFromTime = moment__WEBPACK_IMPORTED_MODULE_10__(bookedFromTime, 'HH:mm:ss');
              _this9.booking.bookedToTime = moment__WEBPACK_IMPORTED_MODULE_10__(bookedToTime, 'HH:mm:ss');

              _this9.getFacilityCategoryList().subscribe(function (facility) {
                if (res.length > 0) {
                  _this9.facilityCatList = facility;

                  _this9.selectFacility(null);
                }
              });

              _this9.getTower().subscribe(function (tower) {
                if (res.length > 0) {
                  _this9.towerList = tower;

                  _this9.getUnits('edit');
                }
              });
            });
          }
          ...
          value: function ngOnInit() {
            ...
            if (this.route.parent) {
              this.route.parent.parent.parent.data.subscribe(function (data) {
                if (data) {
                  ...
                  _this10.selectedCountryISO = response.country.toLowerCase();
                }
              });
            } //User Login
            ...
            if (!this.isAdmin()) {
              ...
              this.lookupService.getLookupValueByLookupTypeId(statusParams).subscribe(function (res) {
                if (res.length > 0) _this10.facilityStatus = res;
              });
            }
            ...
            if (this.urlType == 'create') {
              ...
              this.getFacilityCategoryList().subscribe(function (res) {
                if (res.length > 0) {
                  _this10.facilityCatList = res;

                  if (_this10.info.type) {
                    var calendarInfo = _this10.info.calendarData;
                    _this10.booking.apartmentFacilityId = Number(calendarInfo.resource._resource.id);
                    _this10.booking.bookedForDate = moment__WEBPACK_IMPORTED_MODULE_10__(calendarInfo.startStr).format(), _this10.selectFacility(null);
                  }
                }
              }); // Tower List

              this.getTower().subscribe(function (res) {
                if (res.length > 0) _this10.towerList = res;
              });
            } // Currency Type
            ...
            this.lookupService.getLookupValueByLookupTypeId(pesoParams).subscribe(function (res) {
              if (res.length > 0) _this10.pesoValue = res[0].lookupValueName;
            }); // Tax List
            ...
            this.lookupService.getLookupValueByLookupTypeId(taxListParams).subscribe(function (res) {
              if (res.length > 0) {
                _this10.taxPecentage = parseInt(res[0].lookupValueName);
              }
            });
          ...
          value: function createExpectedVisitor() {
            ...
            if (!this.form.valid) {
              ...
              this.visitorService.addExpectedVisitor(params).subscribe(function (res) {
                _this11.isDataSubmitted = false;

                if (res.message) {
                  _this11.modalResult.emit({
                    message: 'success',
                    id: res.message
                  });
                }
          ...
          value: function getBookingList() {
            ...
            this.facilityService.getApartmentFacilityBookingsByBlockunituserId(params).subscribe(function (res) {
              if (res.length > 0) {
                ...
                _this14.totalItems = facility.localdata.length;
                _this14.bookingListData = new jqx.dataAdapter(facility);
              }

              _this14.isBookingDataLoaded = true;
            });
          }
        }, {
          key: "ngOnInit",
          value: function ngOnInit() {
            ...
            this.columnData = [{
              ...
              cellsrenderer: function cellsrenderer(row, column, value) {
                var time,
                    fromTime,
                    toTime = _this15.bookingListData.loadedData[row].bookedToTime;
              ...
              cellsrenderer: function cellsrenderer(row, column, value) {
                var time,
                    toTime,
                    fromTime = _this15.bookingListData.loadedData[row].bookedFromTime;
              ...
              cellsrenderer: function cellsrenderer(row, column, value) {
                ...
                return "<div class=\"jqx-custom-inner-cell\">\n          <div class=\"status-badge bg-status-".concat(status, "-700\">\n            <span class=\"font-bold text-status-").concat(status, "-900 text-uppercase\">").concat(_this15.bookingListData.loadedData[row].facilityBookingStatusId_Label, "</span>\n          </div>\n        </div>");
              },
              cellsalign: 'center',
              align: 'center',
              minwidth: 100,
            ...
            this.apiSubscribe = this.sharedService.unitlistdeleteindexcast.subscribe(function (id) {
              if (id != null) {
                ...
                _this15.facilityService.deleteApartmentFacilityBooking(params).subscribe(function (res) {
                  _this15.sharedService.setUnitListDeleteIndex(null);

                  if (res.message) {
                    _this15.datagrid.deleterow(id);

                    _this15.datagrid.refresh();
