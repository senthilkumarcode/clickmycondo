                  ...
                  try {
                    for (_iterator.s(); !(_step = _iterator.n()).done;) {
                      ...
                      if (_this3.info.facilityId == data.apartmentFacilityId) {
                        ...
                        data.start = "".concat(moment__WEBPACK_IMPORTED_MODULE_7__(data.bookedForDate).format('YYYY-MM-DD'), " ").concat(data.bookedFromTime);
                        data.end = "".concat(moment__WEBPACK_IMPORTED_MODULE_7__(data.bookedForDate).format('YYYY-MM-DD'), " ").concat(data.bookedToTime);
                        data.color = 'red';
                        break;
                      }
                    }
      ...
      var FacilityCreateBookingComponent = /*#__PURE__*/function () {
        ...
        _createClass(FacilityCreateBookingComponent, [{
          ...
          value: function showBookingDetail() {
            return this.booking.apartmentFacilityId && this.booking.bookedForDate && (this.facilityBookingDetail.facilityTypeId == 184 && this.booking.slotId || this.booking.bookedFromTime && this.booking.bookedToTime && this.booking.amount);
          }
        }, {
          key: "getSlotTime",
          ...
          value: function createVisitor() {
            ...
            dialogRef.afterClosed().subscribe(function (result) {
              if (result && result.message && result.id) {
                ...
                _this8.booking.neededUserId = Number(id[0]);
