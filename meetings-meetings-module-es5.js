...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["meetings-meetings-module"], {
  ...
  function srcAppAmsMeetingsComponentsMeetingsListMeetingsListComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _meeting_edit_display_meeting_edit_display_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    ...
    /*#__PURE__*/
    function () {
      function MeetingsListComponent(router, meetingService, injector, cookieService, sharedService, dialog) {
      ...
      _createClass(MeetingsListComponent, [{
        ...
        value: function oneditMeeting(detail) {
          ...
          var dialogRef = this.dialog.open(_meeting_edit_display_meeting_edit_display_component__WEBPACK_IMPORTED_MODULE_9__["MeetingEditDisplayComponent"], {
            width: 'auto',
            height: '700px',
            data: data
          });
        ...
        value: function getMeetingList() {
          ...
          this.meetingService.getMeetingByApartmentId(params).subscribe(function (res) {
            if (res.length > 0) {
              _this16.lstMeetingData = res.filter(function (data) {
                return data.isActive;
              });
              _this16.gridSourceData = {
                localdata: _this16.lstMeetingData.reverse(),
                datatype: "array"
              };
        ...
        value: function ngOnInit() {
          ...
          this.columnData = [{
            ...
            cellsrenderer: function cellsrenderer(row) {
              return '<div class="simple-actions">' + '<a href="javascript:void(0)" class="mr-3" onClick="editMeeting(' + row + ')"><i class="fa fa-pencil icon edit" aria-hidden="true"></i></a>' + '<a href="javascript:void(0)" class="mr-2" onClick="showConfirmDelete(' + row + ')"><i class="fa fa-trash icon delete" aria-hidden="true"></i></a>';
            },
            minwidth: 120,
            renderer: columnrenderer
          }]; //delete item
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["HostListener"])('window:oneditMeeting', ['$event.detail']), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", Function), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [Object]), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:returntype", void 0)], MeetingsListComponent.prototype, "oneditMeeting", null);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["HostListener"])('window:ondeleteMeeting', ['$event.detail']), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", Function), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [Object]), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:returntype", void 0)], MeetingsListComponent.prototype, "ondeleteSlot", null);
          ...
          this.meetingService.getMeetingByApartmentId(params).subscribe(function (res) {
            if (res.length > 0) {
              ...
              res.forEach(function (data, i) {
                ...
                _this20.schedulerList.push(entity);
              });
              _this20.source.localdata = _this20.schedulerList;
              _this20.dataAdapter = new jqx.dataAdapter(_this20.source); //this.resources.source = new jqx.dataAdapter(this.source);
            }
          });
        }
      }, {
  ...
  function srcAppAmsMeetingsComponentsMeetingsSetupMeetingsSetupComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function MeetingsSetupComponent(lookupService, injector, sharedService, cookieService) {
          ...
          this.sharedService.unitlistdeleteindexcast.subscribe(function (item) {
            if (item != null) {
              ...
              var params = {
                ...
                updateUserId: parseInt(_this22.cookieService.get('userId'))
              };

              _this22.lookupService.deleteLookupvalue(params).subscribe(function (res) {
                _this22.sharedService.setUnitListDeleteIndex(null);

                _this22.meetingCategoryData.splice(item.index, 1);

                _this22.sharedService.setUnitListDeleteIndex(null);

                _this22.isMeetingCategoryLoaded = true;

                _this22.removeCategoryBox();
              });
            }
          });
        }
    ...
    }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [src_app_api_controllers_Lookup__WEBPACK_IMPORTED_MODULE_2__["LookupService"], _angular_core__WEBPACK_IMPORTED_MODULE_1__["Injector"], _shared_services_shared_service__WEBPACK_IMPORTED_MODULE_3__["SharedService"], ngx_cookie_service__WEBPACK_IMPORTED_MODULE_4__["CookieService"]])], MeetingsSetupComponent);
    /***/
  },
