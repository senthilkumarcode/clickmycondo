...
BottomMenuComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-bottom-menu',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./bottom-menu.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/user/components/bottom-menu/bottom-menu.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./bottom-menu.component.scss */ "./src/app/user/components/bottom-menu/bottom-menu.component.scss")).default]
    }),
...
UserSidebarComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./user-sidebar.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/user/components/user-sidebar/user-sidebar.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./user-sidebar.component.scss */ "./src/app/user/components/user-sidebar/user-sidebar.component.scss")).default]
    }),
...
const routes = [
    { path: '', component: _user_component__WEBPACK_IMPORTED_MODULE_3__["UserComponent"],
        children: [
            ...
            { path: 'myprofile', loadChildren: () => __webpack_require__.e(/*! import() | my-profile-my-profile-module */ "my-profile-my-profile-module").then(__webpack_require__.bind(null, /*! ./my-profile/my-profile.module */ "./src/app/user/my-profile/my-profile.module.ts")).then(m => m.MyProfileModule) },
            ...
            { path: 'alert-security', loadChildren: () => Promise.all(/*! import() | alert-security-alert-security-module */[__webpack_require__.e("default~alert-security-alert-security-module~security-security-module"), __webpack_require__.e("alert-security-alert-security-module")]).then(__webpack_require__.bind(null, /*! ./alert-security/alert-security.module */ "./src/app/user/alert-security/alert-security.module.ts")).then(m => m.AlertSecurityModule) },
            { path: 'servicedesk', loadChildren: () => Promise.all(/*! import() | servicedesk-servicedesk-module */[__webpack_require__.e("default~helpdesk-helpdesk-module~servicedesk-servicedesk-module~staff-manager-staff-manager-module"), __webpack_require__.e("default~dashboard-dashboard-module~helpdesk-helpdesk-module~servicedesk-servicedesk-module"), __webpack_require__.e("default~helpdesk-helpdesk-module~servicedesk-servicedesk-module"), __webpack_require__.e("servicedesk-servicedesk-module")]).then(__webpack_require__.bind(null, /*! ./servicedesk/servicedesk.module */ "./src/app/user/servicedesk/servicedesk.module.ts")).then(m => m.ServicedeskModule) },
            { path: 'moveinout-tracker', loadChildren: () => Promise.all(/*! import() | user-moveinout-tracker-user-moveinout-tracker-module */[__webpack_require__.e("default~moveinout-tracker-moveinout-tracker-module~user-moveinout-tracker-user-moveinout-tracker-module"), __webpack_require__.e("user-moveinout-tracker-user-moveinout-tracker-module")]).then(__webpack_require__.bind(null, /*! ./user-moveinout-tracker/user-moveinout-tracker.module */ "./src/app/user/user-moveinout-tracker/user-moveinout-tracker.module.ts")).then(m => m.UserMoveinoutTrackerModule) },
            { path: 'visitor', loadChildren: () => Promise.all(/*! import() | user-visitor-user-visitor-module */[__webpack_require__.e("default~user-visitor-user-visitor-module~visitor-visitor-module"), __webpack_require__.e("user-visitor-user-visitor-module")]).then(__webpack_require__.bind(null, /*! ./user-visitor/user-visitor.module */ "./src/app/user/user-visitor/user-visitor.module.ts")).then(m => m.UserVisitorModule) },
            { path: 'facility-booking', loadChildren: () => Promise.all(/*! import() | facility-booking-facility-booking-module */[__webpack_require__.e("default~facility-booking-facility-booking-module~facility-facility-module"), __webpack_require__.e("facility-booking-facility-booking-module")]).then(__webpack_require__.bind(null, /*! ./facility-booking/facility-booking.module */ "./src/app/user/facility-booking/facility-booking.module.ts")).then(m => m.FacilityBookingModule) },
