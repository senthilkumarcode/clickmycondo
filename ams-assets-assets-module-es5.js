...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["ams-assets-assets-module"], {
  /***/
  ...
  function srcAppAmsAssetsComponentsAddMaintenanceAddMaintenanceComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function AddMaintenanceComponent(route, assetService, lookupService, cookieService, sharedService, router, activatedRoute, staffService) {
      ...
      _createClass(AddMaintenanceComponent, [{
        ...
        value: function onItemSelectToStaff(item) {
          console.log(item);
          this.maintenance.maintainedbyStaff = item.id;
        }
      }, {
        ...
        value: function addMaintenance() {
          ...
          this.assetService.addAssetMaintenancePlan(params).subscribe(function (res) {
            ...
            if (res.message) {
              _this6.sharedService.setAlertMessage("Asset Maintenance added successfully");
        ...
        value: function updateMaintenance() {
          ...
          this.assetService.updateAssetMaintenancePlan(params).subscribe(function (res) {
            if (res) {
              _this7.sharedService.setAlertMessage("Asset maintenance updated successfully");
        ...
        value: function getAllMaintenance() {
          ...
          this.lookupService.getSubcategory(queryParamBase).subscribe(function (res) {
            if (res) {
              ...
              _this8.mainType = res ? res : [];

              if (_this8.isEdit && _this8.maintenance.maintenanceTypeId) {
                _this8.setMainSubType(_this8.maintenance.maintenanceTypeId);
              } else {
                _this8.maintenance.maintenanceTypeId = _this8.mainType && _this8.mainType.length > 0 ? _this8.mainType[0].id : '';
        ...
        value: function getAsset() {
          ...
          this.assetService.getAllAssetByApartmentId(params).subscribe(function (res) {
            if (res) {
              _this9.assetList = res ? res : [];
              _this9.assetId = !_this9.assetId ? _this9.assetList && _this9.assetList.length > 0 && _this9.assetList[0].assetId : '';
            }
          });
        }
      }]);
  ...
  function srcAppAmsAssetsComponentsAssetsCreateAssetsCreateComponentScss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = ".assets-create-wrapper .preview-img {\n  position: relative;\n  display: flex;\n  width: 150px;\n  height: 150px;\n  overflow: hidden;\n  margin: 0 30px 0 0;\n  border: 1px solid #dee2e6;\n  padding: 8px;\n}\n.assets-create-wrapper .preview-img .icon-wrapper {\n  position: absolute;\n  right: 5px;\n  top: 5px;\n  width: 16px;\n  height: 16px;\n  display: inline-flex;\n  justify-content: center;\n  align-items: center;\n  border-radius: 16px !important;\n  background-color: #ffffff;\n}\n.assets-create-wrapper .preview-img .icon-wrapper .del {\n  width: 16px;\n  height: 16px;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
      ...
      _createClass(AssetsCreateComponent, [{
        ...
        value: function uploadFile(event) {
          ...
          this.fileUploadService.upload(file, userId).subscribe(function (res) {
            if (res != undefined) {
              _this10.uploadResponse = res;
            }

            if (_this10.isUploadCompleted()) {
              _this10.asset.assetImageId = _this10.uploadResponse.fileId;
              var newParams = {
                fileDetailsId: _this10.uploadResponse.fileId,
                apartmentId: Number(_this10.cookieService.get('apartmentId'))
              };

              _this10.fileDetailsService.getFileDetailsById(newParams).subscribe(function (res) {
                _this10.filePath = res[0].filePath;

                _this10.downloadFile(_this10.filePath);
              });
            }
          });
        }
        ...
        value: function deleteFile() {
          ...
          this.fileDetailsService.deleteFileDetails(params).subscribe(function (res) {
            _this12.isFileDetailsAvailable = false;
            _this12.uploadResponse = {
              status: '',
              message: '',
              fileId: null
            };
            _this12.asset.assetImageId = _this12.uploadResponse.fileId;
          });
        }
      }, {
        key: "bytesToSize",
        ...
        value: function submitAddAssetForm(form) {
          ...
          if (!this.isEditAsset) {
            var addAssetDetails = {
              ...
              "maximumAllowed": this.asset.maximumAllowed ? this.asset.maximumAllowed : null,
              "salvageValue": this.asset.salvageValue ? this.asset.salvageValue : null,
              "depreciationMethodId": this.asset.depreciationMethodId ? this.asset.depreciationMethodId : null,
              "consumedUnitDescription": this.asset.consumedUnitDescription ? this.asset.consumedUnitDescription : null,
              "depreciationPercentage": this.asset.depreciationPercentage ? parseInt(this.asset.depreciationPercentage) : null,
              "alertBeforeDays": this.asset.alertBeforeDays ? this.asset.alertBeforeDays : null,
              "insertedBy": parseInt(this.cookieService.get('userId')),
              "insertedOn": new Date().toISOString(),
              "updatedBy": 0,
              "updatedOn": new Date().toISOString(),
              ...
              // "salvageValue": null,
              "maintFrequencyInDays": this.asset.maintFrequencyInDays ? this.asset.maintFrequencyInDays : null,
              "assetTypeId": null,
            ...
            this.assetService.addAsset(addAssetParams).subscribe(function (res) {
              if (res.message) {
                ...
                _this13.sharedService.setAlertMessage("Asset added successfully");

                _this13.addInsurance(res.message); //this.router.navigate(['ams/assets/view']);
            ...
            this.assetService.updateAsset(editAssetParams).subscribe(function (res) {
              if (res.message) {
                ...
                _this13.sharedService.setAlertMessage("Asset updated successfully"); // this.router.navigate(['ams/assets/view']);


                if (_this13.isAddInsurance == true) {
                  _this13.addInsurance(res.message);
                } else {
                  _this13.updateInsurance(res.message);
                }
              } else {
                _this13.isAssetSubmitted = false;
                _this13.isError = true;
        ...
        value: function ngOnInit() {
          ...
          if (this.route.params['value'].id != undefined) {
            ...
            this.assetService.getAllAssetByAssetId(params).subscribe(function (res) {
              _this14.asset = res[0];
              var newParams = {
                fileDetailsId: _this14.asset.assetImageId,
                apartmentId: Number(_this14.cookieService.get('apartmentId'))
              };

              _this14.fileDetailsService.getFileDetailsById(newParams).subscribe(function (res) {
                _this14.filePath = res && res.length > 0 ? res[0].filePath : '';

                _this14.downloadFile(_this14.filePath);
              });
            });
            ...
            this.assetService.getAllAssetInsurancePlanByAssetId(reqInsuranceParam).subscribe(function (res) {
              if (res && res.length > 0) {
                _this14.insurance = res[0];
              } else {
                _this14.isAddInsurance = true;
                _this14.insurance = {};
              }
            });
          }
          ...
          this.lookupService.getLookupValueByLookupTypeId(assetCategoryParams).subscribe(function (res) {
            _this14.assetCategoryData = res.filter(function (item) {
              return item.isActive;
            });
          });
          var vendprParams = {
        ...
        value: function addInsurance(assetId) {
          ...
          this.assetService.addAssetInsurancePlan(params).subscribe(function (res) {
            ...
            _this16.isAssetSubmitted = false;
        ...
        value: function getDepreciatonList() {
          ...
          this.lookupService.getLookupValueByLookupTypeId(queryParamBase).subscribe(function (res) {
            if (res) {
              _this18.depreciatonData = res ? res : []; //  if(this.depreciatonData && this.depreciatonData.length){
        ...
        key: "setNextPlanDate",
        value: function setNextPlanDate() {
          if (this.asset.installationDate && this.asset.maintFrequencyInDays) {
            var result = new Date(this.asset.installationDate._d);
            result.setDate(result.getDate() + Number(this.asset.maintFrequencyInDays));
            this.asset.nextPlanDate = result;
          }
        }
      }, {
        key: "getAllCategory",
        value: function getAllCategory() {
          ...
          this.lookupService.getSubcategory(queryParamBase).subscribe(function (res) {
            if (res) {
              ...
              if (_this19.isEditAsset && _this19.asset.assetCategoryId) {
                _this19.setSubCategory(_this19.asset.assetCategoryId);
              } else {
                _this19.asset.assetCategoryId = _this19.categoryList && _this19.categoryList.length > 0 ? _this19.categoryList[0].id : '';
        ...
        value: function setSubCategory(id) {
          ...
          if (this.categoryList && this.categoryList.length > 0) {
            this.categoryList.filter(function (val) {
              if (val.id == id) {
                _this20.categorySubType = val.subCategory;
              }
            });
          }
        }
  ...
  function srcAppAmsAssetsComponentsAssetsReportsAssetsReportsComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function AssetsReportsComponent(router, route, userService, apartmentService, lookupService, sharedService, cookieService, purchaseOrderService) {
      ...
      _createClass(AssetsReportsComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.lookupService.getLookupValueByLookupTypeId(params).subscribe(function (res) {
            ...
            _this23.pageName = res[0].lookupValueName;
            _this23.pageDesp = res[0].description;
        ...
        value: function getCurrentInventory() {
          ...
          this.purchaseOrderService.getAllInventoryCurrentCountByApartmentId(params).subscribe(function (res) {
            if (res) {
              ...
              _this24.inventoryHistoryData = new jqx.dataAdapter(_this24.gridSourceData);
            }
          });
        }
      }]);
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('datagrid', {
      "static": false
    }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", src_app_shared_jqwidgets_scripts_jqwidgets_ts_angular_jqxgrid__WEBPACK_IMPORTED_MODULE_7__["jqxGridComponent"])], AssetsReportsComponent.prototype, "datagrid", void 0);
  ...
  function srcAppAmsAssetsComponentsAssetsSetupAssetsSetupComponentScss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = ".icon-tabs {\n  display: flex;\n  justify-content: center;\n}\n.icon-tabs li {\n  width: 100%;\n  text-align: center;\n  margin-bottom: 20px;\n  padding: 0;\n  box-shadow: 0 2px 3px -1px rgba(0, 0, 0, 0.1);\n  -moz-box-shadow: 0 2px 3px -1px rgba(0, 0, 0, 0.1);\n  -webkit-box-shadow: 0 2px 3px -1px rgba(0, 0, 0, 0.1);\n  border-radius: 6px !important;\n}\n.icon-tabs li a {\n  color: #585858;\n  font-family: \"Montserrat\", sans-serif;\n  font-weight: 500;\n  letter-spacing: 0.2px;\n  font-size: 1.6rem;\n  padding: 10px 25px;\n  position: relative;\n  background-color: #ffffff;\n}\n.icon-tabs li a.active {\n  background-color: #3f51b5;\n  color: #ffffff;\n}\n.setup-search {\n  position: absolute;\n  top: 18px;\n  padding-left: 10px;\n  font-size: 1.3rem;\n  color: #8391a1;\n}\n.sub-dot {\n  width: 6px;\n  height: 6px;\n  border: 1px solid;\n  border-radius: 50%;\n}\n.subCategory {\n  padding-top: 10px;\n  font-family: \"Montserrat\", sans-serif;\n  font-weight: 400;\n  letter-spacing: 0.3px;\n  -webkit-font-smoothing: inherit;\n  -moz-osx-font-smoothing: inherit;\n  padding-bottom: 10px;\n}\n.subCategory li {\n  list-style-type: circle;\n}\n.card-body:hover {\n  background-color: white !important;\n}\n.wd-100 {\n  width: 100%;\n}\n.wd-50 {\n  width: 50%;\n}\n.cus-input {\n  border-radius: 8px;\n  border: 1px solid #dadada;\n  padding-left: 10px;\n  height: 30px;\n}\n.fa-floppy-o {\n  color: #54b941;\n}\n.fa-times {\n  color: #ff3638;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
    ...
    function () {
      ...
      _createClass(AssetsSetupComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.sharedService.unitlistdeleteindexcast.subscribe(function (id) {
            if (id != null) {
              ...
              param = {
                categoryId: id,
                deletedBy: parseInt(_this25.cookieService.get('userId'))
              };

              _this25.lookupService.deleteCategory(param).subscribe(function (res) {
                // _.each(this.categoryList, (type) => {
                // 	if (type.id == id) {
                // 		type.isActive = false;
                // 	}
                // })
                _this25.getAllCategory();

                _this25.getAllMaintenance();

                setTimeout(function () {
                  if (_this25.delType == "maintenance") {
                    _this25.sharedService.setAlertMessage("Maintenance type deleted successfully");
                  } else {
                    _this25.sharedService.setAlertMessage("Asset Category deleted successfully");
                  }
        ...
        value: function filterMaitenanceItem(value) {
          this.mainType = this.tempMainType.filter(function (item) {
            return item.name.toLowerCase().indexOf(value.toLowerCase()) > -1;
          });
        }
      }, {
        ...
        value: function getAllMaintenance() {
          ...
          this.lookupService.getSubcategory(queryParamBase).subscribe(function (res) {
            if (res) {
              ...
              _this28.mainType = res ? res : [];
              _this28.tempMainType = _this28.mainType; // if (this.data && this.data.type === 'addSubType') {
        ...
        value: function getAllCategory() {
          ...
          this.lookupService.getSubcategory(queryParamBase).subscribe(function (res) {
            if (res) {
              ...
              _this29.categoryList = res ? res : [];
              _this29.tempCategoryList = _this29.categoryList;
            }
          });
        }
      }, {
        ...
        value: function editMaintenance(data) {
          ...
          this.lookupService.upsertSubCategory(params).subscribe(function (res) {
            ...
            if (res) {
              _this30.sharedService.setAlertMessage("Maintenance sub types updated successfully");

              _this30.isAssetLoaded = false;

              _this30.getAllMaintenance();

              _this30.mainCurrIndex = -1;
            }
          });
        }
      }, {
        ...
        value: function getDepreciatonList() {
          ...
          this.lookupService.getLookupValueByLookupTypeId(queryParamBase).subscribe(function (res) {
            if (res) {
              _this31.depreciatonData = res ? res : [];

              if (_this31.depreciatonData && _this31.depreciatonData.length) {
                _this31.depreciatonData.filter(function (val) {
                  val.isCheck = val.isDisabled == true ? false : true;
                });
              }
            }
        ...
        value: function updateDepreciatonList(data) {
          ...
          this.lookupService.updateLookupValue(param).subscribe(function (res) {
            if (res) {
              _this32.sharedService.setAlertMessage("Depreciaton method  updated successfully");

              _this32.isAssetLoaded = false;

              _this32.getDepreciatonList();
            } else if (res.body.errorMessage) {
              // this.isError = true;
              // this.errorMessage = 'Not Added it already exist'
              _this32.isAssetLoaded = false; //  this.sharedService.setAlertMessage("Not Added as it already exist");
            }
          });
        }
      }]);
  ...
  function srcAppAmsAssetsComponentsAssetsViewAssetsViewComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function AssetsViewComponent(assetService, cookieService, router, sharedService, injector) {
        ...
        value: function ngOnInit() {
          ...
          this.sharedService.unitlistdeleteindexcast.subscribe(function (id) {
            if (id != null) {
              var params = {
                assetId: id,
                deleteBy: parseInt(_this33.cookieService.get('userId'))
              };

              _this33.assetService.deleteAsset(params).subscribe(function (res) {
                ...
                setTimeout(function () {
                  ...
                  _this33.sharedService.setAlertMessage("Asset deleted");

                  _this33.sharedService.setUnitListDeleteIndex(null);

                  _this33.getAllAssets();
                }, 500);
              }, function (error) {
                console.log(error);
              });
        ...
        value: function getAllAssets() {
          ...
          this.assetService.getAllAssetByApartmentId(params).subscribe(function (res) {
            if (res) {
              ...
              _this34.assetData = new jqx.dataAdapter(_this34.gridSourceData);
            }
          });
        }
      }, {
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('datagrid', {
      "static": false
    }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", src_app_shared_jqwidgets_scripts_jqwidgets_ts_angular_jqxgrid__WEBPACK_IMPORTED_MODULE_3__["jqxGridComponent"])], AssetsViewComponent.prototype, "datagrid", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["HostListener"])('window:deleteAsset', ['$event.detail']), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", Function), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [Object]), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:returntype", void 0)], AssetsViewComponent.prototype, "deleteAsset", null);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["HostListener"])('window:editAsset', ['$event.detail']), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", Function), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [Object]), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:returntype", void 0)], AssetsViewComponent.prototype, "editAsset", null);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["HostListener"])('window:addMaintanence', ['$event.detail']), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", Function), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [Object]), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:returntype", void 0)], AssetsViewComponent.prototype, "addMaintanence", null);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["HostListener"])('window:manageMaintanence', ['$event.detail']), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", Function), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [Object]), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:returntype", void 0)], AssetsViewComponent.prototype, "manageMaintanence", null);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["HostListener"])('window:viewMaintanenceHistory', ['$event.detail']), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", Function), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [Object]), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:returntype", void 0)], AssetsViewComponent.prototype, "viewMaintanenceHistory", null);
  ...
  function srcAppAmsAssetsComponentsLastMaintenanceLastMaintenanceComponentScss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = ".filter-icon {\n  font-size: 2.5rem;\n}\n\n.filter {\n  position: relative !important;\n  left: -4px !important;\n  padding-bottom: 8px;\n  font-size: 21px !important;\n  top: 0px !important;\n}\n\n.search-icon {\n  padding-top: 18px;\n  font-size: 2rem;\n}\n\n.wd-30 {\n  width: 30%;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
  ...
  function srcAppAmsAssetsComponentsLastMaintenanceLastMaintenanceComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function LastMaintenanceComponent(assetService, cookieService, lookupService, route, datePipe) {
          ...
          this.assetService.getAllAssetMaintenancePlanByApartmentIdStatus(params).subscribe(function (res) {
            ...
            if (responeData && responeData.length > 0) {
              responeData.filter(function (val) {
                val.actualMaintDate = val.actualMaintDate ? _this37.datePipe.transform(val.actualMaintDate, 'MM-dd-yyyy') : '';
                val.plannedMaintenanceDate = val.plannedMaintenanceDate ? _this37.datePipe.transform(val.plannedMaintenanceDate, 'MM-dd-yyyy') : '';
                val.nextPlannedMaintenance = val.nextPlannedMaintenance ? _this37.datePipe.transform(val.nextPlannedMaintenance, 'MM-dd-yyyy') : '';
                val.lastMaintenanceDate = val.lastMaintenanceDate ? _this37.datePipe.transform(val.lastMaintenanceDate, 'MM-dd-yyyy') : '';
              });
            }
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('datagrid', {
      "static": false
    }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", src_app_shared_jqwidgets_scripts_jqwidgets_ts_angular_jqxgrid__WEBPACK_IMPORTED_MODULE_6__["jqxGridComponent"])], LastMaintenanceComponent.prototype, "datagrid", void 0);
    ...
    }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [src_app_api_controllers_Asset__WEBPACK_IMPORTED_MODULE_4__["AssetService"], ngx_cookie_service__WEBPACK_IMPORTED_MODULE_5__["CookieService"], src_app_api_controllers_Lookup__WEBPACK_IMPORTED_MODULE_7__["LookupService"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"], _angular_common__WEBPACK_IMPORTED_MODULE_2__["DatePipe"]])], LastMaintenanceComponent);
  ...
  function srcAppAmsAssetsComponentsMaintenanceHistoryMaintenanceHistoryComponentScss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = ".mat-slide-toggle-content {\n  padding-top: 6px;\n}\n\n.list-inline-item {\n  position: relative;\n  bottom: 3px;\n}\n\n.filter-icon {\n  font-size: 2.5rem;\n}\n\n.filter {\n  position: relative !important;\n  font-size: 21px !important;\n  top: 0px !important;\n  padding-right: 17px;\n}\n\n.card.table-card .card-header ul {\n  float: none;\n}\n\n.search-icon {\n  padding-top: 18px;\n  font-size: 2rem;\n}\n\n.wd-30 {\n  width: 30%;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
  ...
  function srcAppAmsAssetsComponentsMaintenanceHistoryMaintenanceHistoryComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*! @angular/common */
    "./node_modules/@angular/common/__ivy_ngcc__/fesm2015/common.js"); // import { Component, OnInit, Injector, ViewChild, TemplateRef } from '@angular/core';
    // import { Router, NavigationStart, NavigationEnd, ActivatedRoute } from '@angular/router';
    // // import { MatDialog } from '@angular/material/dialog';
    // // import { MatDialogRef } from "@angular/material/dialog";
    // // import { AssetsMaintenanceHistoryComponent } from './../assets-maintenance-history/assets-maintenance-history.component';
    ...
    /*#__PURE__*/
    function () {
      function MaintenanceHistoryComponent(assetService, cookieService, lookupService, datePipe) {
        ...
        value: function searchAsset() {
          ...
          if (this.assetName) {
            if (this.tempMaintenanceList && this.tempMaintenanceList.length > 0) {
              this.tempMaintenanceList.filter(function (val) {
                if (_this43.assetName == val.assetName) {
                  filterArr.push(val);
                }
              });
          ...
          if (this.assetName && this.categoryName) {
            ...
            filterArr.filter(function (val) {
              if (_this43.categoryName == val.assetCategoryName) {
          ...
          if (this.categoryName && this.subCategoryName) {
            filterCategoryArr.filter(function (val) {
              if (_this43.subCategoryName == val.assetSubcategoryName) {
          ...
          if (!this.assetName && !this.categoryName && !this.subCategoryName) {
            console.log('last'); // this.maintenanceList  = this.tempMaintenanceList;
        ...
        value: function getMaintenaceHistory() {
          ...
          this.assetService.getAllAssetMaintenancePlanByApartmentId(params).subscribe(function (res) {
            if (res) {
              ...
              _this44.maintenanceList = res;
              _this44.tempMaintenanceList = res;
              console.log(res);
              _this44.gridSourceData = {
                localdata: responeData.length > 0 ? responeData : [],
                datatype: "array"
              };
              _this44.assetsHistoryData = new jqx.dataAdapter(_this44.gridSourceData);
            }
          });
        }
      }, {
    ...
    window.getClassName = getClassName; // assetCategoryData:any;
    // assetCategoryId:string = "";
    // vendorDataList:any;
    // assetConditionData:any;
    // isAssetCategorySelected:boolean = false;
  ...
  function srcAppAmsAssetsComponentsManageMaintenanceManageMaintenanceComponentScss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = ".cardOuter {\n  padding: 20px 20px;\n}\n\n.search-icon {\n  position: absolute;\n  right: -16px;\n  top: 28px;\n  font-size: 2rem;\n}\n\n.ellipse {\n  white-space: nowrap;\n  overflow: hidden !important;\n  text-overflow: ellipsis !important;\n  display: block;\n}\n\n.filter {\n  font-size: 19px;\n  padding-right: 22px;\n}\n\n.ellipse {\n  white-space: nowrap;\n  overflow: hidden !important;\n  text-overflow: ellipsis !important;\n}\n\n.display-name {\n  white-space: nowrap;\n  overflow: hidden !important;\n  text-overflow: ellipsis !important;\n  display: block;\n  padding-bottom: 15px;\n  color: #777c82;\n}\n\n.setup-search {\n  position: relative;\n  top: 18px;\n  padding-left: 10px;\n  font-size: 1.3rem;\n  color: #8391a1;\n  left: 22px;\n  top: 13px;\n}\n\n.mat-accordion .mat-expansion-panel {\n  margin-bottom: 7px;\n  border-radius: 8px !important;\n  border: 1px solid #dadada;\n}\n\n.manage-assets .mat-expansion-panel-header-title {\n  margin-right: 0px !important;\n}\n\n.subCategory {\n  padding-top: 10px;\n  font-family: \"Montserrat\", sans-serif;\n  font-weight: 400;\n  letter-spacing: 0.3px;\n  -webkit-font-smoothing: inherit;\n  -moz-osx-font-smoothing: inherit;\n  padding-bottom: 10px;\n}\n\n.wd-100 {\n  width: 100%;\n}\n\n.wd-50 {\n  width: 50%;\n}\n\n.wd-33 {\n  width: 33%;\n}\n\n.flex-end {\n  justify-content: flex-end;\n  align-items: center;\n}\n\n.mat-expanded .mat-expansion-indicator {\n  margin-top: 8px !important;\n}\n\n.edit-asset {\n  position: absolute;\n  right: 17px;\n  top: 7px;\n}\n\n.delete-asset {\n  position: absolute;\n  right: 0px;\n  top: 7px;\n}\n\n.selected-list .c-btn {\n  color: #373946;\n  font-size: 13px !important;\n  font-family: \"Montserrat\", sans-serif;\n  font-weight: 400;\n  letter-spacing: 0.3px;\n  -webkit-font-smoothing: inherit;\n  -moz-osx-font-smoothing: inherit;\n}\n\n.pure-checkbox {\n  color: #373946;\n  font-size: 12px !important;\n  font-family: \"Montserrat\", sans-serif;\n  font-weight: 400;\n  letter-spacing: 0.3px;\n  -webkit-font-smoothing: inherit;\n  -moz-osx-font-smoothing: inherit;\n}\n\n.outer-maintain app-pagination .pagination-wrapper {\n  background: #f6f8f8;\n  box-shadow: 0px 3px 1px -2px #191c1e, 0px 2px 2px 0px #191c1e, 0px 1px 5px 0px #191c1e;\n  border-radius: 8px;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
  ...
  function srcAppAmsAssetsComponentsManageMaintenanceManageMaintenanceComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function ManageMaintenanceComponent(lookupService, sharedService, route, cookieService, injector, assetService, csvService) {
      ...
      _createClass(ManageMaintenanceComponent, [{
        ...
        key: "onItemSelectSubcategory",
        value: function onItemSelectSubcategory(item) {
          console.log(item);
          this.subCategoryName = item.itemName;
          this.searchAsset();
        }
        ...
        key: "onDeSelectAllSubcategory",
        value: function onDeSelectAllSubcategory(items) {
          console.log(items);
          this.subCategoryName = '';
          this.searchAsset();
        }
        ...
        value: function download() {
          var headerArray = ['assetTagNo', 'assetName', 'assetCategoryName', 'assetSubcategoryName', 'actualMaintDate', 'maintenanceByCompany', 'maintainedbyStaff', 'notes', 'maintLaborCost', 'maintPartsCost', 'maintVat', 'maintWithTax', 'totalDiscount', 'maintenanceTotalBilledAmt', 'plannedMaintenanceDate', 'nextPlannedMaintenance', 'alertBeforeDays'];
          this.csvService.downloadFile(this.maintenanceList, headerArray, 'manageMaintenance');
        }
      }, {
        key: "filterCategoryItem",
        value: function filterCategoryItem(value) {
          this.maintenanceList = this.tempMaintenanceList.filter(function (item) {
            return item.assetName.toString().toLowerCase().indexOf(value.toLowerCase()) > -1;
          } //   ||  item.assetCategoryName.toString().toLowerCase().indexOf(value.toLowerCase()) > -1
          //   ||  item.assetSubcategoryName.toString().toLowerCase().indexOf(value.toLowerCase()) > -1
          );
        }
      }, {
        key: "getSubCategory",
    ...
    }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [src_app_api_controllers_Lookup__WEBPACK_IMPORTED_MODULE_7__["LookupService"], src_app_shared_services_shared_service__WEBPACK_IMPORTED_MODULE_6__["SharedService"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"], ngx_cookie_service__WEBPACK_IMPORTED_MODULE_2__["CookieService"], _angular_core__WEBPACK_IMPORTED_MODULE_1__["Injector"], src_app_api_controllers_Asset__WEBPACK_IMPORTED_MODULE_4__["AssetService"], src_app_shared_services_csv_service__WEBPACK_IMPORTED_MODULE_8__["CsvService"]])], ManageMaintenanceComponent);
    /***/
  }
}]);
//# sourceMappingURL=ams-assets-assets-module-es5.js.map