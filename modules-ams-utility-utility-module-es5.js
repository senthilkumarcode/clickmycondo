  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["modules-ams-utility-utility-module"], {
          ...
          value: function submitInsuranceChargeForm(form) {
            ...
            this.utilityTrackerService.addUtilityTrackerInsuranceCharge(params).subscribe(function (res) {
              if (res.message) {
                ...
                _this.sharedService.openSnackBar("Insurance added successfully", 'success');

                _this.router.navigateByUrl('/ams/utility/history');
              } else {
                _this.isInsuranceSubmitted = true;
                _this.isError = true;
            ...
            if (!this.isEditReading) {
              ...
              this.utilityTrackerService.addUtilityTrackerElectricityCharge(params).subscribe(function (res) {
                if (res.message) {
                  ...
                  _this4.sharedService.openSnackBar("Electricity reading added successfully", 'success');

                  _this4.router.navigateByUrl('/ams/utility/history');
                } else {
                  _this4.isReadingSubmitted = true;
                  _this4.isError = true;
              ...
              this.utilityTrackerService.addUtilityTrackerElectricityCharge(_params).subscribe(function (res) {
                if (res.message) {
                  ...
                  _this4.sharedService.openSnackBar("Electricity reading updated successfully", 'success');
          ...
          value: function ngOnInit() {
            ...
            this.utilityTrackerService.getUtilityTrackerCategorysByApartmentId(params).subscribe(function (res) {
              var electric_category = res.find(function (x) {
                return x.category == 'Electrical Meter';
              });
        ...
        _createClass(UtilityAddReadingComponent, [{
          ...
          value: function loadUtilityCategory() {
            ...
            this.utilityTrackerService.getUtilityTrackerCategorysByApartmentId(params).subscribe(function (res) {
              ...
              _this6.utilityCategoryData.filter(function (key) {
      ...
      var TowerReadingInfoComponent = /*#__PURE__*/function () {
        ...
        _createClass(TowerReadingInfoComponent, [{
          ...
          value: function getWaterReadingCharges() {
            ...
            this.utilityTrackerService.getUtilityTrackerWaterChargesByApartmentIdBlockId(params).subscribe(function (res) {
              _this7.allApartmentWaterCharge = res;

              _this7.getApartmentBlockDetails(); //this.isTowersLoaded = true;
    ...
    function srcAppModulesAmsUtilityComponentsUtilityAddReadingWaterReadingWaterReadingComponentTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var WaterReadingComponent = /*#__PURE__*/function () {
        function WaterReadingComponent(apartmentService, utilityTrackerService, sharedService, sessionService, route) {
        ...
        _createClass(WaterReadingComponent, [{
          ...
          key: "selectedTower",
          value: function selectedTower(e) {
          ...
          value: function ngOnInit() {
            ...
            this.utility_selected_category = {}; //this.utility_selected_category.ratePerUnit =  this.route.params['value'].id;
            ...
            this.utilityTrackerService.getUtilityTrackerCategorysByApartmentId(params).subscribe(function (res) {
              var category = res.find(function (x) {
                return x.category === 'Water Meter Charges';
              });
              _this12.utility_selected_category.ratePerUnit = category.ratePerUnit;
            }, function (error) {});
          }
        }]);
    ...
    function srcAppModulesAmsUtilityComponentsUtilityHistoryUtilityHistoryComponentTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var UtilityHistoryComponent = /*#__PURE__*/function () {
        function UtilityHistoryComponent(lookupService, sharedService, apartmentService, utilityTrackerService, sessionService, constantsService) {
        ...
        _createClass(UtilityHistoryComponent, [{
          ...
          value: function getAllElectricalUtiliy() {
            ...
            this.utilityTrackerService.getElectricityChargesByApartmentId(params).subscribe(function (res) {
              var utilityElecteicalList = res.filter(function (item) {
                return item.isActive;
              });
              var utilityElecteicalSourceData = {
    ...
    function srcAppModulesAmsUtilityUtilityRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var routes = [{
        ...
        children: [{
          ...
          path: 'insurance',
          component: _components_utility_add_reading_add_insurance_add_insurance_component__WEBPACK_IMPORTED_MODULE_14__["AddInsuranceComponent"],
          canActivate: [src_app_core_auth_guards_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]]
        }, {
          path: '**',
          redirectTo: 'water-reading',
