...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["facility-facility-module"], {
  ...
  function srcAppAmsFacilityComponentsFacilityBookingActionsFacilityBookingActionsComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function FacilityBookingActionsComponent(injector, facilityService, cookieService, dialog) {
      ...
      _createClass(FacilityBookingActionsComponent, [{
        ...
        value: function searchData() {
          ...
          if (this.bookingFilter != "") {
            ...
            var filtervalue = this.bookingFilter;
        ...
        value: function ngOnInit() {
          ...
          this.columnData = [{
            ...
            cellsrenderer: function cellsrenderer(row, column, value) {
              var time,
                  fromTime,
                  toTime = _this2.bookingListData.loadedData[row].bookedToTime;
            ...
            cellsrenderer: function cellsrenderer(row, column, value) {
              var time,
                  toTime,
                  fromTime = _this2.bookingListData.loadedData[row].bookedFromTime;
            ...
            cellsrenderer: function cellsrenderer(row, column, value) {
              var rentType,
                  fromTime = _this2.bookingListData.loadedData[row].bookedFromTime;
              var toTime = _this2.bookingListData.loadedData[row].bookedToTime;
              ...
              if (fromTime && toTime) {
                ...
                rentType = "".concat(rentType.hours(), "hrs ").concat(rentType.minutes(), "mins");
            ...
            cellsrenderer: function cellsrenderer(row, column, value) {
              ...
              if (value) {
                label = _this2.bookingListData.loadedData[row].facilityBookingStatusId_Label;
              }
            ...
            cellsrenderer: function cellsrenderer(row) {
              return '<div class="simple-actions">' + '<a href="javascript:void(0)" class="mr-3" onClick="editFacilityBooking(' + row + ')"><i class="fa fa-eye icon view" aria-hidden="true"></i></a>';
            },
            minwidth: 80,
            renderer: columnrenderer
          }];
      ...
      _createClass(FacilityCalenderComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.facilityService.getApartmentFacilityBookingsByApartmentId(bookingParams).subscribe(function (res) {
            ...
            _this3.source.localdata = calenderData;
            _this3.dataAdapter = new jqx.dataAdapter(_this3.source);
            _this3.resources.source = new jqx.dataAdapter(_this3.source);
          });
        }
      }, {
        key: "ngAfterViewInit",
        ...
        value: function createFacility() {
          ...
          this.accessTower.selectedItems.forEach(function (ele) {
            var entity = {
              ...
              apartmentFacilityId: _this4.facilityType.type == 'create' ? 0 : _this4.facility.apartmentFacilityId,
              isActive: true,
          ...
          this.facilityapiservice[apiName](apartmentFacilityParams).subscribe(function (res) {
            if (res.message) {
              var message = _this4.facilityType.type == 'create' ? 'Facility added successfully' : 'Facility Updated successfully';

              _this4.sharedService.setAlertMessage(message);

              _this4.router.navigate(['/ams/facility/list']);
            } else {
            ...
            _this4.isCategoryError = true;
            _this4.alertMessage = "Server Error";
          });
        }
      }, {
        key: "getBlockNumber",
            ...
            if (params.type) {
              if (params.id) {
                ...
                _this5.facilityapiservice.getApartmentFacilityByFacilityId(entity).subscribe(function (res) {
                  ...
                  _this5.facility.minTimeLimit = moment__WEBPACK_IMPORTED_MODULE_2__(_this5.facility.minTimeLimit, 'HH:mm:ss').format();
                  _this5.facility.maxTimeLimit = moment__WEBPACK_IMPORTED_MODULE_2__(_this5.facility.maxTimeLimit, 'HH:mm:ss').format();
                  _this5.facility.apartmentBlockId = _this5.facility.apartmentBlockID;
                  delete _this5.facility.apartmentBlockID;

                  _this5.facility.apartmentFacilitySlot.forEach(function (ele) {
                  ...
                  _this5.facility.apartmentFacilityAllowedBlock.forEach(function (data) {
                    _this5.accessTower.selectedItems.push({
                      apartmentBlockNumber: _this5.getBlockNumber(data.apartmentBlockId),
                      apartmentBlockId: data.apartmentBlockId,
                      id: data.id
                    });
                  });

                  _this5.accessTower.selectedItems;
