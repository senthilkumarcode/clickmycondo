...
const routes = [
    { path: '', component: _ams_component__WEBPACK_IMPORTED_MODULE_3__["AmsComponent"],
        children: [
            ...
            { path: 'broadcast', loadChildren: () => Promise.all(/*! import() | broadcast-broadcast-module */[__webpack_require__.e("default~broadcast-broadcast-module~inbox-inbox-module"), __webpack_require__.e("broadcast-broadcast-module")]).then(__webpack_require__.bind(null, /*! ./broadcast/broadcast.module */ "./src/app/ams/broadcast/broadcast.module.ts")).then(m => m.BroadcastModule) },
            ...
            { path: 'operational-maintenance', loadChildren: () => __webpack_require__.e(/*! import() | operational-maintanance-operational-maintanance-module */ "operational-maintanance-operational-maintanance-module").then(__webpack_require__.bind(null, /*! ./operational-maintanance/operational-maintanance.module */ "./src/app/ams/operational-maintanance/operational-maintanance.module.ts")).then(m => m.OperationalMaintananceModule) },
            ...
            { path: 'inbox', loadChildren: () => Promise.all(/*! import() | inbox-inbox-module */[__webpack_require__.e("default~broadcast-broadcast-module~inbox-inbox-module"), __webpack_require__.e("inbox-inbox-module")]).then(__webpack_require__.bind(null, /*! ./inbox/inbox.module */ "./src/app/ams/inbox/inbox.module.ts")).then(m => m.InboxModule) },
            { path: '**', redirectTo: 'dashboard', pathMatch: 'full' }
        ]
    }
];
