...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["my-property-my-property-module"], {
  ...
  function node_modulesRawLoaderDistCjsJsSrcAppAmsMyPropertyComponentsPropertyConfigurationPropertyConfigurationComponentHtml(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "<app-loader *ngIf=\"!isDataLoaded\"></app-loader>\n<mat-drawer-container class=\"property-configuration-wrapper\" autosize>\n\t<mat-drawer #drawer  class=\"p-0 col-lg-4 col-md-4 col-sm-4 col-xs-12\" [ngClass]=\"isRouteContainer ? 'p-0 col-lg-8 col-md-8 col-sm-8 col-xs-12' : ''\" mode=\"over\" position=\"end\">\n\t\t<mat-list  >\n\t\t\t<div mat-subheader class=\"d-flex justify-content-between\" >\n\t\t\t\t<div>\n\t\t\t\t\t<span>Asset </span><span (click)=\"isRouteContainer=false;selectedSubCategoryName=''\"  *ngIf=\"selectedCategoryName\"  >/ {{selectedCategoryName}}</span><span *ngIf=\"selectedSubCategoryName\"  >/ {{selectedSubCategoryName}}</span>\n\t\t\t\t</div>\n\t\t\t\t<i (click)=\"drawer.toggle()\"  class=\"fa fa-times icon\" aria-hidden=\"true\"></i>\n\t\t\t</div>\n\t\t\t\t<mat-divider></mat-divider>\n\t\t\t<mat-list-item [hidden]=\"isRouteContainer\" class=\"asset-sub-category mt-2\" *ngFor=\"let subMenu of subMenuList\"\n\t\t\trouterLink=\"asset/{{subMenu.id}}\"\n\t\t\t routerLinkActive=\"active\"\n\t\t\t\t\t[routerLinkActiveOptions]=\"{exact:true}\"\n\t\t\t (click)=\"selectedSubCategoryName=subMenu.name;isRouteContainer=true;\"  >\n\t\t\t  <div mat-line>{{subMenu.name}}</div>\n\t\t\t  <mat-divider></mat-divider>\n\t\t\t</mat-list-item>\n\t\t  </mat-list>\n\t\t<div *ngIf=\"isRouteContainer\"  class=\"d-block mt-5\">\n\t\t\t<div class=\"pt-2\">\n\t\t\t\t<router-outlet></router-outlet>\n\t\t\t</div>\n\t\t</div>\n\t</mat-drawer>\n\t\n<!-- <ng-container *ngIf=\"isDataLoaded\">\n\t<div class=\"property-configuration-wrapper \">\n\t\t<div class=\"card mb-4\">\n\t\t\t<div class=\"card-body p-0\">\n\t\t\t\t<nav class=\"nav nav-pills\" id=\"property-wrapper\">\n\t\t\t\t\t<ul class=\"tabs mr-auto\" id=\"property-tabs\">\n\t\t\t\t\t\t<li *ngFor=\"let menu of menuList\">\n\t\t\t\t\t\t\t<a class=\"nav-item nav-link\" href=\"javascript:void(0)\"\n\t\t\t\t\t\t\t\t(click)=\"navigateProperty(menu)\">{{menu?.name}}</a>\n\t\t\t\t\t\t</li>\n\t\t\t\t\t\t<li *ngFor=\"let asset of assetCategoriesData\"><a class=\"nav-item nav-link\"\n\t\t\t\t\t\t\t\thref=\"javascript:void(0)\" routerLink=\"asset/{{asset.lookupValueId}}\"\n\t\t\t\t\t\t\t\trouterLinkActive=\"active\"\n\t\t\t\t\t\t\t\t[routerLinkActiveOptions]=\"{exact:true}\">{{asset.lookupValueName}}</a></li>\n\t\t\t\t\t</ul>\n\t\t\t\t\t<div class=\"buttons ml-auto\">\n\t\t\t\t\t\t<a class=\"nav-item nav-link prev\" (click)=\"moveTabLeft()\" href=\"javascript:void(0)\">\n\t\t\t\t\t\t\t<i class=\"fa fa-angle-left\" aria-hidden=\"true\"></i>\n\t\t\t\t\t\t</a>\n\t\t\t\t\t\t<a class=\"nav-item nav-link next\" (click)=\"moveTabRight()\" href=\"javascript:void(0)\">\n\t\t\t\t\t\t\t<i class=\"fa fa-angle-right\" aria-hidden=\"true\"></i>\n\t\t\t\t\t\t</a>\n\t\t\t\t\t</div>\n\t\t\t\t</nav>\n\t\t\t</div>\n\t\t</div>\n\t\t<div class=\"mainMenu\" *ngIf=\"isShowSubCategory\">\n\t\t\t<div class=\"menu\">\n\t\t\t\t<div class=\"d-flex justify-content-between mt-3\">\n\t\t\t\t\t<label class=\"labelHeader aftBrd mb-3\">\n\t\t\t\t\t\tAssets\n\t\t\t\t\t</label>\n\t\t\t\t\t<div class=\"input-group input-group-sm mt-4\">\n\t\t\t\t\t\t<span class=\"input-group-addon \" id=\"sizing-addon3\">\n\t\t\t\t\t\t\t<img src=\"assets/icons/search.png\" alt=\"\">\n\t\t\t\t\t\t</span>\n\t\t\t\t\t\t<input type=\"text\" class=\"form-control\" tabindex=\"-1\" placeholder=\"Search\"\n\t\t\t\t\t\t\taria-describedby=\"sizing-addon3\">\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\t\t\t\t<div class=\"menuList\">\n\t\t\t\t\t<a *ngFor=\"let menu of categoryList;let i=index;\" class=\"slide menuCard mb-5\"\n\t\t\t\t\t\t(click)=\"sortSubCategory(menu)\" [style.border]=\"'1px solid '+menu.bg\">\n\t\t\t\t\t\t<label [style.color]=\"menu.bg\">{{menu.name}}</label>\n\t\t\t\t\t\t<div *ngIf=\"menu.id == selectedCategory\" class=\"activeTri\"\n\t\t\t\t\t\t\t[style.border-bottom]=\"'10px solid '+menu.bg\"></div>\n\t\t\t\t\t</a>\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t\t<div class=\"childMenu\">\n\t\t\t\t<div class=\"subMenuList\" *ngIf=\"subMenuList.length\"  >\n\t\t\t\t\t<label [style.color]=\"'#00c36c'\"\n\t\t\t\t\t\tclass=\"w-100 mb-4\">Sub Category</label>\n\t\t\t\t\t<div class=\"subMenuCard\" *ngFor=\"let subMenu of subMenuList\" (click)=\"this.openCollapse = false;selectedSubCategoryName=subMenu.name\" \n\t\t\t\t\t\trouterLink=\"asset/{{subMenu.id}}\" routerLinkActive=\"active\"\n\t\t\t\t\t\t[routerLinkActiveOptions]=\"{exact:true}\">\n\t\t\t\t\t\t<label>{{subMenu.name}}</label>\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t</div>\n\t\t<mat-accordion  *ngIf=\"isShowSubCategory\"  >\n\t\t\t<mat-expansion-panel [expanded]=\"openCollapse\">\n\t\t\t\t<mat-expansion-panel-header>\n\t\t\t\t\t<mat-panel-title>\n\t\t\t\t\t\tAsset / {{selectedCategoryName != '' ? (selectedCategoryName +' / '+selectedSubCategoryName) :''}}\n\t\t\t\t\t</mat-panel-title>\n\t\t\t\t</mat-expansion-panel-header>\n\t\t\t\t\n\t\t\t</mat-expansion-panel>\n\t\t</mat-accordion>\n\n\t\t<div class=\"d-block mt-5\">\n\t\t\t<div class=\"pt-2\">\n\t\t\t\t<router-outlet></router-outlet>\n\t\t\t</div>\n\t\t</div>\n\n\t</div>\n</ng-container> -->\n<ng-container *ngIf=\"isDataLoaded\">\n\t\n\n\t\t<div class=\"card mb-4\">\n\t\t\t<div class=\"card-body p-0\">\n\t\t\t\t<nav class=\"nav nav-pills\" id=\"property-wrapper\">\n\t\t\t\t\t<ul class=\"tabs mr-auto\" id=\"property-tabs\">\n\t\t\t\t\t\t<li *ngFor=\"let menu of menuList\">\n\t\t\t\t\t\t\t<a class=\"nav-item nav-link\" href=\"javascript:void(0)\"\n\t\t\t\t\t\t\t\t(click)=\"navigateProperty(menu)\">{{menu?.name}}</a>\n\t\t\t\t\t\t</li>\n\t\t\t\t\t\t<!-- <li *ngFor=\"let asset of assetCategoriesData\"><a class=\"nav-item nav-link\"\n\t\t\t\t\t\t\thref=\"javascript:void(0)\" routerLink=\"asset/{{asset.lookupValueId}}\"\n\t\t\t\t\t\t\trouterLinkActive=\"active\"\n\t\t\t\t\t\t\t[routerLinkActiveOptions]=\"{exact:true}\">{{asset.lookupValueName}}</a></li> -->\n\t\t\t\t\t</ul>\n\t\t\t\t\t<div class=\"buttons ml-auto\">\n\t\t\t\t\t\t<a class=\"nav-item nav-link prev\" (click)=\"moveTabLeft()\" href=\"javascript:void(0)\">\n\t\t\t\t\t\t\t<i class=\"fa fa-angle-left\" aria-hidden=\"true\"></i>\n\t\t\t\t\t\t</a>\n\t\t\t\t\t\t<a class=\"nav-item nav-link next\" (click)=\"moveTabRight()\" href=\"javascript:void(0)\">\n\t\t\t\t\t\t\t<i class=\"fa fa-angle-right\" aria-hidden=\"true\"></i>\n\t\t\t\t\t\t</a>\n\t\t\t\t\t</div>\n\t\t\t\t</nav>\n\t\t\t</div>\n\t\t</div>\n\t\t<div class=\"mainMenu\" *ngIf=\"isShowSubCategory\">\n\t\t\t<div class=\"menu\">\n\t\t\t\t<div class=\"d-flex justify-content-between mt-3\">\n\t\t\t\t\t<label class=\"labelHeader aftBrd mb-3\">\n\t\t\t\t\t\tAssets\n\t\t\t\t\t</label>\n\t\t\t\t\t<div class=\"input-group input-group-sm mt-4\">\n\t\t\t\t\t\t<span class=\"input-group-addon \" id=\"sizing-addon3\">\n\t\t\t\t\t\t\t<img src=\"assets/icons/search.png\" alt=\"\">\n\t\t\t\t\t\t</span>\n\t\t\t\t\t\t<input type=\"text\" class=\"form-control\" tabindex=\"-1\" placeholder=\"Search\"\n\t\t\t\t\t\t\taria-describedby=\"sizing-addon3\">\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\t\t\t\t<div class=\"menuList\">\n\t\t\t\t\t<a *ngFor=\"let menu of categoryList;let i=index;\" class=\"slide menuCard mb-5\"\n\t\t\t\t\t\t(click)=\"sortSubCategory(menu);drawer.toggle();isRouteContainer=false\" [style.border]=\"'1px solid '+menu.bg\">\n\t\t\t\t\t\t<label [style.color]=\"menu.bg\">{{menu.name}}</label>\n\t\t\t\t\t\t<div *ngIf=\"menu.id == selectedCategory\" class=\"activeTri\"\n\t\t\t\t\t\t\t[style.border-bottom]=\"'10px solid '+menu.bg\"></div>\n\t\t\t\t\t</a>\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t\t<!-- <div class=\"childMenu\">\n\t\t\t<div class=\"subMenuList\" *ngIf=\"subMenuList.length\"  >\n\t\t\t\t<label [style.color]=\"'#00c36c'\"\n\t\t\t\t\tclass=\"w-100 mb-4\">Sub Category</label>\n\t\t\t\t<div class=\"subMenuCard\" *ngFor=\"let subMenu of subMenuList\" (click)=\"this.openCollapse = false;selectedSubCategoryName=subMenu.name\" \n\t\t\t\t\trouterLink=\"asset/{{subMenu.id}}\" routerLinkActive=\"active\"\n\t\t\t\t\t[routerLinkActiveOptions]=\"{exact:true}\">\n\t\t\t\t\t<label>{{subMenu.name}}</label>\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t</div> -->\n\t\t</div>\n\t\t<!-- <mat-accordion  *ngIf=\"isShowSubCategory\"  >\n\t\t<mat-expansion-panel [expanded]=\"openCollapse\">\n\t\t\t<mat-expansion-panel-header>\n\t\t\t\t<mat-panel-title>\n\t\t\t\t\tAsset / {{selectedCategoryName != '' ? (selectedCategoryName +' / '+selectedSubCategoryName) :''}}\n\t\t\t\t</mat-panel-title>\n\t\t\t</mat-expansion-panel-header>\n\t\t\t\n\t\t</mat-expansion-panel>\n\t</mat-accordion> -->\n\n\t\t<div class=\"d-block mt-5\" *ngIf=\"isShowMainRoute\" >\n\t\t\t<div class=\"pt-2\">\n\t\t\t\t<router-outlet></router-outlet>\n\t\t\t</div>\n\t\t</div>\n\n\t</ng-container>\n</mat-drawer-container>";
    /***/
  },
  ...
  function srcAppAmsMyPropertyComponentsPropertyAlertsPropertyAlertsInfoPropertyAlertsInfoComponentScss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = ".property-alerts-info-wrapper .alerts-info-box .alert-box {\n  display: flex;\n  padding: 12px 0;\n}\n.property-alerts-info-wrapper .alerts-info-box .alert-box .date {\n  padding: 0 25px 0 0;\n  font-family: \"Lato\", sans-serif;\n  font-weight: 700;\n  letter-spacing: 0.3px;\n  -webkit-font-smoothing: antialiased;\n  -moz-osx-font-smoothing: grayscale;\n  text-rendering: optimizeLegibility;\n  font-size: 1.6rem;\n  color: #8391a1;\n}\n.property-alerts-info-wrapper .alerts-info-box .alert-box .info {\n  flex: 1;\n  border-bottom: 1px solid #eaeaea;\n  padding: 0 0 15px 0;\n}\n.property-alerts-info-wrapper .alerts-info-box .alert-box .info h5 {\n  padding: 0 0 4px 0;\n  color: #373946;\n}\n.property-alerts-info-wrapper .alerts-info-box .alert-box .info ul li {\n  font-family: \"Lato\", sans-serif;\n  font-weight: 700;\n  letter-spacing: 0.3px;\n  -webkit-font-smoothing: antialiased;\n  -moz-osx-font-smoothing: grayscale;\n  text-rendering: optimizeLegibility;\n  font-size: 1.4rem;\n  margin: 0 15px 0 0;\n  color: #8391a1;\n}\n.property-alerts-info-wrapper .alerts-info-box .alert-box:last-child .info {\n  border-bottom: none;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
  ...
  function srcAppAmsMyPropertyComponentsPropertyAlertsPropertyAlertsComponentScss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = ".property-alerts-wrapper .carousel-box .card {\n  min-height: 125px;\n}\n.property-alerts-wrapper .carousel-box .card .card-body {\n  text-align: center;\n}\n.property-alerts-wrapper .carousel-box .card .card-body h3 {\n  margin: 0 0 10px 0;\n  font-size: 3.2rem;\n  color: #373946;\n}\n.property-alerts-wrapper .carousel-box .card .card-body h5 {\n  font-size: 1.6rem;\n  color: #8391a1;\n  width: 80%;\n  margin: auto;\n}\n.property-alerts-wrapper .alerts-tabs-box .card .card-body .nav-pills {\n  height: 45px;\n  margin: 0 auto;\n  overflow: hidden;\n  position: relative;\n}\n.property-alerts-wrapper .alerts-tabs-box .card .card-body .nav-pills .tabs {\n  position: absolute;\n  left: 0px;\n  top: 0px;\n  min-width: 3000px;\n  margin: 0 0 0 12px;\n  transition: all 0.3s ease;\n}\n.property-alerts-wrapper .alerts-tabs-box .card .card-body .nav-pills .tabs li {\n  display: table-cell;\n  position: relative;\n  text-align: center;\n  cursor: grab;\n  cursor: -webkit-grab;\n  vertical-align: middle;\n  padding: 0;\n  border: 0;\n}\n.property-alerts-wrapper .alerts-tabs-box .card .card-body .nav-pills .tabs li a {\n  padding: 12px 15px !important;\n  font-size: 1.4rem;\n  color: #8391a1;\n  position: relative;\n  background-color: #ffffff;\n  display: inline-block;\n}\n.property-alerts-wrapper .alerts-tabs-box .card .card-body .nav-pills .tabs li a.active {\n  background-color: #ffffff !important;\n  color: #3f51b5;\n}\n.property-alerts-wrapper .alerts-tabs-box .card .card-body .nav-pills .tabs li a.active:after {\n  content: \"\";\n  position: absolute;\n  left: 0;\n  bottom: 0;\n  width: 100% !important;\n  height: 3px;\n  background-color: #3f51b5;\n}\n.property-alerts-wrapper .alerts-tabs-box .card .card-body .nav-pills .tabs li a:focus {\n  outline: none;\n}\n.property-alerts-wrapper .alerts-tabs-box .card .card-body .nav-pills .tabs li:after {\n  content: none;\n}\n.property-alerts-wrapper .alerts-tabs-box .card .card-body .nav-pills .buttons {\n  box-shadow: 0 2px 10px 1px rgba(0, 0, 0, 0.25);\n  -moz-box-shadow: 0 2px 10px 1px rgba(0, 0, 0, 0.25);\n  -webkit-box-shadow: 0 2px 10px 1px rgba(0, 0, 0, 0.25);\n  position: absolute;\n  right: 0;\n  z-index: 2;\n  top: 0;\n  background-color: #5cd694;\n  width: 60px;\n  height: 49px;\n}\n.property-alerts-wrapper .alerts-tabs-box .card .card-body .nav-pills .buttons a {\n  display: inline-block;\n  height: 100% !important;\n}\n.property-alerts-wrapper .alerts-tabs-box .card .card-body .nav-pills .buttons a i {\n  font-size: 2.4rem;\n  color: #ffffff;\n  margin: 0 10px;\n  position: relative;\n  top: 2px;\n}\n.property-alerts-wrapper .alerts-tabs-box .card .card-body .nav-pills .buttons a:hover, .property-alerts-wrapper .alerts-tabs-box .card .card-body .nav-pills .buttons a:focus {\n  outline: none;\n}\n.property-alerts-wrapper .alerts-tabs-box .card .card-body .nav-pills .buttons a:hover i, .property-alerts-wrapper .alerts-tabs-box .card .card-body .nav-pills .buttons a:focus i {\n  color: #1f7a49;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
  ...
  function srcAppAmsMyPropertyComponentsPropertyConfigurationPropertyConfigurationComponentScss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = ".property-configuration-wrapper .card {\n  border-radius: 3px !important;\n}\n.property-configuration-wrapper .card-body .nav-pills {\n  height: 45px;\n  margin: 0 auto;\n  overflow: hidden;\n  position: relative;\n}\n.property-configuration-wrapper .card-body .nav-pills .tabs {\n  position: absolute;\n  left: 0px;\n  top: 0px;\n  min-width: 3000px;\n  margin: 0 0 0 12px;\n  transition: all 0.3s ease;\n}\n.property-configuration-wrapper .card-body .nav-pills .tabs li {\n  display: table-cell;\n  position: relative;\n  text-align: center;\n  cursor: grab;\n  cursor: -webkit-grab;\n  vertical-align: middle;\n  padding: 0;\n  border: 0;\n}\n.property-configuration-wrapper .card-body .nav-pills .tabs li a {\n  padding: 12px !important;\n  font-size: 1.4rem;\n  color: #8391a1;\n  position: relative;\n  background-color: #ffffff;\n  display: inline-block;\n}\n.property-configuration-wrapper .card-body .nav-pills .tabs li a.active {\n  color: #ffffff;\n  background-color: #3f51b5;\n}\n.property-configuration-wrapper .card-body .nav-pills .tabs li a:focus {\n  outline: none;\n}\n.property-configuration-wrapper .card-body .nav-pills .tabs li:after {\n  content: none;\n}\n.property-configuration-wrapper .card-body .nav-pills .buttons {\n  box-shadow: 0 2px 10px 1px rgba(0, 0, 0, 0.25);\n  -moz-box-shadow: 0 2px 10px 1px rgba(0, 0, 0, 0.25);\n  -webkit-box-shadow: 0 2px 10px 1px rgba(0, 0, 0, 0.25);\n  position: absolute;\n  right: 0;\n  z-index: 2;\n  top: 0;\n  background-color: #5cd694;\n  width: 60px;\n  height: 49px;\n}\n.property-configuration-wrapper .card-body .nav-pills .buttons a {\n  display: inline-block;\n  height: 100% !important;\n}\n.property-configuration-wrapper .card-body .nav-pills .buttons a i {\n  font-size: 2.4rem;\n  color: #ffffff;\n  margin: 0 10px;\n  position: relative;\n  top: 2px;\n}\n.property-configuration-wrapper .card-body .nav-pills .buttons a:hover, .property-configuration-wrapper .card-body .nav-pills .buttons a:focus {\n  outline: none;\n}\n.property-configuration-wrapper .card-body .nav-pills .buttons a:hover i, .property-configuration-wrapper .card-body .nav-pills .buttons a:focus i {\n  color: #1f7a49;\n}\n.property-configuration-wrapper .card-body.content {\n  min-height: 200px;\n}\n.property-configuration-wrapper .mainMenu {\n  width: 100%;\n  height: auto;\n  padding: 20px;\n  background-color: white;\n  overflow-y: auto;\n}\n.property-configuration-wrapper .mainMenu .labelHeader {\n  color: #5cd67c !important;\n  font-family: \"Montserrat\", sans-serif;\n  font-size: 24px;\n  font-weight: 300 !important;\n}\n.property-configuration-wrapper .mainMenu .quickMenu {\n  display: flex;\n  flex-direction: row;\n  justify-content: flex-start;\n  flex-wrap: wrap;\n  width: 100%;\n  border-bottom: 1px solid rgba(255, 255, 255, 0.1);\n}\n.property-configuration-wrapper .mainMenu .quickMenu .qMenuList {\n  width: 100%;\n  padding: 20px 0px;\n  display: flex;\n  flex-direction: row;\n  flex-wrap: wrap;\n}\n.property-configuration-wrapper .mainMenu .menu {\n  display: flex;\n  flex-direction: column;\n  justify-content: flex-start;\n  flex-wrap: wrap;\n  width: 100%;\n}\n.property-configuration-wrapper .mainMenu .menu .activeTri {\n  position: absolute;\n  content: \"\";\n  top: 116px;\n  left: 35%;\n  width: 0;\n  height: 0;\n  border-left: 20px solid transparent;\n  border-right: 20px solid transparent;\n  border-bottom: 10px solid #00599d;\n}\n.property-configuration-wrapper .mainMenu .menu .input-group-addon {\n  background: transparent !important;\n  border: none !important;\n}\n.property-configuration-wrapper .mainMenu .menu .input-group > input {\n  background: transparent !important;\n  border: none !important;\n  height: 30px !important;\n  padding: 5px 10px !important;\n  color: #ffffff !important;\n}\n.property-configuration-wrapper .mainMenu .menu .menuList {\n  padding: 10px 0px 0px 0px;\n  display: flex;\n  flex-direction: row;\n  width: 100%;\n  max-width: 100%;\n  flex-wrap: wrap;\n}\n.property-configuration-wrapper .mainMenu .menu .menuList::-webkit-scrollbar-track {\n  width: 4px;\n  background-color: #08ab68;\n  border-radius: 6px;\n  box-shadow: none;\n}\n.property-configuration-wrapper .mainMenu .menu .menuList::-webkit-scrollbar-thumb {\n  box-shadow: none;\n  background-color: #264058;\n  border-radius: 6px;\n}\n.property-configuration-wrapper .mainMenu .menu .menuList .menuCard {\n  width: 116px;\n  min-width: 116px;\n  height: 106px;\n  border-radius: 8px;\n  color: #ffffff;\n  font-family: \"Montserrat\", sans-serif;\n  font-size: 15px;\n  font-weight: 400;\n  margin-right: 16px;\n  padding: 10px;\n  display: flex;\n  flex-flow: column;\n  align-items: center;\n  justify-content: center;\n  position: relative;\n}\n.property-configuration-wrapper .mainMenu .menu .menuList .menuCard:focus {\n  outline: none !important;\n}\n.property-configuration-wrapper .mainMenu .menu .menuList .menuCard label {\n  text-align: center;\n}\n.property-configuration-wrapper .mainMenu .menu .input-group {\n  width: 220px;\n  height: 32px;\n  border-radius: 16px;\n  border: 1px solid #dcdcdc;\n}\n.property-configuration-wrapper .mainMenu .menu .input-group > span {\n  width: 30px;\n  padding: 0px 12px;\n}\n.property-configuration-wrapper .mainMenu .menu .input-group > input {\n  background: transparent;\n  color: rgba(255, 255, 255, 0.7);\n  font-family: \"Montserrat\", sans-serif;\n  font-size: 13px;\n  font-weight: 400;\n  border: none;\n  padding-bottom: 6px !important;\n}\n.property-configuration-wrapper .mainMenu .menu .input-group > input:focus {\n  box-shadow: none !important;\n}\n.property-configuration-wrapper .mainMenu .childMenu {\n  width: 100%;\n  display: flex;\n  flex-direction: column;\n  flex-wrap: wrap;\n}\n.property-configuration-wrapper .mainMenu .childMenu .subMenuList {\n  padding: 20px 0px 10px 0px;\n  display: flex;\n  flex-direction: row;\n  flex-wrap: wrap;\n  width: 100%;\n  overflow-x: auto;\n  overflow-y: hidden;\n}\n.property-configuration-wrapper .mainMenu .childMenu .subMenuList label {\n  font-family: \"Montserrat\", sans-serif;\n  font-weight: 500;\n}\n.property-configuration-wrapper .mainMenu .childMenu .subMenuList .subMenuCard {\n  position: relative;\n  width: 86px;\n  height: 78px;\n  border-radius: 8px;\n  background-color: #2c4156;\n  color: rgba(255, 255, 255, 0.8);\n  font-family: \"Montserrat\", sans-serif;\n  font-size: 12px;\n  font-weight: 500;\n  margin-right: 16px;\n  padding: 10px 2px 2px 2px;\n  display: flex;\n  flex-flow: column;\n  align-items: center;\n  justify-content: center;\n  margin-bottom: 12px;\n  transition: box-shadow 0.15s ease 0s, transform 0.15s ease 0s;\n}\n.property-configuration-wrapper .mainMenu .childMenu .subMenuList .subMenuCard .customizeImg {\n  position: absolute;\n  right: -12px;\n  top: -10px;\n}\n.property-configuration-wrapper .mainMenu .childMenu .subMenuList .subMenuCard label {\n  text-align: center;\n  overflow: hidden;\n}\n.property-configuration-wrapper .mainMenu .childMenu .subMenuList .subMenuCard label:focus {\n  outline: none;\n}\n.property-configuration-wrapper .mainMenu .childMenu .subMenuList .subMenuCard:hover {\n  border: 1px solid #03b568;\n  box-shadow: rgba(2, 8, 20, 0.1) 0px 0.35em 1.175em, rgba(2, 8, 20, 0.08) 0px 0.175em 0.5em;\n  transform: translateY(-2px);\n}\n.property-configuration-wrapper .mainMenu .childMenu .subMenuList .subMenuCard:focus {\n  outline: none;\n}\n.asset-sub-category {\n  font-size: 16px;\n  font-family: \"Lato\", sans-serif;\n  padding: 12px;\n  border-left: 12px solid #673ab7;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
  ...
  function srcAppAmsMyPropertyComponentsPropertyConfigurationPropertyConfigurationComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function PropertyConfigurationComponent(lookupService, router, cookieService) {
        ...
        this.isShowMainRoute = true;
        this.isRouteContainer = false;
        this.isDataLoaded = false;
      ...
      _createClass(PropertyConfigurationComponent, [{
        ...
        value: function getAllCategory() {
          ...
          this.lookupService.getSubcategory(queryParamBase).subscribe(function (res) {
            if (res) {
              ...
              _this9.categoryList.filter(function (key) {
                key['bg'] = _this9.getRandomColor();
              });

              _this9.subMenuList = _this9.categoryList[0].subCategory;
            }
          });
        }
      }, {
        key: "sortSubCategory",
        value: function sortSubCategory(menu) {
          var _this10 = this;

          this.selectedCategory = menu.id;
          this.selectedCategoryName = menu.name;
          this.selectedSubCategoryName = '';
          this.categoryList.filter(function (key) {
            if (key.id == menu.id) {
              _this10.subMenuList = key.subCategory;
            }
          });
        }
      }, {
        ...
        key: "navigateProperty",
        value: function navigateProperty(menu) {
          if (menu.name == 'Assets') {
            this.isShowSubCategory = true;
            this.isShowMainRoute = false;
          } else {
            this.isShowSubCategory = false;
            this.selectedCategoryName = '';
            this.selectedSubCategoryName = '';
            var rootUrl = 'ams/my-property/property-configuration' + menu.url;
        ...
        value: function ngAfterViewInit() {
          ...
          this.lookupService.getLookupValueByLookupTypeId(params).subscribe(function (res) {
            ...
            _this11.assetCategoriesData = res.filter(function (item) {
              return item.isActive;
            });
            setTimeout(function () {
              _this11.tab = document.getElementById('property-tabs');
              _this11.tabItems = _this11.tab.getElementsByTagName("li");
              _this11.totalTabItems = _this11.tabItems.length;
    ...
    }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [src_app_api_controllers_Lookup__WEBPACK_IMPORTED_MODULE_2__["LookupService"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"], ngx_cookie_service__WEBPACK_IMPORTED_MODULE_5__["CookieService"]])], PropertyConfigurationComponent);
    /***/
  },
      ...
      _createClass(PropertyTowerInfoComponent, [{
        ...
        value: function submitPropertyDetailsForm(form) {
          ...
          this.apartmentService.updateApartmentBlock(params).subscribe(function (res) {
            if (res.message) {
              ...
              _this13.sharedService.setAlertMessage(_this13.tower.apartmentBlockNumber + " updated successfully");
            } else {
              _this13.isEdit = false;
            }
          });
        ...
        value: function ngOnInit() {
          ...
          this.apartmentService.getApartmentBlockUnitByBlockId(params).subscribe(function (res) {
            _this14.towerUnitData = res;
            _this14.totalItems = _this14.towerUnitData.length;
      ...
      _createClass(PropertyTowerUnitInfoComponent, [{
        ...
        value: function submitPropertyUnitDetailsForm(form) {
          ...
          this.apartmentService.updateApartmentBlockUnit(params).subscribe(function (res) {
            if (res.message) {
              ...
              _this15.sharedService.setAlertMessage(_this15.tower.apartmentBlockNumber + " " + _this15.unit.apartmentBlockUnitNumber + " updated successfully");
            } else {
              _this15.isEdit = false;
            }
          });
        ...
        value: function ngOnInit() {
          ...
          this.lookupService.getLookupValueByLookupTypeId(unitParams).subscribe(function (res) {
            ...
            setTimeout(function () {
              _this16.getUnitType(_this16.unit.unitType);
            }, 1000);
          }, function (error) {});
        }
      }]);
  ...
  function srcAppAmsMyPropertyComponentsPropertyConfigurationPropertyFacilityPropertyFacilityComponentScss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "@media (max-width: 991px) {\n  .property-facility-wrapper .list-boxes .column {\n    margin: 0 0 20px 0;\n  }\n}\n.property-facility-wrapper .list-boxes .card {\n  height: 100% !important;\n}\n.property-facility-wrapper .list-boxes .card h4 {\n  font-size: 1.6rem;\n  color: #373946;\n}\n.property-facility-wrapper .list-boxes .card .card-body {\n  padding: 0 0 5px 0;\n}\n.property-facility-wrapper .list-boxes .card .card-body:hover {\n  background-color: #ffffff;\n}\n.property-facility-wrapper .list-boxes .card .card-body li {\n  list-style: none;\n  margin: 0 !important;\n  padding: 8px 20px;\n  overflow: auto;\n  min-width: auto;\n}\n.property-facility-wrapper .list-boxes .card .card-body li div {\n  font-family: \"Lato\", sans-serif;\n  font-weight: 400;\n  letter-spacing: 0.3px;\n  -webkit-font-smoothing: inherit;\n  -moz-osx-font-smoothing: inherit;\n  font-size: 1.4rem;\n  color: #373946;\n  float: right;\n}\n.property-facility-wrapper .list-boxes .card .card-body li div.title {\n  color: #8391a1;\n  float: left;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
      ...
      _createClass(PropertyFacilityComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.apartmentService.getApartmentBlockByApartmentId(params).subscribe(function (res) {
            ...
            _this17.facilityService.getPcApartmentFacility(params).subscribe(function (res) {
              _this17.facilityData = res;
              underscore__WEBPACK_IMPORTED_MODULE_5__["each"](_this17.facilityData, function (item, index) {
                _this17.facilityData[index]["class"] = _this17.dotItems[Math.floor(Math.random() * _this17.dotItems.length)];
              });
      ...
      _createClass(PropertyParkingDetailsInfoComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.lookupService.getLookupValueByLookupTypeId(params).subscribe(function (res) {
            ...
            _this18.slotDataList = res.filter(function (item) {
              return item.isActive;
            });
          });
        }
  ...
  function srcAppAmsMyPropertyComponentsPropertyConfigurationPropertyProfilePropertyProfileComponentScss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = ".property-profile-wrapper .property-info {\n  width: 80%;\n}\n.property-profile-wrapper .property-info .profile-icon {\n  display: flex;\n  border-radius: 3px !important;\n  width: 150px;\n  height: 100px;\n  overflow: hidden;\n  margin: 0 20px 0 0;\n}\n@media (max-width: 768px) {\n  .property-profile-wrapper .property-info .profile-icon {\n    width: 85px;\n    height: auto;\n    margin: 0 15px 0 0;\n  }\n}\n.property-profile-wrapper .property-info h5 {\n  font-size: 2rem;\n  padding: 0 0 2px 0;\n  color: #3f51b5;\n}\n.property-profile-wrapper .property-info p {\n  font-size: 1.4rem;\n  color: #5f5f5f;\n}\n.property-profile-wrapper .property-info .other {\n  margin: 8px 0 0 0 !important;\n}\n.property-profile-wrapper .property-info .other li {\n  margin: 0 30px 0 0;\n  font-family: \"Lato\", sans-serif;\n  font-weight: 400;\n  letter-spacing: 0.3px;\n  -webkit-font-smoothing: inherit;\n  -moz-osx-font-smoothing: inherit;\n  font-size: 1.4rem;\n  color: #8391a1;\n}\n.property-profile-wrapper .property-info .other li .icon {\n  width: 20px;\n  margin: 0 10px 0 0;\n  color: #673ab7;\n}\n.property-profile-wrapper .property-info .other li .icon.phone {\n  width: 18px;\n}\n@media (max-width: 768px) {\n  .property-profile-wrapper .property-info .other {\n    margin: 20px 0 0 0 !important;\n  }\n  .property-profile-wrapper .property-info .other li {\n    display: block;\n  }\n  .property-profile-wrapper .property-info .other li:not(:last-child) {\n    margin: 0 0 10px 0;\n  }\n  .property-profile-wrapper .property-info .other li .icon {\n    margin: 0 16px 0 0;\n  }\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
      ...
      _createClass(PropertyProfileComponent, [{
        ...
        value: function getProperty(event) {
          ...
          this.updateApartment(function (res) {
            ...
            _this20.apartmentService.getApartmentByApartmentId(params).subscribe(function (res) {
              _this20.property = res[0];
            });
          });
        }
      }, {
        ...
        value: function updateApartment(callback) {
          ...
          this.apartmentService.updateApartment(apartmentParams).subscribe(function (res) {
            if (res.message) {
              ...
              _this21.isEdit = false;

              _this21.sharedService.setAlertMessage("Property updated successfully");
            } else {
              _this21.isDataLoaded = true;
              _this21.isEdit = false;
            }
        ...
        value: function ngOnInit() {
          ...
          this.apartmentService.getApartmentByApartmentId(params).subscribe(function (res) {
            _this22.property = res[0];
            var params = {
              apartmentId: parseInt(_this22.cookieService.get('apartmentId'))
            };

            _this22.apartmentService.getApartmentBlockByApartmentId(params).subscribe(function (res) {
              _this22.towersLength = res.length;
              var params = {
                apartmentId: parseInt(_this22.cookieService.get('apartmentId'))
              };

              _this22.apartmentService.getApartmentBlockUnitByApartmentId(params).subscribe(function (res) {
                _this22.unitsLength = res.length;
              });
            });
          ...
          this.lookupService.getLookupValueByLookupTypeId(propertyCategoryParams).subscribe(function (res) {
            _this22.propertyCategoryData = res;
          }, function (error) {});
        }
      }]);
      ...
      _createClass(PropertyTowerDetailsComponent, [{
        ...
        value: function getFilterBasedData(evt) {
          ...
          var filterTypeName = this.ddlfilterType.find(function (x) {
            return x.TypeId === _this23.selectedFilterType;
          }).TypeName;
  ...
  function srcAppAmsMyPropertyMyPropertyModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    MyPropertyModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      ...
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _shared_shared_module__WEBPACK_IMPORTED_MODULE_4__["SharedModule"], _my_property_routing_module__WEBPACK_IMPORTED_MODULE_3__["MyPropertyRoutingModule"], _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_23__["NgbTooltipModule"], _angular_material_sidenav__WEBPACK_IMPORTED_MODULE_26__["MatSidenavModule"]],
